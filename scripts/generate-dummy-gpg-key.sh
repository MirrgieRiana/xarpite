...
echo ""
echo "export GPG_SIGNING_ZIP_BASE64=\$(cat $OUTPUT_DIR/private-key-base64.txt)"
echo "export GPG_SIGNING_PASSPHRASE=\"\""
echo ""
echo "Then run:"
...
echo "- GPG_SIGNING_ZIP_BASE64: content of private-key-base64.txt"
echo "- GPG_SIGNING_PASSPHRASE: your key password (empty for this test key)"
echo ""
