...
class InfixColonColonNode(left: Node, right: Node, val position: Position) : InfixNode(left, right)
class InfixQuestionColonColonNode(left: Node, right: Node, val position: Position) : InfixNode(left, right)
