...
Leaving the `pattern` empty results in a syntax error. Writing `//` is never treated as a regular expression literal; it becomes a line comment or a syntax error instead.
