...
インクリメント演算子は、変数の値を1増加させる演算子です。

前置版と後置版があり、それぞれ異なる値を返します。

### 前置インクリメント `++value`

前置インクリメント演算子は、値に1を加算し、新しい値を返します。
...
後置インクリメント演算子は、値に1を加算し、古い値を返します。
...
デクリメント演算子は、変数の値を1減少させる演算子です。

前置版と後置版があり、それぞれ異なる値を返します。

### 前置デクリメント `--value`

前置デクリメント演算子は、値から1を減算し、新しい値を返します。
...
後置デクリメント演算子は、値から1を減算し、古い値を返します。
...
インクリメント・デクリメント演算子は純粋な加減算代入のシンタックスシュガーであり、専用のメソッドオーバーライドは存在しません。
