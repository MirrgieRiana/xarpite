...
function parseString$default(string, base, $super) {
  ...
  return $super === VOID ? this.f2d(string, base) : $super.f2d.call(this, string, base);
}
function tryFromFloat$default(float, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.i2d(float, exactRequired) : $super.i2d.call(this, float, exactRequired);
}
function tryFromDouble$default(double, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.k2d(double, exactRequired) : $super.k2d.call(this, double, exactRequired);
}
initMetadataForInterface(Creator, 'Creator');
function plus_0(other) {
  return this.n2d().p2d(other);
}
function minus(other) {
  return this.n2d().r2d(other);
}
function times(other) {
  return this.n2d().t2d(other);
}
function div(other) {
  return this.n2d().v2d(other);
}
function plus_1(int) {
  return this.n2d().p2d(this.m2d().h2d(int));
}
function times_0(int) {
  return this.n2d().t2d(this.m2d().h2d(int));
}
function minus_0(int) {
  return this.n2d().r2d(this.m2d().h2d(int));
}
function div_0(int) {
  return this.n2d().v2d(this.m2d().h2d(int));
}
function rem(int) {
  return this.n2d().b2e(this.m2d().h2d(int));
}
...
function determineDecider($this, discarded) {
  var tmp = Companion_getInstance_1().l2e_1;
  // Inline function 'kotlin.Long.minus' call
  var this_0 = discarded.r2e();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  var scale = tmp.s2e(tmp$ret$0);
  var divrem = discarded.t2e(scale);
  var significant = divrem.u2e_1.w2e().x2e(true);
  var rest = divrem.v2e_1.w2e();
  var tmp_0;
  if (significant === 5) {
    var tmp_1;
    if (rest.equals(Companion_getInstance_1().i2e_1)) {
...
function roundDiscarded($this, significand, discarded, decimalMode) {
  var toDiscard = subtract(significand.r2e(), decimalMode.c2e_1);
  var tmp;
  if (compare(toDiscard, new Long(0, 0)) > 0) {
    var additionallyDiscarded = significand.t2e(Companion_getInstance_1().l2e_1.s2e(toDiscard));
    tmp = new Pair(additionallyDiscarded.u2e_1, additionallyDiscarded.v2e_1);
  } else {
    tmp = new Pair(significand, discarded);
  }
  var _destruct__k2r9zo = tmp;
  var result = _destruct__k2r9zo.ue();
  var remainder = _destruct__k2r9zo.ve();
  var tmp_0;
  if (significand.equals(Companion_getInstance_1().i2e_1)) {
    tmp_0 = discarded.o2e_1;
  } else {
    tmp_0 = significand.o2e_1;
  }
  var sign = tmp_0;
  if (!decimalMode.d2e_1.equals(RoundingMode_AWAY_FROM_ZERO_getInstance()) && !decimalMode.d2e_1.equals(RoundingMode_TOWARDS_ZERO_getInstance())) {
    if (remainder.y2e()) {
      return result;
    }
  } else {
    if (remainder.y2e() && discarded.y2e()) {
      return result;
    }
  }
  var decider = determineDecider($this, remainder);
  switch (decimalMode.d2e_1.r2_1) {
    case 2:
    ...
    case 9:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.a2e(2).w2e().equals(Companion_getInstance_1().j2e_1)) {
          switch (sign.r2_1) {
            case 0:
              result = result.a2f();
              break;
    ...
    case 10:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.a2e(2).equals(Companion_getInstance_1().i2e_1)) {
          switch (sign.r2_1) {
            case 0:
              result = result.a2f();
              break;
...
function roundSignificand($this, significand, exponent, decimalMode) {
  if (significand.y2e()) {
    return new BigDecimal(Companion_getInstance_1().i2e_1, exponent, decimalMode);
  }
  var significandDigits = significand.r2e();
  var tmp;
  if (decimalMode.g2e_1) {
    tmp = add(decimalMode.c2e_1, decimalMode.e2e_1);
  } else {
    tmp = decimalMode.c2e_1;
  }
  var desiredPrecision = tmp;
  var tmp_0;
  if (compare(desiredPrecision, significandDigits) > 0 && !decimalMode.g2e_1) {
    var extendedSignificand = significand.s2d(Companion_getInstance_1().l2e_1.s2e(subtract(desiredPrecision, significandDigits)));
    tmp_0 = new BigDecimal(extendedSignificand, exponent, decimalMode);
  } else if (compare(desiredPrecision, significandDigits) < 0) {
    var divRem = significand.t2e(Companion_getInstance_1().l2e_1.s2e(subtract(significandDigits, desiredPrecision)));
    var resolvedRemainder = divRem.v2e_1;
    if (divRem.v2e_1.equals(Companion_getInstance_1().i2e_1)) {
      return new BigDecimal(divRem.u2e_1, exponent, decimalMode);
    }
    var tmp_1;
    if (equalsLong(significand.r2e(), add(divRem.u2e_1.r2e(), divRem.v2e_1.r2e()))) {
      var newSignificand = roundDiscarded($this, divRem.u2e_1, resolvedRemainder, decimalMode);
      var exponentModifier = subtract(newSignificand.r2e(), divRem.u2e_1.r2e());
      tmp_1 = new BigDecimal(newSignificand, add(exponent, exponentModifier), decimalMode);
    } else {
      tmp_1 = $this.m2f(divRem.u2e_1, exponent, decimalMode);
    }
    tmp_0 = tmp_1;
  } else {
...
function applyScale($this, significand, exponent, decimalMode) {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var this_0 = add(exponent, decimalMode.e2e_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = new DecimalMode(tmp$ret$0, decimalMode.d2e_1);
  } else if (compare(exponent, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = decimalMode.e2e_1;
    var tmp$ret$1 = add(this_1, fromInt(1));
    tmp = new DecimalMode(tmp$ret$1, decimalMode.d2e_1);
  } else {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var tmp_1;
    if (decimalMode.d2e_1.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      var temp = (new BigDecimal(significand, exponent)).w2d(imul(significand.n2f(), 2));
      tmp_1 = roundSignificand($this, temp.p2f_1, temp.q2f_1, workMode).y2d(imul(significand.n2f(), 2));
    } else {
      var temp_0 = (new BigDecimal(significand, exponent)).w2d(significand.n2f());
      tmp_1 = roundSignificand($this, temp_0.p2f_1, temp_0.q2f_1, workMode).y2d(significand.n2f());
    }
    tmp_0 = tmp_1;
  }
  return tmp_0;
...
function resolveDecimalMode($this, firstDecimalMode, secondDecimalMode, suppliedDecimalMode) {
  ...
  if (!(suppliedDecimalMode == null)) {
    ...
    if (!ensureNotNull(firstDecimalMode).d2e_1.equals(ensureNotNull(secondDecimalMode).d2e_1)) {
      throw ArithmeticException_init_$Create$('Different rounding modes! This: ' + firstDecimalMode.d2e_1.toString() + ' Other: ' + secondDecimalMode.d2e_1.toString());
    }
    var tmp_0;
    if (compare(firstDecimalMode.c2e_1, secondDecimalMode.c2e_1) >= 0) {
...
function Companion() {
  ...
  this.b2f_1 = new BigDecimal(Companion_getInstance_1().i2e_1);
  this.c2f_1 = new BigDecimal(Companion_getInstance_1().j2e_1);
  this.d2f_1 = new BigDecimal(Companion_getInstance_1().k2e_1);
  this.e2f_1 = new BigDecimal(Companion_getInstance_1().l2e_1, new Long(1, 0));
  this.f2f_1 = false;
  var tmp = this;
  // Inline function 'kotlin.doubleArrayOf' call
  tmp.g2f_1 = new Float64Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10, 1.0E11, 1.0E12, 1.0E13, 1.0E14, 1.0E15, 1.0E16, 1.0E17, 1.0E18, 1.0E19, 1.0E20, 1.0E21, 1.0E22]);
  this.h2f_1 = this.w2f(1.7976931348623157E308);
  this.i2f_1 = this.w2f(4.9E-324);
  var tmp_0 = this;
  // Inline function 'kotlin.floatArrayOf' call
  tmp_0.j2f_1 = new Float32Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10]);
  this.k2f_1 = this.x2f(3.4028235E38);
  this.l2f_1 = this.x2f(1.4E-45);
}
protoOf(Companion).m2f = function (significand, exponent, decimalMode) {
  var tmp;
  if (significand.o2e_1.equals(Sign_POSITIVE_getInstance())) {
    var tmp_0;
    switch (decimalMode.d2e_1.r2_1) {
      case 1:
      case 2:
        var increasedSignificand = significand.a2f();
        var exponentModifier = subtract(increasedSignificand.r2e(), significand.r2e());
    ...
    tmp = tmp_0;
  } else if (significand.o2e_1.equals(Sign_NEGATIVE_getInstance())) {
    var tmp_1;
    switch (decimalMode.d2e_1.r2_1) {
      case 0:
      case 2:
        var increasedSignificand_0 = significand.z2e();
        var exponentModifier_0 = subtract(increasedSignificand_0.r2e(), significand.r2e());
...
protoOf(Companion).y2f = function (long, decimalMode) {
  var bigint = Companion_getInstance_1().z2f(long);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2e();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2g(decimalMode);
};
protoOf(Companion).b2g = function (int, decimalMode) {
  var bigint = Companion_getInstance_1().h2d(int);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2e();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2g(decimalMode);
};
protoOf(Companion).c2g = function (short, decimalMode) {
  var bigint = Companion_getInstance_1().d2g(short);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2e();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2g(decimalMode);
};
protoOf(Companion).e2g = function (byte, decimalMode) {
  var bigint = Companion_getInstance_1().f2g(byte);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2e();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2g(decimalMode);
};
protoOf(Companion).g2g = function (float, decimalMode) {
  ...
  if (contains(floatString, _Char___init__impl__6a9atx(46)) && !contains(floatString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.h2g(tmp$ret$1, decimalMode).a2g(decimalMode);
  } else {
    tmp = this.h2g(floatString, decimalMode).a2g(decimalMode);
  }
  return tmp;
};
protoOf(Companion).x2f = function (float, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.g2g(float, decimalMode) : $super.g2g.call(this, float, decimalMode);
};
protoOf(Companion).i2g = function (double, decimalMode) {
  ...
  if (contains(doubleString, _Char___init__impl__6a9atx(46)) && !contains(doubleString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.h2g(doubleString, decimalMode).a2g(decimalMode).a2g(decimalMode);
  }
  return tmp;
};
protoOf(Companion).w2f = function (double, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.i2g(double, decimalMode) : $super.i2g.call(this, double, decimalMode);
};
protoOf(Companion).z2f = function (long) {
  return this.y2f(long, null);
};
protoOf(Companion).h2d = function (int) {
  return this.b2g(int, null);
};
protoOf(Companion).d2g = function (short) {
  return this.c2g(short, null);
};
protoOf(Companion).f2g = function (byte) {
  return this.e2g(byte, null);
};
protoOf(Companion).i2d = function (float, exactRequired) {
  return this.g2g(float, null);
};
protoOf(Companion).k2d = function (double, exactRequired) {
  return this.i2g(double, null);
};
protoOf(Companion).f2d = function (string, base) {
  return this.h2g(string, null);
};
protoOf(Companion).j2g = function (string) {
  return this.k2g(string);
};
protoOf(Companion).h2g = function (floatingPointString, decimalMode) {
  ...
  if (contains(floatingPointString, _Char___init__impl__6a9atx(69), true)) {
    ...
    if (split_0.u() === 2) {
      ...
      var significand = Companion_getInstance_1().f2d(leftTruncated + rightTruncated, 10);
      if (significand.equals(Companion_getInstance_1().i2e_1)) {
        sign = Sign_ZERO_getInstance();
      }
      if (sign.equals(Sign_NEGATIVE_getInstance())) {
        significand = significand.l2g();
      }
      var tmp_6;
      if (!(leftTruncated === '0')) {
        // Inline function 'kotlin.Long.plus' call
        ...
        // Inline function 'kotlin.Long.minus' call
        var this_2 = subtract(exponent, subtract(numberToLong(rightTruncated.length), significand.r2e()));
    ...
    if (contains(floatingPointString, _Char___init__impl__6a9atx(46))) {
      ...
      if (split_1.u() === 2) {
        ...
        var significand_0 = Companion_getInstance_1().f2d(leftTruncated_0 + rightTruncated_0, 10);
        var tmp_10;
        var tmp_11;
        ...
        if (significand_0.equals(Companion_getInstance_1().i2e_1)) {
          sign_0 = Sign_ZERO_getInstance();
        }
        if (sign_0.equals(Sign_NEGATIVE_getInstance())) {
          significand_0 = significand_0.l2g();
        }
        return new BigDecimal(significand_0, fromInt(exponent_0), decimalMode);
      } else
        throw ArithmeticException_init_$Create$('Invalid (or unsupported) floating point number format: ' + floatingPointString);
    } else {
      var significand_1 = Companion_getInstance_1().f2d(floatingPointString, 10);
      // Inline function 'kotlin.Long.minus' call
      var this_3 = significand_1.r2e();
      var tmp$ret$16 = subtract(this_3, fromInt(1));
      return new BigDecimal(significand_1, tmp$ret$16, decimalMode);
    }
  }
};
protoOf(Companion).k2g = function (floatingPointString, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.h2g(floatingPointString, decimalMode) : $super.h2g.call(this, floatingPointString, decimalMode);
};
...
function removeTrailingZeroes($this, bigDecimal) {
  if (bigDecimal.y2e())
    return $this;
  var significand = bigDecimal.p2f_1;
  var divisionResult = new QuotientAndRemainder(bigDecimal.p2f_1, Companion_getInstance_1().i2e_1);
  do {
    divisionResult = divisionResult.u2e_1.t2e(Companion_getInstance_1().l2e_1);
    if (divisionResult.v2e_1.equals(Companion_getInstance_1().i2e_1)) {
      significand = divisionResult.u2e_1;
    }
  }
   while (divisionResult.v2e_1.equals(Companion_getInstance_1().i2e_1));
  return new BigDecimal(significand, bigDecimal.q2f_1);
}
...
function computeMode($this, other, op) {
  var tmp;
  if ($this.r2f_1 == null || $this.r2f_1.f2e_1 || other.r2f_1 == null || other.r2f_1.f2e_1) {
    tmp = Companion_getInstance_0().m2g_1;
  } else {
    var tmp0 = $this.r2f_1.c2e_1;
    // Inline function 'kotlin.math.max' call
    var b = other.r2f_1.c2e_1;
    var tmp_0 = compare(tmp0, b) >= 0 ? tmp0 : b;
    var tmp_1;
    if ($this.r2f_1.g2e_1 && other.r2f_1.g2e_1) {
      var tmp_2;
      switch (op.r2_1) {
        case 0:
          var tmp0_0 = $this.r2f_1.e2e_1;
          // Inline function 'kotlin.math.max' call

          var b_0 = other.r2f_1.e2e_1;
          tmp_2 = compare(tmp0_0, b_0) >= 0 ? tmp0_0 : b_0;
          break;
        case 1:
          var tmp0_1 = $this.r2f_1.e2e_1;
          // Inline function 'kotlin.math.min' call

          var b_1 = other.r2f_1.e2e_1;
          tmp_2 = compare(tmp0_1, b_1) <= 0 ? tmp0_1 : b_1;
          break;
        case 2:
          tmp_2 = add($this.r2f_1.e2e_1, other.r2f_1.e2e_1);
          break;
        default:
          noWhenBranchMatchedException();
          break;
    ...
    tmp = new DecimalMode(tmp_0, $this.r2f_1.d2e_1, tmp_1);
  }
  return tmp;
}
function checkWholeness($this, exactRequired) {
  if (exactRequired && !$this.o2g())
...
function getRidOfRadix($this, bigDecimal) {
  var precision = bigDecimal.p2f_1.r2e();
  // Inline function 'kotlin.Long.plus' call
  var this_0 = subtract(bigDecimal.q2f_1, precision);
  var newExponent = add(this_0, fromInt(1));
  return new BigDecimal(bigDecimal.p2f_1, newExponent);
}
function bringSignificandToSameExponent($this, first, second) {
  ...
  var firstPreparedExponent = firstPrepared.q2f_1;
  var secondPreparedExponent = secondPrepared.q2f_1;
  var tmp;
  if (compare(first.q2f_1, second.q2f_1) > 0) {
    var moveFirstBy = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_0;
    if (compare(moveFirstBy, new Long(0, 0)) >= 0) {
      var movedFirst = firstPrepared.p2f_1.s2d(toBigInteger(10).s2e(moveFirstBy));
      return new Triple(movedFirst, second.p2f_1, secondPreparedExponent);
    } else {
      var tmp_1 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$0 = multiply(moveFirstBy, fromInt(-1));
      var movedSecond = secondPrepared.p2f_1.s2d(tmp_1.s2e(tmp$ret$0));
      tmp_0 = new Triple(first.p2f_1, movedSecond, firstPreparedExponent);
    }
    tmp = tmp_0;
  } else if (compare(first.q2f_1, second.q2f_1) < 0) {
    var moveSecondBy = subtract(secondPreparedExponent, firstPreparedExponent);
    var tmp_2;
    if (compare(moveSecondBy, new Long(0, 0)) >= 0) {
      var movedSecond_0 = secondPrepared.p2f_1.s2d(toBigInteger(10).s2e(moveSecondBy));
      tmp_2 = new Triple(first.p2f_1, movedSecond_0, firstPreparedExponent);
    } else {
      var tmp_3 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$1 = multiply(moveSecondBy, fromInt(-1));
      var movedFirst_0 = firstPrepared.p2f_1.s2d(tmp_3.s2e(tmp$ret$1));
      tmp_2 = new Triple(movedFirst_0, second.p2f_1, firstPreparedExponent);
    }
    return tmp_2;
  } else if (equalsLong(first.q2f_1, second.q2f_1)) {
    var delta = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_4;
    if (compare(delta, new Long(0, 0)) > 0) {
      var movedFirst_1 = first.p2f_1.s2d(toBigInteger(10).s2e(delta));
      tmp_4 = new Triple(movedFirst_1, second.p2f_1, firstPreparedExponent);
    } else {
      if (compare(delta, new Long(0, 0)) < 0) {
        var tmp_5 = toBigInteger(10);
        // Inline function 'kotlin.Long.times' call
        var tmp$ret$2 = multiply(delta, fromInt(-1));
        var movedSecond_1 = second.p2f_1.s2d(tmp_5.s2e(tmp$ret$2));
        tmp_4 = new Triple(first.p2f_1, movedSecond_1, firstPreparedExponent);
      } else {
        // Inline function 'kotlin.Long.compareTo' call
        if (delta.z2(fromInt(0)) === 0) {
          tmp_4 = new Triple(first.p2f_1, second.p2f_1, firstPreparedExponent);
        } else {
    ...
    throw RuntimeException_init_$Create$('Invalid comparison state BigInteger: ' + first.q2f_1.toString() + ', ' + second.q2f_1.toString());
  }
  return tmp;
}
function javascriptNumberComparison($this, number) {
  ...
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.p2g(Companion_getInstance().j2g(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.p2g(Companion_getInstance().z2f(numberToLong(number)));
  } else {
    tmp = $this.p2g(toBigDecimal(numberToDouble(number)));
  }
  return tmp;
}
...
function BigDecimal(_significand, _exponent, _decimalMode) {
  ...
  if (!(_decimalMode == null) && _decimalMode.g2e_1) {
    var wrk = applyScale(Companion_getInstance(), _significand, _exponent, _decimalMode);
    if (!wrk.y2e()) {
      this.p2f_1 = wrk.p2f_1;
      this.q2f_1 = wrk.q2f_1;
      var newPrecision = this.p2f_1.r2e();
      this.o2f_1 = newPrecision;
      this.r2f_1 = _decimalMode.q2g(newPrecision);
    } else {
      this.p2f_1 = wrk.p2f_1;
      this.q2f_1 = multiply(wrk.q2f_1, add(_decimalMode.c2e_1, _decimalMode.e2e_1));
      this.o2f_1 = add(_decimalMode.c2e_1, _decimalMode.e2e_1);
      this.r2f_1 = _decimalMode.q2g(this.o2f_1);
    }
  } else {
    this.p2f_1 = _significand;
    this.o2f_1 = _significand.r2e();
    this.q2f_1 = _exponent;
    this.r2f_1 = _decimalMode;
  }
  var tmp = this;
  var tmp0_safe_receiver = this.r2f_1;
  var tmp0_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.c2e_1;
  tmp.s2f_1 = tmp0_elvis_lhs == null ? new Long(0, 0) : tmp0_elvis_lhs;
  var tmp_0 = this;
  var tmp1_safe_receiver = this.r2f_1;
  var tmp0_elvis_lhs_0 = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.d2e_1;
  tmp_0.t2f_1 = tmp0_elvis_lhs_0 == null ? RoundingMode_NONE_getInstance() : tmp0_elvis_lhs_0;
  var tmp_1 = this;
  var tmp13_safe_receiver = this.r2f_1;
  var tmp0_elvis_lhs_1 = tmp13_safe_receiver == null ? null : tmp13_safe_receiver.e2e_1;
  tmp_1.u2f_1 = tmp0_elvis_lhs_1 == null ? new Long(-1, -1) : tmp0_elvis_lhs_1;
  this.v2f_1 = compare(this.u2f_1, new Long(0, 0)) >= 0;
}
protoOf(BigDecimal).m2d = function () {
  return Companion_getInstance();
};
protoOf(BigDecimal).n2d = function () {
  return this;
};
protoOf(BigDecimal).r2g = function (other) {
  return this.s2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).p2d = function (other) {
  return this.r2g(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).s2g = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2f_1, other.r2f_1, decimalMode);
  if (this.y2e()) {
    return roundOrDont(Companion_getInstance(), other.p2f_1, other.q2f_1, resolvedDecimalMode);
  }
  if (other.y2e()) {
    return roundOrDont(Companion_getInstance(), this.p2f_1, this.q2f_1, resolvedDecimalMode);
  }
  var _destruct__k2r9zo = bringSignificandToSameExponent(this, this, other);
  var first = _destruct__k2r9zo.ue();
  var second = _destruct__k2r9zo.ve();
  var firstNumOfDigits = first.r2e();
  var secondNumOfDigits = second.r2e();
  var newSignificand = first.o2d(second);
  var newSignificandNumOfDigit = newSignificand.r2e();
  var tmp;
  ...
  var tmp_0;
  if (resolvedDecimalMode.g2e_1) {
    tmp_0 = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2g(newSignificandNumOfDigit));
  } else {
    tmp_0 = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
  return tmp_0;
};
protoOf(BigDecimal).t2g = function (other) {
  return this.u2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).r2d = function (other) {
  return this.t2g(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).u2g = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2f_1, other.r2f_1, decimalMode);
  if (this.y2e()) {
    return roundOrDont(Companion_getInstance(), other.p2f_1.l2g(), other.q2f_1, resolvedDecimalMode);
  }
  if (other.y2e()) {
    return roundOrDont(Companion_getInstance(), this.p2f_1, this.q2f_1, resolvedDecimalMode);
  }
  ...
  var firstNumOfDigits = first.r2e();
  var secondNumOfDigits = second.r2e();
  var newSignificand = first.q2d(second);
  var newSignificandNumOfDigit = newSignificand.r2e();
  var tmp;
  if (compare(firstNumOfDigits, secondNumOfDigits) > 0) {
    tmp = firstNumOfDigits;
  ...
  if (this.v2f_1) {
    return roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2g(newSignificandNumOfDigit));
  } else {
    return roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
};
protoOf(BigDecimal).v2g = function (other) {
  return this.w2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).t2d = function (other) {
  return this.v2g(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).w2g = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2f_1, other.r2f_1, decimalMode);
  var firstNumOfDigits = this.p2f_1.r2e();
  var secondNumOfDigits = other.p2f_1.r2e();
  var newSignificand = this.p2f_1.s2d(other.p2f_1);
  var newSignificandNumOfDigit = newSignificand.r2e();
  var moveExponent = subtract(newSignificandNumOfDigit, add(firstNumOfDigits, secondNumOfDigits));
  // Inline function 'kotlin.Long.plus' call
  var this_0 = add(add(this.q2f_1, other.q2f_1), moveExponent);
  var newExponent = add(this_0, fromInt(1));
  var tmp;
  if (resolvedDecimalMode.g2e_1) {
    tmp = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2g(newSignificandNumOfDigit));
  } else {
    tmp = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
  return tmp;
};
protoOf(BigDecimal).x2g = function (other) {
  return this.y2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).v2d = function (other) {
  return this.x2g(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).y2g = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2f_1, other.r2f_1, decimalMode);
  if (resolvedDecimalMode.f2e_1 && !resolvedDecimalMode.g2e_1) {
    var newExponent = subtract(this.q2f_1, other.q2f_1);
    // Inline function 'kotlin.Long.times' call
    var this_0 = other.o2f_1;
    // Inline function 'kotlin.Long.plus' call
    var this_1 = multiply(this_0, fromInt(2));
    var power = add(this_1, fromInt(6));
    var thisPrepared = this.p2f_1.s2d(Companion_getInstance_1().l2e_1.s2e(power));
    var divRem = thisPrepared.t2e(other.p2f_1);
    var result = divRem.u2e_1;
    // Inline function 'kotlin.Long.minus' call
    var this_2 = other.o2f_1;
    var expectedDiff = subtract(this_2, fromInt(1));
    var exponentModifier = add(expectedDiff, subtract(result.r2e(), thisPrepared.r2e()));
    if (!divRem.v2e_1.equals(Companion_getInstance_1().i2e_1)) {
    ...
    // Inline function 'kotlin.Long.minus' call
    var this_3 = subtract(this.q2f_1, other.q2f_1);
    var newExponent_0 = subtract(this_3, fromInt(1));
    var desiredPrecision = resolvedDecimalMode.c2e_1;
    var power_0 = add(subtract(desiredPrecision, this.o2f_1), other.o2f_1);
    var tmp;
    if (compare(power_0, new Long(0, 0)) > 0) {
      tmp = this.p2f_1.s2d(toBigInteger(10).s2e(power_0));
    } else if (compare(power_0, new Long(0, 0)) < 0) {
      var tmp_0 = toBigInteger(10);
      // Inline function 'kotlin.math.absoluteValue' call
      var tmp$ret$4 = abs(power_0);
      tmp = this.p2f_1.u2d(tmp_0.s2e(tmp$ret$4));
    } else {
      tmp = this.p2f_1;
    }
    var thisPrepared_0 = tmp;
    var divRem_0 = thisPrepared_0.t2e(other.p2f_1);
    var result_0 = divRem_0.u2e_1;
    if (result_0.equals(Companion_getInstance_1().i2e_1)) {
      var _unary__edvuaz = newExponent_0;
      newExponent_0 = subtract(_unary__edvuaz, get_ONE());
    }
    var exponentModifier_0 = subtract(result_0.r2e(), resolvedDecimalMode.c2e_1);
    var tmp_1;
    if (this.v2f_1) {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.v2e_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode.q2g(result_0.r2e()));
    } else {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.v2e_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode);
    }
    return tmp_1;
  }
};
protoOf(BigDecimal).z2g = function (other) {
  return this.a2h(other).te_1;
};
protoOf(BigDecimal).b2e = function (other) {
  return this.z2g(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).a2h = function (other) {
  if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    return new Pair(Companion_getInstance().b2f_1, this);
  }
  if (other.w2e().b2h(this.w2e()) > 0) {
    return new Pair(Companion_getInstance().b2f_1, this);
  }
  var tmp16_safe_receiver = this.r2f_1;
  var tmp;
  if (tmp16_safe_receiver == null) {
    tmp = null;
  } else {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.q2f_1, other.q2f_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = tmp16_safe_receiver.q2g(tmp$ret$0);
  }
  var tmp0_elvis_lhs = tmp;
  var tmp_0;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = subtract(this.q2f_1, other.q2f_1);
    var tmp$ret$1 = add(this_1, fromInt(1));
  ...
  var quotient = this.y2g(other, resolvedRoundingMode);
  var quotientInfinitePrecision = quotient.c2h(VOID, VOID, Companion_getInstance_0().m2g_1);
  var remainder = this.e2h(quotientInfinitePrecision.d2h(other));
  return new Pair(quotient, remainder);
};
protoOf(BigDecimal).y2e = function () {
  return this.p2f_1.y2e();
};
protoOf(BigDecimal).f2h = function (significand, exponent, decimalMode) {
  return new BigDecimal(significand, exponent, decimalMode);
};
protoOf(BigDecimal).c2h = function (significand, exponent, decimalMode, $super) {
  significand = significand === VOID ? this.p2f_1 : significand;
  exponent = exponent === VOID ? this.q2f_1 : exponent;
  decimalMode = decimalMode === VOID ? this.r2f_1 : decimalMode;
  return $super === VOID ? this.f2h(significand, exponent, decimalMode) : $super.f2h.call(this, significand, exponent, decimalMode);
};
protoOf(BigDecimal).g2h = function (places) {
  if (equalsLong(places, new Long(0, 0))) {
    return this;
  }
  return this.c2h(VOID, add(this.q2f_1, places));
};
protoOf(BigDecimal).h2h = function () {
  if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    var tmp;
    switch (this.p2f_1.o2e_1.r2_1) {
      case 0:
        tmp = Companion_getInstance().b2f_1;
        break;
      case 1:
        tmp = Companion_getInstance().c2f_1.l2g();
        break;
      case 2:
        tmp = Companion_getInstance().b2f_1;
        break;
  ...
  // Inline function 'kotlin.Long.plus' call
  var this_0 = this.q2f_1;
  var tmp$ret$0 = add(this_0, fromInt(1));
  return this.a2g(new DecimalMode(tmp$ret$0, RoundingMode_FLOOR_getInstance()));
};
protoOf(BigDecimal).i2h = function () {
  if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    return Companion_getInstance_1().i2e_1;
  }
  var precisionExponentDiff = subtract(this.q2f_1, this.o2f_1);
  var tmp;
  if (compare(precisionExponentDiff, new Long(0, 0)) > 0) {
    var tmp_0 = toBigInteger(10);
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$0 = add(precisionExponentDiff, fromInt(1));
    tmp = this.p2f_1.s2d(tmp_0.s2e(tmp$ret$0));
    ...
    tmp = this.p2f_1.u2d(tmp_1.s2e(tmp$ret$2));
  } else {
    tmp = this.p2f_1.x2d(10);
  }
  return tmp;
};
protoOf(BigDecimal).j2h = function (other) {
  return this.a2h(other);
};
protoOf(BigDecimal).e2h = function (other) {
  return this.u2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).d2h = function (other) {
  return this.w2g(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).w2e = function () {
  return new BigDecimal(this.p2f_1.w2e(), this.q2f_1, this.r2f_1);
};
protoOf(BigDecimal).l2g = function () {
  return new BigDecimal(this.p2f_1.l2g(), this.q2f_1, this.r2f_1);
};
protoOf(BigDecimal).n2f = function () {
  return this.p2f_1.n2f();
};
protoOf(BigDecimal).x2e = function (exactRequired) {
  checkWholeness(this, exactRequired);
  return this.i2h().x2e(exactRequired);
};
protoOf(BigDecimal).o2g = function () {
  var res = this.w2e().j2h(Companion_getInstance().c2f_1);
  var isWholeNumber = res.te_1.y2e();
  return isWholeNumber;
};
protoOf(BigDecimal).a2g = function (decimalMode) {
  if (decimalMode == null) {
    return this;
  }
  return roundSignificand(Companion_getInstance(), this.p2f_1, this.q2f_1, decimalMode);
};
protoOf(BigDecimal).k2h = function (digitPosition, roundingMode) {
  if (equalsLong(digitPosition, new Long(0, 0))) {
    throw ArithmeticException_init_$Create$('Rounding to 0 position is not supported');
  }
  var tmp;
  if (compare(this.q2f_1, new Long(0, 0)) >= 0) {
    tmp = this.a2g(new DecimalMode(digitPosition, roundingMode));
  } else {
    var tmp_0;
    if (roundingMode.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      tmp_0 = this.w2d(imul(this.n2f(), 2)).a2g(new DecimalMode(digitPosition, roundingMode)).y2d(imul(this.n2f(), 2));
    } else {
      tmp_0 = this.w2d(this.n2f()).a2g(new DecimalMode(digitPosition, roundingMode)).y2d(this.n2f());
    }
    tmp = tmp_0;
  }
  var rounded = tmp;
  var tmp_1;
  if (this.r2f_1 == null) {
    tmp_1 = new BigDecimal(rounded.p2f_1, rounded.q2f_1);
  } else {
    tmp_1 = new BigDecimal(rounded.p2f_1, rounded.q2f_1, this.r2f_1);
  }
  return tmp_1;
};
protoOf(BigDecimal).l2h = function (digitPosition, roundingMode) {
  ...
  if (compare(this.q2f_1, new Long(0, 0)) >= 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = add(this.q2f_1, digitPosition);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = this.k2h(tmp$ret$0, roundingMode);
  } else if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$1 = add(digitPosition, fromInt(1));
    tmp = this.k2h(tmp$ret$1, roundingMode);
  } else {
    throw RuntimeException_init_$Create$('Unexpected state');
  }
  var rounded = tmp;
  var tmp_0;
  if (this.r2f_1 == null) {
    tmp_0 = new BigDecimal(rounded.p2f_1, rounded.q2f_1);
  } else {
    tmp_0 = new BigDecimal(rounded.p2f_1, rounded.q2f_1, this.r2f_1);
  }
  return tmp_0;
};
protoOf(BigDecimal).p2g = function (other) {
  var tmp;
  if (equalsLong(this.q2f_1, other.q2f_1) && equalsLong(this.o2f_1, other.o2f_1)) {
    tmp = this.p2f_1.m2h(other.p2f_1);
  } else {
    var _destruct__k2r9zo = bringSignificandToSameExponent(this, this, other);
    var preparedFirst = _destruct__k2r9zo.ue();
    var preparedSecond = _destruct__k2r9zo.ve();
    tmp = preparedFirst.m2h(preparedSecond);
  }
  return tmp;
};
protoOf(BigDecimal).b2h = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.n2h().equals(Platform_JS_getInstance()) || RuntimePlatform_instance.n2h().equals(Platform_WASMJS_getInstance())) {
  ...
  if (other instanceof BigDecimal) {
    ...
    if (other instanceof Long) {
      tmp = this.p2g(Companion_getInstance().z2f(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.p2g(Companion_getInstance().h2d(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.p2g(Companion_getInstance().d2g(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.p2g(Companion_getInstance().f2g(other));
          } else {
            if (typeof other === 'number') {
              tmp = this.p2g(Companion_getInstance().w2f(other));
            } else {
              if (typeof other === 'number') {
                tmp = this.p2g(Companion_getInstance().x2f(other));
              } else {
...
protoOf(BigDecimal).d = function (other) {
  return this.b2h(!(other == null) ? other : THROW_CCE());
};
...
protoOf(BigDecimal).hashCode = function () {
  ...
  return removeTrailingZeroes(this, this).p2f_1.hashCode() + this.q2f_1.hashCode() | 0;
};
protoOf(BigDecimal).toString = function () {
  if (Companion_getInstance().f2f_1) {
    return this.o2h();
  }
  var significandString = this.p2f_1.p2h(10);
  var tmp;
  if (this.p2f_1.b2h(0) < 0) {
    tmp = 2;
  } else {
    tmp = 1;
  }
  ...
  var tmp_1;
  if (compare(this.q2f_1, new Long(0, 0)) > 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E+' + this.q2f_1.toString();
  } else if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E' + this.q2f_1.toString();
  } else if (equalsLong(this.q2f_1, new Long(0, 0))) {
...
protoOf(BigDecimal).o2h = function () {
  if (this.y2e()) {
    return '0';
  }
  var digits = this.p2f_1.r2e();
  if (compare(this.q2f_1, new Long(2147483647, 0)) > 0) {
    throw RuntimeException_init_$Create$('Invalid toStringExpanded request (exponent > Int.MAX_VALUE)');
  }
  var significandString = this.p2f_1.q2h(10);
  var tmp;
  if (this.p2f_1.o2e_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = '-';
  } else {
    tmp = '';
  }
  ...
  if (compare(this.q2f_1, new Long(0, 0)) > 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.q2f_1, digits);
    var diffBigInt = add(this_0, fromInt(1));
    var tmp_1;
    if (compare(diffBigInt, new Long(0, 0)) > 0) {
      var expandZeros = this.r2h(diffBigInt, _Char___init__impl__6a9atx(48));
      tmp_1 = significandString + expandZeros;
    } else {
      tmp_1 = placeADotInStringExpanded(this, significandString, (significandString.length - convertToInt(this.q2f_1) | 0) - 1 | 0);
    }
    tmp_0 = tmp_1;
  } else if (compare(this.q2f_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.math.absoluteValue' call
    var this_1 = convertToInt(this.q2f_1);
    var diffInt = abs_0(this_1);
    var tmp_2;
    if (diffInt > 0) {
      // Inline function 'kotlin.math.absoluteValue' call
      var this_2 = this.q2f_1;
      var tmp$ret$2 = abs(this_2);
      var expandZeros_0 = this.r2h(tmp$ret$2, _Char___init__impl__6a9atx(48));
...
protoOf(BigDecimal).r2h = function (_this__u8e3s4, char) {
...
function toBigDecimal(_this__u8e3s4, exponentModifier, decimalMode) {
  ...
  decimalMode = decimalMode === VOID ? null : decimalMode;
  var tmp = Companion_getInstance().i2g(_this__u8e3s4, decimalMode);
  return tmp.g2h(exponentModifier == null ? new Long(0, 0) : exponentModifier);
}
function toBigDecimal_0(_this__u8e3s4, exponentModifier, decimalMode) {
  exponentModifier = exponentModifier === VOID ? null : exponentModifier;
  decimalMode = decimalMode === VOID ? null : decimalMode;
  var tmp = Companion_getInstance().h2g(_this__u8e3s4, decimalMode);
  return tmp.g2h(exponentModifier == null ? new Long(0, 0) : exponentModifier);
}
function Companion_0() {
  Companion_instance_0 = this;
  this.m2g_1 = new DecimalMode();
  this.n2g_1 = new DecimalMode(new Long(30, 0), RoundingMode_ROUND_HALF_AWAY_FROM_ZERO_getInstance(), new Long(2, 0));
}
...
function DecimalMode(decimalPrecision, roundingMode, scale) {
  ...
  this.c2e_1 = decimalPrecision;
  this.d2e_1 = roundingMode;
  this.e2e_1 = scale;
  if (compare(this.c2e_1, new Long(0, 0)) < 0) {
    throw ArithmeticException_init_$Create$('Negative decimal precision is not allowed.');
  }
  this.f2e_1 = equalsLong(this.c2e_1, new Long(0, 0));
  this.g2e_1 = compare(this.e2e_1, new Long(0, 0)) >= 0;
  if (!this.g2e_1 && equalsLong(this.c2e_1, new Long(0, 0)) && !this.d2e_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Rounding mode with 0 digits precision.');
  }
  if (compare(this.e2e_1, new Long(-1, -1)) < 0) {
    throw ArithmeticException_init_$Create$('Negative Scale is unsupported.');
  }
  if (this.g2e_1 && this.d2e_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Scale of ' + this.e2e_1.toString() + ' digits to the right of the decimal requires a RoundingMode that is not NONE.');
  }
}
protoOf(DecimalMode).s2h = function (decimalPrecision, roundingMode, scale) {
  return new DecimalMode(decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).q2g = function (decimalPrecision, roundingMode, scale, $super) {
  decimalPrecision = decimalPrecision === VOID ? this.c2e_1 : decimalPrecision;
  roundingMode = roundingMode === VOID ? this.d2e_1 : roundingMode;
  scale = scale === VOID ? this.e2e_1 : scale;
  return $super === VOID ? this.s2h(decimalPrecision, roundingMode, scale) : $super.s2h.call(this, decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).toString = function () {
  return 'DecimalMode(decimalPrecision=' + this.c2e_1.toString() + ', roundingMode=' + this.d2e_1.toString() + ', scale=' + this.e2e_1.toString() + ')';
};
protoOf(DecimalMode).hashCode = function () {
  var result = this.c2e_1.hashCode();
  result = imul(result, 31) + this.d2e_1.hashCode() | 0;
  result = imul(result, 31) + this.e2e_1.hashCode() | 0;
  return result;
};
protoOf(DecimalMode).equals = function (other) {
  ...
  if (!equalsLong(this.c2e_1, tmp0_other_with_cast.c2e_1))
    return false;
  if (!this.d2e_1.equals(tmp0_other_with_cast.d2e_1))
    return false;
  if (!equalsLong(this.e2e_1, tmp0_other_with_cast.e2e_1))
    return false;
  return true;
};
...
function BigInteger_init_$Init$(long, $this) {
  var tmp = Companion_getInstance_1().h2e_1.t2h(long);
  ...
  if (tmp22_subject.equals(getKClass(Long))) {
    ...
    tmp_0 = tmp_1;
  } else if (tmp22_subject.equals(PrimitiveClasses_getInstance().sa())) {
...
function BigInteger_init_$Init$_0(int, $this) {
  var tmp = Companion_getInstance_1().h2e_1.u2h(int);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
  var tmp22_subject = PrimitiveClasses_getInstance().sa();
  var tmp_0;
  if (tmp22_subject.equals(getKClass(Long))) {
    ...
    throw RuntimeException_init_$Create$('Unsupported type ' + toString(PrimitiveClasses_getInstance().sa()));
  }
  var tmp$ret$2 = tmp_0;
  BigInteger.call($this, tmp, tmp$ret$2);
  return $this;
...
function BigInteger_init_$Init$_1(short, $this) {
  var tmp = Companion_getInstance_1().h2e_1.v2h(short);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function BigInteger_init_$Init$_2(byte, $this) {
  var tmp = Companion_getInstance_1().h2e_1.w2h(byte);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function Companion_1() {
  ...
  this.h2e_1 = get_chosenArithmetic();
  this.i2e_1 = new BigInteger(this.h2e_1.x2h(), Sign_ZERO_getInstance());
  this.j2e_1 = new BigInteger(this.h2e_1.y2h(), Sign_POSITIVE_getInstance());
  this.k2e_1 = new BigInteger(this.h2e_1.z2h(), Sign_POSITIVE_getInstance());
  this.l2e_1 = new BigInteger(this.h2e_1.a2i(), Sign_POSITIVE_getInstance());
  var tmp = this;
  // Inline function 'kotlin.math.log10' call
  tmp.m2e_1 = log10(2.0);
}
protoOf(Companion_1).f2d = function (string, base) {
  if (base < 2 || base > 36) {
  ...
  if (decimal) {
    var bigDecimal = Companion_getInstance().j2g(string);
    var isActuallyDecimal = bigDecimal.e2h(bigDecimal.h2h()).b2h(0) > 0;
  ...
  if (signed) {
    ...
    tmp = new BigInteger(this.h2e_1.b2i(substring(string, 1, string.length), base), isNegative);
  } else {
    if (string.length === 1 && charCodeAt(string, 0) === _Char___init__impl__6a9atx(48)) {
      return this.i2e_1;
    }
    tmp = new BigInteger(this.h2e_1.b2i(string, base), Sign_POSITIVE_getInstance());
  }
  return tmp;
};
protoOf(Companion_1).c2i = function (uLong) {
  return new BigInteger(this.h2e_1.d2i(uLong), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).e2i = function (uInt) {
  return new BigInteger(this.h2e_1.f2i(uInt), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).g2i = function (uShort) {
  return new BigInteger(this.h2e_1.h2i(uShort), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).i2i = function (uByte) {
  return new BigInteger(this.h2e_1.j2i(uByte), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).z2f = function (long) {
  return BigInteger_init_$Create$(long);
};
protoOf(Companion_1).h2d = function (int) {
  return BigInteger_init_$Create$_0(int);
};
protoOf(Companion_1).d2g = function (short) {
  return BigInteger_init_$Create$_1(short);
};
protoOf(Companion_1).f2g = function (byte) {
  return BigInteger_init_$Create$_2(byte);
};
protoOf(Companion_1).i2d = function (float, exactRequired) {
  // Inline function 'kotlin.math.floor' call
  var floatDecimalPart = float - Math.floor(float);
  var tmp = Companion_getInstance();
  // Inline function 'kotlin.math.floor' call
  var tmp$ret$1 = Math.floor(float);
  var bigDecimal = tmp.g2g(tmp$ret$1, null);
  if (exactRequired) {
...
protoOf(Companion_1).k2d = function (double, exactRequired) {
  // Inline function 'kotlin.math.floor' call
  var doubleDecimalPart = double - Math.floor(double);
  var tmp = Companion_getInstance();
  // Inline function 'kotlin.math.floor' call
  var tmp$ret$1 = Math.floor(double);
  var bigDecimal = tmp.i2g(tmp$ret$1, null);
  if (exactRequired) {
...
function isResultZero($this, resultMagnitude) {
  return Companion_getInstance_1().h2e_1.k2i(resultMagnitude, Companion_getInstance_1().h2e_1.x2h()) === 0;
}
function javascriptNumberComparison_0($this, number) {
  var double = numberToDouble(number);
  var tmp;
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.m2h(Companion_getInstance_1().g2d(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.m2h(Companion_getInstance_1().z2f(numberToLong(number)));
  } else {
    var tmp_0 = numberToDouble(number);
    tmp = $this.l2i(tmp_0, BigInteger$javascriptNumberComparison$lambda($this));
  }
  return tmp;
}
function QuotientAndRemainder(quotient, remainder) {
  this.u2e_1 = quotient;
  this.v2e_1 = remainder;
}
protoOf(QuotientAndRemainder).toString = function () {
  return 'QuotientAndRemainder(quotient=' + this.u2e_1.toString() + ', remainder=' + this.v2e_1.toString() + ')';
};
protoOf(QuotientAndRemainder).hashCode = function () {
  var result = this.u2e_1.hashCode();
...
function BigInteger(wordArray, requestedSign) {
  ...
  this.n2e_1 = BigInteger63Arithmetic_getInstance().e2j(wordArray);
  var tmp = this;
  var tmp_0;
  if (isResultZero(this, this.n2e_1)) {
    tmp_0 = Sign_ZERO_getInstance();
  } else {
    tmp_0 = requestedSign;
  }
  tmp.o2e_1 = tmp_0;
  this.p2e_1 = _ULongArray___get_size__impl__ju6dtr(this.n2e_1);
  this.q2e_1 = null;
}
protoOf(BigInteger).m2d = function () {
  return Companion_getInstance_1();
};
protoOf(BigInteger).n2d = function () {
  return this;
};
protoOf(BigInteger).f2j = function (other) {
  var comparison = Companion_getInstance_1().h2e_1.k2i(this.n2e_1, other.n2e_1);
  var tmp;
  if (other.o2e_1.equals(this.o2e_1)) {
    return new BigInteger(Companion_getInstance_1().h2e_1.h2j(this.n2e_1, other.n2e_1), this.o2e_1);
  } else {
    var tmp_0;
    if (comparison > 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().h2e_1.g2j(this.n2e_1, other.n2e_1), this.o2e_1);
    } else if (comparison < 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().h2e_1.g2j(other.n2e_1, this.n2e_1), other.o2e_1);
    } else {
      tmp_0 = Companion_getInstance_1().i2e_1;
    }
    tmp = tmp_0;
  }
  return tmp;
};
protoOf(BigInteger).p2d = function (other) {
  return this.f2j(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).i2j = function (other) {
  ...
  if (other.o2e_1.equals(this.o2e_1)) {
    ...
    if (comparison > 0) {
      ...
      tmp_0 = new BigInteger(Companion_getInstance_1().h2e_1.g2j(other.n2e_1, this.n2e_1), this.o2e_1.l2j());
    } else {
      tmp_0 = Companion_getInstance_1().i2e_1;
    }
    tmp = tmp_0;
...
protoOf(BigInteger).r2d = function (other) {
  return this.i2j(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).m2j = function (other) {
  if (this.y2e() || other.y2e()) {
    return Companion_getInstance_1().i2e_1;
  }
  if (other.equals(Companion_getInstance_1().j2e_1)) {
    return this;
  }
  var tmp;
  if (!this.o2e_1.equals(other.o2e_1)) {
  ...
  var tmp_0;
  if (sign.equals(Sign_POSITIVE_getInstance())) {
    tmp_0 = new BigInteger(Companion_getInstance_1().h2e_1.n2j(this.n2e_1, other.n2e_1), sign);
  } else {
    tmp_0 = new BigInteger(Companion_getInstance_1().h2e_1.n2j(this.n2e_1, other.n2e_1), sign);
  }
  return tmp_0;
};
protoOf(BigInteger).t2d = function (other) {
  return this.m2j(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).o2j = function (other) {
  if (other.y2e()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var result = Companion_getInstance_1().h2e_1.p2j(this.n2e_1, other.n2e_1).se_1.an_1;
  var tmp;
  if (equals(result, Companion_getInstance_1().h2e_1.x2h())) {
    tmp = Companion_getInstance_1().i2e_1;
  } else {
    var tmp_0;
    if (!this.o2e_1.equals(other.o2e_1)) {
      tmp_0 = Sign_NEGATIVE_getInstance();
...
protoOf(BigInteger).v2d = function (other) {
  return this.o2j(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).q2j = function (other) {
  if (other.y2e()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var tmp;
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().h2e_1.p2j(this.n2e_1, other.n2e_1).te_1.an_1;
  if (equals(result, Companion_getInstance_1().h2e_1.x2h())) {
    sign = Sign_ZERO_getInstance();
  }
...
protoOf(BigInteger).b2e = function (other) {
  return this.q2j(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).r2j = function (other) {
  if (other.y2e()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var tmp;
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().h2e_1.p2j(this.n2e_1, other.n2e_1);
  var tmp_0;
  if (equals(result.se_1, new ULongArray(Companion_getInstance_1().h2e_1.x2h()))) {
    tmp_0 = Companion_getInstance_1().i2e_1;
  } else {
    tmp_0 = new BigInteger(result.se_1.an_1, sign);
  }
  var quotient = tmp_0;
  var tmp_1;
  if (equals(result.te_1, new ULongArray(Companion_getInstance_1().h2e_1.x2h()))) {
    tmp_1 = Companion_getInstance_1().i2e_1;
  } else {
    tmp_1 = new BigInteger(result.te_1.an_1, this.o2e_1);
  }
  var remainder = tmp_1;
  return new Pair(quotient, remainder);
};
protoOf(BigInteger).m2h = function (other) {
  if (this.y2e() && other.y2e())
    return 0;
  if (other.y2e() && this.o2e_1.equals(Sign_POSITIVE_getInstance()))
    return 1;
  if (other.y2e() && this.o2e_1.equals(Sign_NEGATIVE_getInstance()))
    return -1;
  if (this.y2e() && other.o2e_1.equals(Sign_POSITIVE_getInstance()))
    return -1;
  if (this.y2e() && other.o2e_1.equals(Sign_NEGATIVE_getInstance()))
    return 1;
  if (!this.o2e_1.equals(other.o2e_1))
    return this.o2e_1.equals(Sign_POSITIVE_getInstance()) ? 1 : -1;
  var result = Companion_getInstance_1().h2e_1.k2i(this.n2e_1, other.n2e_1);
  var tmp;
  if (this.o2e_1.equals(Sign_NEGATIVE_getInstance()) && other.o2e_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = imul(result, -1);
  } else {
    tmp = result;
  }
...
protoOf(BigInteger).y2e = function () {
  return this.o2e_1.equals(Sign_ZERO_getInstance()) || get_chosenArithmetic().k2i(this.n2e_1, get_chosenArithmetic().x2h()) === 0;
};
protoOf(BigInteger).l2g = function () {
  return new BigInteger(this.n2e_1, this.o2e_1.l2j());
};
protoOf(BigInteger).w2e = function () {
  return new BigInteger(this.n2e_1, Sign_POSITIVE_getInstance());
};
protoOf(BigInteger).s2e = function (exponent) {
  if (compare(exponent, new Long(0, 0)) < 0) {
  ...
  if (this.y2e()) {
    tmp = Companion_getInstance_1().i2e_1;
  } else if (this.equals(Companion_getInstance_1().j2e_1)) {
    tmp = Companion_getInstance_1().j2e_1;
  } else {
    var tmp_0;
    if (this.o2e_1.equals(Sign_NEGATIVE_getInstance())) {
      var tmp_1;
    ...
    var sign = tmp_0;
    tmp = new BigInteger(Companion_getInstance_1().h2e_1.s2j(this.n2e_1, exponent), sign);
  }
  return tmp;
};
protoOf(BigInteger).t2j = function (exponent) {
  return this.s2e(fromInt(exponent));
};
protoOf(BigInteger).n2f = function () {
  var tmp;
  switch (this.o2e_1.r2_1) {
    case 0:
      tmp = 1;
      break;
    case 1:
...
protoOf(BigInteger).r2e = function () {
  if (this.y2e()) {
    return new Long(1, 0);
  }
  var powersOf10 = BigInteger63Arithmetic_getInstance().d2j_1;
  var tmp$ret$1;
  $l$block: {
    ...
    if (inductionVariable <= last)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var it = powersOf10[index].an_1;
        if (BigInteger63Arithmetic_getInstance().u2j(it, this.n2e_1) > 0) {
          tmp$ret$1 = index;
          break $l$block;
        }
      }
  ...
  var tmp = this.u2d(Companion_getInstance_1().l2e_1.t2j(powersOf10.length));
...
protoOf(BigInteger).z2e = function () {
  return this.q2d(Companion_getInstance_1().j2e_1);
};
protoOf(BigInteger).a2f = function () {
  return this.o2d(Companion_getInstance_1().j2e_1);
};
protoOf(BigInteger).t2e = function (other) {
  var result = this.r2j(other);
  return new QuotientAndRemainder(result.se_1, result.te_1);
};
protoOf(BigInteger).b2h = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.n2h().equals(Platform_JS_getInstance())) {
  ...
  if (other instanceof BigInteger) {
    ...
    if (other instanceof Long) {
      tmp = this.m2h(Companion_getInstance_1().z2f(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.m2h(Companion_getInstance_1().h2d(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.m2h(Companion_getInstance_1().d2g(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.m2h(Companion_getInstance_1().f2g(other));
          } else {
            if (other instanceof ULong) {
              tmp = this.m2h(Companion_getInstance_1().c2i(other.l1_1));
            } else {
              if (other instanceof UInt) {
                tmp = this.m2h(Companion_getInstance_1().e2i(other.mm_1));
              } else {
                if (other instanceof UShort) {
                  tmp = this.m2h(Companion_getInstance_1().g2i(other.fn_1));
                } else {
                  if (other instanceof UByte) {
                    tmp = this.m2h(Companion_getInstance_1().i2i(other.cm_1));
                  } else {
                    if (typeof other === 'number') {
                      tmp = this.l2i(other, BigInteger$compareTo$lambda(this));
                    } else {
                      if (typeof other === 'number') {
                        tmp = this.v2j(other, BigInteger$compareTo$lambda_0(this));
                      } else {
...
protoOf(BigInteger).l2i = function (float, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
  var withoutDecimalPart = Math.floor(float);
  var hasDecimalPart = !(float % 1 === 0.0);
  var tmp;
  if (hasDecimalPart) {
    var comparisonResult = comparisonBlock(Companion_getInstance_1().j2d(withoutDecimalPart + 1));
    var tmp_0;
    ...
    tmp = comparisonBlock(Companion_getInstance_1().j2d(withoutDecimalPart));
  }
  return tmp;
};
protoOf(BigInteger).v2j = function (double, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
  var withoutDecimalPart = Math.floor(double);
  var hasDecimalPart = !(double % 1 === 0.0);
  var tmp;
  if (hasDecimalPart) {
    var comparisonResult = comparisonBlock(Companion_getInstance_1().l2d(withoutDecimalPart + 1));
    var tmp_0;
    if (comparisonResult === 0) {
      tmp_0 = 1;
    } else {
    ...
    tmp = comparisonBlock(Companion_getInstance_1().l2d(withoutDecimalPart));
  }
  return tmp;
};
...
protoOf(BigInteger).hashCode = function () {
  ...
  return accumulator + this.o2e_1.hashCode() | 0;
};
protoOf(BigInteger).toString = function () {
  return this.p2h(10);
};
protoOf(BigInteger).p2h = function (base) {
  var tmp;
  if (this.o2e_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = '-';
  } else {
  ...
  var sign = tmp;
  return sign + this.q2h(base);
};
protoOf(BigInteger).q2h = function (base) {
  return Companion_getInstance_1().h2e_1.w2j(this.n2e_1, base);
};
protoOf(BigInteger).x2e = function (exactRequired) {
  if (exactRequired && (this.b2h(2147483647) > 0 || this.b2h(-2147483648) < 0)) {
    throw ArithmeticException_init_$Create$('Cannot convert to int and provide exact value');
  }
  // Inline function 'kotlin.ULong.toInt' call
  var this_0 = ULongArray__get_impl_pr71q9(this.n2e_1, 0);
  var tmp$ret$0 = convertToInt(_ULong___get_data__impl__fggpzb(this_0));
  return imul(tmp$ret$0, this.n2f());
};
...
function toBigInteger_0(_this__u8e3s4, base) {
  base = base === VOID ? 10 : base;
  return Companion_getInstance_1().f2d(_this__u8e3s4, base);
}
...
protoOf(Sextuple).ve = function () {
  return this.y2j_1;
};
protoOf(Sextuple).sl = function () {
  return this.z2j_1;
};
protoOf(Sextuple).d2k = function () {
  return this.a2k_1;
};
protoOf(Sextuple).e2k = function () {
  return this.b2k_1;
};
protoOf(Sextuple).f2k = function () {
  return this.c2k_1;
};
protoOf(Sextuple).toString = function () {
  return 'Sextuple(a=' + toString_0(this.x2j_1) + ', b=' + toString_0(this.y2j_1) + ', c=' + toString_0(this.z2j_1) + ', d=' + toString_0(this.a2k_1) + ', e=' + toString_0(this.b2k_1) + ', f=' + toString_0(this.c2k_1) + ')';
};
protoOf(Sextuple).hashCode = function () {
  var result = this.x2j_1 == null ? 0 : hashCode(this.x2j_1);
...
protoOf(Quadruple).ve = function () {
  return this.h2k_1;
};
protoOf(Quadruple).sl = function () {
  return this.i2k_1;
};
protoOf(Quadruple).d2k = function () {
  return this.j2k_1;
};
protoOf(Quadruple).toString = function () {
  return 'Quadruple(a=' + toString_0(this.g2k_1) + ', b=' + toString_0(this.h2k_1) + ', c=' + toString_0(this.i2k_1) + ', d=' + toString_0(this.j2k_1) + ')';
};
protoOf(Quadruple).hashCode = function () {
  var result = this.g2k_1 == null ? 0 : hashCode(this.g2k_1);
  result = imul(result, 31) + (this.h2k_1 == null ? 0 : hashCode(this.h2k_1)) | 0;
  result = imul(result, 31) + (this.i2k_1 == null ? 0 : hashCode(this.i2k_1)) | 0;
  result = imul(result, 31) + (this.j2k_1 == null ? 0 : hashCode(this.j2k_1)) | 0;
  return result;
};
...
function SignedUIntArray(unsignedValue, sign) {
  this.k2k_1 = unsignedValue;
  this.l2k_1 = sign;
}
protoOf(SignedUIntArray).toString = function () {
  return 'SignedUIntArray(unsignedValue=' + UIntArray__toString_impl_3zy802(this.k2k_1) + ', sign=' + this.l2k_1 + ')';
};
protoOf(SignedUIntArray).hashCode = function () {
  var result = UIntArray__hashCode_impl_hr7ost(this.k2k_1);
...
function BigInteger32Arithmetic() {
  ...
  tmp.m2k_1 = new Int32Array([]);
  this.n2k_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.o2k_1 = _UInt___init__impl__l7qpdl(-1);
  this.p2k_1 = _ULong___init__impl__c78o9k(new Long(0, 1));
  this.q2k_1 = _ULong___init__impl__c78o9k(new Long(65535, 0));
  this.r2k_1 = _UInt___init__impl__l7qpdl(-1);
  this.s2k_1 = 32;
  this.t2k_1 = 32;
  this.u2k_1 = _UIntArray___init__impl__ghjpc6(0);
  var tmp_0 = this;
  ...
  tmp_0.v2k_1 = _UIntArray___init__impl__ghjpc6_0(tmp_2);
  var tmp_4 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_5 = 0;
  ...
  tmp_4.w2k_1 = _UIntArray___init__impl__ghjpc6_0(tmp_6);
  var tmp_8 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_9 = 0;
  ...
  tmp_8.x2k_1 = _UIntArray___init__impl__ghjpc6_0(tmp_10);
  this.y2k_1 = 60;
  this.z2k_1 = 15000;
  this.a2l_1 = new SignedUIntArray(this.w2k_1, true);
}
protoOf(BigInteger32Arithmetic).b2l = function (value) {
  var x = value;
  var y;
  var n = this.s2k_1;
...
protoOf(BigInteger32Arithmetic).c2l = function (value) {
  ...
  return this.d2l(mostSignificant) + imul(_UIntArray___get_size__impl__r6l8ci(value) - 1 | 0, this.s2k_1) | 0;
};
protoOf(BigInteger32Arithmetic).d2l = function (value) {
  return this.s2k_1 - this.b2l(value) | 0;
};
protoOf(BigInteger32Arithmetic).e2l = function (bigInteger) {
...
protoOf(BigInteger32Arithmetic).f2l = function (bigInteger) {
...
protoOf(BigInteger32Arithmetic).g2l = function (operand, places) {
  if (UIntArray__isEmpty_impl_vd8j4n(operand) || places === 0) {
    return operand;
  }
  var originalSize = _UIntArray___get_size__impl__r6l8ci(operand);
  var leadingZeros = this.b2l(UIntArray__get_impl_gp5kza(operand, _UIntArray___get_size__impl__r6l8ci(operand) - 1 | 0));
  var shiftWords = places / this.s2k_1 | 0;
  var shiftBits = places % this.s2k_1 | 0;
  var tmp;
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.UInt.shr' call
          var bitCount = BigInteger32Arithmetic_getInstance().s2k_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.UInt.shr' call
            var bitCount_0 = BigInteger32Arithmetic_getInstance().s2k_1 - shiftBits | 0;
...
protoOf(BigInteger32Arithmetic).h2l = function (operand, places) {
  if (UIntArray__isEmpty_impl_vd8j4n(operand) || places === 0) {
    return operand;
  }
  var shiftBits = places % this.s2k_1 | 0;
  var wordsToDiscard = places / this.s2k_1 | 0;
  ...
  return this.e2l(result);
};
protoOf(BigInteger32Arithmetic).i2l = function (dividend, divisor) {
  var divisorSize = _UIntArray___get_size__impl__r6l8ci(divisor);
  var normalizationShift = this.b2l(UIntArray__get_impl_gp5kza(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.j2l(divisor, normalizationShift);
  var dividendNormalized = this.j2l(dividend, normalizationShift);
  return new Triple(new UIntArray(dividendNormalized), new UIntArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger32Arithmetic).k2l = function (remainderNormalized, normalizationShift) {
  var remainder = this.l2l(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger32Arithmetic).m2l = function (first, second) {
  var firstStart = _UIntArray___get_size__impl__r6l8ci(first) - this.f2l(first) | 0;
  var secondStart = _UIntArray___get_size__impl__r6l8ci(second) - this.f2l(second) | 0;
...
protoOf(BigInteger32Arithmetic).n2l = function (first, second) {
  ...
  var _destruct__k2r9zo = tmp;
  var maxLength = _destruct__k2r9zo.ue();
  var minLength = _destruct__k2r9zo.ve();
  var largerData = _destruct__k2r9zo.sl().rm_1;
  var smallerData = _destruct__k2r9zo.d2k().rm_1;
  // Inline function 'kotlin.UIntArray' call
  var tmp_0 = 0;
  ...
  while (true) {
    ...
    var tmp0_5 = sum;
    // Inline function 'kotlin.ULong.shr' call
    var bitCount_0 = this.s2k_1;
    sum = _ULong___init__impl__c78o9k(shiftRightUnsigned(_ULong___get_data__impl__fggpzb(tmp0_5), bitCount_0));
    i = i + 1 | 0;
  }
};
protoOf(BigInteger32Arithmetic).o2l = function (first, second) {
  var firstWithoutLeadingZeroes = this.e2l(first);
  var secondWithoutLeadingZeroes = this.e2l(second);
  var firstIsLarger = this.m2l(firstWithoutLeadingZeroes, secondWithoutLeadingZeroes) === 1;
  var tmp;
  if (firstIsLarger) {
  ...
  var _destruct__k2r9zo = tmp;
  var largerLength = _destruct__k2r9zo.ue();
  var smallerLength = _destruct__k2r9zo.ve();
  var largerData = _destruct__k2r9zo.sl().rm_1;
  var smallerData = _destruct__k2r9zo.d2k().rm_1;
  // Inline function 'kotlin.UIntArray' call
  var tmp_0 = 0;
  ...
  while (_iterator__ex2g4s.s()) {
    var element = _iterator__ex2g4s.t().mm_1;
...
protoOf(BigInteger32Arithmetic).p2l = function (first, second) {
...
protoOf(BigInteger32Arithmetic).q2l = function (first, second) {
  return this.r2l(first, second);
};
protoOf(BigInteger32Arithmetic).r2l = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.s2l(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new UIntArray(this.u2k_1), new UIntArray(unnormalizedDividend));
  }
  if (_UIntArray___get_size__impl__r6l8ci(unnormalizedDivisor) === 1 && _UIntArray___get_size__impl__r6l8ci(unnormalizedDividend) === 1) {
    ...
    return new Pair(new UIntArray(tmp), new UIntArray(this.e2l(tmp$ret$3)));
  }
  var bitPrecision = this.c2l(unnormalizedDividend) - this.c2l(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    // Inline function 'kotlin.uintArrayOf' call
    var tmp$ret$4 = _UIntArray___init__impl__ghjpc6_0(new Int32Array([_UInt___init__impl__l7qpdl(1)]));
    return new Pair(new UIntArray(tmp$ret$4), new UIntArray(this.t2l(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.i2l(unnormalizedDividend, unnormalizedDivisor);
  var dividend = _destruct__k2r9zo.ue().rm_1;
  var divisor = _destruct__k2r9zo.ve().rm_1;
  var normalizationShift = _destruct__k2r9zo.sl();
  ...
  var divisorTimesBaseToPowerOfM = this.j2l(divisor, imul(wordPrecision, this.s2k_1));
  if (this.s2l(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.t2l(dividend, divisorTimesBaseToPowerOfM);
  }
  ...
  if (0 <= inductionVariable)
    do {
      ...
      reconstructedQuotient = this.j2l(this.u2l(divisor, UIntArray__get_impl_gp5kza(quotient, j)), imul(j, this.s2k_1));
      while (this.s2l(reconstructedQuotient, dividend) > 0) {
        var tmp_4 = quotient;
      ...
      dividend = this.t2l(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.s2l(dividend, divisor) >= 0) {
    quotient = this.v2l(quotient, _UInt___init__impl__l7qpdl(1));
    dividend = this.t2l(dividend, divisor);
  }
  var denormRemainder = this.k2l(dividend, normalizationShift);
  return new Pair(new UIntArray(this.e2l(quotient)), new UIntArray(denormRemainder));
};
protoOf(BigInteger32Arithmetic).j2l = function (_this__u8e3s4, places) {
  return this.g2l(_this__u8e3s4, places);
};
protoOf(BigInteger32Arithmetic).l2l = function (_this__u8e3s4, places) {
  return this.h2l(_this__u8e3s4, places);
};
protoOf(BigInteger32Arithmetic).t2l = function (_this__u8e3s4, other) {
  return this.o2l(_this__u8e3s4, other);
};
protoOf(BigInteger32Arithmetic).v2l = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.uintArrayOf' call
  var tmp$ret$0 = _UIntArray___init__impl__ghjpc6_0(new Int32Array([other]));
  return this.n2l(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger32Arithmetic).u2l = function (_this__u8e3s4, other) {
  return this.p2l(_this__u8e3s4, other);
};
protoOf(BigInteger32Arithmetic).s2l = function (_this__u8e3s4, other) {
  return this.m2l(_this__u8e3s4, other);
};
...
function basecaseMultiplyWithCorrectedSize($this, first, second, firstCorrectedSizeStart, secondCorrectedSizeStart) {
  ...
  while (_iterator__ex2g4s.s()) {
    ...
    if (_unary__edvuaz > secondCorrectedSizeStart) {
      ...
      resultArray = BigInteger63Arithmetic_getInstance().z2l(resultArray, BigInteger63Arithmetic_getInstance().y2l(BigInteger63Arithmetic_getInstance().x2l(first, item), imul(_unary__edvuaz, BigInteger63Arithmetic_getInstance().s2i_1)));
    }
  }
  return resultArray;
}
function karatsubaMultiplyWithCorrectedSizes($this, firstUnsigned, secondUnsigned, firstCorrectedSize, secondCorrectedSize) {
  ...
  var mask = $this.a2m($this.y2l($this.o2i_1, imul(halfLength, $this.t2i_1)), _ULong___init__impl__c78o9k(new Long(1, 0)));
  var firstLower = $this.b2m(first, mask);
  var firstHigher = $this.c2m(first, imul(halfLength, $this.t2i_1));
  var secondLower = $this.b2m(second, mask);
  var secondHigher = $this.c2m(second, imul(halfLength, $this.t2i_1));
  var higherProduct = $this.d2m(firstHigher, secondHigher);
  var lowerProduct = $this.d2m(firstLower, secondLower);
  var middleProduct = $this.d2m($this.e2m(firstHigher, firstLower), $this.e2m(secondHigher, secondLower));
  var result = $this.e2m($this.e2m($this.f2m(higherProduct, imul(imul(2, $this.t2i_1), halfLength)), $this.f2m($this.g2m($this.g2m(middleProduct, higherProduct), lowerProduct), imul($this.t2i_1, halfLength))), lowerProduct);
  return result.h2m_1;
}
function isZero($this, _this__u8e3s4) {
  if (equals(_this__u8e3s4, $this.n2i_1))
    return true;
  if (_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) === 1 && equals(ULongArray__get_impl_pr71q9(_this__u8e3s4, 0), _ULong___init__impl__c78o9k(new Long(0, 0))))
    return true;
  if ((_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) - $this.j2m(_this__u8e3s4) | 0) === 0)
    return true;
  return false;
}
function SignedULongArray(unsignedValue, sign) {
  this.h2m_1 = unsignedValue;
  this.i2m_1 = sign;
}
protoOf(SignedULongArray).k2m = function (unsignedValue, sign) {
  return new SignedULongArray(unsignedValue, sign);
};
protoOf(SignedULongArray).l2m = function (unsignedValue, sign, $super) {
  unsignedValue = unsignedValue === VOID ? this.h2m_1 : unsignedValue;
  sign = sign === VOID ? this.i2m_1 : sign;
  return $super === VOID ? this.k2m(unsignedValue, sign) : $super.k2m.call(this, new ULongArray(unsignedValue), sign);
};
protoOf(SignedULongArray).toString = function () {
  return 'SignedULongArray(unsignedValue=' + ULongArray__toString_impl_wqk1p5(this.h2m_1) + ', sign=' + this.i2m_1 + ')';
};
protoOf(SignedULongArray).hashCode = function () {
  var result = ULongArray__hashCode_impl_aze4wa(this.h2m_1);
...
function signedAdd($this, first, second) {
  var tmp;
  if (!!(first.i2m_1 ^ second.i2m_1)) {
    var tmp_0;
    if ($this.u2j(first.h2m_1, second.h2m_1) > 0) {
      tmp_0 = new SignedULongArray($this.m2m(first.h2m_1, second.h2m_1), first.i2m_1);
    } else {
      tmp_0 = new SignedULongArray($this.m2m(second.h2m_1, first.h2m_1), second.i2m_1);
    }
    tmp = tmp_0;
  } else {
    tmp = new SignedULongArray($this.z2l(first.h2m_1, second.h2m_1), first.i2m_1);
  }
  return tmp;
}
function signedSubtract($this, first, second) {
  return signedAdd($this, first, second.l2m(VOID, !second.i2m_1));
}
function signedMultiply($this, first, second) {
  return new SignedULongArray($this.n2m(first.h2m_1, second.h2m_1), !!!(first.i2m_1 ^ second.i2m_1));
}
function signedDivide($this, first, second) {
  return new SignedULongArray($this.o2m(first.h2m_1, second.h2m_1), !!!(first.i2m_1 ^ second.i2m_1));
}
function BigInteger63Arithmetic() {
  BigInteger63Arithmetic_instance = this;
  var tmp = this;
  // Inline function 'kotlin.longArrayOf' call
  tmp.m2i_1 = longArrayOf([]);
  var tmp_0 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_0.n2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(0, 0))]));
  var tmp_1 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_1.o2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(1, 0))]));
  var tmp_2 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_2.p2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(2, 0))]));
  var tmp_3 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_3.q2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(10, 0))]));
  var tmp_4 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_4.r2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1431655765, 715827882))]));
  this.s2i_1 = 63;
  this.t2i_1 = 63;
  this.u2i_1 = _ULong___init__impl__c78o9k(new Long(-1, 2147483647));
  var tmp_5 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_5.v2i_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1, 2147483647))]));
  this.w2i_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.x2i_1 = _ULong___init__impl__c78o9k(new Long(0, 2147483647));
  this.y2i_1 = _ULong___init__impl__c78o9k(new Long(0, -2147483648));
  this.z2i_1 = 120;
  this.a2j_1 = 15000;
  this.b2j_1 = false;
  this.c2j_1 = new SignedULongArray(BigInteger63Arithmetic_getInstance().p2i_1, true);
  var tmp_6 = this;
  // Inline function 'kotlin.ulongArrayOf' call
...
protoOf(BigInteger63Arithmetic).q2m = function (value) {
  if (isZero(this, value)) {
    return 0;
  }
  var start = (_ULongArray___get_size__impl__ju6dtr(value) - this.j2m(value) | 0) - 1 | 0;
  var mostSignificant = ULongArray__get_impl_pr71q9(value, start);
  return this.r2m(mostSignificant) + imul(start, 63) | 0;
};
protoOf(BigInteger63Arithmetic).r2m = function (value) {
  return 63 - this.p2m(value) | 0;
};
protoOf(BigInteger63Arithmetic).e2j = function (bigInteger) {
  var correctedSize = _ULongArray___get_size__impl__ju6dtr(bigInteger) - this.j2m(bigInteger) | 0;
  if (correctedSize === 0) {
    return this.n2i_1;
  }
...
protoOf(BigInteger63Arithmetic).j2m = function (bigInteger) {
...
protoOf(BigInteger63Arithmetic).s2m = function (operand, places) {
  ...
  var leadingZeroWords = this.j2m(operand);
  ...
  var leadingZeros = this.p2m(ULongArray__get_impl_pr71q9(operand, originalSize - 1 | 0));
  var shiftWords = places / this.s2i_1 | 0;
  var shiftBits = places % this.s2i_1 | 0;
  var tmp;
  if (shiftBits > leadingZeros) {
    tmp = shiftWords + 1 | 0;
  } else {
  ...
  while (tmp_4 < tmp_5) {
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        // Inline function 'kotlin.ULong.and' call
        var other = BigInteger63Arithmetic_getInstance().u2i_1;
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.ULong.and' call
          var other_0 = BigInteger63Arithmetic_getInstance().u2i_1;
          ...
          // Inline function 'kotlin.ULong.shr' call
          var bitCount = BigInteger63Arithmetic_getInstance().s2i_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.ULong.shr' call
            var bitCount_0 = BigInteger63Arithmetic_getInstance().s2i_1 - shiftBits | 0;
...
protoOf(BigInteger63Arithmetic).t2m = function (operand, places) {
  ...
  var shiftBits = places % this.s2i_1 | 0;
  var wordsToDiscard = places / this.s2i_1 | 0;
...
protoOf(BigInteger63Arithmetic).u2m = function (first, second, firstStart, secondStart) {
  if (firstStart > secondStart) {
    return 1;
  }
  if (secondStart > firstStart) {
...
protoOf(BigInteger63Arithmetic).k2i = function (first, second) {
  var firstStart = _ULongArray___get_size__impl__ju6dtr(first) - this.j2m(first) | 0;
  var secondStart = _ULongArray___get_size__impl__ju6dtr(second) - this.j2m(second) | 0;
  return this.u2m(first, second, firstStart, secondStart);
};
protoOf(BigInteger63Arithmetic).v2m = function (resultArray, resultArrayStart, first, second) {
  ...
  var largerLength = _destruct__k2r9zo.ue();
  var smallerLength = _destruct__k2r9zo.ve();
  var largerData = _destruct__k2r9zo.sl().an_1;
  var smallerData = _destruct__k2r9zo.d2k().an_1;
  var largerStart = _destruct__k2r9zo.e2k();
  var smallerStart = _destruct__k2r9zo.f2k();
  var i = 0;
  var sum = _ULong___init__impl__c78o9k(new Long(0, 0));
...
protoOf(BigInteger63Arithmetic).h2j = function (first, second) {
  if (isZero(this, first))
    return second;
  if (isZero(this, second))
    return first;
  ...
  var result = tmp_1;
  this.v2m(result, 0, first, second);
  var tmp_9;
  if (possibleOverflow_0) {
    tmp_9 = this.e2j(result);
  } else {
    tmp_9 = result;
  }
  return tmp_9;
};
protoOf(BigInteger63Arithmetic).w2m = function (first, second, firstStart, secondStart) {
  var comparison = this.u2m(first, second, firstStart, secondStart);
  ...
  var _destruct__k2r9zo = tmp;
  var largerData = _destruct__k2r9zo.ue().an_1;
  var smallerData = _destruct__k2r9zo.ve().an_1;
  var largerStart = _destruct__k2r9zo.sl();
  var smallerStart = _destruct__k2r9zo.d2k();
  // Inline function 'kotlin.ULongArray' call
  var tmp_0 = 0;
  ...
  if (this.j2m(result) === (_ULongArray___get_size__impl__ju6dtr(result) - 1 | 0) && equals(ULongArray__get_impl_pr71q9(result, 0), _ULong___init__impl__c78o9k(new Long(0, 0)))) {
    return this.n2i_1;
  }
  return this.e2j(result);
};
protoOf(BigInteger63Arithmetic).g2j = function (first, second) {
  var firstStart = _ULongArray___get_size__impl__ju6dtr(first) - this.j2m(first) | 0;
  var secondStart = _ULongArray___get_size__impl__ju6dtr(second) - this.j2m(second) | 0;
  return this.w2m(first, second, firstStart, secondStart);
};
protoOf(BigInteger63Arithmetic).n2j = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.j2m(first) | 0;
  var secondCorrectedSize = _ULongArray___get_size__impl__ju6dtr(second) - this.j2m(second) | 0;
  return multiplyWithCorrectedSize(this, first, second, firstCorrectedSize, secondCorrectedSize);
};
protoOf(BigInteger63Arithmetic).x2m = function (original, numberOfWords, value) {
  // Inline function 'kotlin.ULongArray' call
  var tmp = 0;
...
protoOf(BigInteger63Arithmetic).w2l = function (firstUnchecked, secondUnchecked) {
  var tmp;
  ...
  if (firstLength > secondLength) {
    var prepared = this.x2m(second, firstLength - secondLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
    tmp_9 = new Pair(new ULongArray(first), new ULongArray(prepared));
  } else if (firstLength < secondLength) {
    var prepared_0 = this.x2m(first, secondLength - firstLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
  ...
  var firstPrepared = _destruct__k2r9zo.ue().an_1;
  var secondPrepared = _destruct__k2r9zo.ve().an_1;
  ...
  var p0 = this.e2m(m0, m2);
  var pe0 = m0;
  var pe1 = this.e2m(p0, m1);
  var pem1 = this.g2m(p0, m1);
  var doublePemM2 = this.d2m(this.e2m(pem1, m2), this.c2j_1);
  var pem2 = this.g2m(doublePemM2, m0);
  var pinf = m2;
  var q0 = this.e2m(n0, n2);
  var qe0 = n0;
  var qe1 = this.e2m(q0, n1);
  var qem1 = this.g2m(q0, n1);
  var doubleQemN2 = this.d2m(this.e2m(qem1, n2), this.c2j_1);
  var qem2 = this.g2m(doubleQemN2, n0);
  var qinf = n2;
  var re0 = this.d2m(pe0, qe0);
  var re1 = this.d2m(pe1, qe1);
  var rem1 = this.d2m(pem1, qem1);
  var rem2 = this.d2m(pem2, qem2);
  var rinf = this.d2m(pinf, qinf);
  var r0 = re0;
  var r4 = rinf;
  var rem2re1diff = this.g2m(rem2, re1);
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$11 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(3, 0))]));
  var r3 = this.y2m(rem2re1diff, new SignedULongArray(tmp$ret$11, true));
  var r1 = this.c2m(this.g2m(re1, rem1), 1);
  var r2 = this.g2m(rem1, r0);
  r3 = this.e2m(this.c2m(this.g2m(r2, r3), 1), this.d2m(this.c2j_1, rinf));
  r2 = this.g2m(this.e2m(r2, r1), r4);
  r1 = this.g2m(r1, r3);
  var bShiftAmount = imul(extendedDigit, 63);
  var rb0 = r0;
  var rb1 = this.f2m(r1, bShiftAmount);
  var rb2 = this.f2m(r2, imul(bShiftAmount, 2));
  var rb3 = this.f2m(r3, imul(bShiftAmount, 3));
  var rb4 = this.f2m(r4, imul(bShiftAmount, 4));
  var rb = this.e2m(this.e2m(this.e2m(this.e2m(rb0, rb1), rb2), rb3), rb4);
  return rb.h2m_1;
};
protoOf(BigInteger63Arithmetic).x2l = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.j2m(first) | 0;
  return this.z2m(first, second, firstCorrectedSize);
};
protoOf(BigInteger63Arithmetic).z2m = function (first, second, firstCorrectedSize) {
  // Inline function 'kotlin.ULong.and' call
  var other = this.w2i_1;
  ...
  var requiredBits = this.q2m(first) + this.r2m(second) | 0;
  var tmp;
...
protoOf(BigInteger63Arithmetic).s2j = function (base, exponent) {
  ...
  if (_ULongArray___get_size__impl__ju6dtr(base) === 1 && equals(ULongArray__get_impl_pr71q9(base, 0), _ULong___init__impl__c78o9k(new Long(10, 0))) && compare(exponent, fromInt(this.d2j_1.length)) < 0) {
    return this.d2j_1[convertToInt(exponent)].an_1;
  }
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(base) - this.j2m(base) | 0;
  var helperVar = this.o2i_1;
  ...
  while (compare(exponentVar, new Long(1, 0)) > 0) {
    ...
    if (equalsLong(tmp$ret$0, new Long(0, 0))) {
      baseVar = this.n2m(baseVar, baseVar);
      // Inline function 'kotlin.Long.div' call
      var this_1 = exponentVar;
      exponentVar = divide(this_1, fromInt(2));
    } else {
      helperVar = this.n2m(baseVar, helperVar);
      baseVar = this.n2m(baseVar, baseVar);
      // Inline function 'kotlin.Long.minus' call
  ...
  return this.n2m(helperVar, baseVar);
};
protoOf(BigInteger63Arithmetic).a2n = function (dividend, divisor) {
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var normalizationShift = this.p2m(ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.y2l(divisor, normalizationShift);
  var dividendNormalized = this.y2l(dividend, normalizationShift);
  return new Triple(new ULongArray(dividendNormalized), new ULongArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger63Arithmetic).b2n = function (remainderNormalized, normalizationShift) {
  var remainder = this.c2n(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger63Arithmetic).d2n = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.u2j(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new ULongArray(this.n2i_1), new ULongArray(unnormalizedDividend));
  }
  if (_ULongArray___get_size__impl__ju6dtr(unnormalizedDivisor) === 1 && _ULongArray___get_size__impl__ju6dtr(unnormalizedDividend) === 1) {
    ...
    return new Pair(new ULongArray(tmp), new ULongArray(this.e2j(tmp$ret$3)));
  }
  var bitPrecision = this.q2m(unnormalizedDividend) - this.q2m(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    return new Pair(new ULongArray(this.o2i_1), new ULongArray(this.m2m(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.a2n(unnormalizedDividend, unnormalizedDivisor);
  var dividend = _destruct__k2r9zo.ue().an_1;
  var divisor = _destruct__k2r9zo.ve().an_1;
  var normalizationShift = _destruct__k2r9zo.sl();
  var dividendSize = _ULongArray___get_size__impl__ju6dtr(dividend);
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var divisorCorrectedSize = _ULongArray___get_size__impl__ju6dtr(divisor) - this.j2m(divisor) | 0;
  var wordPrecision = dividendSize - divisorSize | 0;
  var qjhat;
  var reconstructedQuotient;
  var quotient = _ULongArray___init__impl__twm1l3_0(wordPrecision);
  var divisorTimesBaseToPowerOfM = this.y2l(divisor, imul(wordPrecision, this.s2i_1));
  if (this.u2j(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.m2m(dividend, divisorTimesBaseToPowerOfM);
  }
  var inductionVariable = wordPrecision - 1 | 0;
  if (0 <= inductionVariable)
    do {
      ...
      if ((divisorSize + j | 0) < _ULongArray___get_size__impl__ju6dtr(dividend)) {
        ...
        tmp_0 = this.e2n(this.y2l(tmp$ret$4, this.s2i_1), ULongArray__get_impl_pr71q9(dividend, (divisorSize + j | 0) - 1 | 0));
      } else {
        var tmp_1;
        if ((divisorSize + j | 0) === _ULongArray___get_size__impl__ju6dtr(dividend)) {
          // Inline function 'kotlin.ulongArrayOf' call
      ...
      var tmp_3 = this.f2n(twoDigit);
      // Inline function 'kotlin.ulongArrayOf' call
      var tmp$ret$6 = _ULongArray___init__impl__twm1l3(longArrayOf([ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0)]));
      var convertedResult = tmp_2.q2l(tmp_3, this.f2n(tmp$ret$6));
      qjhat = this.g2n(convertedResult.se_1.rm_1);
      var tmp_4 = quotient;
      var tmp_5;
      var tmp_6 = qjhat;
      var tmp0_1 = this.u2i_1;
      // Inline function 'kotlin.ULong.minus' call
      ...
      if (this.h2n(tmp_6, tmp$ret$7) < 0) {
        tmp_5 = ULongArray__get_impl_pr71q9(qjhat, 0);
      } else {
        tmp_5 = this.u2i_1;
      }
      ULongArray__set_impl_z19mvh(tmp_4, j, tmp_5);
      reconstructedQuotient = this.y2l(this.z2m(divisor, ULongArray__get_impl_pr71q9(quotient, j), divisorCorrectedSize), imul(j, this.s2i_1));
      while (this.u2j(reconstructedQuotient, dividend) > 0) {
        var tmp_7 = quotient;
      ...
      dividend = this.m2m(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.u2j(dividend, divisor) >= 0) {
    quotient = this.e2n(quotient, _ULong___init__impl__c78o9k(new Long(1, 0)));
    dividend = this.m2m(dividend, divisor);
  }
  var denormRemainder = this.b2n(dividend, normalizationShift);
  return new Pair(new ULongArray(this.e2j(quotient)), new ULongArray(denormRemainder));
};
protoOf(BigInteger63Arithmetic).i2n = function (operand) {
  if (isZero(this, operand))
    return this.n2i_1;
  var length = this.q2m(operand);
  var tmp;
  if ((length % 64 | 0) === 0) {
    tmp = length / 64 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).j2n = function (operand) {
  var power64Representation = this.i2n(operand);
  ...
  if (inductionVariable < last)
    do {
      ...
      // Inline function 'kotlin.UInt.toULong' call
      var this_0 = BigInteger32Arithmetic_getInstance().r2k_1;
      // Inline function 'kotlin.uintToULong' call
      // Inline function 'kotlin.uintToLong' call
      var value = _UInt___get_data__impl__f0vqqw(this_0);
      var tmp$ret$0 = bitwiseAnd(fromInt(value), new Long(-1, 0));
     ...
     while (inductionVariable < last);
  return BigInteger32Arithmetic_getInstance().e2l(result);
};
protoOf(BigInteger63Arithmetic).k2n = function (operand) {
  ...
  var length = BigInteger32Arithmetic_getInstance().c2l(operand);
  var tmp;
  if ((length % 63 | 0) === 0) {
    tmp = length / 63 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).p2j = function (first, second) {
  return this.d2n(first, second);
};
protoOf(BigInteger63Arithmetic).e2m = function (_this__u8e3s4, other) {
  return signedAdd(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).g2m = function (_this__u8e3s4, other) {
  return signedSubtract(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).d2m = function (_this__u8e3s4, other) {
  return signedMultiply(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).y2m = function (_this__u8e3s4, other) {
  return signedDivide(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).c2m = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.c2n(_this__u8e3s4.h2m_1, places), _this__u8e3s4.i2m_1);
};
protoOf(BigInteger63Arithmetic).f2m = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.y2l(_this__u8e3s4.h2m_1, places), _this__u8e3s4.i2m_1);
};
protoOf(BigInteger63Arithmetic).b2m = function (_this__u8e3s4, operand) {
  return new SignedULongArray(this.l2n(_this__u8e3s4.h2m_1, operand), _this__u8e3s4.i2m_1);
};
protoOf(BigInteger63Arithmetic).b2i = function (number, base) {
  var parsed = this.n2i_1;
  ...
  while (inductionVariable < charSequenceLength(indexedObject)) {
    ...
    var tmp_2 = tmp_0.m2n(tmp_1, tmp$ret$2);
    // Inline function 'kotlin.toULong' call
    var this_0 = toDigit(element, base);
    var tmp$ret$3 = _ULong___init__impl__c78o9k(fromInt(this_0));
    parsed = tmp.e2n(tmp_2, tmp$ret$3);
  }
  return this.e2j(parsed);
};
protoOf(BigInteger63Arithmetic).w2j = function (operand, base) {
  ...
  var stringBuilder = StringBuilder_init_$Create$();
  while (!equals(copy, this.n2i_1)) {
    var divremResult = this.n2n(copy, baseArray);
    if (ULongArray__isEmpty_impl_c3yngu(divremResult.te_1.an_1)) {
      stringBuilder.kb(0);
    } else {
      stringBuilder.s7(toString_1(ULongArray__get_impl_pr71q9(divremResult.te_1.an_1, 0), base));
    }
    copy = divremResult.se_1.an_1;
  }
...
protoOf(BigInteger63Arithmetic).l2n = function (operand, mask) {
  var tmp;
  ...
  var _destruct__k2r9zo = tmp;
  var bigger = _destruct__k2r9zo.ue().an_1;
  var smaller = _destruct__k2r9zo.ve().an_1;
  // Inline function 'kotlin.ULongArray' call
  var tmp_0 = 0;
...
protoOf(BigInteger63Arithmetic).y2l = function (_this__u8e3s4, places) {
  return this.s2m(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).c2n = function (_this__u8e3s4, places) {
  return this.t2m(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).z2l = function (_this__u8e3s4, other) {
  return this.h2j(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).m2m = function (_this__u8e3s4, other) {
  return this.g2j(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).n2m = function (_this__u8e3s4, other) {
  return this.n2j(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).e2n = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.h2j(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).a2m = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.g2j(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).m2n = function (_this__u8e3s4, other) {
  return this.x2l(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).o2m = function (_this__u8e3s4, other) {
  return this.p2j(_this__u8e3s4, other).se_1.an_1;
};
protoOf(BigInteger63Arithmetic).n2n = function (_this__u8e3s4, other) {
  return this.p2j(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).u2j = function (_this__u8e3s4, other) {
  return this.k2i(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).h2n = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.k2i(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).f2n = function (_this__u8e3s4) {
  return this.j2n(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).g2n = function (_this__u8e3s4) {
  return this.k2n(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).d2i = function (uLong) {
  var tmp;
  // Inline function 'kotlin.ULong.and' call
  var other = this.y2i_1;
...
protoOf(BigInteger63Arithmetic).f2i = function (uInt) {
  // Inline function 'kotlin.UInt.toULong' call
  // Inline function 'kotlin.uintToULong' call
  // Inline function 'kotlin.uintToLong' call
...
protoOf(BigInteger63Arithmetic).h2i = function (uShort) {
...
protoOf(BigInteger63Arithmetic).j2i = function (uByte) {
...
protoOf(BigInteger63Arithmetic).t2h = function (long) {
...
protoOf(BigInteger63Arithmetic).u2h = function (int) {
  // Inline function 'kotlin.math.absoluteValue' call
...
protoOf(BigInteger63Arithmetic).v2h = function (short) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(BigInteger63Arithmetic).w2h = function (byte) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(RuntimePlatform).n2h = function () {
...
protoOf(Companion).j2d = tryFromFloat$default;
protoOf(Companion).l2d = tryFromDouble$default;
protoOf(Companion).g2d = parseString$default;
protoOf(BigDecimal).w2d = plus_1;
protoOf(BigDecimal).y2d = minus_0;
protoOf(Companion_1).g2d = parseString$default;
protoOf(Companion_1).j2d = tryFromFloat$default;
protoOf(Companion_1).l2d = tryFromDouble$default;
protoOf(BigInteger).o2d = plus_0;
protoOf(BigInteger).q2d = minus;
protoOf(BigInteger).s2d = times;
protoOf(BigInteger).x2d = times_0;
protoOf(BigInteger).u2d = div;
protoOf(BigInteger).z2d = div_0;
protoOf(BigInteger).a2e = rem;
//endregion
//region block: init
