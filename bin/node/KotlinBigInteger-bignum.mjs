...
function parseString$default(string, base, $super) {
  ...
  return $super === VOID ? this.z2e(string, base) : $super.z2e.call(this, string, base);
}
function tryFromFloat$default(float, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.c2f(float, exactRequired) : $super.c2f.call(this, float, exactRequired);
}
function tryFromDouble$default(double, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.e2f(double, exactRequired) : $super.e2f.call(this, double, exactRequired);
}
initMetadataForInterface(Creator, 'Creator');
function plus_0(other) {
  return this.h2f().j2f(other);
}
function minus(other) {
  return this.h2f().l2f(other);
}
function times(other) {
  return this.h2f().n2f(other);
}
function div(other) {
  return this.h2f().p2f(other);
}
function plus_1(int) {
  return this.h2f().j2f(this.g2f().b2f(int));
}
function times_0(int) {
  return this.h2f().n2f(this.g2f().b2f(int));
}
function minus_0(int) {
  return this.h2f().l2f(this.g2f().b2f(int));
}
function div_0(int) {
  return this.h2f().p2f(this.g2f().b2f(int));
}
function rem(int) {
  return this.h2f().v2f(this.g2f().b2f(int));
}
...
function determineDecider($this, discarded) {
  var tmp = Companion_getInstance_1().f2g_1;
  // Inline function 'kotlin.Long.minus' call
  var this_0 = discarded.l2g();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  var scale = tmp.m2g(tmp$ret$0);
  var divrem = discarded.n2g(scale);
  var significant = divrem.o2g_1.q2g().r2g(true);
  var rest = divrem.p2g_1.q2g();
  var tmp_0;
  if (significant === 5) {
    var tmp_1;
    if (rest.equals(Companion_getInstance_1().c2g_1)) {
...
function roundDiscarded($this, significand, discarded, decimalMode) {
  var toDiscard = subtract(significand.l2g(), decimalMode.w2f_1);
  var tmp;
  if (compare(toDiscard, new Long(0, 0)) > 0) {
    var additionallyDiscarded = significand.n2g(Companion_getInstance_1().f2g_1.m2g(toDiscard));
    tmp = new Pair(additionallyDiscarded.o2g_1, additionallyDiscarded.p2g_1);
  } else {
  ...
  var tmp_0;
  if (significand.equals(Companion_getInstance_1().c2g_1)) {
    tmp_0 = discarded.i2g_1;
  } else {
    tmp_0 = significand.i2g_1;
  }
  var sign = tmp_0;
  if (!decimalMode.x2f_1.equals(RoundingMode_AWAY_FROM_ZERO_getInstance()) && !decimalMode.x2f_1.equals(RoundingMode_TOWARDS_ZERO_getInstance())) {
    if (remainder.s2g()) {
      return result;
    }
  } else {
    if (remainder.s2g() && discarded.s2g()) {
      return result;
    }
  }
  var decider = determineDecider($this, remainder);
  switch (decimalMode.x2f_1.q2_1) {
    case 2:
    ...
    case 9:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.u2f(2).q2g().equals(Companion_getInstance_1().d2g_1)) {
          switch (sign.q2_1) {
            case 0:
              result = result.u2g();
              break;
    ...
    case 10:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.u2f(2).equals(Companion_getInstance_1().c2g_1)) {
          switch (sign.q2_1) {
            case 0:
              result = result.u2g();
              break;
...
function roundSignificand($this, significand, exponent, decimalMode) {
  if (significand.s2g()) {
    return new BigDecimal(Companion_getInstance_1().c2g_1, exponent, decimalMode);
  }
  var significandDigits = significand.l2g();
  var tmp;
  if (decimalMode.a2g_1) {
    tmp = add(decimalMode.w2f_1, decimalMode.y2f_1);
  } else {
    tmp = decimalMode.w2f_1;
  }
  var desiredPrecision = tmp;
  var tmp_0;
  if (compare(desiredPrecision, significandDigits) > 0 && !decimalMode.a2g_1) {
    var extendedSignificand = significand.m2f(Companion_getInstance_1().f2g_1.m2g(subtract(desiredPrecision, significandDigits)));
    tmp_0 = new BigDecimal(extendedSignificand, exponent, decimalMode);
  } else if (compare(desiredPrecision, significandDigits) < 0) {
    var divRem = significand.n2g(Companion_getInstance_1().f2g_1.m2g(subtract(significandDigits, desiredPrecision)));
    var resolvedRemainder = divRem.p2g_1;
    if (divRem.p2g_1.equals(Companion_getInstance_1().c2g_1)) {
      return new BigDecimal(divRem.o2g_1, exponent, decimalMode);
    }
    var tmp_1;
    if (equalsLong(significand.l2g(), add(divRem.o2g_1.l2g(), divRem.p2g_1.l2g()))) {
      var newSignificand = roundDiscarded($this, divRem.o2g_1, resolvedRemainder, decimalMode);
      var exponentModifier = subtract(newSignificand.l2g(), divRem.o2g_1.l2g());
      tmp_1 = new BigDecimal(newSignificand, add(exponent, exponentModifier), decimalMode);
    } else {
      tmp_1 = $this.g2h(divRem.o2g_1, exponent, decimalMode);
    }
    tmp_0 = tmp_1;
  } else {
...
function applyScale($this, significand, exponent, decimalMode) {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var this_0 = add(exponent, decimalMode.y2f_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = new DecimalMode(tmp$ret$0, decimalMode.x2f_1);
  } else if (compare(exponent, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = decimalMode.y2f_1;
    var tmp$ret$1 = add(this_1, fromInt(1));
    tmp = new DecimalMode(tmp$ret$1, decimalMode.x2f_1);
  } else {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var tmp_1;
    if (decimalMode.x2f_1.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      var temp = (new BigDecimal(significand, exponent)).q2f(imul(significand.h2h(), 2));
      tmp_1 = roundSignificand($this, temp.j2h_1, temp.k2h_1, workMode).s2f(imul(significand.h2h(), 2));
    } else {
      var temp_0 = (new BigDecimal(significand, exponent)).q2f(significand.h2h());
      tmp_1 = roundSignificand($this, temp_0.j2h_1, temp_0.k2h_1, workMode).s2f(significand.h2h());
    }
    tmp_0 = tmp_1;
  }
  return tmp_0;
...
function resolveDecimalMode($this, firstDecimalMode, secondDecimalMode, suppliedDecimalMode) {
  ...
  if (!(suppliedDecimalMode == null)) {
    ...
    if (!ensureNotNull(firstDecimalMode).x2f_1.equals(ensureNotNull(secondDecimalMode).x2f_1)) {
      throw ArithmeticException_init_$Create$('Different rounding modes! This: ' + firstDecimalMode.x2f_1.toString() + ' Other: ' + secondDecimalMode.x2f_1.toString());
    }
    var tmp_0;
    if (compare(firstDecimalMode.w2f_1, secondDecimalMode.w2f_1) >= 0) {
...
function Companion() {
  ...
  this.y2g_1 = new BigDecimal(Companion_getInstance_1().f2g_1, new Long(1, 0));
  this.z2g_1 = false;
  var tmp = this;
  // Inline function 'kotlin.doubleArrayOf' call
  tmp.a2h_1 = new Float64Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10, 1.0E11, 1.0E12, 1.0E13, 1.0E14, 1.0E15, 1.0E16, 1.0E17, 1.0E18, 1.0E19, 1.0E20, 1.0E21, 1.0E22]);
  this.b2h_1 = this.q2h(1.7976931348623157E308);
  this.c2h_1 = this.q2h(4.9E-324);
  var tmp_0 = this;
  // Inline function 'kotlin.floatArrayOf' call
  tmp_0.d2h_1 = new Float32Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10]);
  this.e2h_1 = this.r2h(3.4028235E38);
  this.f2h_1 = this.r2h(1.4E-45);
}
protoOf(Companion).g2h = function (significand, exponent, decimalMode) {
  var tmp;
  if (significand.i2g_1.equals(Sign_POSITIVE_getInstance())) {
    var tmp_0;
    switch (decimalMode.x2f_1.q2_1) {
      case 1:
      case 2:
        var increasedSignificand = significand.u2g();
        var exponentModifier = subtract(increasedSignificand.l2g(), significand.l2g());
    ...
    tmp = tmp_0;
  } else if (significand.i2g_1.equals(Sign_NEGATIVE_getInstance())) {
    var tmp_1;
    switch (decimalMode.x2f_1.q2_1) {
      case 0:
      case 2:
        var increasedSignificand_0 = significand.t2g();
        var exponentModifier_0 = subtract(increasedSignificand_0.l2g(), significand.l2g());
...
protoOf(Companion).s2h = function (long, decimalMode) {
  var bigint = Companion_getInstance_1().t2h(long);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.l2g();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).u2h(decimalMode);
};
protoOf(Companion).v2h = function (int, decimalMode) {
  var bigint = Companion_getInstance_1().b2f(int);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.l2g();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).u2h(decimalMode);
};
protoOf(Companion).w2h = function (short, decimalMode) {
  var bigint = Companion_getInstance_1().x2h(short);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.l2g();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).u2h(decimalMode);
};
protoOf(Companion).y2h = function (byte, decimalMode) {
  var bigint = Companion_getInstance_1().z2h(byte);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.l2g();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).u2h(decimalMode);
};
protoOf(Companion).a2i = function (float, decimalMode) {
  ...
  if (contains(floatString, _Char___init__impl__6a9atx(46)) && !contains(floatString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.b2i(tmp$ret$1, decimalMode).u2h(decimalMode);
  } else {
    tmp = this.b2i(floatString, decimalMode).u2h(decimalMode);
  }
  return tmp;
};
protoOf(Companion).r2h = function (float, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.a2i(float, decimalMode) : $super.a2i.call(this, float, decimalMode);
};
protoOf(Companion).c2i = function (double, decimalMode) {
  ...
  if (contains(doubleString, _Char___init__impl__6a9atx(46)) && !contains(doubleString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.b2i(doubleString, decimalMode).u2h(decimalMode).u2h(decimalMode);
  }
  return tmp;
};
protoOf(Companion).q2h = function (double, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.c2i(double, decimalMode) : $super.c2i.call(this, double, decimalMode);
};
protoOf(Companion).t2h = function (long) {
  return this.s2h(long, null);
};
protoOf(Companion).b2f = function (int) {
  return this.v2h(int, null);
};
protoOf(Companion).x2h = function (short) {
  return this.w2h(short, null);
};
protoOf(Companion).z2h = function (byte) {
  return this.y2h(byte, null);
};
protoOf(Companion).c2f = function (float, exactRequired) {
  return this.a2i(float, null);
};
protoOf(Companion).e2f = function (double, exactRequired) {
  return this.c2i(double, null);
};
protoOf(Companion).z2e = function (string, base) {
  return this.b2i(string, null);
};
protoOf(Companion).d2i = function (string) {
  return this.e2i(string);
};
protoOf(Companion).b2i = function (floatingPointString, decimalMode) {
  ...
  if (contains(floatingPointString, _Char___init__impl__6a9atx(69), true)) {
    ...
    if (split_0.u() === 2) {
      ...
      var significand = Companion_getInstance_1().z2e(leftTruncated + rightTruncated, 10);
      if (significand.equals(Companion_getInstance_1().c2g_1)) {
        sign = Sign_ZERO_getInstance();
      }
      if (sign.equals(Sign_NEGATIVE_getInstance())) {
        significand = significand.f2i();
      }
      var tmp_6;
      if (!(leftTruncated === '0')) {
        // Inline function 'kotlin.Long.plus' call
        ...
        // Inline function 'kotlin.Long.minus' call
        var this_2 = subtract(exponent, subtract(numberToLong(rightTruncated.length), significand.l2g()));
    ...
    if (contains(floatingPointString, _Char___init__impl__6a9atx(46))) {
      ...
      if (split_1.u() === 2) {
        ...
        var significand_0 = Companion_getInstance_1().z2e(leftTruncated_0 + rightTruncated_0, 10);
        var tmp_10;
        var tmp_11;
        ...
        if (significand_0.equals(Companion_getInstance_1().c2g_1)) {
          sign_0 = Sign_ZERO_getInstance();
        }
        if (sign_0.equals(Sign_NEGATIVE_getInstance())) {
          significand_0 = significand_0.f2i();
        }
        return new BigDecimal(significand_0, fromInt(exponent_0), decimalMode);
      } else
        throw ArithmeticException_init_$Create$('Invalid (or unsupported) floating point number format: ' + floatingPointString);
    } else {
      var significand_1 = Companion_getInstance_1().z2e(floatingPointString, 10);
      // Inline function 'kotlin.Long.minus' call
      var this_3 = significand_1.l2g();
      var tmp$ret$16 = subtract(this_3, fromInt(1));
      return new BigDecimal(significand_1, tmp$ret$16, decimalMode);
    }
  }
};
protoOf(Companion).e2i = function (floatingPointString, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.b2i(floatingPointString, decimalMode) : $super.b2i.call(this, floatingPointString, decimalMode);
};
...
function removeTrailingZeroes($this, bigDecimal) {
  if (bigDecimal.s2g())
    return $this;
  var significand = bigDecimal.j2h_1;
  var divisionResult = new QuotientAndRemainder(bigDecimal.j2h_1, Companion_getInstance_1().c2g_1);
  do {
    divisionResult = divisionResult.o2g_1.n2g(Companion_getInstance_1().f2g_1);
    if (divisionResult.p2g_1.equals(Companion_getInstance_1().c2g_1)) {
      significand = divisionResult.o2g_1;
    }
  }
   while (divisionResult.p2g_1.equals(Companion_getInstance_1().c2g_1));
  return new BigDecimal(significand, bigDecimal.k2h_1);
}
...
function computeMode($this, other, op) {
  var tmp;
  if ($this.l2h_1 == null || $this.l2h_1.z2f_1 || other.l2h_1 == null || other.l2h_1.z2f_1) {
    tmp = Companion_getInstance_0().g2i_1;
  } else {
    var tmp0 = $this.l2h_1.w2f_1;
    // Inline function 'kotlin.math.max' call
    var b = other.l2h_1.w2f_1;
    var tmp_0 = compare(tmp0, b) >= 0 ? tmp0 : b;
    var tmp_1;
    if ($this.l2h_1.a2g_1 && other.l2h_1.a2g_1) {
      var tmp_2;
      switch (op.q2_1) {
        case 0:
          var tmp0_0 = $this.l2h_1.y2f_1;
          // Inline function 'kotlin.math.max' call

          var b_0 = other.l2h_1.y2f_1;
          tmp_2 = compare(tmp0_0, b_0) >= 0 ? tmp0_0 : b_0;
          break;
        case 1:
          var tmp0_1 = $this.l2h_1.y2f_1;
          // Inline function 'kotlin.math.min' call

          var b_1 = other.l2h_1.y2f_1;
          tmp_2 = compare(tmp0_1, b_1) <= 0 ? tmp0_1 : b_1;
          break;
        case 2:
          tmp_2 = add($this.l2h_1.y2f_1, other.l2h_1.y2f_1);
          break;
        default:
          noWhenBranchMatchedException();
          break;
    ...
    tmp = new DecimalMode(tmp_0, $this.l2h_1.x2f_1, tmp_1);
  }
  return tmp;
}
function checkWholeness($this, exactRequired) {
  if (exactRequired && !$this.i2i())
...
function getRidOfRadix($this, bigDecimal) {
  var precision = bigDecimal.j2h_1.l2g();
  // Inline function 'kotlin.Long.plus' call
  var this_0 = subtract(bigDecimal.k2h_1, precision);
  var newExponent = add(this_0, fromInt(1));
  return new BigDecimal(bigDecimal.j2h_1, newExponent);
}
function bringSignificandToSameExponent($this, first, second) {
  ...
  var firstPreparedExponent = firstPrepared.k2h_1;
  var secondPreparedExponent = secondPrepared.k2h_1;
  var tmp;
  if (compare(first.k2h_1, second.k2h_1) > 0) {
    var moveFirstBy = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_0;
    if (compare(moveFirstBy, new Long(0, 0)) >= 0) {
      var movedFirst = firstPrepared.j2h_1.m2f(toBigInteger(10).m2g(moveFirstBy));
      return new Triple(movedFirst, second.j2h_1, secondPreparedExponent);
    } else {
      var tmp_1 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$0 = multiply(moveFirstBy, fromInt(-1));
      var movedSecond = secondPrepared.j2h_1.m2f(tmp_1.m2g(tmp$ret$0));
      tmp_0 = new Triple(first.j2h_1, movedSecond, firstPreparedExponent);
    }
    tmp = tmp_0;
  } else if (compare(first.k2h_1, second.k2h_1) < 0) {
    var moveSecondBy = subtract(secondPreparedExponent, firstPreparedExponent);
    var tmp_2;
    if (compare(moveSecondBy, new Long(0, 0)) >= 0) {
      var movedSecond_0 = secondPrepared.j2h_1.m2f(toBigInteger(10).m2g(moveSecondBy));
      tmp_2 = new Triple(first.j2h_1, movedSecond_0, firstPreparedExponent);
    } else {
      var tmp_3 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$1 = multiply(moveSecondBy, fromInt(-1));
      var movedFirst_0 = firstPrepared.j2h_1.m2f(tmp_3.m2g(tmp$ret$1));
      tmp_2 = new Triple(movedFirst_0, second.j2h_1, firstPreparedExponent);
    }
    return tmp_2;
  } else if (equalsLong(first.k2h_1, second.k2h_1)) {
    var delta = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_4;
    if (compare(delta, new Long(0, 0)) > 0) {
      var movedFirst_1 = first.j2h_1.m2f(toBigInteger(10).m2g(delta));
      tmp_4 = new Triple(movedFirst_1, second.j2h_1, firstPreparedExponent);
    } else {
      if (compare(delta, new Long(0, 0)) < 0) {
        var tmp_5 = toBigInteger(10);
        // Inline function 'kotlin.Long.times' call
        var tmp$ret$2 = multiply(delta, fromInt(-1));
        var movedSecond_1 = second.j2h_1.m2f(tmp_5.m2g(tmp$ret$2));
        tmp_4 = new Triple(first.j2h_1, movedSecond_1, firstPreparedExponent);
      } else {
        // Inline function 'kotlin.Long.compareTo' call
        if (delta.y2(fromInt(0)) === 0) {
          tmp_4 = new Triple(first.j2h_1, second.j2h_1, firstPreparedExponent);
        } else {
    ...
    throw RuntimeException_init_$Create$('Invalid comparison state BigInteger: ' + first.k2h_1.toString() + ', ' + second.k2h_1.toString());
  }
  return tmp;
}
function javascriptNumberComparison($this, number) {
  ...
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.j2i(Companion_getInstance().d2i(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.j2i(Companion_getInstance().t2h(numberToLong(number)));
  } else {
    tmp = $this.j2i(toBigDecimal(numberToDouble(number)));
  }
  return tmp;
}
...
function BigDecimal(_significand, _exponent, _decimalMode) {
  ...
  if (!(_decimalMode == null) && _decimalMode.a2g_1) {
    var wrk = applyScale(Companion_getInstance(), _significand, _exponent, _decimalMode);
    if (!wrk.s2g()) {
      this.j2h_1 = wrk.j2h_1;
      this.k2h_1 = wrk.k2h_1;
      var newPrecision = this.j2h_1.l2g();
      this.i2h_1 = newPrecision;
      this.l2h_1 = _decimalMode.k2i(newPrecision);
    } else {
      this.j2h_1 = wrk.j2h_1;
      this.k2h_1 = multiply(wrk.k2h_1, add(_decimalMode.w2f_1, _decimalMode.y2f_1));
      this.i2h_1 = add(_decimalMode.w2f_1, _decimalMode.y2f_1);
      this.l2h_1 = _decimalMode.k2i(this.i2h_1);
    }
  } else {
    this.j2h_1 = _significand;
    this.i2h_1 = _significand.l2g();
    this.k2h_1 = _exponent;
    this.l2h_1 = _decimalMode;
  }
  var tmp = this;
  var tmp0_safe_receiver = this.l2h_1;
  var tmp0_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.w2f_1;
  tmp.m2h_1 = tmp0_elvis_lhs == null ? new Long(0, 0) : tmp0_elvis_lhs;
  var tmp_0 = this;
  var tmp1_safe_receiver = this.l2h_1;
  var tmp0_elvis_lhs_0 = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.x2f_1;
  tmp_0.n2h_1 = tmp0_elvis_lhs_0 == null ? RoundingMode_NONE_getInstance() : tmp0_elvis_lhs_0;
  var tmp_1 = this;
  var tmp13_safe_receiver = this.l2h_1;
  var tmp0_elvis_lhs_1 = tmp13_safe_receiver == null ? null : tmp13_safe_receiver.y2f_1;
  tmp_1.o2h_1 = tmp0_elvis_lhs_1 == null ? new Long(-1, -1) : tmp0_elvis_lhs_1;
  this.p2h_1 = compare(this.o2h_1, new Long(0, 0)) >= 0;
}
protoOf(BigDecimal).g2f = function () {
  return Companion_getInstance();
};
protoOf(BigDecimal).h2f = function () {
  return this;
};
protoOf(BigDecimal).l2i = function (other) {
  return this.m2i(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).j2f = function (other) {
  return this.l2i(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).m2i = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.l2h_1, other.l2h_1, decimalMode);
  if (this.s2g()) {
    return roundOrDont(Companion_getInstance(), other.j2h_1, other.k2h_1, resolvedDecimalMode);
  }
  if (other.s2g()) {
    return roundOrDont(Companion_getInstance(), this.j2h_1, this.k2h_1, resolvedDecimalMode);
  }
  ...
  var firstNumOfDigits = first.l2g();
  var secondNumOfDigits = second.l2g();
  var newSignificand = first.i2f(second);
  var newSignificandNumOfDigit = newSignificand.l2g();
  var tmp;
  ...
  var tmp_0;
  if (resolvedDecimalMode.a2g_1) {
    tmp_0 = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.k2i(newSignificandNumOfDigit));
  } else {
...
protoOf(BigDecimal).o2i = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.l2h_1, other.l2h_1, decimalMode);
  if (this.s2g()) {
    return roundOrDont(Companion_getInstance(), other.j2h_1.f2i(), other.k2h_1, resolvedDecimalMode);
  }
  if (other.s2g()) {
    return roundOrDont(Companion_getInstance(), this.j2h_1, this.k2h_1, resolvedDecimalMode);
  }
  ...
  if (this.p2h_1) {
    return roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.k2i(newSignificandNumOfDigit));
  } else {
...
protoOf(BigDecimal).q2i = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.l2h_1, other.l2h_1, decimalMode);
  var firstNumOfDigits = this.j2h_1.l2g();
  var secondNumOfDigits = other.j2h_1.l2g();
  var newSignificand = this.j2h_1.m2f(other.j2h_1);
  var newSignificandNumOfDigit = newSignificand.l2g();
  var moveExponent = subtract(newSignificandNumOfDigit, add(firstNumOfDigits, secondNumOfDigits));
  // Inline function 'kotlin.Long.plus' call
  var this_0 = add(add(this.k2h_1, other.k2h_1), moveExponent);
  var newExponent = add(this_0, fromInt(1));
  var tmp;
  if (resolvedDecimalMode.a2g_1) {
    tmp = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.k2i(newSignificandNumOfDigit));
  } else {
...
protoOf(BigDecimal).s2i = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.l2h_1, other.l2h_1, decimalMode);
  if (resolvedDecimalMode.z2f_1 && !resolvedDecimalMode.a2g_1) {
    var newExponent = subtract(this.k2h_1, other.k2h_1);
    // Inline function 'kotlin.Long.times' call
    var this_0 = other.i2h_1;
    // Inline function 'kotlin.Long.plus' call
    var this_1 = multiply(this_0, fromInt(2));
    var power = add(this_1, fromInt(6));
    var thisPrepared = this.j2h_1.m2f(Companion_getInstance_1().f2g_1.m2g(power));
    var divRem = thisPrepared.n2g(other.j2h_1);
    var result = divRem.o2g_1;
    // Inline function 'kotlin.Long.minus' call
    var this_2 = other.i2h_1;
    var expectedDiff = subtract(this_2, fromInt(1));
    var exponentModifier = add(expectedDiff, subtract(result.l2g(), thisPrepared.l2g()));
    if (!divRem.p2g_1.equals(Companion_getInstance_1().c2g_1)) {
    ...
    // Inline function 'kotlin.Long.minus' call
    var this_3 = subtract(this.k2h_1, other.k2h_1);
    var newExponent_0 = subtract(this_3, fromInt(1));
    var desiredPrecision = resolvedDecimalMode.w2f_1;
    var power_0 = add(subtract(desiredPrecision, this.i2h_1), other.i2h_1);
    var tmp;
    if (compare(power_0, new Long(0, 0)) > 0) {
      tmp = this.j2h_1.m2f(toBigInteger(10).m2g(power_0));
    } else if (compare(power_0, new Long(0, 0)) < 0) {
      var tmp_0 = toBigInteger(10);
      // Inline function 'kotlin.math.absoluteValue' call
      var tmp$ret$4 = abs(power_0);
      tmp = this.j2h_1.o2f(tmp_0.m2g(tmp$ret$4));
    } else {
      tmp = this.j2h_1;
    }
    var thisPrepared_0 = tmp;
    var divRem_0 = thisPrepared_0.n2g(other.j2h_1);
    var result_0 = divRem_0.o2g_1;
    if (result_0.equals(Companion_getInstance_1().c2g_1)) {
      var _unary__edvuaz = newExponent_0;
      newExponent_0 = subtract(_unary__edvuaz, get_ONE());
    }
    var exponentModifier_0 = subtract(result_0.l2g(), resolvedDecimalMode.w2f_1);
    var tmp_1;
    if (this.p2h_1) {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.p2g_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode.k2i(result_0.l2g()));
    } else {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.p2g_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode);
    }
    return tmp_1;
  }
};
protoOf(BigDecimal).t2i = function (other) {
  return this.u2i(other).se_1;
};
protoOf(BigDecimal).v2f = function (other) {
  return this.t2i(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).u2i = function (other) {
  if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    return new Pair(Companion_getInstance().v2g_1, this);
  }
  if (other.q2g().v2i(this.q2g()) > 0) {
    return new Pair(Companion_getInstance().v2g_1, this);
  }
  var tmp16_safe_receiver = this.l2h_1;
  var tmp;
  if (tmp16_safe_receiver == null) {
    tmp = null;
  } else {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.k2h_1, other.k2h_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = tmp16_safe_receiver.k2i(tmp$ret$0);
  }
  var tmp0_elvis_lhs = tmp;
  var tmp_0;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = subtract(this.k2h_1, other.k2h_1);
    var tmp$ret$1 = add(this_1, fromInt(1));
  ...
  var quotient = this.s2i(other, resolvedRoundingMode);
  var quotientInfinitePrecision = quotient.w2i(VOID, VOID, Companion_getInstance_0().g2i_1);
  var remainder = this.y2i(quotientInfinitePrecision.x2i(other));
  return new Pair(quotient, remainder);
};
protoOf(BigDecimal).s2g = function () {
  return this.j2h_1.s2g();
};
protoOf(BigDecimal).z2i = function (significand, exponent, decimalMode) {
  return new BigDecimal(significand, exponent, decimalMode);
};
protoOf(BigDecimal).w2i = function (significand, exponent, decimalMode, $super) {
  significand = significand === VOID ? this.j2h_1 : significand;
  exponent = exponent === VOID ? this.k2h_1 : exponent;
  decimalMode = decimalMode === VOID ? this.l2h_1 : decimalMode;
  return $super === VOID ? this.z2i(significand, exponent, decimalMode) : $super.z2i.call(this, significand, exponent, decimalMode);
};
protoOf(BigDecimal).a2j = function (places) {
  if (equalsLong(places, new Long(0, 0))) {
    return this;
  }
  return this.w2i(VOID, add(this.k2h_1, places));
};
protoOf(BigDecimal).b2j = function () {
  if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    var tmp;
    switch (this.j2h_1.i2g_1.q2_1) {
      case 0:
        tmp = Companion_getInstance().v2g_1;
        break;
      case 1:
        tmp = Companion_getInstance().w2g_1.f2i();
        break;
      case 2:
        tmp = Companion_getInstance().v2g_1;
        break;
  ...
  var tmp$ret$0 = add(this_0, fromInt(1));
  return this.u2h(new DecimalMode(tmp$ret$0, RoundingMode_FLOOR_getInstance()));
};
protoOf(BigDecimal).c2j = function () {
  if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    return Companion_getInstance_1().c2g_1;
  }
  var precisionExponentDiff = subtract(this.k2h_1, this.i2h_1);
  var tmp;
  if (compare(precisionExponentDiff, new Long(0, 0)) > 0) {
    var tmp_0 = toBigInteger(10);
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$0 = add(precisionExponentDiff, fromInt(1));
    tmp = this.j2h_1.m2f(tmp_0.m2g(tmp$ret$0));
    ...
    tmp = this.j2h_1.o2f(tmp_1.m2g(tmp$ret$2));
  } else {
    tmp = this.j2h_1.r2f(10);
  }
  return tmp;
};
protoOf(BigDecimal).d2j = function (other) {
  return this.u2i(other);
};
protoOf(BigDecimal).y2i = function (other) {
  return this.o2i(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).x2i = function (other) {
  return this.q2i(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).q2g = function () {
  return new BigDecimal(this.j2h_1.q2g(), this.k2h_1, this.l2h_1);
};
protoOf(BigDecimal).f2i = function () {
  return new BigDecimal(this.j2h_1.f2i(), this.k2h_1, this.l2h_1);
};
protoOf(BigDecimal).h2h = function () {
  return this.j2h_1.h2h();
};
protoOf(BigDecimal).r2g = function (exactRequired) {
  checkWholeness(this, exactRequired);
  return this.c2j().r2g(exactRequired);
};
protoOf(BigDecimal).i2i = function () {
  var res = this.q2g().d2j(Companion_getInstance().w2g_1);
  var isWholeNumber = res.se_1.s2g();
  return isWholeNumber;
};
protoOf(BigDecimal).u2h = function (decimalMode) {
  if (decimalMode == null) {
    return this;
  }
  return roundSignificand(Companion_getInstance(), this.j2h_1, this.k2h_1, decimalMode);
};
protoOf(BigDecimal).e2j = function (digitPosition, roundingMode) {
  ...
  var tmp;
  if (compare(this.k2h_1, new Long(0, 0)) >= 0) {
    tmp = this.u2h(new DecimalMode(digitPosition, roundingMode));
  } else {
    var tmp_0;
    if (roundingMode.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      tmp_0 = this.q2f(imul(this.h2h(), 2)).u2h(new DecimalMode(digitPosition, roundingMode)).s2f(imul(this.h2h(), 2));
    } else {
      tmp_0 = this.q2f(this.h2h()).u2h(new DecimalMode(digitPosition, roundingMode)).s2f(this.h2h());
    }
    tmp = tmp_0;
  }
  var rounded = tmp;
  var tmp_1;
  if (this.l2h_1 == null) {
    tmp_1 = new BigDecimal(rounded.j2h_1, rounded.k2h_1);
  } else {
    tmp_1 = new BigDecimal(rounded.j2h_1, rounded.k2h_1, this.l2h_1);
  }
  return tmp_1;
};
protoOf(BigDecimal).f2j = function (digitPosition, roundingMode) {
  ...
  if (compare(this.k2h_1, new Long(0, 0)) >= 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = add(this.k2h_1, digitPosition);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = this.e2j(tmp$ret$0, roundingMode);
  } else if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$1 = add(digitPosition, fromInt(1));
    tmp = this.e2j(tmp$ret$1, roundingMode);
  } else {
    throw RuntimeException_init_$Create$('Unexpected state');
  }
  var rounded = tmp;
  var tmp_0;
  if (this.l2h_1 == null) {
    tmp_0 = new BigDecimal(rounded.j2h_1, rounded.k2h_1);
  } else {
    tmp_0 = new BigDecimal(rounded.j2h_1, rounded.k2h_1, this.l2h_1);
  }
  return tmp_0;
};
protoOf(BigDecimal).j2i = function (other) {
  var tmp;
  if (equalsLong(this.k2h_1, other.k2h_1) && equalsLong(this.i2h_1, other.i2h_1)) {
    tmp = this.j2h_1.g2j(other.j2h_1);
  } else {
    var _destruct__k2r9zo = bringSignificandToSameExponent(this, this, other);
    var preparedFirst = _destruct__k2r9zo.te();
    var preparedSecond = _destruct__k2r9zo.ue();
    tmp = preparedFirst.g2j(preparedSecond);
  }
  return tmp;
};
protoOf(BigDecimal).v2i = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.h2j().equals(Platform_JS_getInstance()) || RuntimePlatform_instance.h2j().equals(Platform_WASMJS_getInstance())) {
  ...
  if (other instanceof BigDecimal) {
    ...
    if (other instanceof Long) {
      tmp = this.j2i(Companion_getInstance().t2h(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.j2i(Companion_getInstance().b2f(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.j2i(Companion_getInstance().x2h(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.j2i(Companion_getInstance().z2h(other));
          } else {
            if (typeof other === 'number') {
              tmp = this.j2i(Companion_getInstance().q2h(other));
            } else {
              if (typeof other === 'number') {
                tmp = this.j2i(Companion_getInstance().r2h(other));
              } else {
...
protoOf(BigDecimal).d = function (other) {
  return this.v2i(!(other == null) ? other : THROW_CCE());
};
...
protoOf(BigDecimal).hashCode = function () {
  ...
  return removeTrailingZeroes(this, this).j2h_1.hashCode() + this.k2h_1.hashCode() | 0;
};
protoOf(BigDecimal).toString = function () {
  if (Companion_getInstance().z2g_1) {
    return this.i2j();
  }
  var significandString = this.j2h_1.j2j(10);
  var tmp;
  if (this.j2h_1.v2i(0) < 0) {
    tmp = 2;
  } else {
    tmp = 1;
  }
  ...
  var tmp_1;
  if (compare(this.k2h_1, new Long(0, 0)) > 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E+' + this.k2h_1.toString();
  } else if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E' + this.k2h_1.toString();
  } else if (equalsLong(this.k2h_1, new Long(0, 0))) {
...
protoOf(BigDecimal).i2j = function () {
  if (this.s2g()) {
    return '0';
  }
  var digits = this.j2h_1.l2g();
  if (compare(this.k2h_1, new Long(2147483647, 0)) > 0) {
    throw RuntimeException_init_$Create$('Invalid toStringExpanded request (exponent > Int.MAX_VALUE)');
  }
  var significandString = this.j2h_1.k2j(10);
  var tmp;
  if (this.j2h_1.i2g_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = '-';
  } else {
    tmp = '';
  }
  ...
  if (compare(this.k2h_1, new Long(0, 0)) > 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.k2h_1, digits);
    var diffBigInt = add(this_0, fromInt(1));
    var tmp_1;
    if (compare(diffBigInt, new Long(0, 0)) > 0) {
      var expandZeros = this.l2j(diffBigInt, _Char___init__impl__6a9atx(48));
      tmp_1 = significandString + expandZeros;
    } else {
      tmp_1 = placeADotInStringExpanded(this, significandString, (significandString.length - convertToInt(this.k2h_1) | 0) - 1 | 0);
    }
    tmp_0 = tmp_1;
  } else if (compare(this.k2h_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.math.absoluteValue' call
    var this_1 = convertToInt(this.k2h_1);
    var diffInt = abs_0(this_1);
    var tmp_2;
    if (diffInt > 0) {
      // Inline function 'kotlin.math.absoluteValue' call
      var this_2 = this.k2h_1;
      var tmp$ret$2 = abs(this_2);
      var expandZeros_0 = this.l2j(tmp$ret$2, _Char___init__impl__6a9atx(48));
...
protoOf(BigDecimal).l2j = function (_this__u8e3s4, char) {
...
function toBigDecimal(_this__u8e3s4, exponentModifier, decimalMode) {
  ...
  decimalMode = decimalMode === VOID ? null : decimalMode;
  var tmp = Companion_getInstance().c2i(_this__u8e3s4, decimalMode);
  return tmp.a2j(exponentModifier == null ? new Long(0, 0) : exponentModifier);
}
...
function Companion_0() {
  ...
  this.g2i_1 = new DecimalMode();
  this.h2i_1 = new DecimalMode(new Long(30, 0), RoundingMode_ROUND_HALF_AWAY_FROM_ZERO_getInstance(), new Long(2, 0));
}
...
function DecimalMode(decimalPrecision, roundingMode, scale) {
  ...
  this.w2f_1 = decimalPrecision;
  this.x2f_1 = roundingMode;
  this.y2f_1 = scale;
  if (compare(this.w2f_1, new Long(0, 0)) < 0) {
    throw ArithmeticException_init_$Create$('Negative decimal precision is not allowed.');
  }
  this.z2f_1 = equalsLong(this.w2f_1, new Long(0, 0));
  this.a2g_1 = compare(this.y2f_1, new Long(0, 0)) >= 0;
  if (!this.a2g_1 && equalsLong(this.w2f_1, new Long(0, 0)) && !this.x2f_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Rounding mode with 0 digits precision.');
  }
  if (compare(this.y2f_1, new Long(-1, -1)) < 0) {
    throw ArithmeticException_init_$Create$('Negative Scale is unsupported.');
  }
  if (this.a2g_1 && this.x2f_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Scale of ' + this.y2f_1.toString() + ' digits to the right of the decimal requires a RoundingMode that is not NONE.');
  }
}
protoOf(DecimalMode).m2j = function (decimalPrecision, roundingMode, scale) {
  return new DecimalMode(decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).k2i = function (decimalPrecision, roundingMode, scale, $super) {
  decimalPrecision = decimalPrecision === VOID ? this.w2f_1 : decimalPrecision;
  roundingMode = roundingMode === VOID ? this.x2f_1 : roundingMode;
  scale = scale === VOID ? this.y2f_1 : scale;
  return $super === VOID ? this.m2j(decimalPrecision, roundingMode, scale) : $super.m2j.call(this, decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).toString = function () {
  return 'DecimalMode(decimalPrecision=' + this.w2f_1.toString() + ', roundingMode=' + this.x2f_1.toString() + ', scale=' + this.y2f_1.toString() + ')';
};
...
protoOf(DecimalMode).equals = function (other) {
  ...
  if (!equalsLong(this.w2f_1, tmp0_other_with_cast.w2f_1))
    return false;
...
function BigInteger_init_$Init$(long, $this) {
  var tmp = Companion_getInstance_1().b2g_1.n2j(long);
...
function BigInteger_init_$Init$_0(int, $this) {
  var tmp = Companion_getInstance_1().b2g_1.o2j(int);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function BigInteger_init_$Init$_1(short, $this) {
  var tmp = Companion_getInstance_1().b2g_1.p2j(short);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function BigInteger_init_$Init$_2(byte, $this) {
  var tmp = Companion_getInstance_1().b2g_1.q2j(byte);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function Companion_1() {
  ...
  this.b2g_1 = get_chosenArithmetic();
  this.c2g_1 = new BigInteger(this.b2g_1.r2j(), Sign_ZERO_getInstance());
  this.d2g_1 = new BigInteger(this.b2g_1.s2j(), Sign_POSITIVE_getInstance());
  this.e2g_1 = new BigInteger(this.b2g_1.t2j(), Sign_POSITIVE_getInstance());
  this.f2g_1 = new BigInteger(this.b2g_1.u2j(), Sign_POSITIVE_getInstance());
  var tmp = this;
  // Inline function 'kotlin.math.log10' call
  tmp.g2g_1 = log10(2.0);
}
protoOf(Companion_1).z2e = function (string, base) {
  if (base < 2 || base > 36) {
  ...
  if (decimal) {
    var bigDecimal = Companion_getInstance().d2i(string);
    var isActuallyDecimal = bigDecimal.y2i(bigDecimal.b2j()).v2i(0) > 0;
  ...
  if (signed) {
    ...
    tmp = new BigInteger(this.b2g_1.v2j(substring(string, 1, string.length), base), isNegative);
  } else {
    if (string.length === 1 && charCodeAt(string, 0) === _Char___init__impl__6a9atx(48)) {
      return this.c2g_1;
    }
    tmp = new BigInteger(this.b2g_1.v2j(string, base), Sign_POSITIVE_getInstance());
  }
  return tmp;
};
protoOf(Companion_1).w2j = function (uLong) {
  return new BigInteger(this.b2g_1.x2j(uLong), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).y2j = function (uInt) {
  return new BigInteger(this.b2g_1.z2j(uInt), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).a2k = function (uShort) {
  return new BigInteger(this.b2g_1.b2k(uShort), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).c2k = function (uByte) {
  return new BigInteger(this.b2g_1.d2k(uByte), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).t2h = function (long) {
  return BigInteger_init_$Create$(long);
};
protoOf(Companion_1).b2f = function (int) {
  return BigInteger_init_$Create$_0(int);
};
protoOf(Companion_1).x2h = function (short) {
  return BigInteger_init_$Create$_1(short);
};
protoOf(Companion_1).z2h = function (byte) {
  return BigInteger_init_$Create$_2(byte);
};
protoOf(Companion_1).c2f = function (float, exactRequired) {
  // Inline function 'kotlin.math.floor' call
  var floatDecimalPart = float - Math.floor(float);
  var tmp = Companion_getInstance();
  // Inline function 'kotlin.math.floor' call
  var tmp$ret$1 = Math.floor(float);
  var bigDecimal = tmp.a2i(tmp$ret$1, null);
  if (exactRequired) {
...
protoOf(Companion_1).e2f = function (double, exactRequired) {
  // Inline function 'kotlin.math.floor' call
...
function isResultZero($this, resultMagnitude) {
  return Companion_getInstance_1().b2g_1.e2k(resultMagnitude, Companion_getInstance_1().b2g_1.r2j()) === 0;
}
function javascriptNumberComparison_0($this, number) {
  var double = numberToDouble(number);
  var tmp;
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.g2j(Companion_getInstance_1().a2f(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.g2j(Companion_getInstance_1().t2h(numberToLong(number)));
  } else {
    var tmp_0 = numberToDouble(number);
    tmp = $this.f2k(tmp_0, BigInteger$javascriptNumberComparison$lambda($this));
  }
  return tmp;
}
function QuotientAndRemainder(quotient, remainder) {
  this.o2g_1 = quotient;
  this.p2g_1 = remainder;
}
protoOf(QuotientAndRemainder).toString = function () {
  return 'QuotientAndRemainder(quotient=' + this.o2g_1.toString() + ', remainder=' + this.p2g_1.toString() + ')';
};
protoOf(QuotientAndRemainder).hashCode = function () {
  var result = this.o2g_1.hashCode();
...
function BigInteger(wordArray, requestedSign) {
  ...
  this.h2g_1 = BigInteger63Arithmetic_getInstance().y2k(wordArray);
  var tmp = this;
  var tmp_0;
  if (isResultZero(this, this.h2g_1)) {
    tmp_0 = Sign_ZERO_getInstance();
  } else {
    tmp_0 = requestedSign;
  }
  tmp.i2g_1 = tmp_0;
  this.j2g_1 = _ULongArray___get_size__impl__ju6dtr(this.h2g_1);
  this.k2g_1 = null;
}
protoOf(BigInteger).g2f = function () {
  return Companion_getInstance_1();
};
protoOf(BigInteger).h2f = function () {
  return this;
};
protoOf(BigInteger).z2k = function (other) {
  var comparison = Companion_getInstance_1().b2g_1.e2k(this.h2g_1, other.h2g_1);
  var tmp;
  if (other.i2g_1.equals(this.i2g_1)) {
    return new BigInteger(Companion_getInstance_1().b2g_1.b2l(this.h2g_1, other.h2g_1), this.i2g_1);
  } else {
    var tmp_0;
    if (comparison > 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().b2g_1.a2l(this.h2g_1, other.h2g_1), this.i2g_1);
    } else if (comparison < 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().b2g_1.a2l(other.h2g_1, this.h2g_1), other.i2g_1);
    } else {
      tmp_0 = Companion_getInstance_1().c2g_1;
    }
    tmp = tmp_0;
  }
  return tmp;
};
protoOf(BigInteger).j2f = function (other) {
  return this.z2k(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).c2l = function (other) {
  if (this.s2g()) {
    return other.f2i();
  }
  if (other.s2g()) {
  ...
  if (other.i2g_1.equals(this.i2g_1)) {
    ...
    if (comparison > 0) {
      ...
      tmp_0 = new BigInteger(Companion_getInstance_1().b2g_1.a2l(other.h2g_1, this.h2g_1), this.i2g_1.f2l());
    } else {
      tmp_0 = Companion_getInstance_1().c2g_1;
    }
    tmp = tmp_0;
...
protoOf(BigInteger).l2f = function (other) {
  return this.c2l(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).g2l = function (other) {
  if (this.s2g() || other.s2g()) {
    return Companion_getInstance_1().c2g_1;
  }
  if (other.equals(Companion_getInstance_1().d2g_1)) {
    return this;
  }
  var tmp;
  if (!this.i2g_1.equals(other.i2g_1)) {
  ...
  var tmp_0;
  if (sign.equals(Sign_POSITIVE_getInstance())) {
    tmp_0 = new BigInteger(Companion_getInstance_1().b2g_1.h2l(this.h2g_1, other.h2g_1), sign);
  } else {
    tmp_0 = new BigInteger(Companion_getInstance_1().b2g_1.h2l(this.h2g_1, other.h2g_1), sign);
  }
  return tmp_0;
...
protoOf(BigInteger).n2f = function (other) {
  return this.g2l(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).i2l = function (other) {
  ...
  var result = Companion_getInstance_1().b2g_1.j2l(this.h2g_1, other.h2g_1).re_1.ym_1;
  var tmp;
  if (equals(result, Companion_getInstance_1().b2g_1.r2j())) {
...
protoOf(BigInteger).k2l = function (other) {
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().b2g_1.j2l(this.h2g_1, other.h2g_1).se_1.ym_1;
  if (equals(result, Companion_getInstance_1().b2g_1.r2j())) {
    sign = Sign_ZERO_getInstance();
  }
...
protoOf(BigInteger).l2l = function (other) {
  if (other.s2g()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var tmp;
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().b2g_1.j2l(this.h2g_1, other.h2g_1);
  var tmp_0;
  if (equals(result.re_1, new ULongArray(Companion_getInstance_1().b2g_1.r2j()))) {
    tmp_0 = Companion_getInstance_1().c2g_1;
  } else {
  ...
  var quotient = tmp_0;
  var tmp_1;
  if (equals(result.se_1, new ULongArray(Companion_getInstance_1().b2g_1.r2j()))) {
    tmp_1 = Companion_getInstance_1().c2g_1;
  } else {
    tmp_1 = new BigInteger(result.se_1.ym_1, this.i2g_1);
  }
  var remainder = tmp_1;
  return new Pair(quotient, remainder);
};
protoOf(BigInteger).g2j = function (other) {
  if (this.s2g() && other.s2g())
    return 0;
  if (other.s2g() && this.i2g_1.equals(Sign_POSITIVE_getInstance()))
    return 1;
  if (other.s2g() && this.i2g_1.equals(Sign_NEGATIVE_getInstance()))
    return -1;
  if (this.s2g() && other.i2g_1.equals(Sign_POSITIVE_getInstance()))
    return -1;
  if (this.s2g() && other.i2g_1.equals(Sign_NEGATIVE_getInstance()))
    return 1;
  if (!this.i2g_1.equals(other.i2g_1))
    return this.i2g_1.equals(Sign_POSITIVE_getInstance()) ? 1 : -1;
  var result = Companion_getInstance_1().b2g_1.e2k(this.h2g_1, other.h2g_1);
  var tmp;
  if (this.i2g_1.equals(Sign_NEGATIVE_getInstance()) && other.i2g_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = imul(result, -1);
  } else {
    tmp = result;
  }
...
protoOf(BigInteger).s2g = function () {
  return this.i2g_1.equals(Sign_ZERO_getInstance()) || get_chosenArithmetic().e2k(this.h2g_1, get_chosenArithmetic().r2j()) === 0;
};
protoOf(BigInteger).f2i = function () {
  return new BigInteger(this.h2g_1, this.i2g_1.f2l());
};
protoOf(BigInteger).q2g = function () {
  return new BigInteger(this.h2g_1, Sign_POSITIVE_getInstance());
};
protoOf(BigInteger).m2g = function (exponent) {
  if (compare(exponent, new Long(0, 0)) < 0) {
  ...
  if (this.s2g()) {
    tmp = Companion_getInstance_1().c2g_1;
  } else if (this.equals(Companion_getInstance_1().d2g_1)) {
    tmp = Companion_getInstance_1().d2g_1;
  } else {
    var tmp_0;
    if (this.i2g_1.equals(Sign_NEGATIVE_getInstance())) {
      var tmp_1;
    ...
    var sign = tmp_0;
    tmp = new BigInteger(Companion_getInstance_1().b2g_1.m2l(this.h2g_1, exponent), sign);
  }
  return tmp;
};
protoOf(BigInteger).n2l = function (exponent) {
  return this.m2g(fromInt(exponent));
};
protoOf(BigInteger).h2h = function () {
  var tmp;
  switch (this.i2g_1.q2_1) {
    case 0:
      tmp = 1;
      break;
    case 1:
...
protoOf(BigInteger).l2g = function () {
  ...
  var powersOf10 = BigInteger63Arithmetic_getInstance().x2k_1;
  var tmp$ret$1;
  $l$block: {
    ...
    if (inductionVariable <= last)
      do {
        ...
        if (BigInteger63Arithmetic_getInstance().o2l(it, this.h2g_1) > 0) {
          tmp$ret$1 = index;
          break $l$block;
        }
      }
  ...
  var tmp = this.o2f(Companion_getInstance_1().f2g_1.n2l(powersOf10.length));
...
protoOf(BigInteger).t2g = function () {
  return this.k2f(Companion_getInstance_1().d2g_1);
};
protoOf(BigInteger).u2g = function () {
  return this.i2f(Companion_getInstance_1().d2g_1);
};
protoOf(BigInteger).n2g = function (other) {
  var result = this.l2l(other);
  return new QuotientAndRemainder(result.re_1, result.se_1);
};
protoOf(BigInteger).v2i = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.h2j().equals(Platform_JS_getInstance())) {
  ...
  if (other instanceof BigInteger) {
    ...
    if (other instanceof Long) {
      tmp = this.g2j(Companion_getInstance_1().t2h(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.g2j(Companion_getInstance_1().b2f(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.g2j(Companion_getInstance_1().x2h(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.g2j(Companion_getInstance_1().z2h(other));
          } else {
            if (other instanceof ULong) {
              tmp = this.g2j(Companion_getInstance_1().w2j(other.l1_1));
            } else {
              if (other instanceof UInt) {
                tmp = this.g2j(Companion_getInstance_1().y2j(other.km_1));
              } else {
                if (other instanceof UShort) {
                  tmp = this.g2j(Companion_getInstance_1().a2k(other.dn_1));
                } else {
                  if (other instanceof UByte) {
                    tmp = this.g2j(Companion_getInstance_1().c2k(other.am_1));
                  } else {
                    if (typeof other === 'number') {
                      tmp = this.f2k(other, BigInteger$compareTo$lambda(this));
                    } else {
                      if (typeof other === 'number') {
                        tmp = this.p2l(other, BigInteger$compareTo$lambda_0(this));
                      } else {
...
protoOf(BigInteger).f2k = function (float, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
  var withoutDecimalPart = Math.floor(float);
  var hasDecimalPart = !(float % 1 === 0.0);
  var tmp;
  if (hasDecimalPart) {
    var comparisonResult = comparisonBlock(Companion_getInstance_1().d2f(withoutDecimalPart + 1));
    var tmp_0;
    ...
    tmp = comparisonBlock(Companion_getInstance_1().d2f(withoutDecimalPart));
  }
  return tmp;
};
protoOf(BigInteger).p2l = function (double, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
...
protoOf(BigInteger).hashCode = function () {
  ...
  return accumulator + this.i2g_1.hashCode() | 0;
};
...
protoOf(BigInteger).j2j = function (base) {
  ...
  var sign = tmp;
  return sign + this.k2j(base);
};
protoOf(BigInteger).k2j = function (base) {
  return Companion_getInstance_1().b2g_1.q2l(this.h2g_1, base);
};
protoOf(BigInteger).r2g = function (exactRequired) {
  if (exactRequired && (this.v2i(2147483647) > 0 || this.v2i(-2147483648) < 0)) {
    throw ArithmeticException_init_$Create$('Cannot convert to int and provide exact value');
  }
  // Inline function 'kotlin.ULong.toInt' call
  var this_0 = ULongArray__get_impl_pr71q9(this.h2g_1, 0);
  var tmp$ret$0 = convertToInt(_ULong___get_data__impl__fggpzb(this_0));
  return imul(tmp$ret$0, this.h2h());
};
...
function toBigInteger(_this__u8e3s4) {
  return Companion_getInstance_1().b2f(_this__u8e3s4);
}
function toBigInteger_0(_this__u8e3s4, base) {
  base = base === VOID ? 10 : base;
  return Companion_getInstance_1().z2e(_this__u8e3s4, base);
}
...
protoOf(Sextuple).toString = function () {
  return 'Sextuple(a=' + toString_0(this.r2l_1) + ', b=' + toString_0(this.s2l_1) + ', c=' + toString_0(this.t2l_1) + ', d=' + toString_0(this.u2l_1) + ', e=' + toString_0(this.v2l_1) + ', f=' + toString_0(this.w2l_1) + ')';
};
protoOf(Sextuple).hashCode = function () {
  var result = this.r2l_1 == null ? 0 : hashCode(this.r2l_1);
...
protoOf(Quadruple).x2l = function () {
  return this.d2m_1;
};
protoOf(Quadruple).toString = function () {
  return 'Quadruple(a=' + toString_0(this.a2m_1) + ', b=' + toString_0(this.b2m_1) + ', c=' + toString_0(this.c2m_1) + ', d=' + toString_0(this.d2m_1) + ')';
};
...
function SignedUIntArray(unsignedValue, sign) {
  this.e2m_1 = unsignedValue;
  this.f2m_1 = sign;
}
protoOf(SignedUIntArray).toString = function () {
  return 'SignedUIntArray(unsignedValue=' + UIntArray__toString_impl_3zy802(this.e2m_1) + ', sign=' + this.f2m_1 + ')';
};
protoOf(SignedUIntArray).hashCode = function () {
  var result = UIntArray__hashCode_impl_hr7ost(this.e2m_1);
...
function BigInteger32Arithmetic() {
  ...
  tmp.g2m_1 = new Int32Array([]);
  this.h2m_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.i2m_1 = _UInt___init__impl__l7qpdl(-1);
  this.j2m_1 = _ULong___init__impl__c78o9k(new Long(0, 1));
  this.k2m_1 = _ULong___init__impl__c78o9k(new Long(65535, 0));
  this.l2m_1 = _UInt___init__impl__l7qpdl(-1);
  this.m2m_1 = 32;
  this.n2m_1 = 32;
  this.o2m_1 = _UIntArray___init__impl__ghjpc6(0);
  var tmp_0 = this;
  ...
  tmp_0.p2m_1 = _UIntArray___init__impl__ghjpc6_0(tmp_2);
  var tmp_4 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_5 = 0;
  ...
  tmp_4.q2m_1 = _UIntArray___init__impl__ghjpc6_0(tmp_6);
  var tmp_8 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_9 = 0;
  ...
  tmp_8.r2m_1 = _UIntArray___init__impl__ghjpc6_0(tmp_10);
  this.s2m_1 = 60;
  this.t2m_1 = 15000;
  this.u2m_1 = new SignedUIntArray(this.q2m_1, true);
}
...
protoOf(BigInteger32Arithmetic).w2m = function (value) {
  ...
  return this.x2m(mostSignificant) + imul(_UIntArray___get_size__impl__r6l8ci(value) - 1 | 0, this.m2m_1) | 0;
};
protoOf(BigInteger32Arithmetic).x2m = function (value) {
  return this.m2m_1 - this.v2m(value) | 0;
};
...
protoOf(BigInteger32Arithmetic).z2m = function (bigInteger) {
...
protoOf(BigInteger32Arithmetic).a2n = function (operand, places) {
  ...
  var leadingZeros = this.v2m(UIntArray__get_impl_gp5kza(operand, _UIntArray___get_size__impl__r6l8ci(operand) - 1 | 0));
  var shiftWords = places / this.m2m_1 | 0;
  var shiftBits = places % this.m2m_1 | 0;
  var tmp;
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.UInt.shr' call
          var bitCount = BigInteger32Arithmetic_getInstance().m2m_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.UInt.shr' call
            var bitCount_0 = BigInteger32Arithmetic_getInstance().m2m_1 - shiftBits | 0;
...
protoOf(BigInteger32Arithmetic).b2n = function (operand, places) {
  if (UIntArray__isEmpty_impl_vd8j4n(operand) || places === 0) {
    return operand;
  }
  var shiftBits = places % this.m2m_1 | 0;
  var wordsToDiscard = places / this.m2m_1 | 0;
  ...
  return this.y2m(result);
};
protoOf(BigInteger32Arithmetic).c2n = function (dividend, divisor) {
  var divisorSize = _UIntArray___get_size__impl__r6l8ci(divisor);
  var normalizationShift = this.v2m(UIntArray__get_impl_gp5kza(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.d2n(divisor, normalizationShift);
  var dividendNormalized = this.d2n(dividend, normalizationShift);
  return new Triple(new UIntArray(dividendNormalized), new UIntArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger32Arithmetic).e2n = function (remainderNormalized, normalizationShift) {
  var remainder = this.f2n(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger32Arithmetic).g2n = function (first, second) {
  var firstStart = _UIntArray___get_size__impl__r6l8ci(first) - this.z2m(first) | 0;
  var secondStart = _UIntArray___get_size__impl__r6l8ci(second) - this.z2m(second) | 0;
...
protoOf(BigInteger32Arithmetic).h2n = function (first, second) {
  ...
  var smallerData = _destruct__k2r9zo.x2l().pm_1;
  // Inline function 'kotlin.UIntArray' call
  var tmp_0 = 0;
...
protoOf(BigInteger32Arithmetic).i2n = function (first, second) {
  var firstWithoutLeadingZeroes = this.y2m(first);
  var secondWithoutLeadingZeroes = this.y2m(second);
  var firstIsLarger = this.g2n(firstWithoutLeadingZeroes, secondWithoutLeadingZeroes) === 1;
  var tmp;
  if (firstIsLarger) {
...
protoOf(BigInteger32Arithmetic).k2n = function (first, second) {
  return this.l2n(first, second);
};
protoOf(BigInteger32Arithmetic).l2n = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.m2n(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new UIntArray(this.o2m_1), new UIntArray(unnormalizedDividend));
  }
  if (_UIntArray___get_size__impl__r6l8ci(unnormalizedDivisor) === 1 && _UIntArray___get_size__impl__r6l8ci(unnormalizedDividend) === 1) {
    ...
    return new Pair(new UIntArray(tmp), new UIntArray(this.y2m(tmp$ret$3)));
  }
  var bitPrecision = this.w2m(unnormalizedDividend) - this.w2m(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    // Inline function 'kotlin.uintArrayOf' call
    var tmp$ret$4 = _UIntArray___init__impl__ghjpc6_0(new Int32Array([_UInt___init__impl__l7qpdl(1)]));
    return new Pair(new UIntArray(tmp$ret$4), new UIntArray(this.n2n(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.c2n(unnormalizedDividend, unnormalizedDivisor);
  ...
  var divisorTimesBaseToPowerOfM = this.d2n(divisor, imul(wordPrecision, this.m2m_1));
  if (this.m2n(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.n2n(dividend, divisorTimesBaseToPowerOfM);
  }
  ...
  if (0 <= inductionVariable)
    do {
      ...
      reconstructedQuotient = this.d2n(this.o2n(divisor, UIntArray__get_impl_gp5kza(quotient, j)), imul(j, this.m2m_1));
      while (this.m2n(reconstructedQuotient, dividend) > 0) {
        var tmp_4 = quotient;
      ...
      dividend = this.n2n(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.m2n(dividend, divisor) >= 0) {
    quotient = this.p2n(quotient, _UInt___init__impl__l7qpdl(1));
    dividend = this.n2n(dividend, divisor);
  }
  var denormRemainder = this.e2n(dividend, normalizationShift);
  return new Pair(new UIntArray(this.y2m(quotient)), new UIntArray(denormRemainder));
};
protoOf(BigInteger32Arithmetic).d2n = function (_this__u8e3s4, places) {
  return this.a2n(_this__u8e3s4, places);
};
protoOf(BigInteger32Arithmetic).f2n = function (_this__u8e3s4, places) {
  return this.b2n(_this__u8e3s4, places);
};
...
function basecaseMultiplyWithCorrectedSize($this, first, second, firstCorrectedSizeStart, secondCorrectedSizeStart) {
  ...
  while (_iterator__ex2g4s.s()) {
    ...
    if (_unary__edvuaz > secondCorrectedSizeStart) {
      ...
      resultArray = BigInteger63Arithmetic_getInstance().t2n(resultArray, BigInteger63Arithmetic_getInstance().s2n(BigInteger63Arithmetic_getInstance().r2n(first, item), imul(_unary__edvuaz, BigInteger63Arithmetic_getInstance().m2k_1)));
    }
  }
  return resultArray;
}
function karatsubaMultiplyWithCorrectedSizes($this, firstUnsigned, secondUnsigned, firstCorrectedSize, secondCorrectedSize) {
  ...
  var mask = $this.u2n($this.s2n($this.i2k_1, imul(halfLength, $this.n2k_1)), _ULong___init__impl__c78o9k(new Long(1, 0)));
  var firstLower = $this.v2n(first, mask);
  var firstHigher = $this.w2n(first, imul(halfLength, $this.n2k_1));
  var secondLower = $this.v2n(second, mask);
  var secondHigher = $this.w2n(second, imul(halfLength, $this.n2k_1));
  var higherProduct = $this.x2n(firstHigher, secondHigher);
  var lowerProduct = $this.x2n(firstLower, secondLower);
  var middleProduct = $this.x2n($this.y2n(firstHigher, firstLower), $this.y2n(secondHigher, secondLower));
  var result = $this.y2n($this.y2n($this.z2n(higherProduct, imul(imul(2, $this.n2k_1), halfLength)), $this.z2n($this.a2o($this.a2o(middleProduct, higherProduct), lowerProduct), imul($this.n2k_1, halfLength))), lowerProduct);
  return result.b2o_1;
}
function isZero($this, _this__u8e3s4) {
  if (equals(_this__u8e3s4, $this.h2k_1))
    return true;
  if (_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) === 1 && equals(ULongArray__get_impl_pr71q9(_this__u8e3s4, 0), _ULong___init__impl__c78o9k(new Long(0, 0))))
    return true;
  if ((_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) - $this.d2o(_this__u8e3s4) | 0) === 0)
    return true;
  return false;
}
function SignedULongArray(unsignedValue, sign) {
  this.b2o_1 = unsignedValue;
  this.c2o_1 = sign;
}
protoOf(SignedULongArray).e2o = function (unsignedValue, sign) {
  return new SignedULongArray(unsignedValue, sign);
};
protoOf(SignedULongArray).f2o = function (unsignedValue, sign, $super) {
  unsignedValue = unsignedValue === VOID ? this.b2o_1 : unsignedValue;
  sign = sign === VOID ? this.c2o_1 : sign;
  return $super === VOID ? this.e2o(unsignedValue, sign) : $super.e2o.call(this, new ULongArray(unsignedValue), sign);
};
protoOf(SignedULongArray).toString = function () {
  return 'SignedULongArray(unsignedValue=' + ULongArray__toString_impl_wqk1p5(this.b2o_1) + ', sign=' + this.c2o_1 + ')';
};
protoOf(SignedULongArray).hashCode = function () {
  var result = ULongArray__hashCode_impl_aze4wa(this.b2o_1);
...
function signedAdd($this, first, second) {
  var tmp;
  if (!!(first.c2o_1 ^ second.c2o_1)) {
    var tmp_0;
    if ($this.o2l(first.b2o_1, second.b2o_1) > 0) {
      tmp_0 = new SignedULongArray($this.g2o(first.b2o_1, second.b2o_1), first.c2o_1);
    } else {
      tmp_0 = new SignedULongArray($this.g2o(second.b2o_1, first.b2o_1), second.c2o_1);
    }
    tmp = tmp_0;
  } else {
    tmp = new SignedULongArray($this.t2n(first.b2o_1, second.b2o_1), first.c2o_1);
  }
  return tmp;
}
function signedSubtract($this, first, second) {
  return signedAdd($this, first, second.f2o(VOID, !second.c2o_1));
}
function signedMultiply($this, first, second) {
  return new SignedULongArray($this.h2o(first.b2o_1, second.b2o_1), !!!(first.c2o_1 ^ second.c2o_1));
}
function signedDivide($this, first, second) {
  return new SignedULongArray($this.i2o(first.b2o_1, second.b2o_1), !!!(first.c2o_1 ^ second.c2o_1));
}
function BigInteger63Arithmetic() {
  BigInteger63Arithmetic_instance = this;
  var tmp = this;
  // Inline function 'kotlin.longArrayOf' call
  tmp.g2k_1 = longArrayOf([]);
  var tmp_0 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_0.h2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(0, 0))]));
  var tmp_1 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_1.i2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(1, 0))]));
  var tmp_2 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_2.j2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(2, 0))]));
  var tmp_3 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_3.k2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(10, 0))]));
  var tmp_4 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_4.l2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1431655765, 715827882))]));
  this.m2k_1 = 63;
  this.n2k_1 = 63;
  this.o2k_1 = _ULong___init__impl__c78o9k(new Long(-1, 2147483647));
  var tmp_5 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_5.p2k_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1, 2147483647))]));
  this.q2k_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.r2k_1 = _ULong___init__impl__c78o9k(new Long(0, 2147483647));
  this.s2k_1 = _ULong___init__impl__c78o9k(new Long(0, -2147483648));
  this.t2k_1 = 120;
  this.u2k_1 = 15000;
  this.v2k_1 = false;
  this.w2k_1 = new SignedULongArray(BigInteger63Arithmetic_getInstance().j2k_1, true);
  var tmp_6 = this;
  // Inline function 'kotlin.ulongArrayOf' call
...
protoOf(BigInteger63Arithmetic).k2o = function (value) {
  ...
  var start = (_ULongArray___get_size__impl__ju6dtr(value) - this.d2o(value) | 0) - 1 | 0;
  var mostSignificant = ULongArray__get_impl_pr71q9(value, start);
  return this.l2o(mostSignificant) + imul(start, 63) | 0;
};
protoOf(BigInteger63Arithmetic).l2o = function (value) {
  return 63 - this.j2o(value) | 0;
};
protoOf(BigInteger63Arithmetic).y2k = function (bigInteger) {
  var correctedSize = _ULongArray___get_size__impl__ju6dtr(bigInteger) - this.d2o(bigInteger) | 0;
  if (correctedSize === 0) {
    return this.h2k_1;
  }
...
protoOf(BigInteger63Arithmetic).d2o = function (bigInteger) {
...
protoOf(BigInteger63Arithmetic).m2o = function (operand, places) {
  ...
  var leadingZeroWords = this.d2o(operand);
  ...
  var leadingZeros = this.j2o(ULongArray__get_impl_pr71q9(operand, originalSize - 1 | 0));
  var shiftWords = places / this.m2k_1 | 0;
  var shiftBits = places % this.m2k_1 | 0;
  var tmp;
  if (shiftBits > leadingZeros) {
    tmp = shiftWords + 1 | 0;
  } else {
  ...
  while (tmp_4 < tmp_5) {
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        // Inline function 'kotlin.ULong.and' call
        var other = BigInteger63Arithmetic_getInstance().o2k_1;
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.ULong.and' call
          var other_0 = BigInteger63Arithmetic_getInstance().o2k_1;
          ...
          // Inline function 'kotlin.ULong.shr' call
          var bitCount = BigInteger63Arithmetic_getInstance().m2k_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.ULong.shr' call
            var bitCount_0 = BigInteger63Arithmetic_getInstance().m2k_1 - shiftBits | 0;
...
protoOf(BigInteger63Arithmetic).n2o = function (operand, places) {
  ...
  var shiftBits = places % this.m2k_1 | 0;
  var wordsToDiscard = places / this.m2k_1 | 0;
...
protoOf(BigInteger63Arithmetic).o2o = function (first, second, firstStart, secondStart) {
  if (firstStart > secondStart) {
    return 1;
  }
  if (secondStart > firstStart) {
...
protoOf(BigInteger63Arithmetic).e2k = function (first, second) {
  var firstStart = _ULongArray___get_size__impl__ju6dtr(first) - this.d2o(first) | 0;
  var secondStart = _ULongArray___get_size__impl__ju6dtr(second) - this.d2o(second) | 0;
  return this.o2o(first, second, firstStart, secondStart);
};
protoOf(BigInteger63Arithmetic).p2o = function (resultArray, resultArrayStart, first, second) {
  ...
  var smallerData = _destruct__k2r9zo.x2l().ym_1;
  var largerStart = _destruct__k2r9zo.y2l();
...
protoOf(BigInteger63Arithmetic).b2l = function (first, second) {
  if (isZero(this, first))
    return second;
  if (isZero(this, second))
    return first;
  ...
  var result = tmp_1;
  this.p2o(result, 0, first, second);
  var tmp_9;
  if (possibleOverflow_0) {
    tmp_9 = this.y2k(result);
  } else {
    tmp_9 = result;
  }
  return tmp_9;
...
protoOf(BigInteger63Arithmetic).q2o = function (first, second, firstStart, secondStart) {
  var comparison = this.o2o(first, second, firstStart, secondStart);
  ...
  var smallerStart = _destruct__k2r9zo.x2l();
  // Inline function 'kotlin.ULongArray' call
  var tmp_0 = 0;
  ...
  if (this.d2o(result) === (_ULongArray___get_size__impl__ju6dtr(result) - 1 | 0) && equals(ULongArray__get_impl_pr71q9(result, 0), _ULong___init__impl__c78o9k(new Long(0, 0)))) {
    return this.h2k_1;
  }
...
protoOf(BigInteger63Arithmetic).h2l = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.d2o(first) | 0;
  var secondCorrectedSize = _ULongArray___get_size__impl__ju6dtr(second) - this.d2o(second) | 0;
  return multiplyWithCorrectedSize(this, first, second, firstCorrectedSize, secondCorrectedSize);
};
protoOf(BigInteger63Arithmetic).r2o = function (original, numberOfWords, value) {
  // Inline function 'kotlin.ULongArray' call
  var tmp = 0;
...
protoOf(BigInteger63Arithmetic).q2n = function (firstUnchecked, secondUnchecked) {
  var tmp;
  ...
  if (firstLength > secondLength) {
    var prepared = this.r2o(second, firstLength - secondLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
    tmp_9 = new Pair(new ULongArray(first), new ULongArray(prepared));
  } else if (firstLength < secondLength) {
    var prepared_0 = this.r2o(first, secondLength - firstLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
  ...
  var p0 = this.y2n(m0, m2);
  var pe0 = m0;
  var pe1 = this.y2n(p0, m1);
  var pem1 = this.a2o(p0, m1);
  var doublePemM2 = this.x2n(this.y2n(pem1, m2), this.w2k_1);
  var pem2 = this.a2o(doublePemM2, m0);
  var pinf = m2;
  var q0 = this.y2n(n0, n2);
  var qe0 = n0;
  var qe1 = this.y2n(q0, n1);
  var qem1 = this.a2o(q0, n1);
  var doubleQemN2 = this.x2n(this.y2n(qem1, n2), this.w2k_1);
  var qem2 = this.a2o(doubleQemN2, n0);
  var qinf = n2;
  var re0 = this.x2n(pe0, qe0);
  var re1 = this.x2n(pe1, qe1);
  var rem1 = this.x2n(pem1, qem1);
  var rem2 = this.x2n(pem2, qem2);
  var rinf = this.x2n(pinf, qinf);
  var r0 = re0;
  var r4 = rinf;
  var rem2re1diff = this.a2o(rem2, re1);
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$11 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(3, 0))]));
  var r3 = this.s2o(rem2re1diff, new SignedULongArray(tmp$ret$11, true));
  var r1 = this.w2n(this.a2o(re1, rem1), 1);
  var r2 = this.a2o(rem1, r0);
  r3 = this.y2n(this.w2n(this.a2o(r2, r3), 1), this.x2n(this.w2k_1, rinf));
  r2 = this.a2o(this.y2n(r2, r1), r4);
  r1 = this.a2o(r1, r3);
  var bShiftAmount = imul(extendedDigit, 63);
  var rb0 = r0;
  var rb1 = this.z2n(r1, bShiftAmount);
  var rb2 = this.z2n(r2, imul(bShiftAmount, 2));
  var rb3 = this.z2n(r3, imul(bShiftAmount, 3));
  var rb4 = this.z2n(r4, imul(bShiftAmount, 4));
  var rb = this.y2n(this.y2n(this.y2n(this.y2n(rb0, rb1), rb2), rb3), rb4);
  return rb.b2o_1;
};
protoOf(BigInteger63Arithmetic).r2n = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.d2o(first) | 0;
  return this.t2o(first, second, firstCorrectedSize);
};
protoOf(BigInteger63Arithmetic).t2o = function (first, second, firstCorrectedSize) {
  // Inline function 'kotlin.ULong.and' call
  ...
  var requiredBits = this.k2o(first) + this.l2o(second) | 0;
  var tmp;
...
protoOf(BigInteger63Arithmetic).m2l = function (base, exponent) {
  ...
  if (_ULongArray___get_size__impl__ju6dtr(base) === 1 && equals(ULongArray__get_impl_pr71q9(base, 0), _ULong___init__impl__c78o9k(new Long(10, 0))) && compare(exponent, fromInt(this.x2k_1.length)) < 0) {
    return this.x2k_1[convertToInt(exponent)].ym_1;
  }
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(base) - this.d2o(base) | 0;
  var helperVar = this.i2k_1;
  ...
  while (compare(exponentVar, new Long(1, 0)) > 0) {
    ...
    if (equalsLong(tmp$ret$0, new Long(0, 0))) {
      baseVar = this.h2o(baseVar, baseVar);
      // Inline function 'kotlin.Long.div' call
      var this_1 = exponentVar;
      exponentVar = divide(this_1, fromInt(2));
    } else {
      helperVar = this.h2o(baseVar, helperVar);
      baseVar = this.h2o(baseVar, baseVar);
      // Inline function 'kotlin.Long.minus' call
  ...
  return this.h2o(helperVar, baseVar);
};
protoOf(BigInteger63Arithmetic).u2o = function (dividend, divisor) {
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var normalizationShift = this.j2o(ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.s2n(divisor, normalizationShift);
  var dividendNormalized = this.s2n(dividend, normalizationShift);
  return new Triple(new ULongArray(dividendNormalized), new ULongArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger63Arithmetic).v2o = function (remainderNormalized, normalizationShift) {
  var remainder = this.w2o(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger63Arithmetic).x2o = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.o2l(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new ULongArray(this.h2k_1), new ULongArray(unnormalizedDividend));
  }
  if (_ULongArray___get_size__impl__ju6dtr(unnormalizedDivisor) === 1 && _ULongArray___get_size__impl__ju6dtr(unnormalizedDividend) === 1) {
    ...
    return new Pair(new ULongArray(tmp), new ULongArray(this.y2k(tmp$ret$3)));
  }
  var bitPrecision = this.k2o(unnormalizedDividend) - this.k2o(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    return new Pair(new ULongArray(this.i2k_1), new ULongArray(this.g2o(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.u2o(unnormalizedDividend, unnormalizedDivisor);
  ...
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var divisorCorrectedSize = _ULongArray___get_size__impl__ju6dtr(divisor) - this.d2o(divisor) | 0;
  var wordPrecision = dividendSize - divisorSize | 0;
  var qjhat;
  var reconstructedQuotient;
  var quotient = _ULongArray___init__impl__twm1l3_0(wordPrecision);
  var divisorTimesBaseToPowerOfM = this.s2n(divisor, imul(wordPrecision, this.m2k_1));
  if (this.o2l(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.g2o(dividend, divisorTimesBaseToPowerOfM);
  }
  var inductionVariable = wordPrecision - 1 | 0;
  if (0 <= inductionVariable)
    do {
      ...
      if ((divisorSize + j | 0) < _ULongArray___get_size__impl__ju6dtr(dividend)) {
        ...
        tmp_0 = this.y2o(this.s2n(tmp$ret$4, this.m2k_1), ULongArray__get_impl_pr71q9(dividend, (divisorSize + j | 0) - 1 | 0));
      } else {
        var tmp_1;
        if ((divisorSize + j | 0) === _ULongArray___get_size__impl__ju6dtr(dividend)) {
          // Inline function 'kotlin.ulongArrayOf' call
      ...
      var tmp_3 = this.z2o(twoDigit);
      // Inline function 'kotlin.ulongArrayOf' call
      var tmp$ret$6 = _ULongArray___init__impl__twm1l3(longArrayOf([ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0)]));
      var convertedResult = tmp_2.k2n(tmp_3, this.z2o(tmp$ret$6));
      qjhat = this.a2p(convertedResult.re_1.pm_1);
      var tmp_4 = quotient;
      var tmp_5;
      var tmp_6 = qjhat;
      var tmp0_1 = this.o2k_1;
      // Inline function 'kotlin.ULong.minus' call
      ...
      if (this.b2p(tmp_6, tmp$ret$7) < 0) {
        tmp_5 = ULongArray__get_impl_pr71q9(qjhat, 0);
      } else {
        tmp_5 = this.o2k_1;
      }
      ULongArray__set_impl_z19mvh(tmp_4, j, tmp_5);
      reconstructedQuotient = this.s2n(this.t2o(divisor, ULongArray__get_impl_pr71q9(quotient, j), divisorCorrectedSize), imul(j, this.m2k_1));
      while (this.o2l(reconstructedQuotient, dividend) > 0) {
        var tmp_7 = quotient;
      ...
      dividend = this.g2o(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.o2l(dividend, divisor) >= 0) {
    quotient = this.y2o(quotient, _ULong___init__impl__c78o9k(new Long(1, 0)));
    dividend = this.g2o(dividend, divisor);
  }
  var denormRemainder = this.v2o(dividend, normalizationShift);
  return new Pair(new ULongArray(this.y2k(quotient)), new ULongArray(denormRemainder));
};
protoOf(BigInteger63Arithmetic).c2p = function (operand) {
  if (isZero(this, operand))
    return this.h2k_1;
  var length = this.k2o(operand);
  var tmp;
  if ((length % 64 | 0) === 0) {
    tmp = length / 64 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).d2p = function (operand) {
  var power64Representation = this.c2p(operand);
  ...
  if (inductionVariable < last)
    do {
      ...
      // Inline function 'kotlin.UInt.toULong' call
      var this_0 = BigInteger32Arithmetic_getInstance().l2m_1;
      // Inline function 'kotlin.uintToULong' call
      // Inline function 'kotlin.uintToLong' call
      var value = _UInt___get_data__impl__f0vqqw(this_0);
      var tmp$ret$0 = bitwiseAnd(fromInt(value), new Long(-1, 0));
     ...
     while (inductionVariable < last);
  return BigInteger32Arithmetic_getInstance().y2m(result);
};
protoOf(BigInteger63Arithmetic).e2p = function (operand) {
  ...
  var length = BigInteger32Arithmetic_getInstance().w2m(operand);
  var tmp;
  if ((length % 63 | 0) === 0) {
    tmp = length / 63 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).j2l = function (first, second) {
  return this.x2o(first, second);
};
protoOf(BigInteger63Arithmetic).y2n = function (_this__u8e3s4, other) {
...
protoOf(BigInteger63Arithmetic).s2o = function (_this__u8e3s4, other) {
  return signedDivide(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).w2n = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.w2o(_this__u8e3s4.b2o_1, places), _this__u8e3s4.c2o_1);
};
protoOf(BigInteger63Arithmetic).z2n = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.s2n(_this__u8e3s4.b2o_1, places), _this__u8e3s4.c2o_1);
};
protoOf(BigInteger63Arithmetic).v2n = function (_this__u8e3s4, operand) {
  return new SignedULongArray(this.f2p(_this__u8e3s4.b2o_1, operand), _this__u8e3s4.c2o_1);
};
protoOf(BigInteger63Arithmetic).v2j = function (number, base) {
  var parsed = this.h2k_1;
  ...
  while (inductionVariable < charSequenceLength(indexedObject)) {
    ...
    var tmp_2 = tmp_0.g2p(tmp_1, tmp$ret$2);
    // Inline function 'kotlin.toULong' call
    var this_0 = toDigit(element, base);
    var tmp$ret$3 = _ULong___init__impl__c78o9k(fromInt(this_0));
    parsed = tmp.y2o(tmp_2, tmp$ret$3);
  }
  return this.y2k(parsed);
};
protoOf(BigInteger63Arithmetic).q2l = function (operand, base) {
  ...
  var stringBuilder = StringBuilder_init_$Create$();
  while (!equals(copy, this.h2k_1)) {
    var divremResult = this.h2p(copy, baseArray);
...
protoOf(BigInteger63Arithmetic).f2p = function (operand, mask) {
  var tmp;
...
protoOf(BigInteger63Arithmetic).s2n = function (_this__u8e3s4, places) {
  return this.m2o(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).w2o = function (_this__u8e3s4, places) {
  return this.n2o(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).t2n = function (_this__u8e3s4, other) {
  return this.b2l(_this__u8e3s4, other);
};
...
protoOf(BigInteger63Arithmetic).h2o = function (_this__u8e3s4, other) {
  return this.h2l(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).y2o = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.b2l(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).u2n = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.a2l(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).g2p = function (_this__u8e3s4, other) {
  return this.r2n(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).i2o = function (_this__u8e3s4, other) {
  return this.j2l(_this__u8e3s4, other).re_1.ym_1;
};
protoOf(BigInteger63Arithmetic).h2p = function (_this__u8e3s4, other) {
  return this.j2l(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).o2l = function (_this__u8e3s4, other) {
  return this.e2k(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).b2p = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.e2k(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).z2o = function (_this__u8e3s4) {
  return this.d2p(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).a2p = function (_this__u8e3s4) {
  return this.e2p(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).x2j = function (uLong) {
  var tmp;
  // Inline function 'kotlin.ULong.and' call
...
protoOf(BigInteger63Arithmetic).z2j = function (uInt) {
  // Inline function 'kotlin.UInt.toULong' call
  // Inline function 'kotlin.uintToULong' call
  // Inline function 'kotlin.uintToLong' call
...
protoOf(BigInteger63Arithmetic).b2k = function (uShort) {
...
protoOf(BigInteger63Arithmetic).d2k = function (uByte) {
...
protoOf(BigInteger63Arithmetic).n2j = function (long) {
...
protoOf(BigInteger63Arithmetic).o2j = function (int) {
  // Inline function 'kotlin.math.absoluteValue' call
...
protoOf(BigInteger63Arithmetic).p2j = function (short) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(BigInteger63Arithmetic).q2j = function (byte) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(RuntimePlatform).h2j = function () {
...
protoOf(Companion).d2f = tryFromFloat$default;
protoOf(Companion).f2f = tryFromDouble$default;
protoOf(Companion).a2f = parseString$default;
protoOf(BigDecimal).q2f = plus_1;
protoOf(BigDecimal).s2f = minus_0;
protoOf(Companion_1).a2f = parseString$default;
protoOf(Companion_1).d2f = tryFromFloat$default;
protoOf(Companion_1).f2f = tryFromDouble$default;
protoOf(BigInteger).i2f = plus_0;
protoOf(BigInteger).k2f = minus;
protoOf(BigInteger).m2f = times;
protoOf(BigInteger).r2f = times_0;
protoOf(BigInteger).o2f = div;
protoOf(BigInteger).t2f = div_0;
protoOf(BigInteger).u2f = rem;
//endregion
//region block: init
