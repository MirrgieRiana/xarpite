...
function parseString$default(string, base, $super) {
  ...
  return $super === VOID ? this.f2a(string, base) : $super.f2a.call(this, string, base);
}
function tryFromFloat$default(float, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.i2a(float, exactRequired) : $super.i2a.call(this, float, exactRequired);
}
function tryFromDouble$default(double, exactRequired, $super) {
  exactRequired = exactRequired === VOID ? false : exactRequired;
  return $super === VOID ? this.k2a(double, exactRequired) : $super.k2a.call(this, double, exactRequired);
}
initMetadataForInterface(Creator, 'Creator');
function plus_0(other) {
  return this.n2a().p2a(other);
}
function minus(other) {
  return this.n2a().r2a(other);
}
function times(other) {
  return this.n2a().t2a(other);
}
function div(other) {
  return this.n2a().v2a(other);
}
function plus_1(int) {
  return this.n2a().p2a(this.m2a().h2a(int));
}
function times_0(int) {
  return this.n2a().t2a(this.m2a().h2a(int));
}
function minus_0(int) {
  return this.n2a().r2a(this.m2a().h2a(int));
}
function div_0(int) {
  return this.n2a().v2a(this.m2a().h2a(int));
}
function rem(int) {
  return this.n2a().b2b(this.m2a().h2a(int));
}
...
function determineDecider($this, discarded) {
  var tmp = Companion_getInstance_1().l2b_1;
  // Inline function 'kotlin.Long.minus' call
  var this_0 = discarded.r2b();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  var scale = tmp.s2b(tmp$ret$0);
  var divrem = discarded.t2b(scale);
  var significant = divrem.u2b_1.w2b().x2b(true);
  var rest = divrem.v2b_1.w2b();
  var tmp_0;
  if (significant === 5) {
    var tmp_1;
    if (rest.equals(Companion_getInstance_1().i2b_1)) {
...
function roundDiscarded($this, significand, discarded, decimalMode) {
  var toDiscard = subtract(significand.r2b(), decimalMode.c2b_1);
  var tmp;
  if (compare(toDiscard, new Long(0, 0)) > 0) {
    var additionallyDiscarded = significand.t2b(Companion_getInstance_1().l2b_1.s2b(toDiscard));
    tmp = new Pair(additionallyDiscarded.u2b_1, additionallyDiscarded.v2b_1);
  } else {
    tmp = new Pair(significand, discarded);
  }
  var _destruct__k2r9zo = tmp;
  var result = _destruct__k2r9zo.qe();
  var remainder = _destruct__k2r9zo.re();
  var tmp_0;
  if (significand.equals(Companion_getInstance_1().i2b_1)) {
    tmp_0 = discarded.o2b_1;
  } else {
    tmp_0 = significand.o2b_1;
  }
  var sign = tmp_0;
  if (!decimalMode.d2b_1.equals(RoundingMode_AWAY_FROM_ZERO_getInstance()) && !decimalMode.d2b_1.equals(RoundingMode_TOWARDS_ZERO_getInstance())) {
    if (remainder.y2b()) {
      return result;
    }
  } else {
    if (remainder.y2b() && discarded.y2b()) {
      return result;
    }
  }
  var decider = determineDecider($this, remainder);
  switch (decimalMode.d2b_1.p2_1) {
    case 2:
    ...
    case 9:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.a2b(2).w2b().equals(Companion_getInstance_1().j2b_1)) {
          switch (sign.p2_1) {
            case 0:
              result = result.a2c();
              break;
    ...
    case 10:
      if (decider.equals(SignificantDecider_FIVE_getInstance())) {
        if (significand.a2b(2).equals(Companion_getInstance_1().i2b_1)) {
          switch (sign.p2_1) {
            case 0:
              result = result.a2c();
              break;
...
function roundSignificand($this, significand, exponent, decimalMode) {
  if (significand.y2b()) {
    return new BigDecimal(Companion_getInstance_1().i2b_1, exponent, decimalMode);
  }
  var significandDigits = significand.r2b();
  var tmp;
  if (decimalMode.g2b_1) {
    tmp = add(decimalMode.c2b_1, decimalMode.e2b_1);
  } else {
    tmp = decimalMode.c2b_1;
  }
  var desiredPrecision = tmp;
  var tmp_0;
  if (compare(desiredPrecision, significandDigits) > 0 && !decimalMode.g2b_1) {
    var extendedSignificand = significand.s2a(Companion_getInstance_1().l2b_1.s2b(subtract(desiredPrecision, significandDigits)));
    tmp_0 = new BigDecimal(extendedSignificand, exponent, decimalMode);
  } else if (compare(desiredPrecision, significandDigits) < 0) {
    var divRem = significand.t2b(Companion_getInstance_1().l2b_1.s2b(subtract(significandDigits, desiredPrecision)));
    var resolvedRemainder = divRem.v2b_1;
    if (divRem.v2b_1.equals(Companion_getInstance_1().i2b_1)) {
      return new BigDecimal(divRem.u2b_1, exponent, decimalMode);
    }
    var tmp_1;
    if (equalsLong(significand.r2b(), add(divRem.u2b_1.r2b(), divRem.v2b_1.r2b()))) {
      var newSignificand = roundDiscarded($this, divRem.u2b_1, resolvedRemainder, decimalMode);
      var exponentModifier = subtract(newSignificand.r2b(), divRem.u2b_1.r2b());
      tmp_1 = new BigDecimal(newSignificand, add(exponent, exponentModifier), decimalMode);
    } else {
      tmp_1 = $this.m2c(divRem.u2b_1, exponent, decimalMode);
    }
    tmp_0 = tmp_1;
  } else {
...
function applyScale($this, significand, exponent, decimalMode) {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var this_0 = add(exponent, decimalMode.e2b_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = new DecimalMode(tmp$ret$0, decimalMode.d2b_1);
  } else if (compare(exponent, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = decimalMode.e2b_1;
    var tmp$ret$1 = add(this_1, fromInt(1));
    tmp = new DecimalMode(tmp$ret$1, decimalMode.d2b_1);
  } else {
  ...
  if (compare(exponent, new Long(0, 0)) >= 0) {
    ...
    var tmp_1;
    if (decimalMode.d2b_1.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      var temp = (new BigDecimal(significand, exponent)).w2a(imul(significand.n2c(), 2));
      tmp_1 = roundSignificand($this, temp.p2c_1, temp.q2c_1, workMode).y2a(imul(significand.n2c(), 2));
    } else {
      var temp_0 = (new BigDecimal(significand, exponent)).w2a(significand.n2c());
      tmp_1 = roundSignificand($this, temp_0.p2c_1, temp_0.q2c_1, workMode).y2a(significand.n2c());
    }
    tmp_0 = tmp_1;
  }
  return tmp_0;
...
function resolveDecimalMode($this, firstDecimalMode, secondDecimalMode, suppliedDecimalMode) {
  ...
  if (!(suppliedDecimalMode == null)) {
    ...
    if (!ensureNotNull(firstDecimalMode).d2b_1.equals(ensureNotNull(secondDecimalMode).d2b_1)) {
      throw ArithmeticException_init_$Create$('Different rounding modes! This: ' + firstDecimalMode.d2b_1.toString() + ' Other: ' + secondDecimalMode.d2b_1.toString());
    }
    var tmp_0;
    if (compare(firstDecimalMode.c2b_1, secondDecimalMode.c2b_1) >= 0) {
...
function Companion() {
  ...
  this.b2c_1 = new BigDecimal(Companion_getInstance_1().i2b_1);
  this.c2c_1 = new BigDecimal(Companion_getInstance_1().j2b_1);
  this.d2c_1 = new BigDecimal(Companion_getInstance_1().k2b_1);
  this.e2c_1 = new BigDecimal(Companion_getInstance_1().l2b_1, new Long(1, 0));
  this.f2c_1 = false;
  var tmp = this;
  // Inline function 'kotlin.doubleArrayOf' call
  tmp.g2c_1 = new Float64Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10, 1.0E11, 1.0E12, 1.0E13, 1.0E14, 1.0E15, 1.0E16, 1.0E17, 1.0E18, 1.0E19, 1.0E20, 1.0E21, 1.0E22]);
  this.h2c_1 = this.w2c(1.7976931348623157E308);
  this.i2c_1 = this.w2c(4.9E-324);
  var tmp_0 = this;
  // Inline function 'kotlin.floatArrayOf' call
  tmp_0.j2c_1 = new Float32Array([1.0, 10.0, 100.0, 1000.0, 10000.0, 100000.0, 1000000.0, 1.0E7, 1.0E8, 1.0E9, 1.0E10]);
  this.k2c_1 = this.x2c(3.4028235E38);
  this.l2c_1 = this.x2c(1.4E-45);
}
protoOf(Companion).m2c = function (significand, exponent, decimalMode) {
  var tmp;
  if (significand.o2b_1.equals(Sign_POSITIVE_getInstance())) {
    var tmp_0;
    switch (decimalMode.d2b_1.p2_1) {
      case 1:
      case 2:
        var increasedSignificand = significand.a2c();
        var exponentModifier = subtract(increasedSignificand.r2b(), significand.r2b());
    ...
    tmp = tmp_0;
  } else if (significand.o2b_1.equals(Sign_NEGATIVE_getInstance())) {
    var tmp_1;
    switch (decimalMode.d2b_1.p2_1) {
      case 0:
      case 2:
        var increasedSignificand_0 = significand.z2b();
        var exponentModifier_0 = subtract(increasedSignificand_0.r2b(), significand.r2b());
...
protoOf(Companion).y2c = function (long, decimalMode) {
  var bigint = Companion_getInstance_1().z2c(long);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2b();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2d(decimalMode);
};
protoOf(Companion).b2d = function (int, decimalMode) {
  var bigint = Companion_getInstance_1().h2a(int);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2b();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2d(decimalMode);
};
protoOf(Companion).c2d = function (short, decimalMode) {
  var bigint = Companion_getInstance_1().d2d(short);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2b();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2d(decimalMode);
};
protoOf(Companion).e2d = function (byte, decimalMode) {
  var bigint = Companion_getInstance_1().f2d(byte);
  // Inline function 'kotlin.Long.minus' call
  var this_0 = bigint.r2b();
  var tmp$ret$0 = subtract(this_0, fromInt(1));
  return (new BigDecimal(bigint, tmp$ret$0, decimalMode)).a2d(decimalMode);
};
protoOf(Companion).g2d = function (float, decimalMode) {
  ...
  if (contains(floatString, _Char___init__impl__6a9atx(46)) && !contains(floatString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.h2d(tmp$ret$1, decimalMode).a2d(decimalMode);
  } else {
    tmp = this.h2d(floatString, decimalMode).a2d(decimalMode);
  }
  return tmp;
};
protoOf(Companion).x2c = function (float, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.g2d(float, decimalMode) : $super.g2d.call(this, float, decimalMode);
};
protoOf(Companion).i2d = function (double, decimalMode) {
  ...
  if (contains(doubleString, _Char___init__impl__6a9atx(46)) && !contains(doubleString, _Char___init__impl__6a9atx(69), true)) {
    ...
    tmp = this.h2d(doubleString, decimalMode).a2d(decimalMode).a2d(decimalMode);
  }
  return tmp;
};
protoOf(Companion).w2c = function (double, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.i2d(double, decimalMode) : $super.i2d.call(this, double, decimalMode);
};
protoOf(Companion).z2c = function (long) {
  return this.y2c(long, null);
};
protoOf(Companion).h2a = function (int) {
  return this.b2d(int, null);
};
protoOf(Companion).d2d = function (short) {
  return this.c2d(short, null);
};
protoOf(Companion).f2d = function (byte) {
  return this.e2d(byte, null);
};
protoOf(Companion).i2a = function (float, exactRequired) {
  return this.g2d(float, null);
};
protoOf(Companion).k2a = function (double, exactRequired) {
  return this.i2d(double, null);
};
protoOf(Companion).f2a = function (string, base) {
  return this.h2d(string, null);
};
protoOf(Companion).j2d = function (string) {
  return this.k2d(string);
};
protoOf(Companion).h2d = function (floatingPointString, decimalMode) {
  ...
  if (contains(floatingPointString, _Char___init__impl__6a9atx(69), true)) {
    ...
    if (split_0.u() === 2) {
      ...
      var significand = Companion_getInstance_1().f2a(leftTruncated + rightTruncated, 10);
      if (significand.equals(Companion_getInstance_1().i2b_1)) {
        sign = Sign_ZERO_getInstance();
      }
      if (sign.equals(Sign_NEGATIVE_getInstance())) {
        significand = significand.l2d();
      }
      var tmp_6;
      if (!(leftTruncated === '0')) {
        // Inline function 'kotlin.Long.plus' call
        ...
        // Inline function 'kotlin.Long.minus' call
        var this_2 = subtract(exponent, subtract(numberToLong(rightTruncated.length), significand.r2b()));
    ...
    if (contains(floatingPointString, _Char___init__impl__6a9atx(46))) {
      ...
      if (split_1.u() === 2) {
        ...
        var significand_0 = Companion_getInstance_1().f2a(leftTruncated_0 + rightTruncated_0, 10);
        var tmp_10;
        var tmp_11;
        ...
        if (significand_0.equals(Companion_getInstance_1().i2b_1)) {
          sign_0 = Sign_ZERO_getInstance();
        }
        if (sign_0.equals(Sign_NEGATIVE_getInstance())) {
          significand_0 = significand_0.l2d();
        }
        return new BigDecimal(significand_0, fromInt(exponent_0), decimalMode);
      } else
        throw ArithmeticException_init_$Create$('Invalid (or unsupported) floating point number format: ' + floatingPointString);
    } else {
      var significand_1 = Companion_getInstance_1().f2a(floatingPointString, 10);
      // Inline function 'kotlin.Long.minus' call
      var this_3 = significand_1.r2b();
      var tmp$ret$16 = subtract(this_3, fromInt(1));
      return new BigDecimal(significand_1, tmp$ret$16, decimalMode);
    }
  }
};
protoOf(Companion).k2d = function (floatingPointString, decimalMode, $super) {
  decimalMode = decimalMode === VOID ? null : decimalMode;
  return $super === VOID ? this.h2d(floatingPointString, decimalMode) : $super.h2d.call(this, floatingPointString, decimalMode);
};
...
function removeTrailingZeroes($this, bigDecimal) {
  if (bigDecimal.y2b())
    return $this;
  var significand = bigDecimal.p2c_1;
  var divisionResult = new QuotientAndRemainder(bigDecimal.p2c_1, Companion_getInstance_1().i2b_1);
  do {
    divisionResult = divisionResult.u2b_1.t2b(Companion_getInstance_1().l2b_1);
    if (divisionResult.v2b_1.equals(Companion_getInstance_1().i2b_1)) {
      significand = divisionResult.u2b_1;
    }
  }
   while (divisionResult.v2b_1.equals(Companion_getInstance_1().i2b_1));
  return new BigDecimal(significand, bigDecimal.q2c_1);
}
...
function computeMode($this, other, op) {
  var tmp;
  if ($this.r2c_1 == null || $this.r2c_1.f2b_1 || other.r2c_1 == null || other.r2c_1.f2b_1) {
    tmp = Companion_getInstance_0().m2d_1;
  } else {
    var tmp0 = $this.r2c_1.c2b_1;
    // Inline function 'kotlin.math.max' call
    var b = other.r2c_1.c2b_1;
    var tmp_0 = compare(tmp0, b) >= 0 ? tmp0 : b;
    var tmp_1;
    if ($this.r2c_1.g2b_1 && other.r2c_1.g2b_1) {
      var tmp_2;
      switch (op.p2_1) {
        case 0:
          var tmp0_0 = $this.r2c_1.e2b_1;
          // Inline function 'kotlin.math.max' call

          var b_0 = other.r2c_1.e2b_1;
          tmp_2 = compare(tmp0_0, b_0) >= 0 ? tmp0_0 : b_0;
          break;
        case 1:
          var tmp0_1 = $this.r2c_1.e2b_1;
          // Inline function 'kotlin.math.min' call

          var b_1 = other.r2c_1.e2b_1;
          tmp_2 = compare(tmp0_1, b_1) <= 0 ? tmp0_1 : b_1;
          break;
        case 2:
          tmp_2 = add($this.r2c_1.e2b_1, other.r2c_1.e2b_1);
          break;
        default:
          noWhenBranchMatchedException();
          break;
    ...
    tmp = new DecimalMode(tmp_0, $this.r2c_1.d2b_1, tmp_1);
  }
  return tmp;
}
function checkWholeness($this, exactRequired) {
  if (exactRequired && !$this.o2d())
...
function getRidOfRadix($this, bigDecimal) {
  var precision = bigDecimal.p2c_1.r2b();
  // Inline function 'kotlin.Long.plus' call
  var this_0 = subtract(bigDecimal.q2c_1, precision);
  var newExponent = add(this_0, fromInt(1));
  return new BigDecimal(bigDecimal.p2c_1, newExponent);
}
function bringSignificandToSameExponent($this, first, second) {
  ...
  var firstPreparedExponent = firstPrepared.q2c_1;
  var secondPreparedExponent = secondPrepared.q2c_1;
  var tmp;
  if (compare(first.q2c_1, second.q2c_1) > 0) {
    var moveFirstBy = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_0;
    if (compare(moveFirstBy, new Long(0, 0)) >= 0) {
      var movedFirst = firstPrepared.p2c_1.s2a(toBigInteger(10).s2b(moveFirstBy));
      return new Triple(movedFirst, second.p2c_1, secondPreparedExponent);
    } else {
      var tmp_1 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$0 = multiply(moveFirstBy, fromInt(-1));
      var movedSecond = secondPrepared.p2c_1.s2a(tmp_1.s2b(tmp$ret$0));
      tmp_0 = new Triple(first.p2c_1, movedSecond, firstPreparedExponent);
    }
    tmp = tmp_0;
  } else if (compare(first.q2c_1, second.q2c_1) < 0) {
    var moveSecondBy = subtract(secondPreparedExponent, firstPreparedExponent);
    var tmp_2;
    if (compare(moveSecondBy, new Long(0, 0)) >= 0) {
      var movedSecond_0 = secondPrepared.p2c_1.s2a(toBigInteger(10).s2b(moveSecondBy));
      tmp_2 = new Triple(first.p2c_1, movedSecond_0, firstPreparedExponent);
    } else {
      var tmp_3 = toBigInteger(10);
      // Inline function 'kotlin.Long.times' call
      var tmp$ret$1 = multiply(moveSecondBy, fromInt(-1));
      var movedFirst_0 = firstPrepared.p2c_1.s2a(tmp_3.s2b(tmp$ret$1));
      tmp_2 = new Triple(movedFirst_0, second.p2c_1, firstPreparedExponent);
    }
    return tmp_2;
  } else if (equalsLong(first.q2c_1, second.q2c_1)) {
    var delta = subtract(firstPreparedExponent, secondPreparedExponent);
    var tmp_4;
    if (compare(delta, new Long(0, 0)) > 0) {
      var movedFirst_1 = first.p2c_1.s2a(toBigInteger(10).s2b(delta));
      tmp_4 = new Triple(movedFirst_1, second.p2c_1, firstPreparedExponent);
    } else {
      if (compare(delta, new Long(0, 0)) < 0) {
        var tmp_5 = toBigInteger(10);
        // Inline function 'kotlin.Long.times' call
        var tmp$ret$2 = multiply(delta, fromInt(-1));
        var movedSecond_1 = second.p2c_1.s2a(tmp_5.s2b(tmp$ret$2));
        tmp_4 = new Triple(first.p2c_1, movedSecond_1, firstPreparedExponent);
      } else {
        // Inline function 'kotlin.Long.compareTo' call
        if (delta.x2(fromInt(0)) === 0) {
          tmp_4 = new Triple(first.p2c_1, second.p2c_1, firstPreparedExponent);
        } else {
    ...
    throw RuntimeException_init_$Create$('Invalid comparison state BigInteger: ' + first.q2c_1.toString() + ', ' + second.q2c_1.toString());
  }
  return tmp;
}
function javascriptNumberComparison($this, number) {
  ...
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.p2d(Companion_getInstance().j2d(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.p2d(Companion_getInstance().z2c(numberToLong(number)));
  } else {
    tmp = $this.p2d(toBigDecimal(numberToDouble(number)));
  }
  return tmp;
}
...
function BigDecimal(_significand, _exponent, _decimalMode) {
  ...
  if (!(_decimalMode == null) && _decimalMode.g2b_1) {
    var wrk = applyScale(Companion_getInstance(), _significand, _exponent, _decimalMode);
    if (!wrk.y2b()) {
      this.p2c_1 = wrk.p2c_1;
      this.q2c_1 = wrk.q2c_1;
      var newPrecision = this.p2c_1.r2b();
      this.o2c_1 = newPrecision;
      this.r2c_1 = _decimalMode.q2d(newPrecision);
    } else {
      this.p2c_1 = wrk.p2c_1;
      this.q2c_1 = multiply(wrk.q2c_1, add(_decimalMode.c2b_1, _decimalMode.e2b_1));
      this.o2c_1 = add(_decimalMode.c2b_1, _decimalMode.e2b_1);
      this.r2c_1 = _decimalMode.q2d(this.o2c_1);
    }
  } else {
    this.p2c_1 = _significand;
    this.o2c_1 = _significand.r2b();
    this.q2c_1 = _exponent;
    this.r2c_1 = _decimalMode;
  }
  var tmp = this;
  var tmp0_safe_receiver = this.r2c_1;
  var tmp0_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.c2b_1;
  tmp.s2c_1 = tmp0_elvis_lhs == null ? new Long(0, 0) : tmp0_elvis_lhs;
  var tmp_0 = this;
  var tmp1_safe_receiver = this.r2c_1;
  var tmp0_elvis_lhs_0 = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.d2b_1;
  tmp_0.t2c_1 = tmp0_elvis_lhs_0 == null ? RoundingMode_NONE_getInstance() : tmp0_elvis_lhs_0;
  var tmp_1 = this;
  var tmp13_safe_receiver = this.r2c_1;
  var tmp0_elvis_lhs_1 = tmp13_safe_receiver == null ? null : tmp13_safe_receiver.e2b_1;
  tmp_1.u2c_1 = tmp0_elvis_lhs_1 == null ? new Long(-1, -1) : tmp0_elvis_lhs_1;
  this.v2c_1 = compare(this.u2c_1, new Long(0, 0)) >= 0;
}
protoOf(BigDecimal).m2a = function () {
  return Companion_getInstance();
};
protoOf(BigDecimal).n2a = function () {
  return this;
};
protoOf(BigDecimal).r2d = function (other) {
  return this.s2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).p2a = function (other) {
  return this.r2d(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).s2d = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2c_1, other.r2c_1, decimalMode);
  if (this.y2b()) {
    return roundOrDont(Companion_getInstance(), other.p2c_1, other.q2c_1, resolvedDecimalMode);
  }
  if (other.y2b()) {
    return roundOrDont(Companion_getInstance(), this.p2c_1, this.q2c_1, resolvedDecimalMode);
  }
  var _destruct__k2r9zo = bringSignificandToSameExponent(this, this, other);
  var first = _destruct__k2r9zo.qe();
  var second = _destruct__k2r9zo.re();
  var firstNumOfDigits = first.r2b();
  var secondNumOfDigits = second.r2b();
  var newSignificand = first.o2a(second);
  var newSignificandNumOfDigit = newSignificand.r2b();
  var tmp;
  ...
  var tmp_0;
  if (resolvedDecimalMode.g2b_1) {
    tmp_0 = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2d(newSignificandNumOfDigit));
  } else {
    tmp_0 = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
  return tmp_0;
};
protoOf(BigDecimal).t2d = function (other) {
  return this.u2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).r2a = function (other) {
  return this.t2d(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).u2d = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2c_1, other.r2c_1, decimalMode);
  if (this.y2b()) {
    return roundOrDont(Companion_getInstance(), other.p2c_1.l2d(), other.q2c_1, resolvedDecimalMode);
  }
  if (other.y2b()) {
    return roundOrDont(Companion_getInstance(), this.p2c_1, this.q2c_1, resolvedDecimalMode);
  }
  ...
  var firstNumOfDigits = first.r2b();
  var secondNumOfDigits = second.r2b();
  var newSignificand = first.q2a(second);
  var newSignificandNumOfDigit = newSignificand.r2b();
  var tmp;
  if (compare(firstNumOfDigits, secondNumOfDigits) > 0) {
    tmp = firstNumOfDigits;
  ...
  if (this.v2c_1) {
    return roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2d(newSignificandNumOfDigit));
  } else {
    return roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
};
protoOf(BigDecimal).v2d = function (other) {
  return this.w2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).t2a = function (other) {
  return this.v2d(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).w2d = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2c_1, other.r2c_1, decimalMode);
  var firstNumOfDigits = this.p2c_1.r2b();
  var secondNumOfDigits = other.p2c_1.r2b();
  var newSignificand = this.p2c_1.s2a(other.p2c_1);
  var newSignificandNumOfDigit = newSignificand.r2b();
  var moveExponent = subtract(newSignificandNumOfDigit, add(firstNumOfDigits, secondNumOfDigits));
  // Inline function 'kotlin.Long.plus' call
  var this_0 = add(add(this.q2c_1, other.q2c_1), moveExponent);
  var newExponent = add(this_0, fromInt(1));
  var tmp;
  if (resolvedDecimalMode.g2b_1) {
    tmp = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode.q2d(newSignificandNumOfDigit));
  } else {
    tmp = roundOrDont(Companion_getInstance(), newSignificand, newExponent, resolvedDecimalMode);
  }
  return tmp;
};
protoOf(BigDecimal).x2d = function (other) {
  return this.y2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).v2a = function (other) {
  return this.x2d(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).y2d = function (other, decimalMode) {
  var resolvedDecimalMode = resolveDecimalMode(Companion_getInstance(), this.r2c_1, other.r2c_1, decimalMode);
  if (resolvedDecimalMode.f2b_1 && !resolvedDecimalMode.g2b_1) {
    var newExponent = subtract(this.q2c_1, other.q2c_1);
    // Inline function 'kotlin.Long.times' call
    var this_0 = other.o2c_1;
    // Inline function 'kotlin.Long.plus' call
    var this_1 = multiply(this_0, fromInt(2));
    var power = add(this_1, fromInt(6));
    var thisPrepared = this.p2c_1.s2a(Companion_getInstance_1().l2b_1.s2b(power));
    var divRem = thisPrepared.t2b(other.p2c_1);
    var result = divRem.u2b_1;
    // Inline function 'kotlin.Long.minus' call
    var this_2 = other.o2c_1;
    var expectedDiff = subtract(this_2, fromInt(1));
    var exponentModifier = add(expectedDiff, subtract(result.r2b(), thisPrepared.r2b()));
    if (!divRem.v2b_1.equals(Companion_getInstance_1().i2b_1)) {
    ...
    // Inline function 'kotlin.Long.minus' call
    var this_3 = subtract(this.q2c_1, other.q2c_1);
    var newExponent_0 = subtract(this_3, fromInt(1));
    var desiredPrecision = resolvedDecimalMode.c2b_1;
    var power_0 = add(subtract(desiredPrecision, this.o2c_1), other.o2c_1);
    var tmp;
    if (compare(power_0, new Long(0, 0)) > 0) {
      tmp = this.p2c_1.s2a(toBigInteger(10).s2b(power_0));
    } else if (compare(power_0, new Long(0, 0)) < 0) {
      var tmp_0 = toBigInteger(10);
      // Inline function 'kotlin.math.absoluteValue' call
      var tmp$ret$4 = abs(power_0);
      tmp = this.p2c_1.u2a(tmp_0.s2b(tmp$ret$4));
    } else {
      tmp = this.p2c_1;
    }
    var thisPrepared_0 = tmp;
    var divRem_0 = thisPrepared_0.t2b(other.p2c_1);
    var result_0 = divRem_0.u2b_1;
    if (result_0.equals(Companion_getInstance_1().i2b_1)) {
      var _unary__edvuaz = newExponent_0;
      newExponent_0 = subtract(_unary__edvuaz, get_ONE());
    }
    var exponentModifier_0 = subtract(result_0.r2b(), resolvedDecimalMode.c2b_1);
    var tmp_1;
    if (this.v2c_1) {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.v2b_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode.q2d(result_0.r2b()));
    } else {
      tmp_1 = new BigDecimal(roundDiscarded(Companion_getInstance(), result_0, divRem_0.v2b_1, resolvedDecimalMode), add(newExponent_0, exponentModifier_0), resolvedDecimalMode);
    }
    return tmp_1;
  }
};
protoOf(BigDecimal).z2d = function (other) {
  return this.a2e(other).pe_1;
};
protoOf(BigDecimal).b2b = function (other) {
  return this.z2d(other instanceof BigDecimal ? other : THROW_CCE());
};
protoOf(BigDecimal).a2e = function (other) {
  if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    return new Pair(Companion_getInstance().b2c_1, this);
  }
  if (other.w2b().b2e(this.w2b()) > 0) {
    return new Pair(Companion_getInstance().b2c_1, this);
  }
  var tmp16_safe_receiver = this.r2c_1;
  var tmp;
  if (tmp16_safe_receiver == null) {
    tmp = null;
  } else {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.q2c_1, other.q2c_1);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = tmp16_safe_receiver.q2d(tmp$ret$0);
  }
  var tmp0_elvis_lhs = tmp;
  var tmp_0;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.Long.plus' call
    var this_1 = subtract(this.q2c_1, other.q2c_1);
    var tmp$ret$1 = add(this_1, fromInt(1));
  ...
  var quotient = this.y2d(other, resolvedRoundingMode);
  var quotientInfinitePrecision = quotient.c2e(VOID, VOID, Companion_getInstance_0().m2d_1);
  var remainder = this.e2e(quotientInfinitePrecision.d2e(other));
  return new Pair(quotient, remainder);
};
protoOf(BigDecimal).y2b = function () {
  return this.p2c_1.y2b();
};
protoOf(BigDecimal).f2e = function (significand, exponent, decimalMode) {
  return new BigDecimal(significand, exponent, decimalMode);
};
protoOf(BigDecimal).c2e = function (significand, exponent, decimalMode, $super) {
  significand = significand === VOID ? this.p2c_1 : significand;
  exponent = exponent === VOID ? this.q2c_1 : exponent;
  decimalMode = decimalMode === VOID ? this.r2c_1 : decimalMode;
  return $super === VOID ? this.f2e(significand, exponent, decimalMode) : $super.f2e.call(this, significand, exponent, decimalMode);
};
protoOf(BigDecimal).g2e = function (places) {
  if (equalsLong(places, new Long(0, 0))) {
    return this;
  }
  return this.c2e(VOID, add(this.q2c_1, places));
};
protoOf(BigDecimal).h2e = function () {
  if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    var tmp;
    switch (this.p2c_1.o2b_1.p2_1) {
      case 0:
        tmp = Companion_getInstance().b2c_1;
        break;
      case 1:
        tmp = Companion_getInstance().c2c_1.l2d();
        break;
      case 2:
        tmp = Companion_getInstance().b2c_1;
        break;
  ...
  var tmp$ret$0 = add(this_0, fromInt(1));
  return this.a2d(new DecimalMode(tmp$ret$0, RoundingMode_FLOOR_getInstance()));
};
protoOf(BigDecimal).i2e = function () {
  if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    return Companion_getInstance_1().i2b_1;
  }
  var precisionExponentDiff = subtract(this.q2c_1, this.o2c_1);
  var tmp;
  if (compare(precisionExponentDiff, new Long(0, 0)) > 0) {
    var tmp_0 = toBigInteger(10);
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$0 = add(precisionExponentDiff, fromInt(1));
    tmp = this.p2c_1.s2a(tmp_0.s2b(tmp$ret$0));
    ...
    tmp = this.p2c_1.u2a(tmp_1.s2b(tmp$ret$2));
  } else {
    tmp = this.p2c_1.x2a(10);
  }
  return tmp;
};
protoOf(BigDecimal).j2e = function (other) {
  return this.a2e(other);
};
protoOf(BigDecimal).e2e = function (other) {
  return this.u2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).d2e = function (other) {
  return this.w2d(other, computeMode(this, other, ScaleOps_Max_getInstance()));
};
protoOf(BigDecimal).w2b = function () {
  return new BigDecimal(this.p2c_1.w2b(), this.q2c_1, this.r2c_1);
};
protoOf(BigDecimal).l2d = function () {
  return new BigDecimal(this.p2c_1.l2d(), this.q2c_1, this.r2c_1);
};
protoOf(BigDecimal).n2c = function () {
  return this.p2c_1.n2c();
};
protoOf(BigDecimal).x2b = function (exactRequired) {
  checkWholeness(this, exactRequired);
  return this.i2e().x2b(exactRequired);
};
protoOf(BigDecimal).o2d = function () {
  var res = this.w2b().j2e(Companion_getInstance().c2c_1);
  var isWholeNumber = res.pe_1.y2b();
  return isWholeNumber;
};
protoOf(BigDecimal).a2d = function (decimalMode) {
  if (decimalMode == null) {
    return this;
  }
  return roundSignificand(Companion_getInstance(), this.p2c_1, this.q2c_1, decimalMode);
};
protoOf(BigDecimal).k2e = function (digitPosition, roundingMode) {
  if (equalsLong(digitPosition, new Long(0, 0))) {
    throw ArithmeticException_init_$Create$('Rounding to 0 position is not supported');
  }
  var tmp;
  if (compare(this.q2c_1, new Long(0, 0)) >= 0) {
    tmp = this.a2d(new DecimalMode(digitPosition, roundingMode));
  } else {
    var tmp_0;
    if (roundingMode.equals(RoundingMode_ROUND_HALF_TO_EVEN_getInstance())) {
      tmp_0 = this.w2a(imul(this.n2c(), 2)).a2d(new DecimalMode(digitPosition, roundingMode)).y2a(imul(this.n2c(), 2));
    } else {
      tmp_0 = this.w2a(this.n2c()).a2d(new DecimalMode(digitPosition, roundingMode)).y2a(this.n2c());
    }
    tmp = tmp_0;
  }
  var rounded = tmp;
  var tmp_1;
  if (this.r2c_1 == null) {
    tmp_1 = new BigDecimal(rounded.p2c_1, rounded.q2c_1);
  } else {
    tmp_1 = new BigDecimal(rounded.p2c_1, rounded.q2c_1, this.r2c_1);
  }
  return tmp_1;
};
protoOf(BigDecimal).l2e = function (digitPosition, roundingMode) {
  ...
  if (compare(this.q2c_1, new Long(0, 0)) >= 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = add(this.q2c_1, digitPosition);
    var tmp$ret$0 = add(this_0, fromInt(1));
    tmp = this.k2e(tmp$ret$0, roundingMode);
  } else if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.Long.plus' call
    var tmp$ret$1 = add(digitPosition, fromInt(1));
    tmp = this.k2e(tmp$ret$1, roundingMode);
  } else {
    throw RuntimeException_init_$Create$('Unexpected state');
  }
  var rounded = tmp;
  var tmp_0;
  if (this.r2c_1 == null) {
    tmp_0 = new BigDecimal(rounded.p2c_1, rounded.q2c_1);
  } else {
    tmp_0 = new BigDecimal(rounded.p2c_1, rounded.q2c_1, this.r2c_1);
  }
  return tmp_0;
};
protoOf(BigDecimal).p2d = function (other) {
  var tmp;
  if (equalsLong(this.q2c_1, other.q2c_1) && equalsLong(this.o2c_1, other.o2c_1)) {
    tmp = this.p2c_1.m2e(other.p2c_1);
  } else {
    var _destruct__k2r9zo = bringSignificandToSameExponent(this, this, other);
    var preparedFirst = _destruct__k2r9zo.qe();
    var preparedSecond = _destruct__k2r9zo.re();
    tmp = preparedFirst.m2e(preparedSecond);
  }
  return tmp;
};
protoOf(BigDecimal).b2e = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.n2e().equals(Platform_JS_getInstance()) || RuntimePlatform_instance.n2e().equals(Platform_WASMJS_getInstance())) {
  ...
  if (other instanceof BigDecimal) {
    ...
    if (other instanceof Long) {
      tmp = this.p2d(Companion_getInstance().z2c(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.p2d(Companion_getInstance().h2a(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.p2d(Companion_getInstance().d2d(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.p2d(Companion_getInstance().f2d(other));
          } else {
            if (typeof other === 'number') {
              tmp = this.p2d(Companion_getInstance().w2c(other));
            } else {
              if (typeof other === 'number') {
                tmp = this.p2d(Companion_getInstance().x2c(other));
              } else {
                throw RuntimeException_init_$Create$('Invalid comparison type for BigDecimal: ' + getKClassFromExpression(other).w9());
              }
            }
          }
        }
...
protoOf(BigDecimal).d = function (other) {
  return this.b2e(!(other == null) ? other : THROW_CCE());
};
...
protoOf(BigDecimal).hashCode = function () {
  ...
  return removeTrailingZeroes(this, this).p2c_1.hashCode() + this.q2c_1.hashCode() | 0;
};
protoOf(BigDecimal).toString = function () {
  if (Companion_getInstance().f2c_1) {
    return this.o2e();
  }
  var significandString = this.p2c_1.p2e(10);
  var tmp;
  if (this.p2c_1.b2e(0) < 0) {
    tmp = 2;
  } else {
    tmp = 1;
  }
  ...
  var tmp_1;
  if (compare(this.q2c_1, new Long(0, 0)) > 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E+' + this.q2c_1.toString();
  } else if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    tmp_1 = placeADotInString(this, significandString, significandString.length - modifier | 0) + expand + 'E' + this.q2c_1.toString();
  } else if (equalsLong(this.q2c_1, new Long(0, 0))) {
...
protoOf(BigDecimal).o2e = function () {
  if (this.y2b()) {
    return '0';
  }
  var digits = this.p2c_1.r2b();
  if (compare(this.q2c_1, new Long(2147483647, 0)) > 0) {
    throw RuntimeException_init_$Create$('Invalid toStringExpanded request (exponent > Int.MAX_VALUE)');
  }
  var significandString = this.p2c_1.q2e(10);
  var tmp;
  if (this.p2c_1.o2b_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = '-';
  } else {
    tmp = '';
  }
  ...
  if (compare(this.q2c_1, new Long(0, 0)) > 0) {
    // Inline function 'kotlin.Long.plus' call
    var this_0 = subtract(this.q2c_1, digits);
    var diffBigInt = add(this_0, fromInt(1));
    var tmp_1;
    if (compare(diffBigInt, new Long(0, 0)) > 0) {
      var expandZeros = this.r2e(diffBigInt, _Char___init__impl__6a9atx(48));
      tmp_1 = significandString + expandZeros;
    } else {
      tmp_1 = placeADotInStringExpanded(this, significandString, (significandString.length - convertToInt(this.q2c_1) | 0) - 1 | 0);
    }
    tmp_0 = tmp_1;
  } else if (compare(this.q2c_1, new Long(0, 0)) < 0) {
    // Inline function 'kotlin.math.absoluteValue' call
    var this_1 = convertToInt(this.q2c_1);
    var diffInt = abs_0(this_1);
    var tmp_2;
    if (diffInt > 0) {
      // Inline function 'kotlin.math.absoluteValue' call
      var this_2 = this.q2c_1;
      var tmp$ret$2 = abs(this_2);
      var expandZeros_0 = this.r2e(tmp$ret$2, _Char___init__impl__6a9atx(48));
...
protoOf(BigDecimal).r2e = function (_this__u8e3s4, char) {
...
function toBigDecimal(_this__u8e3s4, exponentModifier, decimalMode) {
  ...
  decimalMode = decimalMode === VOID ? null : decimalMode;
  var tmp = Companion_getInstance().i2d(_this__u8e3s4, decimalMode);
  return tmp.g2e(exponentModifier == null ? new Long(0, 0) : exponentModifier);
}
function toBigDecimal_0(_this__u8e3s4, exponentModifier, decimalMode) {
  exponentModifier = exponentModifier === VOID ? null : exponentModifier;
  decimalMode = decimalMode === VOID ? null : decimalMode;
  var tmp = Companion_getInstance().h2d(_this__u8e3s4, decimalMode);
  return tmp.g2e(exponentModifier == null ? new Long(0, 0) : exponentModifier);
}
function Companion_0() {
  Companion_instance_0 = this;
  this.m2d_1 = new DecimalMode();
  this.n2d_1 = new DecimalMode(new Long(30, 0), RoundingMode_ROUND_HALF_AWAY_FROM_ZERO_getInstance(), new Long(2, 0));
}
...
function DecimalMode(decimalPrecision, roundingMode, scale) {
  ...
  this.c2b_1 = decimalPrecision;
  this.d2b_1 = roundingMode;
  this.e2b_1 = scale;
  if (compare(this.c2b_1, new Long(0, 0)) < 0) {
    throw ArithmeticException_init_$Create$('Negative decimal precision is not allowed.');
  }
  this.f2b_1 = equalsLong(this.c2b_1, new Long(0, 0));
  this.g2b_1 = compare(this.e2b_1, new Long(0, 0)) >= 0;
  if (!this.g2b_1 && equalsLong(this.c2b_1, new Long(0, 0)) && !this.d2b_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Rounding mode with 0 digits precision.');
  }
  if (compare(this.e2b_1, new Long(-1, -1)) < 0) {
    throw ArithmeticException_init_$Create$('Negative Scale is unsupported.');
  }
  if (this.g2b_1 && this.d2b_1.equals(RoundingMode_NONE_getInstance())) {
    throw ArithmeticException_init_$Create$('Scale of ' + this.e2b_1.toString() + ' digits to the right of the decimal requires a RoundingMode that is not NONE.');
  }
}
protoOf(DecimalMode).s2e = function (decimalPrecision, roundingMode, scale) {
  return new DecimalMode(decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).q2d = function (decimalPrecision, roundingMode, scale, $super) {
  decimalPrecision = decimalPrecision === VOID ? this.c2b_1 : decimalPrecision;
  roundingMode = roundingMode === VOID ? this.d2b_1 : roundingMode;
  scale = scale === VOID ? this.e2b_1 : scale;
  return $super === VOID ? this.s2e(decimalPrecision, roundingMode, scale) : $super.s2e.call(this, decimalPrecision, roundingMode, scale);
};
protoOf(DecimalMode).toString = function () {
  return 'DecimalMode(decimalPrecision=' + this.c2b_1.toString() + ', roundingMode=' + this.d2b_1.toString() + ', scale=' + this.e2b_1.toString() + ')';
};
protoOf(DecimalMode).hashCode = function () {
  var result = this.c2b_1.hashCode();
...
protoOf(DecimalMode).equals = function (other) {
  ...
  if (!equalsLong(this.c2b_1, tmp0_other_with_cast.c2b_1))
    return false;
  if (!this.d2b_1.equals(tmp0_other_with_cast.d2b_1))
    return false;
  if (!equalsLong(this.e2b_1, tmp0_other_with_cast.e2b_1))
    return false;
  return true;
};
...
function BigInteger_init_$Init$(long, $this) {
  var tmp = Companion_getInstance_1().h2b_1.t2e(long);
...
function BigInteger_init_$Init$_0(int, $this) {
  var tmp = Companion_getInstance_1().h2b_1.u2e(int);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function BigInteger_init_$Init$_1(short, $this) {
  var tmp = Companion_getInstance_1().h2b_1.v2e(short);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function BigInteger_init_$Init$_2(byte, $this) {
  var tmp = Companion_getInstance_1().h2b_1.w2e(byte);
  // Inline function 'com.ionspin.kotlin.bignum.integer.Companion.determinSignFromNumber' call
  Companion_getInstance_1();
...
function Companion_1() {
  ...
  this.h2b_1 = get_chosenArithmetic();
  this.i2b_1 = new BigInteger(this.h2b_1.x2e(), Sign_ZERO_getInstance());
  this.j2b_1 = new BigInteger(this.h2b_1.y2e(), Sign_POSITIVE_getInstance());
  this.k2b_1 = new BigInteger(this.h2b_1.z2e(), Sign_POSITIVE_getInstance());
  this.l2b_1 = new BigInteger(this.h2b_1.a2f(), Sign_POSITIVE_getInstance());
  var tmp = this;
  // Inline function 'kotlin.math.log10' call
  tmp.m2b_1 = log10(2.0);
}
protoOf(Companion_1).f2a = function (string, base) {
  if (base < 2 || base > 36) {
  ...
  if (decimal) {
    var bigDecimal = Companion_getInstance().j2d(string);
    var isActuallyDecimal = bigDecimal.e2e(bigDecimal.h2e()).b2e(0) > 0;
  ...
  if (signed) {
    ...
    tmp = new BigInteger(this.h2b_1.b2f(substring(string, 1, string.length), base), isNegative);
  } else {
    if (string.length === 1 && charCodeAt(string, 0) === _Char___init__impl__6a9atx(48)) {
      return this.i2b_1;
    }
    tmp = new BigInteger(this.h2b_1.b2f(string, base), Sign_POSITIVE_getInstance());
  }
  return tmp;
};
protoOf(Companion_1).c2f = function (uLong) {
  return new BigInteger(this.h2b_1.d2f(uLong), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).e2f = function (uInt) {
  return new BigInteger(this.h2b_1.f2f(uInt), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).g2f = function (uShort) {
  return new BigInteger(this.h2b_1.h2f(uShort), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).i2f = function (uByte) {
  return new BigInteger(this.h2b_1.j2f(uByte), Sign_POSITIVE_getInstance());
};
protoOf(Companion_1).z2c = function (long) {
  return BigInteger_init_$Create$(long);
};
protoOf(Companion_1).h2a = function (int) {
  return BigInteger_init_$Create$_0(int);
};
protoOf(Companion_1).d2d = function (short) {
  return BigInteger_init_$Create$_1(short);
};
protoOf(Companion_1).f2d = function (byte) {
  return BigInteger_init_$Create$_2(byte);
};
protoOf(Companion_1).i2a = function (float, exactRequired) {
  // Inline function 'kotlin.math.floor' call
  var floatDecimalPart = float - Math.floor(float);
  var tmp = Companion_getInstance();
  // Inline function 'kotlin.math.floor' call
  var tmp$ret$1 = Math.floor(float);
  var bigDecimal = tmp.g2d(tmp$ret$1, null);
  if (exactRequired) {
...
protoOf(Companion_1).k2a = function (double, exactRequired) {
  // Inline function 'kotlin.math.floor' call
  var doubleDecimalPart = double - Math.floor(double);
  var tmp = Companion_getInstance();
  // Inline function 'kotlin.math.floor' call
  var tmp$ret$1 = Math.floor(double);
  var bigDecimal = tmp.i2d(tmp$ret$1, null);
  if (exactRequired) {
...
function isResultZero($this, resultMagnitude) {
  return Companion_getInstance_1().h2b_1.k2f(resultMagnitude, Companion_getInstance_1().h2b_1.x2e()) === 0;
}
function javascriptNumberComparison_0($this, number) {
  var double = numberToDouble(number);
  var tmp;
  if (double > toNumber(new Long(-1, 2147483647))) {
    tmp = $this.m2e(Companion_getInstance_1().g2a(double.toString()));
  } else if (double % 1 === 0.0) {
    tmp = $this.m2e(Companion_getInstance_1().z2c(numberToLong(number)));
  } else {
    var tmp_0 = numberToDouble(number);
    tmp = $this.l2f(tmp_0, BigInteger$javascriptNumberComparison$lambda($this));
  }
  return tmp;
}
function QuotientAndRemainder(quotient, remainder) {
  this.u2b_1 = quotient;
  this.v2b_1 = remainder;
}
protoOf(QuotientAndRemainder).toString = function () {
  return 'QuotientAndRemainder(quotient=' + this.u2b_1.toString() + ', remainder=' + this.v2b_1.toString() + ')';
};
...
function BigInteger(wordArray, requestedSign) {
  ...
  this.n2b_1 = BigInteger63Arithmetic_getInstance().e2g(wordArray);
  var tmp = this;
  var tmp_0;
  if (isResultZero(this, this.n2b_1)) {
    tmp_0 = Sign_ZERO_getInstance();
  } else {
    tmp_0 = requestedSign;
  }
  tmp.o2b_1 = tmp_0;
  this.p2b_1 = _ULongArray___get_size__impl__ju6dtr(this.n2b_1);
  this.q2b_1 = null;
}
protoOf(BigInteger).m2a = function () {
  return Companion_getInstance_1();
};
protoOf(BigInteger).n2a = function () {
  return this;
};
protoOf(BigInteger).f2g = function (other) {
  var comparison = Companion_getInstance_1().h2b_1.k2f(this.n2b_1, other.n2b_1);
  var tmp;
  if (other.o2b_1.equals(this.o2b_1)) {
    return new BigInteger(Companion_getInstance_1().h2b_1.h2g(this.n2b_1, other.n2b_1), this.o2b_1);
  } else {
    var tmp_0;
    if (comparison > 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().h2b_1.g2g(this.n2b_1, other.n2b_1), this.o2b_1);
    } else if (comparison < 0) {
      tmp_0 = new BigInteger(Companion_getInstance_1().h2b_1.g2g(other.n2b_1, this.n2b_1), other.o2b_1);
    } else {
      tmp_0 = Companion_getInstance_1().i2b_1;
    }
    tmp = tmp_0;
  }
  return tmp;
};
protoOf(BigInteger).p2a = function (other) {
  return this.f2g(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).i2g = function (other) {
  if (this.y2b()) {
    return other.l2d();
  }
  if (other.y2b()) {
  ...
  if (other.o2b_1.equals(this.o2b_1)) {
    ...
    if (comparison > 0) {
      ...
      tmp_0 = new BigInteger(Companion_getInstance_1().h2b_1.g2g(other.n2b_1, this.n2b_1), this.o2b_1.l2g());
    } else {
      tmp_0 = Companion_getInstance_1().i2b_1;
    }
    tmp = tmp_0;
...
protoOf(BigInteger).r2a = function (other) {
  return this.i2g(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).m2g = function (other) {
  if (this.y2b() || other.y2b()) {
    return Companion_getInstance_1().i2b_1;
  }
  if (other.equals(Companion_getInstance_1().j2b_1)) {
    return this;
  }
  var tmp;
  if (!this.o2b_1.equals(other.o2b_1)) {
  ...
  var tmp_0;
  if (sign.equals(Sign_POSITIVE_getInstance())) {
    tmp_0 = new BigInteger(Companion_getInstance_1().h2b_1.n2g(this.n2b_1, other.n2b_1), sign);
  } else {
    tmp_0 = new BigInteger(Companion_getInstance_1().h2b_1.n2g(this.n2b_1, other.n2b_1), sign);
  }
  return tmp_0;
};
protoOf(BigInteger).t2a = function (other) {
  return this.m2g(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).o2g = function (other) {
  if (other.y2b()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var result = Companion_getInstance_1().h2b_1.p2g(this.n2b_1, other.n2b_1).oe_1.jl_1;
  var tmp;
  if (equals(result, Companion_getInstance_1().h2b_1.x2e())) {
    tmp = Companion_getInstance_1().i2b_1;
  } else {
    var tmp_0;
    if (!this.o2b_1.equals(other.o2b_1)) {
      tmp_0 = Sign_NEGATIVE_getInstance();
...
protoOf(BigInteger).v2a = function (other) {
  return this.o2g(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).q2g = function (other) {
  if (other.y2b()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var tmp;
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().h2b_1.p2g(this.n2b_1, other.n2b_1).pe_1.jl_1;
  if (equals(result, Companion_getInstance_1().h2b_1.x2e())) {
    sign = Sign_ZERO_getInstance();
  }
  return new BigInteger(result, sign);
};
protoOf(BigInteger).b2b = function (other) {
  return this.q2g(other instanceof BigInteger ? other : THROW_CCE());
};
protoOf(BigInteger).r2g = function (other) {
  if (other.y2b()) {
    throw ArithmeticException_init_$Create$('Division by zero! ' + this.toString() + ' / ' + other.toString());
  }
  var tmp;
  ...
  var sign = tmp;
  var result = Companion_getInstance_1().h2b_1.p2g(this.n2b_1, other.n2b_1);
  var tmp_0;
  if (equals(result.oe_1, new ULongArray(Companion_getInstance_1().h2b_1.x2e()))) {
    tmp_0 = Companion_getInstance_1().i2b_1;
  } else {
    tmp_0 = new BigInteger(result.oe_1.jl_1, sign);
  }
  var quotient = tmp_0;
  var tmp_1;
  if (equals(result.pe_1, new ULongArray(Companion_getInstance_1().h2b_1.x2e()))) {
    tmp_1 = Companion_getInstance_1().i2b_1;
  } else {
    tmp_1 = new BigInteger(result.pe_1.jl_1, this.o2b_1);
  }
  var remainder = tmp_1;
  return new Pair(quotient, remainder);
};
protoOf(BigInteger).m2e = function (other) {
  if (this.y2b() && other.y2b())
    return 0;
  if (other.y2b() && this.o2b_1.equals(Sign_POSITIVE_getInstance()))
    return 1;
  if (other.y2b() && this.o2b_1.equals(Sign_NEGATIVE_getInstance()))
    return -1;
  if (this.y2b() && other.o2b_1.equals(Sign_POSITIVE_getInstance()))
    return -1;
  if (this.y2b() && other.o2b_1.equals(Sign_NEGATIVE_getInstance()))
    return 1;
  if (!this.o2b_1.equals(other.o2b_1))
    return this.o2b_1.equals(Sign_POSITIVE_getInstance()) ? 1 : -1;
  var result = Companion_getInstance_1().h2b_1.k2f(this.n2b_1, other.n2b_1);
  var tmp;
  if (this.o2b_1.equals(Sign_NEGATIVE_getInstance()) && other.o2b_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = imul(result, -1);
  } else {
    tmp = result;
  }
...
protoOf(BigInteger).y2b = function () {
  return this.o2b_1.equals(Sign_ZERO_getInstance()) || get_chosenArithmetic().k2f(this.n2b_1, get_chosenArithmetic().x2e()) === 0;
};
protoOf(BigInteger).l2d = function () {
  return new BigInteger(this.n2b_1, this.o2b_1.l2g());
};
protoOf(BigInteger).w2b = function () {
  return new BigInteger(this.n2b_1, Sign_POSITIVE_getInstance());
};
protoOf(BigInteger).s2b = function (exponent) {
  if (compare(exponent, new Long(0, 0)) < 0) {
  ...
  if (this.y2b()) {
    tmp = Companion_getInstance_1().i2b_1;
  } else if (this.equals(Companion_getInstance_1().j2b_1)) {
    tmp = Companion_getInstance_1().j2b_1;
  } else {
    var tmp_0;
    if (this.o2b_1.equals(Sign_NEGATIVE_getInstance())) {
      var tmp_1;
    ...
    var sign = tmp_0;
    tmp = new BigInteger(Companion_getInstance_1().h2b_1.s2g(this.n2b_1, exponent), sign);
  }
  return tmp;
};
protoOf(BigInteger).t2g = function (exponent) {
  return this.s2b(fromInt(exponent));
};
protoOf(BigInteger).n2c = function () {
  var tmp;
  switch (this.o2b_1.p2_1) {
    case 0:
      tmp = 1;
      break;
    case 1:
...
protoOf(BigInteger).r2b = function () {
  if (this.y2b()) {
    return new Long(1, 0);
  }
  var powersOf10 = BigInteger63Arithmetic_getInstance().d2g_1;
  var tmp$ret$1;
  $l$block: {
    ...
    if (inductionVariable <= last)
      do {
        ...
        if (BigInteger63Arithmetic_getInstance().u2g(it, this.n2b_1) > 0) {
          tmp$ret$1 = index;
          break $l$block;
        }
      }
  ...
  var tmp = this.u2a(Companion_getInstance_1().l2b_1.t2g(powersOf10.length));
...
protoOf(BigInteger).z2b = function () {
  return this.q2a(Companion_getInstance_1().j2b_1);
};
protoOf(BigInteger).a2c = function () {
  return this.o2a(Companion_getInstance_1().j2b_1);
};
protoOf(BigInteger).t2b = function (other) {
  var result = this.r2g(other);
  return new QuotientAndRemainder(result.oe_1, result.pe_1);
};
protoOf(BigInteger).b2e = function (other) {
  if (isNumber(other)) {
    if (RuntimePlatform_instance.n2e().equals(Platform_JS_getInstance())) {
  ...
  if (other instanceof BigInteger) {
    ...
    if (other instanceof Long) {
      tmp = this.m2e(Companion_getInstance_1().z2c(other));
    } else {
      if (typeof other === 'number') {
        tmp = this.m2e(Companion_getInstance_1().h2a(other));
      } else {
        if (typeof other === 'number') {
          tmp = this.m2e(Companion_getInstance_1().d2d(other));
        } else {
          if (typeof other === 'number') {
            tmp = this.m2e(Companion_getInstance_1().f2d(other));
          } else {
            if (other instanceof ULong) {
              tmp = this.m2e(Companion_getInstance_1().c2f(other.k1_1));
            } else {
              if (other instanceof UInt) {
                tmp = this.m2e(Companion_getInstance_1().e2f(other.vk_1));
              } else {
                if (other instanceof UShort) {
                  tmp = this.m2e(Companion_getInstance_1().g2f(other.ol_1));
                } else {
                  if (other instanceof UByte) {
                    tmp = this.m2e(Companion_getInstance_1().i2f(other.lk_1));
                  } else {
                    if (typeof other === 'number') {
                      tmp = this.l2f(other, BigInteger$compareTo$lambda(this));
                    } else {
                      if (typeof other === 'number') {
                        tmp = this.v2g(other, BigInteger$compareTo$lambda_0(this));
                      } else {
...
protoOf(BigInteger).l2f = function (float, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
  var withoutDecimalPart = Math.floor(float);
  var hasDecimalPart = !(float % 1 === 0.0);
  var tmp;
  if (hasDecimalPart) {
    var comparisonResult = comparisonBlock(Companion_getInstance_1().j2a(withoutDecimalPart + 1));
    var tmp_0;
    ...
    tmp = comparisonBlock(Companion_getInstance_1().j2a(withoutDecimalPart));
  }
  return tmp;
};
protoOf(BigInteger).v2g = function (double, comparisonBlock) {
  // Inline function 'kotlin.math.floor' call
  var withoutDecimalPart = Math.floor(double);
  var hasDecimalPart = !(double % 1 === 0.0);
  var tmp;
  if (hasDecimalPart) {
    var comparisonResult = comparisonBlock(Companion_getInstance_1().l2a(withoutDecimalPart + 1));
    var tmp_0;
    if (comparisonResult === 0) {
      tmp_0 = 1;
    } else {
    ...
    tmp = comparisonBlock(Companion_getInstance_1().l2a(withoutDecimalPart));
  }
  return tmp;
};
...
protoOf(BigInteger).hashCode = function () {
  ...
  return accumulator + this.o2b_1.hashCode() | 0;
};
protoOf(BigInteger).toString = function () {
  return this.p2e(10);
};
protoOf(BigInteger).p2e = function (base) {
  var tmp;
  if (this.o2b_1.equals(Sign_NEGATIVE_getInstance())) {
    tmp = '-';
  } else {
  ...
  var sign = tmp;
  return sign + this.q2e(base);
};
protoOf(BigInteger).q2e = function (base) {
  return Companion_getInstance_1().h2b_1.w2g(this.n2b_1, base);
};
protoOf(BigInteger).x2b = function (exactRequired) {
  if (exactRequired && (this.b2e(2147483647) > 0 || this.b2e(-2147483648) < 0)) {
    throw ArithmeticException_init_$Create$('Cannot convert to int and provide exact value');
  }
  // Inline function 'kotlin.ULong.toInt' call
  var this_0 = ULongArray__get_impl_pr71q9(this.n2b_1, 0);
  var tmp$ret$0 = convertToInt(_ULong___get_data__impl__fggpzb(this_0));
  return imul(tmp$ret$0, this.n2c());
};
...
function toBigInteger(_this__u8e3s4) {
  return Companion_getInstance_1().h2a(_this__u8e3s4);
}
function toBigInteger_0(_this__u8e3s4, base) {
  base = base === VOID ? 10 : base;
  return Companion_getInstance_1().f2a(_this__u8e3s4, base);
}
...
protoOf(Sextuple).qe = function () {
  return this.x2g_1;
};
protoOf(Sextuple).re = function () {
  return this.y2g_1;
};
protoOf(Sextuple).bk = function () {
  return this.z2g_1;
};
protoOf(Sextuple).d2h = function () {
  return this.a2h_1;
};
protoOf(Sextuple).e2h = function () {
  return this.b2h_1;
};
protoOf(Sextuple).f2h = function () {
  return this.c2h_1;
};
protoOf(Sextuple).toString = function () {
  return 'Sextuple(a=' + toString_0(this.x2g_1) + ', b=' + toString_0(this.y2g_1) + ', c=' + toString_0(this.z2g_1) + ', d=' + toString_0(this.a2h_1) + ', e=' + toString_0(this.b2h_1) + ', f=' + toString_0(this.c2h_1) + ')';
};
protoOf(Sextuple).hashCode = function () {
  var result = this.x2g_1 == null ? 0 : hashCode(this.x2g_1);
  result = imul(result, 31) + (this.y2g_1 == null ? 0 : hashCode(this.y2g_1)) | 0;
  result = imul(result, 31) + (this.z2g_1 == null ? 0 : hashCode(this.z2g_1)) | 0;
  result = imul(result, 31) + (this.a2h_1 == null ? 0 : hashCode(this.a2h_1)) | 0;
  result = imul(result, 31) + (this.b2h_1 == null ? 0 : hashCode(this.b2h_1)) | 0;
  result = imul(result, 31) + (this.c2h_1 == null ? 0 : hashCode(this.c2h_1)) | 0;
  return result;
};
protoOf(Sextuple).equals = function (other) {
  ...
  if (!equals(this.z2g_1, tmp0_other_with_cast.z2g_1))
    return false;
  if (!equals(this.a2h_1, tmp0_other_with_cast.a2h_1))
    return false;
  if (!equals(this.b2h_1, tmp0_other_with_cast.b2h_1))
    return false;
...
protoOf(Quadruple).qe = function () {
  return this.g2h_1;
};
protoOf(Quadruple).re = function () {
  return this.h2h_1;
};
protoOf(Quadruple).bk = function () {
  return this.i2h_1;
};
protoOf(Quadruple).d2h = function () {
  return this.j2h_1;
};
protoOf(Quadruple).toString = function () {
  return 'Quadruple(a=' + toString_0(this.g2h_1) + ', b=' + toString_0(this.h2h_1) + ', c=' + toString_0(this.i2h_1) + ', d=' + toString_0(this.j2h_1) + ')';
};
protoOf(Quadruple).hashCode = function () {
  var result = this.g2h_1 == null ? 0 : hashCode(this.g2h_1);
  result = imul(result, 31) + (this.h2h_1 == null ? 0 : hashCode(this.h2h_1)) | 0;
  result = imul(result, 31) + (this.i2h_1 == null ? 0 : hashCode(this.i2h_1)) | 0;
  result = imul(result, 31) + (this.j2h_1 == null ? 0 : hashCode(this.j2h_1)) | 0;
  return result;
};
...
function SignedUIntArray(unsignedValue, sign) {
  this.k2h_1 = unsignedValue;
  this.l2h_1 = sign;
}
protoOf(SignedUIntArray).toString = function () {
  return 'SignedUIntArray(unsignedValue=' + UIntArray__toString_impl_3zy802(this.k2h_1) + ', sign=' + this.l2h_1 + ')';
};
protoOf(SignedUIntArray).hashCode = function () {
  var result = UIntArray__hashCode_impl_hr7ost(this.k2h_1);
  result = imul(result, 31) + getBooleanHashCode(this.l2h_1) | 0;
  return result;
};
...
function BigInteger32Arithmetic() {
  ...
  tmp.m2h_1 = new Int32Array([]);
  this.n2h_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.o2h_1 = _UInt___init__impl__l7qpdl(-1);
  this.p2h_1 = _ULong___init__impl__c78o9k(new Long(0, 1));
  this.q2h_1 = _ULong___init__impl__c78o9k(new Long(65535, 0));
  this.r2h_1 = _UInt___init__impl__l7qpdl(-1);
  this.s2h_1 = 32;
  this.t2h_1 = 32;
  this.u2h_1 = _UIntArray___init__impl__ghjpc6(0);
  var tmp_0 = this;
  ...
  tmp_0.v2h_1 = _UIntArray___init__impl__ghjpc6_0(tmp_2);
  var tmp_4 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_5 = 0;
  ...
  tmp_4.w2h_1 = _UIntArray___init__impl__ghjpc6_0(tmp_6);
  var tmp_8 = this;
  // Inline function 'kotlin.UIntArray' call
  var tmp_9 = 0;
  ...
  tmp_8.x2h_1 = _UIntArray___init__impl__ghjpc6_0(tmp_10);
  this.y2h_1 = 60;
  this.z2h_1 = 15000;
  this.a2i_1 = new SignedUIntArray(this.w2h_1, true);
}
protoOf(BigInteger32Arithmetic).b2i = function (value) {
  var x = value;
  var y;
  var n = this.s2h_1;
...
protoOf(BigInteger32Arithmetic).c2i = function (value) {
  ...
  return this.d2i(mostSignificant) + imul(_UIntArray___get_size__impl__r6l8ci(value) - 1 | 0, this.s2h_1) | 0;
};
protoOf(BigInteger32Arithmetic).d2i = function (value) {
  return this.s2h_1 - this.b2i(value) | 0;
};
protoOf(BigInteger32Arithmetic).e2i = function (bigInteger) {
...
protoOf(BigInteger32Arithmetic).f2i = function (bigInteger) {
...
protoOf(BigInteger32Arithmetic).g2i = function (operand, places) {
  if (UIntArray__isEmpty_impl_vd8j4n(operand) || places === 0) {
    return operand;
  }
  var originalSize = _UIntArray___get_size__impl__r6l8ci(operand);
  var leadingZeros = this.b2i(UIntArray__get_impl_gp5kza(operand, _UIntArray___get_size__impl__r6l8ci(operand) - 1 | 0));
  var shiftWords = places / this.s2h_1 | 0;
  var shiftBits = places % this.s2h_1 | 0;
  var tmp;
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.UInt.shr' call
          var bitCount = BigInteger32Arithmetic_getInstance().s2h_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.UInt.shr' call
            var bitCount_0 = BigInteger32Arithmetic_getInstance().s2h_1 - shiftBits | 0;
...
protoOf(BigInteger32Arithmetic).h2i = function (operand, places) {
  if (UIntArray__isEmpty_impl_vd8j4n(operand) || places === 0) {
    return operand;
  }
  var shiftBits = places % this.s2h_1 | 0;
  var wordsToDiscard = places / this.s2h_1 | 0;
  ...
  return this.e2i(result);
};
protoOf(BigInteger32Arithmetic).i2i = function (dividend, divisor) {
  var divisorSize = _UIntArray___get_size__impl__r6l8ci(divisor);
  var normalizationShift = this.b2i(UIntArray__get_impl_gp5kza(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.j2i(divisor, normalizationShift);
  var dividendNormalized = this.j2i(dividend, normalizationShift);
  return new Triple(new UIntArray(dividendNormalized), new UIntArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger32Arithmetic).k2i = function (remainderNormalized, normalizationShift) {
  var remainder = this.l2i(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger32Arithmetic).m2i = function (first, second) {
  var firstStart = _UIntArray___get_size__impl__r6l8ci(first) - this.f2i(first) | 0;
  var secondStart = _UIntArray___get_size__impl__r6l8ci(second) - this.f2i(second) | 0;
...
protoOf(BigInteger32Arithmetic).n2i = function (first, second) {
  ...
  var _destruct__k2r9zo = tmp;
  var maxLength = _destruct__k2r9zo.qe();
  var minLength = _destruct__k2r9zo.re();
  var largerData = _destruct__k2r9zo.bk().al_1;
  var smallerData = _destruct__k2r9zo.d2h().al_1;
  // Inline function 'kotlin.UIntArray' call
  var tmp_0 = 0;
  ...
  while (true) {
    ...
    var tmp0_5 = sum;
    // Inline function 'kotlin.ULong.shr' call
    var bitCount_0 = this.s2h_1;
    sum = _ULong___init__impl__c78o9k(shiftRightUnsigned(_ULong___get_data__impl__fggpzb(tmp0_5), bitCount_0));
    i = i + 1 | 0;
  }
};
protoOf(BigInteger32Arithmetic).o2i = function (first, second) {
  var firstWithoutLeadingZeroes = this.e2i(first);
  var secondWithoutLeadingZeroes = this.e2i(second);
  var firstIsLarger = this.m2i(firstWithoutLeadingZeroes, secondWithoutLeadingZeroes) === 1;
  var tmp;
  if (firstIsLarger) {
  ...
  var _destruct__k2r9zo = tmp;
  var largerLength = _destruct__k2r9zo.qe();
  var smallerLength = _destruct__k2r9zo.re();
  var largerData = _destruct__k2r9zo.bk().al_1;
  var smallerData = _destruct__k2r9zo.d2h().al_1;
  // Inline function 'kotlin.UIntArray' call
  var tmp_0 = 0;
...
protoOf(BigInteger32Arithmetic).p2i = function (first, second) {
...
protoOf(BigInteger32Arithmetic).q2i = function (first, second) {
  return this.r2i(first, second);
};
protoOf(BigInteger32Arithmetic).r2i = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.s2i(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new UIntArray(this.u2h_1), new UIntArray(unnormalizedDividend));
  }
  if (_UIntArray___get_size__impl__r6l8ci(unnormalizedDivisor) === 1 && _UIntArray___get_size__impl__r6l8ci(unnormalizedDividend) === 1) {
    ...
    return new Pair(new UIntArray(tmp), new UIntArray(this.e2i(tmp$ret$3)));
  }
  var bitPrecision = this.c2i(unnormalizedDividend) - this.c2i(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    // Inline function 'kotlin.uintArrayOf' call
    var tmp$ret$4 = _UIntArray___init__impl__ghjpc6_0(new Int32Array([_UInt___init__impl__l7qpdl(1)]));
    return new Pair(new UIntArray(tmp$ret$4), new UIntArray(this.t2i(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.i2i(unnormalizedDividend, unnormalizedDivisor);
  var dividend = _destruct__k2r9zo.qe().al_1;
  var divisor = _destruct__k2r9zo.re().al_1;
  var normalizationShift = _destruct__k2r9zo.bk();
  ...
  var divisorTimesBaseToPowerOfM = this.j2i(divisor, imul(wordPrecision, this.s2h_1));
  if (this.s2i(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.t2i(dividend, divisorTimesBaseToPowerOfM);
  }
  ...
  if (0 <= inductionVariable)
    do {
      ...
      reconstructedQuotient = this.j2i(this.u2i(divisor, UIntArray__get_impl_gp5kza(quotient, j)), imul(j, this.s2h_1));
      while (this.s2i(reconstructedQuotient, dividend) > 0) {
        var tmp_4 = quotient;
      ...
      dividend = this.t2i(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.s2i(dividend, divisor) >= 0) {
    quotient = this.v2i(quotient, _UInt___init__impl__l7qpdl(1));
    dividend = this.t2i(dividend, divisor);
  }
  var denormRemainder = this.k2i(dividend, normalizationShift);
  return new Pair(new UIntArray(this.e2i(quotient)), new UIntArray(denormRemainder));
};
protoOf(BigInteger32Arithmetic).j2i = function (_this__u8e3s4, places) {
  return this.g2i(_this__u8e3s4, places);
};
protoOf(BigInteger32Arithmetic).l2i = function (_this__u8e3s4, places) {
  return this.h2i(_this__u8e3s4, places);
};
protoOf(BigInteger32Arithmetic).t2i = function (_this__u8e3s4, other) {
  return this.o2i(_this__u8e3s4, other);
};
protoOf(BigInteger32Arithmetic).v2i = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.uintArrayOf' call
  var tmp$ret$0 = _UIntArray___init__impl__ghjpc6_0(new Int32Array([other]));
  return this.n2i(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger32Arithmetic).u2i = function (_this__u8e3s4, other) {
  return this.p2i(_this__u8e3s4, other);
};
protoOf(BigInteger32Arithmetic).s2i = function (_this__u8e3s4, other) {
  return this.m2i(_this__u8e3s4, other);
};
...
function basecaseMultiplyWithCorrectedSize($this, first, second, firstCorrectedSizeStart, secondCorrectedSizeStart) {
  ...
  while (_iterator__ex2g4s.s()) {
    ...
    if (_unary__edvuaz > secondCorrectedSizeStart) {
      ...
      resultArray = BigInteger63Arithmetic_getInstance().z2i(resultArray, BigInteger63Arithmetic_getInstance().y2i(BigInteger63Arithmetic_getInstance().x2i(first, item), imul(_unary__edvuaz, BigInteger63Arithmetic_getInstance().s2f_1)));
    }
  }
  return resultArray;
}
function karatsubaMultiplyWithCorrectedSizes($this, firstUnsigned, secondUnsigned, firstCorrectedSize, secondCorrectedSize) {
  ...
  var mask = $this.a2j($this.y2i($this.o2f_1, imul(halfLength, $this.t2f_1)), _ULong___init__impl__c78o9k(new Long(1, 0)));
  var firstLower = $this.b2j(first, mask);
  var firstHigher = $this.c2j(first, imul(halfLength, $this.t2f_1));
  var secondLower = $this.b2j(second, mask);
  var secondHigher = $this.c2j(second, imul(halfLength, $this.t2f_1));
  var higherProduct = $this.d2j(firstHigher, secondHigher);
  var lowerProduct = $this.d2j(firstLower, secondLower);
  var middleProduct = $this.d2j($this.e2j(firstHigher, firstLower), $this.e2j(secondHigher, secondLower));
  var result = $this.e2j($this.e2j($this.f2j(higherProduct, imul(imul(2, $this.t2f_1), halfLength)), $this.f2j($this.g2j($this.g2j(middleProduct, higherProduct), lowerProduct), imul($this.t2f_1, halfLength))), lowerProduct);
  return result.h2j_1;
}
function isZero($this, _this__u8e3s4) {
  if (equals(_this__u8e3s4, $this.n2f_1))
    return true;
  if (_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) === 1 && equals(ULongArray__get_impl_pr71q9(_this__u8e3s4, 0), _ULong___init__impl__c78o9k(new Long(0, 0))))
    return true;
  if ((_ULongArray___get_size__impl__ju6dtr(_this__u8e3s4) - $this.j2j(_this__u8e3s4) | 0) === 0)
    return true;
  return false;
}
function SignedULongArray(unsignedValue, sign) {
  this.h2j_1 = unsignedValue;
  this.i2j_1 = sign;
}
protoOf(SignedULongArray).k2j = function (unsignedValue, sign) {
  return new SignedULongArray(unsignedValue, sign);
};
protoOf(SignedULongArray).l2j = function (unsignedValue, sign, $super) {
  unsignedValue = unsignedValue === VOID ? this.h2j_1 : unsignedValue;
  sign = sign === VOID ? this.i2j_1 : sign;
  return $super === VOID ? this.k2j(unsignedValue, sign) : $super.k2j.call(this, new ULongArray(unsignedValue), sign);
};
protoOf(SignedULongArray).toString = function () {
  return 'SignedULongArray(unsignedValue=' + ULongArray__toString_impl_wqk1p5(this.h2j_1) + ', sign=' + this.i2j_1 + ')';
};
protoOf(SignedULongArray).hashCode = function () {
  var result = ULongArray__hashCode_impl_aze4wa(this.h2j_1);
...
function signedAdd($this, first, second) {
  var tmp;
  if (!!(first.i2j_1 ^ second.i2j_1)) {
    var tmp_0;
    if ($this.u2g(first.h2j_1, second.h2j_1) > 0) {
      tmp_0 = new SignedULongArray($this.m2j(first.h2j_1, second.h2j_1), first.i2j_1);
    } else {
      tmp_0 = new SignedULongArray($this.m2j(second.h2j_1, first.h2j_1), second.i2j_1);
    }
    tmp = tmp_0;
  } else {
    tmp = new SignedULongArray($this.z2i(first.h2j_1, second.h2j_1), first.i2j_1);
  }
  return tmp;
}
function signedSubtract($this, first, second) {
  return signedAdd($this, first, second.l2j(VOID, !second.i2j_1));
}
function signedMultiply($this, first, second) {
  return new SignedULongArray($this.n2j(first.h2j_1, second.h2j_1), !!!(first.i2j_1 ^ second.i2j_1));
}
function signedDivide($this, first, second) {
  return new SignedULongArray($this.o2j(first.h2j_1, second.h2j_1), !!!(first.i2j_1 ^ second.i2j_1));
}
function BigInteger63Arithmetic() {
  BigInteger63Arithmetic_instance = this;
  var tmp = this;
  // Inline function 'kotlin.longArrayOf' call
  tmp.m2f_1 = longArrayOf([]);
  var tmp_0 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_0.n2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(0, 0))]));
  var tmp_1 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_1.o2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(1, 0))]));
  var tmp_2 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_2.p2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(2, 0))]));
  var tmp_3 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_3.q2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(10, 0))]));
  var tmp_4 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_4.r2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1431655765, 715827882))]));
  this.s2f_1 = 63;
  this.t2f_1 = 63;
  this.u2f_1 = _ULong___init__impl__c78o9k(new Long(-1, 2147483647));
  var tmp_5 = this;
  // Inline function 'kotlin.ulongArrayOf' call
  tmp_5.v2f_1 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(-1, 2147483647))]));
  this.w2f_1 = _ULong___init__impl__c78o9k(new Long(-1, 0));
  this.x2f_1 = _ULong___init__impl__c78o9k(new Long(0, 2147483647));
  this.y2f_1 = _ULong___init__impl__c78o9k(new Long(0, -2147483648));
  this.z2f_1 = 120;
  this.a2g_1 = 15000;
  this.b2g_1 = false;
  this.c2g_1 = new SignedULongArray(BigInteger63Arithmetic_getInstance().p2f_1, true);
  var tmp_6 = this;
  // Inline function 'kotlin.ulongArrayOf' call
...
protoOf(BigInteger63Arithmetic).q2j = function (value) {
  if (isZero(this, value)) {
    return 0;
  }
  var start = (_ULongArray___get_size__impl__ju6dtr(value) - this.j2j(value) | 0) - 1 | 0;
  var mostSignificant = ULongArray__get_impl_pr71q9(value, start);
  return this.r2j(mostSignificant) + imul(start, 63) | 0;
};
protoOf(BigInteger63Arithmetic).r2j = function (value) {
  return 63 - this.p2j(value) | 0;
};
protoOf(BigInteger63Arithmetic).e2g = function (bigInteger) {
  var correctedSize = _ULongArray___get_size__impl__ju6dtr(bigInteger) - this.j2j(bigInteger) | 0;
  if (correctedSize === 0) {
    return this.n2f_1;
  }
...
protoOf(BigInteger63Arithmetic).j2j = function (bigInteger) {
...
protoOf(BigInteger63Arithmetic).s2j = function (operand, places) {
  ...
  var leadingZeroWords = this.j2j(operand);
  ...
  var leadingZeros = this.p2j(ULongArray__get_impl_pr71q9(operand, originalSize - 1 | 0));
  var shiftWords = places / this.s2f_1 | 0;
  var shiftBits = places % this.s2f_1 | 0;
  var tmp;
  if (shiftBits > leadingZeros) {
    tmp = shiftWords + 1 | 0;
  } else {
  ...
  while (tmp_4 < tmp_5) {
    ...
    if (0 <= tmp_7 ? tmp_7 < shiftWords : false) {
      ...
      if (tmp_7 === shiftWords) {
        ...
        // Inline function 'kotlin.ULong.and' call
        var other = BigInteger63Arithmetic_getInstance().u2f_1;
        ...
        if (tmp_7 < (originalSize + shiftWords | 0) ? containsLower <= tmp_7 : false) {
          ...
          // Inline function 'kotlin.ULong.and' call
          var other_0 = BigInteger63Arithmetic_getInstance().u2f_1;
          ...
          // Inline function 'kotlin.ULong.shr' call
          var bitCount = BigInteger63Arithmetic_getInstance().s2f_1 - shiftBits | 0;
          ...
          if (tmp_7 === ((originalSize + wordsNeeded | 0) - 1 | 0)) {
            ...
            // Inline function 'kotlin.ULong.shr' call
            var bitCount_0 = BigInteger63Arithmetic_getInstance().s2f_1 - shiftBits | 0;
...
protoOf(BigInteger63Arithmetic).t2j = function (operand, places) {
  ...
  var shiftBits = places % this.s2f_1 | 0;
  var wordsToDiscard = places / this.s2f_1 | 0;
...
protoOf(BigInteger63Arithmetic).u2j = function (first, second, firstStart, secondStart) {
  if (firstStart > secondStart) {
    return 1;
  }
  if (secondStart > firstStart) {
...
protoOf(BigInteger63Arithmetic).k2f = function (first, second) {
  var firstStart = _ULongArray___get_size__impl__ju6dtr(first) - this.j2j(first) | 0;
  var secondStart = _ULongArray___get_size__impl__ju6dtr(second) - this.j2j(second) | 0;
  return this.u2j(first, second, firstStart, secondStart);
};
protoOf(BigInteger63Arithmetic).v2j = function (resultArray, resultArrayStart, first, second) {
  ...
  var largerLength = _destruct__k2r9zo.qe();
  var smallerLength = _destruct__k2r9zo.re();
  var largerData = _destruct__k2r9zo.bk().jl_1;
  var smallerData = _destruct__k2r9zo.d2h().jl_1;
  var largerStart = _destruct__k2r9zo.e2h();
  var smallerStart = _destruct__k2r9zo.f2h();
  var i = 0;
  var sum = _ULong___init__impl__c78o9k(new Long(0, 0));
...
protoOf(BigInteger63Arithmetic).h2g = function (first, second) {
  if (isZero(this, first))
    return second;
  if (isZero(this, second))
    return first;
  ...
  var result = tmp_1;
  this.v2j(result, 0, first, second);
  var tmp_9;
  if (possibleOverflow_0) {
    tmp_9 = this.e2g(result);
  } else {
    tmp_9 = result;
  }
  return tmp_9;
};
protoOf(BigInteger63Arithmetic).w2j = function (first, second, firstStart, secondStart) {
  var comparison = this.u2j(first, second, firstStart, secondStart);
  ...
  var _destruct__k2r9zo = tmp;
  var largerData = _destruct__k2r9zo.qe().jl_1;
  var smallerData = _destruct__k2r9zo.re().jl_1;
  var largerStart = _destruct__k2r9zo.bk();
  var smallerStart = _destruct__k2r9zo.d2h();
  // Inline function 'kotlin.ULongArray' call
  var tmp_0 = 0;
  ...
  if (this.j2j(result) === (_ULongArray___get_size__impl__ju6dtr(result) - 1 | 0) && equals(ULongArray__get_impl_pr71q9(result, 0), _ULong___init__impl__c78o9k(new Long(0, 0)))) {
    return this.n2f_1;
  }
  return this.e2g(result);
};
protoOf(BigInteger63Arithmetic).g2g = function (first, second) {
  var firstStart = _ULongArray___get_size__impl__ju6dtr(first) - this.j2j(first) | 0;
  var secondStart = _ULongArray___get_size__impl__ju6dtr(second) - this.j2j(second) | 0;
  return this.w2j(first, second, firstStart, secondStart);
};
protoOf(BigInteger63Arithmetic).n2g = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.j2j(first) | 0;
  var secondCorrectedSize = _ULongArray___get_size__impl__ju6dtr(second) - this.j2j(second) | 0;
  return multiplyWithCorrectedSize(this, first, second, firstCorrectedSize, secondCorrectedSize);
};
protoOf(BigInteger63Arithmetic).x2j = function (original, numberOfWords, value) {
  // Inline function 'kotlin.ULongArray' call
  var tmp = 0;
...
protoOf(BigInteger63Arithmetic).w2i = function (firstUnchecked, secondUnchecked) {
  var tmp;
  ...
  if (firstLength > secondLength) {
    var prepared = this.x2j(second, firstLength - secondLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
    tmp_9 = new Pair(new ULongArray(first), new ULongArray(prepared));
  } else if (firstLength < secondLength) {
    var prepared_0 = this.x2j(first, secondLength - firstLength | 0, _ULong___init__impl__c78o9k(new Long(0, 0)));
  ...
  var firstPrepared = _destruct__k2r9zo.qe().jl_1;
  var secondPrepared = _destruct__k2r9zo.re().jl_1;
  ...
  var p0 = this.e2j(m0, m2);
  var pe0 = m0;
  var pe1 = this.e2j(p0, m1);
  var pem1 = this.g2j(p0, m1);
  var doublePemM2 = this.d2j(this.e2j(pem1, m2), this.c2g_1);
  var pem2 = this.g2j(doublePemM2, m0);
  var pinf = m2;
  var q0 = this.e2j(n0, n2);
  var qe0 = n0;
  var qe1 = this.e2j(q0, n1);
  var qem1 = this.g2j(q0, n1);
  var doubleQemN2 = this.d2j(this.e2j(qem1, n2), this.c2g_1);
  var qem2 = this.g2j(doubleQemN2, n0);
  var qinf = n2;
  var re0 = this.d2j(pe0, qe0);
  var re1 = this.d2j(pe1, qe1);
  var rem1 = this.d2j(pem1, qem1);
  var rem2 = this.d2j(pem2, qem2);
  var rinf = this.d2j(pinf, qinf);
  var r0 = re0;
  var r4 = rinf;
  var rem2re1diff = this.g2j(rem2, re1);
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$11 = _ULongArray___init__impl__twm1l3(longArrayOf([_ULong___init__impl__c78o9k(new Long(3, 0))]));
  var r3 = this.y2j(rem2re1diff, new SignedULongArray(tmp$ret$11, true));
  var r1 = this.c2j(this.g2j(re1, rem1), 1);
  var r2 = this.g2j(rem1, r0);
  r3 = this.e2j(this.c2j(this.g2j(r2, r3), 1), this.d2j(this.c2g_1, rinf));
  r2 = this.g2j(this.e2j(r2, r1), r4);
  r1 = this.g2j(r1, r3);
  var bShiftAmount = imul(extendedDigit, 63);
  var rb0 = r0;
  var rb1 = this.f2j(r1, bShiftAmount);
  var rb2 = this.f2j(r2, imul(bShiftAmount, 2));
  var rb3 = this.f2j(r3, imul(bShiftAmount, 3));
  var rb4 = this.f2j(r4, imul(bShiftAmount, 4));
  var rb = this.e2j(this.e2j(this.e2j(this.e2j(rb0, rb1), rb2), rb3), rb4);
  return rb.h2j_1;
};
protoOf(BigInteger63Arithmetic).x2i = function (first, second) {
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(first) - this.j2j(first) | 0;
  return this.z2j(first, second, firstCorrectedSize);
};
protoOf(BigInteger63Arithmetic).z2j = function (first, second, firstCorrectedSize) {
  // Inline function 'kotlin.ULong.and' call
  var other = this.w2f_1;
  ...
  var requiredBits = this.q2j(first) + this.r2j(second) | 0;
  var tmp;
...
protoOf(BigInteger63Arithmetic).s2g = function (base, exponent) {
  ...
  if (_ULongArray___get_size__impl__ju6dtr(base) === 1 && equals(ULongArray__get_impl_pr71q9(base, 0), _ULong___init__impl__c78o9k(new Long(10, 0))) && compare(exponent, fromInt(this.d2g_1.length)) < 0) {
    return this.d2g_1[convertToInt(exponent)].jl_1;
  }
  var firstCorrectedSize = _ULongArray___get_size__impl__ju6dtr(base) - this.j2j(base) | 0;
  var helperVar = this.o2f_1;
  ...
  while (compare(exponentVar, new Long(1, 0)) > 0) {
    ...
    if (equalsLong(tmp$ret$0, new Long(0, 0))) {
      baseVar = this.n2j(baseVar, baseVar);
      // Inline function 'kotlin.Long.div' call
      var this_1 = exponentVar;
      exponentVar = divide(this_1, fromInt(2));
    } else {
      helperVar = this.n2j(baseVar, helperVar);
      baseVar = this.n2j(baseVar, baseVar);
      // Inline function 'kotlin.Long.minus' call
  ...
  return this.n2j(helperVar, baseVar);
};
protoOf(BigInteger63Arithmetic).a2k = function (dividend, divisor) {
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var normalizationShift = this.p2j(ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0));
  var divisorNormalized = this.y2i(divisor, normalizationShift);
  var dividendNormalized = this.y2i(dividend, normalizationShift);
  return new Triple(new ULongArray(dividendNormalized), new ULongArray(divisorNormalized), normalizationShift);
};
protoOf(BigInteger63Arithmetic).b2k = function (remainderNormalized, normalizationShift) {
  var remainder = this.c2k(remainderNormalized, normalizationShift);
  return remainder;
};
protoOf(BigInteger63Arithmetic).d2k = function (unnormalizedDividend, unnormalizedDivisor) {
  if (this.u2g(unnormalizedDivisor, unnormalizedDividend) > 0) {
    return new Pair(new ULongArray(this.n2f_1), new ULongArray(unnormalizedDividend));
  }
  if (_ULongArray___get_size__impl__ju6dtr(unnormalizedDivisor) === 1 && _ULongArray___get_size__impl__ju6dtr(unnormalizedDividend) === 1) {
    ...
    return new Pair(new ULongArray(tmp), new ULongArray(this.e2g(tmp$ret$3)));
  }
  var bitPrecision = this.q2j(unnormalizedDividend) - this.q2j(unnormalizedDivisor) | 0;
  if (bitPrecision === 0) {
    return new Pair(new ULongArray(this.o2f_1), new ULongArray(this.m2j(unnormalizedDividend, unnormalizedDivisor)));
  }
  var _destruct__k2r9zo = this.a2k(unnormalizedDividend, unnormalizedDivisor);
  var dividend = _destruct__k2r9zo.qe().jl_1;
  var divisor = _destruct__k2r9zo.re().jl_1;
  var normalizationShift = _destruct__k2r9zo.bk();
  var dividendSize = _ULongArray___get_size__impl__ju6dtr(dividend);
  var divisorSize = _ULongArray___get_size__impl__ju6dtr(divisor);
  var divisorCorrectedSize = _ULongArray___get_size__impl__ju6dtr(divisor) - this.j2j(divisor) | 0;
  var wordPrecision = dividendSize - divisorSize | 0;
  var qjhat;
  var reconstructedQuotient;
  var quotient = _ULongArray___init__impl__twm1l3_0(wordPrecision);
  var divisorTimesBaseToPowerOfM = this.y2i(divisor, imul(wordPrecision, this.s2f_1));
  if (this.u2g(dividend, divisorTimesBaseToPowerOfM) >= 0) {
    ...
    dividend = this.m2j(dividend, divisorTimesBaseToPowerOfM);
  }
  var inductionVariable = wordPrecision - 1 | 0;
  if (0 <= inductionVariable)
    do {
      ...
      if ((divisorSize + j | 0) < _ULongArray___get_size__impl__ju6dtr(dividend)) {
        ...
        tmp_0 = this.e2k(this.y2i(tmp$ret$4, this.s2f_1), ULongArray__get_impl_pr71q9(dividend, (divisorSize + j | 0) - 1 | 0));
      } else {
        var tmp_1;
        if ((divisorSize + j | 0) === _ULongArray___get_size__impl__ju6dtr(dividend)) {
          // Inline function 'kotlin.ulongArrayOf' call
      ...
      var tmp_3 = this.f2k(twoDigit);
      // Inline function 'kotlin.ulongArrayOf' call
      var tmp$ret$6 = _ULongArray___init__impl__twm1l3(longArrayOf([ULongArray__get_impl_pr71q9(divisor, divisorSize - 1 | 0)]));
      var convertedResult = tmp_2.q2i(tmp_3, this.f2k(tmp$ret$6));
      qjhat = this.g2k(convertedResult.oe_1.al_1);
      var tmp_4 = quotient;
      var tmp_5;
      var tmp_6 = qjhat;
      var tmp0_1 = this.u2f_1;
      // Inline function 'kotlin.ULong.minus' call
      ...
      if (this.h2k(tmp_6, tmp$ret$7) < 0) {
        tmp_5 = ULongArray__get_impl_pr71q9(qjhat, 0);
      } else {
        tmp_5 = this.u2f_1;
      }
      ULongArray__set_impl_z19mvh(tmp_4, j, tmp_5);
      reconstructedQuotient = this.y2i(this.z2j(divisor, ULongArray__get_impl_pr71q9(quotient, j), divisorCorrectedSize), imul(j, this.s2f_1));
      while (this.u2g(reconstructedQuotient, dividend) > 0) {
        var tmp_7 = quotient;
      ...
      dividend = this.m2j(dividend, reconstructedQuotient);
    }
     while (0 <= inductionVariable);
  while (this.u2g(dividend, divisor) >= 0) {
    quotient = this.e2k(quotient, _ULong___init__impl__c78o9k(new Long(1, 0)));
    dividend = this.m2j(dividend, divisor);
  }
  var denormRemainder = this.b2k(dividend, normalizationShift);
  return new Pair(new ULongArray(this.e2g(quotient)), new ULongArray(denormRemainder));
};
protoOf(BigInteger63Arithmetic).i2k = function (operand) {
  if (isZero(this, operand))
    return this.n2f_1;
  var length = this.q2j(operand);
  var tmp;
  if ((length % 64 | 0) === 0) {
    tmp = length / 64 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).j2k = function (operand) {
  var power64Representation = this.i2k(operand);
  ...
  if (inductionVariable < last)
    do {
      ...
      // Inline function 'kotlin.UInt.toULong' call
      var this_0 = BigInteger32Arithmetic_getInstance().r2h_1;
      // Inline function 'kotlin.uintToULong' call
      // Inline function 'kotlin.uintToLong' call
      var value = _UInt___get_data__impl__f0vqqw(this_0);
      var tmp$ret$0 = bitwiseAnd(fromInt(value), new Long(-1, 0));
     ...
     while (inductionVariable < last);
  return BigInteger32Arithmetic_getInstance().e2i(result);
};
protoOf(BigInteger63Arithmetic).k2k = function (operand) {
  ...
  var length = BigInteger32Arithmetic_getInstance().c2i(operand);
  var tmp;
  if ((length % 63 | 0) === 0) {
    tmp = length / 63 | 0;
  } else {
...
protoOf(BigInteger63Arithmetic).p2g = function (first, second) {
  return this.d2k(first, second);
};
protoOf(BigInteger63Arithmetic).e2j = function (_this__u8e3s4, other) {
  return signedAdd(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).g2j = function (_this__u8e3s4, other) {
  return signedSubtract(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).d2j = function (_this__u8e3s4, other) {
  return signedMultiply(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).y2j = function (_this__u8e3s4, other) {
  return signedDivide(this, _this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).c2j = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.c2k(_this__u8e3s4.h2j_1, places), _this__u8e3s4.i2j_1);
};
protoOf(BigInteger63Arithmetic).f2j = function (_this__u8e3s4, places) {
  return new SignedULongArray(this.y2i(_this__u8e3s4.h2j_1, places), _this__u8e3s4.i2j_1);
};
protoOf(BigInteger63Arithmetic).b2j = function (_this__u8e3s4, operand) {
  return new SignedULongArray(this.l2k(_this__u8e3s4.h2j_1, operand), _this__u8e3s4.i2j_1);
};
protoOf(BigInteger63Arithmetic).b2f = function (number, base) {
  var parsed = this.n2f_1;
  ...
  while (inductionVariable < charSequenceLength(indexedObject)) {
    ...
    var tmp_2 = tmp_0.m2k(tmp_1, tmp$ret$2);
    // Inline function 'kotlin.toULong' call
    var this_0 = toDigit(element, base);
    var tmp$ret$3 = _ULong___init__impl__c78o9k(fromInt(this_0));
    parsed = tmp.e2k(tmp_2, tmp$ret$3);
  }
  return this.e2g(parsed);
};
protoOf(BigInteger63Arithmetic).w2g = function (operand, base) {
  ...
  var stringBuilder = StringBuilder_init_$Create$();
  while (!equals(copy, this.n2f_1)) {
    var divremResult = this.n2k(copy, baseArray);
    if (ULongArray__isEmpty_impl_c3yngu(divremResult.pe_1.jl_1)) {
      stringBuilder.ib(0);
    } else {
      stringBuilder.q7(toString_1(ULongArray__get_impl_pr71q9(divremResult.pe_1.jl_1, 0), base));
    }
    copy = divremResult.oe_1.jl_1;
  }
...
protoOf(BigInteger63Arithmetic).l2k = function (operand, mask) {
  var tmp;
  ...
  var _destruct__k2r9zo = tmp;
  var bigger = _destruct__k2r9zo.qe().jl_1;
  var smaller = _destruct__k2r9zo.re().jl_1;
  // Inline function 'kotlin.ULongArray' call
  var tmp_0 = 0;
...
protoOf(BigInteger63Arithmetic).y2i = function (_this__u8e3s4, places) {
  return this.s2j(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).c2k = function (_this__u8e3s4, places) {
  return this.t2j(_this__u8e3s4, places);
};
protoOf(BigInteger63Arithmetic).z2i = function (_this__u8e3s4, other) {
  return this.h2g(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).m2j = function (_this__u8e3s4, other) {
  return this.g2g(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).n2j = function (_this__u8e3s4, other) {
  return this.n2g(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).e2k = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.h2g(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).a2j = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.g2g(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).m2k = function (_this__u8e3s4, other) {
  return this.x2i(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).o2j = function (_this__u8e3s4, other) {
  return this.p2g(_this__u8e3s4, other).oe_1.jl_1;
};
protoOf(BigInteger63Arithmetic).n2k = function (_this__u8e3s4, other) {
  return this.p2g(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).u2g = function (_this__u8e3s4, other) {
  return this.k2f(_this__u8e3s4, other);
};
protoOf(BigInteger63Arithmetic).h2k = function (_this__u8e3s4, other) {
  // Inline function 'kotlin.ulongArrayOf' call
  var tmp$ret$0 = _ULongArray___init__impl__twm1l3(longArrayOf([other]));
  return this.k2f(_this__u8e3s4, tmp$ret$0);
};
protoOf(BigInteger63Arithmetic).f2k = function (_this__u8e3s4) {
  return this.j2k(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).g2k = function (_this__u8e3s4) {
  return this.k2k(_this__u8e3s4);
};
protoOf(BigInteger63Arithmetic).d2f = function (uLong) {
  var tmp;
  // Inline function 'kotlin.ULong.and' call
  var other = this.y2f_1;
...
protoOf(BigInteger63Arithmetic).f2f = function (uInt) {
  // Inline function 'kotlin.UInt.toULong' call
  // Inline function 'kotlin.uintToULong' call
  // Inline function 'kotlin.uintToLong' call
...
protoOf(BigInteger63Arithmetic).h2f = function (uShort) {
...
protoOf(BigInteger63Arithmetic).j2f = function (uByte) {
...
protoOf(BigInteger63Arithmetic).t2e = function (long) {
...
protoOf(BigInteger63Arithmetic).u2e = function (int) {
  // Inline function 'kotlin.math.absoluteValue' call
...
protoOf(BigInteger63Arithmetic).v2e = function (short) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(BigInteger63Arithmetic).w2e = function (byte) {
  // Inline function 'kotlin.math.absoluteValue' call
  // Inline function 'kotlin.toULong' call
...
protoOf(RuntimePlatform).n2e = function () {
...
protoOf(Companion).j2a = tryFromFloat$default;
protoOf(Companion).l2a = tryFromDouble$default;
protoOf(Companion).g2a = parseString$default;
protoOf(BigDecimal).w2a = plus_1;
protoOf(BigDecimal).y2a = minus_0;
protoOf(Companion_1).g2a = parseString$default;
protoOf(Companion_1).j2a = tryFromFloat$default;
protoOf(Companion_1).l2a = tryFromDouble$default;
protoOf(BigInteger).o2a = plus_0;
protoOf(BigInteger).q2a = minus;
protoOf(BigInteger).s2a = times;
protoOf(BigInteger).x2a = times_0;
protoOf(BigInteger).u2a = div;
protoOf(BigInteger).z2a = div_0;
protoOf(BigInteger).a2b = rem;
//endregion
//region block: init
