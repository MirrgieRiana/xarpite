...
protoOf(Segment).i1g = function () {
  this.c1g_1 = true;
  return Segment_init_$Create$_0(this.z1f_1, this.a1g_1, this.b1g_1, true, false);
};
protoOf(Segment).j1g = function () {
  var result = !(this.e1g_1 === this) ? this.e1g_1 : null;
  ensureNotNull(this.f1g_1).e1g_1 = this.e1g_1;
  ensureNotNull(this.e1g_1).f1g_1 = this.f1g_1;
  this.e1g_1 = null;
  this.f1g_1 = null;
  return result;
};
protoOf(Segment).k1g = function (segment) {
  segment.f1g_1 = this;
  segment.e1g_1 = this.e1g_1;
  ensureNotNull(this.e1g_1).f1g_1 = segment;
  this.e1g_1 = segment;
  return segment;
};
protoOf(Segment).l1g = function (byteCount) {
  // Inline function 'kotlin.require' call
  if (!(byteCount > 0 && byteCount <= (this.b1g_1 - this.a1g_1 | 0))) {
  ...
  if (byteCount >= 1024) {
    ...
    prefix = SegmentPool_instance.o1g();
    var tmp0 = this.z1f_1;
    var tmp2 = prefix.z1f_1;
    var tmp4 = this.a1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.a1g_1 + byteCount | 0;
  ...
  prefix.b1g_1 = prefix.a1g_1 + byteCount | 0;
  this.a1g_1 = this.a1g_1 + byteCount | 0;
  ensureNotNull(this.f1g_1).k1g(prefix);
  return prefix;
};
protoOf(Segment).p1g = function () {
  // Inline function 'kotlin.check' call
  if (!!(this.f1g_1 === this)) {
    var message = 'cannot compact';
    throw IllegalStateException_init_$Create$(toString(message));
  }
  if (!ensureNotNull(this.f1g_1).d1g_1)
    return Unit_instance;
  var byteCount = this.b1g_1 - this.a1g_1 | 0;
  var availableByteCount = (8192 - ensureNotNull(this.f1g_1).b1g_1 | 0) + (ensureNotNull(this.f1g_1).c1g_1 ? 0 : ensureNotNull(this.f1g_1).a1g_1) | 0;
  if (byteCount > availableByteCount)
    return Unit_instance;
  this.q1g(ensureNotNull(this.f1g_1), byteCount);
  this.j1g();
  SegmentPool_instance.r1g(this);
};
protoOf(Segment).q1g = function (sink, byteCount) {
  // Inline function 'kotlin.check' call
  if (!sink.d1g_1) {
    var message = 'only owner can write';
    throw IllegalStateException_init_$Create$(toString(message));
  }
  if ((sink.b1g_1 + byteCount | 0) > 8192) {
    if (sink.c1g_1)
      throw IllegalArgumentException_init_$Create$_0();
    if (((sink.b1g_1 + byteCount | 0) - sink.a1g_1 | 0) > 8192)
      throw IllegalArgumentException_init_$Create$_0();
    var tmp0 = sink.z1f_1;
    var tmp2 = sink.z1f_1;
    var tmp4 = sink.a1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = sink.b1g_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    arrayCopy(tmp, tmp2, 0, tmp4, endIndex);
    sink.b1g_1 = sink.b1g_1 - sink.a1g_1 | 0;
    sink.a1g_1 = 0;
  }
  var tmp0_0 = this.z1f_1;
  var tmp2_0 = sink.z1f_1;
  var tmp4_0 = sink.b1g_1;
  var tmp6 = this.a1g_1;
  // Inline function 'kotlin.collections.copyInto' call
  var endIndex_0 = this.a1g_1 + byteCount | 0;
  // Inline function 'kotlin.js.unsafeCast' call
  // Inline function 'kotlin.js.asDynamic' call
  var tmp_0 = tmp0_0;
  // Inline function 'kotlin.js.unsafeCast' call
  ...
  sink.b1g_1 = sink.b1g_1 + byteCount | 0;
  this.a1g_1 = this.a1g_1 + byteCount | 0;
};
function Segment() {
  this.a1g_1 = 0;
...
function readUtf8Line(_this__u8e3s4, newline) {
  ...
  if (compare(newline, new Long(0, 0)) > 0) {
    ...
    var tmp_1 = _this__u8e3s4.x1g(tmp$ret$0);
    // Inline function 'kotlin.code' call
  ...
  if (tmp_0) {
    var result = _this__u8e3s4.y1g(subtract(newline, new Long(1, 0)));
    _this__u8e3s4.z1g(new Long(2, 0));
    tmp = result;
  } else {
    var result_0 = _this__u8e3s4.y1g(newline);
    _this__u8e3s4.z1g(new Long(1, 0));
    tmp = result_0;
  }
  return tmp;
}
...
function commonWrite(_this__u8e3s4, buffer, offset, byteCount) {
  _init_properties_ByteString_kt__sqjq7b();
  buffer.a1h(_this__u8e3s4.s1g_1, offset, byteCount);
}
...
function commonToPath(_this__u8e3s4, normalize) {
  _init_properties_Path_kt__cy3pvf();
  return toPath((new Buffer()).b1h(_this__u8e3s4), normalize);
}
...
function toPath(_this__u8e3s4, normalize) {
  ...
  while (_this__u8e3s4.c1h(new Long(0, 0), get_SLASH()) || _this__u8e3s4.c1h(new Long(0, 0), get_BACKSLASH())) {
    var byte = _this__u8e3s4.d1h();
  ...
  if (windowsUncPath) {
    result.h1h(ensureNotNull(slash));
    result.h1h(slash);
  } else if (leadingSlashCount > 0) {
    result.h1h(ensureNotNull(slash));
  } else {
    var limit = _this__u8e3s4.e1h(get_ANY_SLASH());
    var tmp1_elvis_lhs = slash;
    var tmp;
    if (tmp1_elvis_lhs == null) {
      tmp = equalsLong(limit, new Long(-1, -1)) ? toSlash(Companion_getInstance_2().f1h_1) : toSlash_0(_this__u8e3s4.x1g(limit));
    } else {
      tmp = tmp1_elvis_lhs;
    }
    slash = tmp;
    if (startsWithVolumeLetterAndColon(_this__u8e3s4, slash)) {
      if (equalsLong(limit, new Long(2, 0))) {
        result.g1h(_this__u8e3s4, new Long(3, 0));
      } else {
        result.g1h(_this__u8e3s4, new Long(2, 0));
      }
    }
  }
  var absolute = compare(result.w1g_1, new Long(0, 0)) > 0;
  // Inline function 'kotlin.collections.mutableListOf' call
  var canonicalParts = ArrayList_init_$Create$();
  while (!_this__u8e3s4.i1h()) {
    var limit_0 = _this__u8e3s4.e1h(get_ANY_SLASH());
    var part;
    if (equalsLong(limit_0, new Long(-1, -1))) {
      part = _this__u8e3s4.k1h();
    } else {
      part = _this__u8e3s4.j1h(limit_0);
      _this__u8e3s4.d1h();
    }
    if (part.equals(get_DOT_DOT())) {
      if (!absolute || !canonicalParts.n())
        if (!normalize || (!absolute && (canonicalParts.n() || last(canonicalParts).equals(get_DOT_DOT())))) {
          canonicalParts.i(part);
        } else if (!windowsUncPath || canonicalParts.t() !== 1) {
          removeLastOrNull(canonicalParts);
        }
    } else if (!part.equals(get_DOT()) && !part.equals(Companion_getInstance_1().l1h_1)) {
      canonicalParts.i(part);
    }
  }
  var inductionVariable = 0;
  var last_0 = canonicalParts.t();
  if (inductionVariable < last_0)
    do {
      ...
      result.h1h(canonicalParts.v(i));
    }
     while (inductionVariable < last_0);
  if (equalsLong(result.w1g_1, new Long(0, 0))) {
    result.h1h(get_DOT());
  }
  return new Path(result.k1h());
}
...
function startsWithVolumeLetterAndColon(_this__u8e3s4, slash) {
  ...
  if (!slash.equals(get_BACKSLASH()))
    return false;
  if (compare(_this__u8e3s4.w1g_1, new Long(2, 0)) < 0)
    return false;
  var tmp = _this__u8e3s4.x1g(new Long(1, 0));
  // Inline function 'kotlin.code' call
  var this_0 = _Char___init__impl__6a9atx(58);
  var tmp$ret$0 = Char__toInt_impl_vasixd(this_0);
  if (!(tmp === toByte(tmp$ret$0)))
    return false;
  var b = numberToChar(_this__u8e3s4.x1g(new Long(0, 0)));
...
function _init_properties_Path_kt__cy3pvf() {
  if (!properties_initialized_Path_kt_a3g6iv) {
    ...
    SLASH = Companion_getInstance_1().m1h('/');
    BACKSLASH = Companion_getInstance_1().m1h('\\');
    ANY_SLASH = Companion_getInstance_1().m1h('/\\');
    DOT = Companion_getInstance_1().m1h('.');
    DOT_DOT = Companion_getInstance_1().m1h('..');
  }
}
function segment(_this__u8e3s4, pos) {
  var i = binarySearch(_this__u8e3s4.r1h_1, pos + 1 | 0, 0, _this__u8e3s4.q1h_1.length);
  return i >= 0 ? i : ~i;
}
...
function Companion_0() {
  ...
  this.s1h_1 = Companion_getInstance_2().t1h(get_tmpdir());
}
...
protoOf(FileSystem).v1h = function () {
};
function get_tmpdir() {
...
protoOf(ByteString).x1h = function (value) {
};
protoOf(ByteString).w1h = function (value) {
};
protoOf(ByteString).y1h = function () {
  // Inline function 'okio.internal.commonUtf8' call
  var result = this.u1g_1;
  if (result == null) {
    result = toUtf8String(this.z1h());
    this.w1h(result);
  }
  return result;
};
protoOf(ByteString).a1i = function () {
  // Inline function 'okio.internal.commonHex' call
  var result = charArray(imul(this.s1g_1.length, 2));
  var c = 0;
  var indexedObject = this.s1g_1;
  var inductionVariable = 0;
...
protoOf(ByteString).b1i = function (pos) {
  if (pos >= this.t() || pos < 0)
    throw new ArrayIndexOutOfBoundsException('size=' + this.t() + ' pos=' + pos);
  // Inline function 'okio.internal.commonGetByte' call
  return this.s1g_1[pos];
};
protoOf(ByteString).v = function (index) {
  return this.b1i(index);
};
protoOf(ByteString).t = function () {
  return this.c1i();
};
protoOf(ByteString).c1i = function () {
  // Inline function 'okio.internal.commonGetSize' call
  return this.s1g_1.length;
};
protoOf(ByteString).z1h = function () {
  // Inline function 'okio.internal.commonInternalArray' call
  return this.s1g_1;
};
protoOf(ByteString).d1i = function (buffer, offset, byteCount) {
  return commonWrite(this, buffer, offset, byteCount);
};
protoOf(ByteString).e1i = function (offset, other, otherOffset, byteCount) {
  // Inline function 'okio.internal.commonRangeEquals' call
  return offset >= 0 && offset <= (this.s1g_1.length - byteCount | 0) && otherOffset >= 0 && otherOffset <= (other.length - byteCount | 0) && arrayRangeEquals(this.s1g_1, offset, other, otherOffset, byteCount);
};
protoOf(ByteString).equals = function (other) {
  ...
  if (other === this) {
    ...
    if (other instanceof ByteString) {
      tmp = (other.t() === this.s1g_1.length && other.e1i(0, this.s1g_1, 0, this.s1g_1.length));
    } else {
      tmp = false;
    }
  }
...
protoOf(ByteString).hashCode = function () {
  ...
  $l$block: {
    ...
    var result = this.t1g_1;
    if (!(result === 0)) {
      tmp$ret$0 = result;
      break $l$block;
    }
    // Inline function 'kotlin.also' call
    var this_0 = contentHashCode(this.s1g_1);
    this.x1h(this_0);
    tmp$ret$0 = this_0;
  }
  return tmp$ret$0;
};
protoOf(ByteString).f1i = function (other) {
  var tmp$ret$3;
  $l$block_0: {
...
protoOf(ByteString).v1 = function (other) {
  return this.f1i(other instanceof ByteString ? other : THROW_CCE());
};
protoOf(ByteString).toString = function () {
  ...
  $l$block_1: {
    ...
    if (this.s1g_1.length === 0) {
      tmp$ret$1 = '[size=0]';
      break $l$block_1;
    }
    var i = access$codePointIndexToCharIndex$tByteStringKt(this.s1g_1, 64);
    if (i === -1) {
      var tmp;
      if (this.s1g_1.length <= 64) {
        tmp = '[hex=' + this.a1i() + ']';
      } else {
        var tmp_0 = this.s1g_1.length;
        var tmp$ret$8;
        $l$block_0: {
          ...
          // Inline function 'kotlin.require' call
          if (!(endIndex <= this.s1g_1.length)) {
            var message_0 = 'endIndex > length(' + this.s1g_1.length + ')';
          ...
          if (0 === 0 && endIndex === this.s1g_1.length) {
            tmp$ret$8 = this;
            break $l$block_0;
          }
          tmp$ret$8 = new ByteString(copyOfRange(this.s1g_1, 0, endIndex));
        }
        tmp = '[size=' + tmp_0 + ' hex=' + tmp$ret$8.a1i() + '\u2026]';
      }
      tmp$ret$1 = tmp;
      break $l$block_1;
    }
    ...
    var tmp_1;
    if (i < text.length) {
      tmp_1 = '[size=' + this.s1g_1.length + ' text=' + safeText + '\u2026]';
    } else {
      tmp_1 = '[text=' + safeText + ']';
    }
    tmp$ret$1 = tmp_1;
...
function toByteString($this) {
  return new ByteString($this.g1i());
}
function SegmentedByteString(segments, directory) {
  ByteString.call(this, Companion_getInstance_1().l1h_1.s1g_1);
  this.q1h_1 = segments;
  this.r1h_1 = directory;
}
protoOf(SegmentedByteString).a1i = function () {
  return toByteString(this).a1i();
};
protoOf(SegmentedByteString).b1i = function (pos) {
  // Inline function 'okio.internal.commonInternalGet' call
  checkOffsetAndCount(fromInt(this.r1h_1[this.q1h_1.length - 1 | 0]), fromInt(pos), new Long(1, 0));
  var segment_0 = segment(this, pos);
  var segmentOffset = segment_0 === 0 ? 0 : this.r1h_1[segment_0 - 1 | 0];
  var segmentPos = this.r1h_1[segment_0 + this.q1h_1.length | 0];
  return this.q1h_1[segment_0][(pos - segmentOffset | 0) + segmentPos | 0];
};
protoOf(SegmentedByteString).c1i = function () {
  // Inline function 'okio.internal.commonGetSize' call
  return this.r1h_1[this.q1h_1.length - 1 | 0];
};
protoOf(SegmentedByteString).g1i = function () {
  ...
  var segmentCount = this.q1h_1.length;
  var s = 0;
  var pos = 0;
  while (s < segmentCount) {
    var segmentPos = this.r1h_1[segmentCount + s | 0];
    var nextSegmentOffset = this.r1h_1[s];
    var tmp0 = this.q1h_1[s];
...
protoOf(SegmentedByteString).d1i = function (buffer, offset, byteCount) {
  // Inline function 'okio.internal.commonWrite' call
  var endIndex = offset + byteCount | 0;
  var s = segment(this, offset);
  var pos = offset;
  while (pos < endIndex) {
    var segmentOffset = s === 0 ? 0 : this.r1h_1[s - 1 | 0];
    var segmentSize = this.r1h_1[s] - segmentOffset | 0;
    var segmentPos = this.r1h_1[this.q1h_1.length + s | 0];
    // Inline function 'kotlin.comparisons.minOf' call
    var b = segmentOffset + segmentSize | 0;
    var byteCount_0 = Math.min(endIndex, b) - pos | 0;
    var offset_0 = segmentPos + (pos - segmentOffset | 0) | 0;
    var data = this.q1h_1[s];
    var segment_0 = Segment_init_$Create$_0(data, offset_0, offset_0 + byteCount_0 | 0, true, false);
    if (buffer.v1g_1 == null) {
      segment_0.f1g_1 = segment_0;
      segment_0.e1g_1 = segment_0.f1g_1;
      buffer.v1g_1 = segment_0.e1g_1;
    } else {
      ensureNotNull(ensureNotNull(buffer.v1g_1).f1g_1).k1g(segment_0);
    }
  ...
  var this_0 = buffer.w1g_1;
  tmp.w1g_1 = add(this_0, fromInt(byteCount));
  return Unit_instance;
};
protoOf(SegmentedByteString).h1i = function (offset, other, otherOffset, byteCount) {
  var tmp$ret$0;
  $l$block_0: {
    // Inline function 'okio.internal.commonRangeEquals' call
    ...
    while (pos < endIndex) {
      ...
      var offset_0 = segmentPos + (pos - segmentOffset | 0) | 0;
      var data = this.q1h_1[s];
      if (!other.e1i(otherOffset_0, data, offset_0, byteCount_0)) {
        tmp$ret$0 = false;
        break $l$block_0;
      }
...
protoOf(SegmentedByteString).e1i = function (offset, other, otherOffset, byteCount) {
  var tmp$ret$0;
  $l$block_0: {
    // Inline function 'okio.internal.commonRangeEquals' call
...
protoOf(SegmentedByteString).z1h = function () {
  return this.g1i();
};
protoOf(SegmentedByteString).equals = function (other) {
  ...
  if (other === this) {
    ...
    if (other instanceof ByteString) {
      tmp = (other.t() === this.t() && this.h1i(0, other, 0, this.t()));
    } else {
      tmp = false;
    }
  }
...
function UnsafeCursor() {
  ...
  this.j1i_1 = false;
  this.k1i_1 = null;
  this.l1i_1 = new Long(-1, -1);
  this.m1i_1 = null;
  this.n1i_1 = -1;
  this.o1i_1 = -1;
}
protoOf(UnsafeCursor).v1h = function () {
...
function Buffer() {
  this.v1g_1 = null;
  this.w1g_1 = new Long(0, 0);
}
protoOf(Buffer).i1h = function () {
  return equalsLong(this.w1g_1, new Long(0, 0));
};
protoOf(Buffer).x1g = function (pos) {
  var tmp$ret$0;
  $l$block_1: {
    // Inline function 'okio.internal.commonGet' call
    checkOffsetAndCount(this.w1g_1, pos, new Long(1, 0));
    // Inline function 'okio.internal.seek' call
    var tmp0_elvis_lhs = this.v1g_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      var offset = new Long(-1, -1);
      tmp$ret$0 = ensureNotNull(null).z1f_1[convertToInt(subtract(add(numberToLong(null.a1g_1), pos), offset))];
      break $l$block_1;
    } else {
      tmp = tmp0_elvis_lhs;
    }
    var s = tmp;
    if (compare(subtract(this.w1g_1, pos), pos) < 0) {
      var offset_0 = this.w1g_1;
      while (compare(offset_0, pos) > 0) {
        s = ensureNotNull(s.f1g_1);
        offset_0 = subtract(offset_0, fromInt(s.b1g_1 - s.a1g_1 | 0));
      }
      var tmp0 = s;
      var offset_1 = offset_0;
      tmp$ret$0 = ensureNotNull(tmp0).z1f_1[convertToInt(subtract(add(numberToLong(tmp0.a1g_1), pos), offset_1))];
      break $l$block_1;
    } else {
      ...
      $l$loop: while (true) {
        var tmp0_0 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other = s.b1g_1 - s.a1g_1 | 0;
        var nextOffset = add(tmp0_0, fromInt(other));
        if (compare(nextOffset, pos) > 0)
          break $l$loop;
        s = ensureNotNull(s.e1g_1);
        offset_2 = nextOffset;
      }
      var tmp0_1 = s;
      var offset_3 = offset_2;
      tmp$ret$0 = ensureNotNull(tmp0_1).z1f_1[convertToInt(subtract(add(numberToLong(tmp0_1.a1g_1), pos), offset_3))];
      break $l$block_1;
    }
  }
  return tmp$ret$0;
...
protoOf(Buffer).d1h = function () {
  ...
  if (equalsLong(this.w1g_1, new Long(0, 0)))
    throw EOFException_init_$Create$();
  var segment = ensureNotNull(this.v1g_1);
  var pos = segment.a1g_1;
  var limit = segment.b1g_1;
  var data = segment.z1f_1;
  var _unary__edvuaz = pos;
  pos = _unary__edvuaz + 1 | 0;
  var b = data[_unary__edvuaz];
  this.w1g_1 = subtract(this.w1g_1, new Long(1, 0));
  if (pos === limit) {
    this.v1g_1 = segment.j1g();
    SegmentPool_instance.r1g(segment);
  } else {
    segment.a1g_1 = pos;
  }
  return b;
...
protoOf(Buffer).k1h = function () {
  ...
  return this.j1h(this.w1g_1);
};
protoOf(Buffer).j1h = function (byteCount) {
  var tmp$ret$4;
  $l$block_0: {
    // Inline function 'okio.internal.commonReadByteString' call
    // Inline function 'kotlin.require' call
    ...
    if (compare(this.w1g_1, byteCount) < 0)
      throw EOFException_init_$Create$();
    if (compare(byteCount, new Long(4096, 0)) >= 0) {
      // Inline function 'kotlin.also' call
      var this_0 = this.q1i(convertToInt(byteCount));
      this.z1g(byteCount);
      tmp$ret$4 = this_0;
      break $l$block_0;
    } else {
      tmp$ret$4 = new ByteString(this.p1i(byteCount));
      break $l$block_0;
    }
  }
  return tmp$ret$4;
};
protoOf(Buffer).y1g = function (byteCount) {
  var tmp$ret$2;
  $l$block_0: {
    ...
    var s = ensureNotNull(this.v1g_1);
    if (compare(add(numberToLong(s.a1g_1), byteCount), fromInt(s.b1g_1)) > 0) {
      tmp$ret$2 = commonToUtf8String(this.p1i(byteCount));
      break $l$block_0;
    }
    var result = commonToUtf8String(s.z1f_1, s.a1g_1, s.a1g_1 + convertToInt(byteCount) | 0);
    s.a1g_1 = s.a1g_1 + convertToInt(byteCount) | 0;
    this.w1g_1 = subtract(this.w1g_1, byteCount);
    if (s.a1g_1 === s.b1g_1) {
      this.v1g_1 = s.j1g();
      SegmentPool_instance.r1g(s);
    }
    tmp$ret$2 = result;
  }
  return tmp$ret$2;
...
protoOf(Buffer).r1i = function () {
  ...
  var this_0 = _Char___init__impl__6a9atx(10);
  var tmp$ret$0 = Char__toInt_impl_vasixd(this_0);
  var newline = this.s1i(toByte(tmp$ret$0));
  return !equalsLong(newline, new Long(-1, -1)) ? readUtf8Line(this, newline) : !equalsLong(this.w1g_1, new Long(0, 0)) ? this.y1g(this.w1g_1) : null;
};
...
protoOf(Buffer).t1i = function (sink) {
  // Inline function 'okio.internal.commonReadFully' call
  var offset = 0;
  while (offset < sink.length) {
    var read = this.u1i(sink, offset, sink.length - offset | 0);
    if (read === -1)
      throw EOFException_init_$Create$();
...
protoOf(Buffer).u1i = function (sink, offset, byteCount) {
  var tmp$ret$0;
  $l$block: {
    ...
    var s = tmp;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = s.b1g_1 - s.a1g_1 | 0;
    var toCopy = Math.min(byteCount, b);
    var tmp0 = s.z1f_1;
    var tmp6 = s.a1g_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = s.a1g_1 + toCopy | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    s.a1g_1 = s.a1g_1 + toCopy | 0;
    this.w1g_1 = subtract(this.w1g_1, fromInt(toCopy));
    if (s.a1g_1 === s.b1g_1) {
      this.v1g_1 = s.j1g();
      SegmentPool_instance.r1g(s);
    }
...
protoOf(Buffer).z1g = function (byteCount) {
  ...
  while (compare(byteCount_0, new Long(0, 0)) > 0) {
    ...
    var b = head.b1g_1 - head.a1g_1 | 0;
    // Inline function 'kotlin.comparisons.minOf' call
    var b_0 = fromInt(b);
    var tmp$ret$1 = compare(tmp0, b_0) <= 0 ? tmp0 : b_0;
    var toSkip = convertToInt(tmp$ret$1);
    this.w1g_1 = subtract(this.w1g_1, fromInt(toSkip));
    byteCount_0 = subtract(byteCount_0, fromInt(toSkip));
    head.a1g_1 = head.a1g_1 + toSkip | 0;
    if (head.a1g_1 === head.b1g_1) {
      this.v1g_1 = head.j1g();
      SegmentPool_instance.r1g(head);
    }
  }
  return Unit_instance;
};
protoOf(Buffer).h1h = function (byteString) {
  // Inline function 'okio.internal.commonWrite' call
  var byteCount = byteString.t();
  byteString.d1i(this, 0, byteCount);
  return this;
};
protoOf(Buffer).v1i = function (minimumCapacity) {
  var tmp$ret$2;
  $l$block: {
    ...
    if (this.v1g_1 == null) {
      var result = SegmentPool_instance.o1g();
      this.v1g_1 = result;
      result.f1g_1 = result;
      result.e1g_1 = result;
      tmp$ret$2 = result;
    ...
    var tail = ensureNotNull(this.v1g_1).f1g_1;
    if ((ensureNotNull(tail).b1g_1 + minimumCapacity | 0) > 8192 || !tail.d1g_1) {
      tail = tail.k1g(SegmentPool_instance.o1g());
    }
    tmp$ret$2 = tail;
  }
  return tmp$ret$2;
};
protoOf(Buffer).b1h = function (string) {
  return this.w1i(string, 0, string.length);
};
protoOf(Buffer).w1i = function (string, beginIndex, endIndex) {
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      var tail = this.v1i(1);
      var data = tail.z1f_1;
      var segmentOffset = tail.b1g_1 - i | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      ...
      var runSize = (i + segmentOffset | 0) - tail.b1g_1 | 0;
      tail.b1g_1 = tail.b1g_1 + runSize | 0;
      this.w1g_1 = add(this.w1g_1, fromInt(runSize));
    } else if (c < 2048) {
      var tail_0 = this.v1i(2);
      tail_0.z1f_1[tail_0.b1g_1] = toByte(c >> 6 | 192);
      tail_0.z1f_1[tail_0.b1g_1 + 1 | 0] = toByte(c & 63 | 128);
      tail_0.b1g_1 = tail_0.b1g_1 + 2 | 0;
      this.w1g_1 = add(this.w1g_1, new Long(2, 0));
      i = i + 1 | 0;
    } else if (c < 55296 || c > 57343) {
      var tail_1 = this.v1i(3);
      tail_1.z1f_1[tail_1.b1g_1] = toByte(c >> 12 | 224);
      tail_1.z1f_1[tail_1.b1g_1 + 1 | 0] = toByte(c >> 6 & 63 | 128);
      tail_1.z1f_1[tail_1.b1g_1 + 2 | 0] = toByte(c & 63 | 128);
      tail_1.b1g_1 = tail_1.b1g_1 + 3 | 0;
      this.w1g_1 = add(this.w1g_1, new Long(3, 0));
      i = i + 1 | 0;
    } else {
      var tmp;
      if ((i + 1 | 0) < endIndex) {
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        var tail_2 = this.v1i(4);
        tail_2.z1f_1[tail_2.b1g_1] = toByte(codePoint >> 18 | 240);
        tail_2.z1f_1[tail_2.b1g_1 + 1 | 0] = toByte(codePoint >> 12 & 63 | 128);
        tail_2.z1f_1[tail_2.b1g_1 + 2 | 0] = toByte(codePoint >> 6 & 63 | 128);
        tail_2.z1f_1[tail_2.b1g_1 + 3 | 0] = toByte(codePoint & 63 | 128);
        tail_2.b1g_1 = tail_2.b1g_1 + 4 | 0;
        this.w1g_1 = add(this.w1g_1, new Long(4, 0));
        i = i + 2 | 0;
      }
    }
  }
...
protoOf(Buffer).a1h = function (source, offset, byteCount) {
  // Inline function 'okio.internal.commonWrite' call
  var offset_0 = offset;
  ...
  while (offset_0 < limit) {
    ...
    tail.b1g_1 = tail.b1g_1 + toCopy | 0;
  }
  this.w1g_1 = add(this.w1g_1, fromInt(byteCount));
  return this;
};
protoOf(Buffer).x1i = function (b) {
  // Inline function 'okio.internal.commonWriteByte' call
  var tail = this.v1i(1);
  var _unary__edvuaz = tail.b1g_1;
  tail.b1g_1 = _unary__edvuaz + 1 | 0;
  tail.z1f_1[_unary__edvuaz] = toByte(b);
  this.w1g_1 = add(this.w1g_1, new Long(1, 0));
  return this;
};
protoOf(Buffer).g1h = function (source, byteCount) {
  var tmp$ret$4;
  $l$block: {
    // Inline function 'okio.internal.commonWrite' call
    var byteCount_0 = byteCount;
    ...
    checkOffsetAndCount(source.w1g_1, new Long(0, 0), byteCount_0);
    while (compare(byteCount_0, new Long(0, 0)) > 0) {
      if (compare(byteCount_0, fromInt(ensureNotNull(source.v1g_1).b1g_1 - ensureNotNull(source.v1g_1).a1g_1 | 0)) < 0) {
        var tail = !(this.v1g_1 == null) ? ensureNotNull(this.v1g_1).f1g_1 : null;
        var tmp;
        if (!(tail == null) && tail.d1g_1) {
          var tmp0 = byteCount_0;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.b1g_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.c1g_1 ? 0 : tail.a1g_1;
        ...
        if (tmp) {
          ensureNotNull(source.v1g_1).q1g(tail, convertToInt(byteCount_0));
          source.w1g_1 = subtract(source.w1g_1, byteCount_0);
          this.w1g_1 = add(this.w1g_1, byteCount_0);
          tmp$ret$4 = Unit_instance;
          break $l$block;
        } else {
          source.v1g_1 = ensureNotNull(source.v1g_1).l1g(convertToInt(byteCount_0));
        }
      }
      var segmentToMove = source.v1g_1;
      var movedByteCount = fromInt(ensureNotNull(segmentToMove).b1g_1 - segmentToMove.a1g_1 | 0);
      source.v1g_1 = segmentToMove.j1g();
      if (this.v1g_1 == null) {
        this.v1g_1 = segmentToMove;
        segmentToMove.f1g_1 = segmentToMove;
        segmentToMove.e1g_1 = segmentToMove.f1g_1;
      } else {
        var tail_0 = ensureNotNull(this.v1g_1).f1g_1;
        tail_0 = ensureNotNull(tail_0).k1g(segmentToMove);
        tail_0.p1g();
      }
      source.w1g_1 = subtract(source.w1g_1, movedByteCount);
      this.w1g_1 = add(this.w1g_1, movedByteCount);
...
protoOf(Buffer).y1i = function (sink, byteCount) {
  var tmp$ret$2;
  $l$block: {
    // Inline function 'okio.internal.commonRead' call
    var byteCount_0 = byteCount;
    ...
    if (compare(byteCount_0, this.w1g_1) > 0)
      byteCount_0 = this.w1g_1;
    sink.g1h(this, byteCount_0);
    tmp$ret$2 = byteCount_0;
  }
  return tmp$ret$2;
};
protoOf(Buffer).s1i = function (b) {
  return this.z1i(b, new Long(0, 0), new Long(-1, 2147483647));
};
protoOf(Buffer).z1i = function (b, fromIndex, toIndex) {
  var tmp$ret$2;
  $l$block_8: {
    ...
    if (!(compare(new Long(0, 0), fromIndex_0) <= 0 ? compare(fromIndex_0, toIndex_0) <= 0 : false)) {
      var message = 'size=' + this.w1g_1.toString() + ' fromIndex=' + fromIndex_0.toString() + ' toIndex=' + toIndex_0.toString();
      throw IllegalArgumentException_init_$Create$(toString(message));
    }
    if (compare(toIndex_0, this.w1g_1) > 0)
      toIndex_0 = this.w1g_1;
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      while (compare(offset_0, toIndex_0) < 0) {
        var data = s.z1f_1;
        var tmp0 = fromInt(s.b1g_1);
        // Inline function 'kotlin.comparisons.minOf' call
        var b_0 = subtract(add(numberToLong(s.a1g_1), toIndex_0), offset_0);
        var tmp$ret$3 = compare(tmp0, b_0) <= 0 ? tmp0 : b_0;
        var limit = convertToInt(tmp$ret$3);
        var pos = convertToInt(subtract(add(numberToLong(s.a1g_1), fromIndex_0), offset_0));
        while (pos < limit) {
          if (data[pos] === b) {
            tmp$ret$2 = add(numberToLong(pos - s.a1g_1 | 0), offset_0);
            break $l$block_8;
          }
          pos = pos + 1 | 0;
        }
        offset_0 = add(offset_0, fromInt(s.b1g_1 - s.a1g_1 | 0));
    ...
    var s_0 = tmp;
    if (compare(subtract(this.w1g_1, fromIndex_1), fromIndex_1) < 0) {
      var offset_1 = this.w1g_1;
      while (compare(offset_1, fromIndex_1) > 0) {
        s_0 = ensureNotNull(s_0.f1g_1);
        offset_1 = subtract(offset_1, fromInt(s_0.b1g_1 - s_0.a1g_1 | 0));
      }
      var tmp0_0 = s_0;
      ...
      while (compare(offset_3, toIndex_0) < 0) {
        var data_0 = s_1.z1f_1;
        var tmp0_1 = fromInt(s_1.b1g_1);
        // Inline function 'kotlin.comparisons.minOf' call
        var b_1 = subtract(add(numberToLong(s_1.a1g_1), toIndex_0), offset_3);
        var tmp$ret$5 = compare(tmp0_1, b_1) <= 0 ? tmp0_1 : b_1;
        var limit_0 = convertToInt(tmp$ret$5);
        var pos_0 = convertToInt(subtract(add(numberToLong(s_1.a1g_1), fromIndex_0), offset_3));
        while (pos_0 < limit_0) {
          if (data_0[pos_0] === b) {
            tmp$ret$2 = add(numberToLong(pos_0 - s_1.a1g_1 | 0), offset_3);
            break $l$block_8;
          }
          pos_0 = pos_0 + 1 | 0;
        }
        offset_3 = add(offset_3, fromInt(s_1.b1g_1 - s_1.a1g_1 | 0));
        fromIndex_0 = offset_3;
        s_1 = ensureNotNull(s_1.e1g_1);
      }
      tmp$ret$2 = new Long(-1, -1);
      break $l$block_8;
    } else {
      ...
      while (compare(offset_6, toIndex_0) < 0) {
        var data_1 = s_2.z1f_1;
        var tmp0_4 = fromInt(s_2.b1g_1);
        // Inline function 'kotlin.comparisons.minOf' call
        var b_2 = subtract(add(numberToLong(s_2.a1g_1), toIndex_0), offset_6);
        var tmp$ret$7 = compare(tmp0_4, b_2) <= 0 ? tmp0_4 : b_2;
        var limit_1 = convertToInt(tmp$ret$7);
        var pos_1 = convertToInt(subtract(add(numberToLong(s_2.a1g_1), fromIndex_0), offset_6));
        while (pos_1 < limit_1) {
          if (data_1[pos_1] === b) {
            tmp$ret$2 = add(numberToLong(pos_1 - s_2.a1g_1 | 0), offset_6);
            break $l$block_8;
          }
          pos_1 = pos_1 + 1 | 0;
        }
        offset_6 = add(offset_6, fromInt(s_2.b1g_1 - s_2.a1g_1 | 0));
        fromIndex_0 = offset_6;
        s_2 = ensureNotNull(s_2.e1g_1);
      }
      tmp$ret$2 = new Long(-1, -1);
      break $l$block_8;
    }
...
protoOf(Buffer).e1h = function (targetBytes) {
  return this.a1j(targetBytes, new Long(0, 0));
};
protoOf(Buffer).a1j = function (targetBytes, fromIndex) {
  var tmp$ret$2;
  $l$block_10: {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      if (targetBytes.t() === 2) {
        ...
        while (compare(offset_0, this.w1g_1) < 0) {
          var data = s.z1f_1;
          var pos = convertToInt(subtract(add(numberToLong(s.a1g_1), fromIndex_0), offset_0));
          var limit = s.b1g_1;
          while (pos < limit) {
        ...
        var targetByteArray = targetBytes.z1h();
        while (compare(offset_0, this.w1g_1) < 0) {
          var data_0 = s.z1f_1;
          var pos_0 = convertToInt(subtract(add(numberToLong(s.a1g_1), fromIndex_0), offset_0));
          var limit_0 = s.b1g_1;
          while (pos_0 < limit_0) {
            ...
            while (inductionVariable < last) {
              ...
              inductionVariable = inductionVariable + 1 | 0;
              if (b_0 === t) {
                tmp$ret$2 = add(numberToLong(pos_0 - s.a1g_1 | 0), offset_0);
                break $l$block_10;
              }
            }
            pos_0 = pos_0 + 1 | 0;
    ...
    if (compare(subtract(this.w1g_1, fromIndex_1), fromIndex_1) < 0) {
      ...
      if (targetBytes.t() === 2) {
        ...
        while (compare(offset_3, this.w1g_1) < 0) {
          var data_1 = s_1.z1f_1;
          var pos_1 = convertToInt(subtract(add(numberToLong(s_1.a1g_1), fromIndex_0), offset_3));
          var limit_1 = s_1.b1g_1;
          while (pos_1 < limit_1) {
            var b_1 = data_1[pos_1];
            if (b_1 === b0_0 || b_1 === b1_0) {
              tmp$ret$2 = add(numberToLong(pos_1 - s_1.a1g_1 | 0), offset_3);
              break $l$block_10;
            }
            pos_1 = pos_1 + 1 | 0;
          }
        ...
        var targetByteArray_0 = targetBytes.z1h();
        while (compare(offset_3, this.w1g_1) < 0) {
          var data_2 = s_1.z1f_1;
          var pos_2 = convertToInt(subtract(add(numberToLong(s_1.a1g_1), fromIndex_0), offset_3));
          var limit_2 = s_1.b1g_1;
          while (pos_2 < limit_2) {
            ...
            while (inductionVariable_0 < last_0) {
              ...
              if (b_2 === t_0) {
                tmp$ret$2 = add(numberToLong(pos_2 - s_1.a1g_1 | 0), offset_3);
                break $l$block_10;
              }
            }
            pos_2 = pos_2 + 1 | 0;
      ...
      if (targetBytes.t() === 2) {
        ...
        while (compare(offset_6, this.w1g_1) < 0) {
          var data_3 = s_2.z1f_1;
          var pos_3 = convertToInt(subtract(add(numberToLong(s_2.a1g_1), fromIndex_0), offset_6));
          var limit_3 = s_2.b1g_1;
          while (pos_3 < limit_3) {
            var b_3 = data_3[pos_3];
            if (b_3 === b0_1 || b_3 === b1_1) {
              tmp$ret$2 = add(numberToLong(pos_3 - s_2.a1g_1 | 0), offset_6);
              break $l$block_10;
            }
            pos_3 = pos_3 + 1 | 0;
          }
        ...
        var targetByteArray_1 = targetBytes.z1h();
        while (compare(offset_6, this.w1g_1) < 0) {
          var data_4 = s_2.z1f_1;
          var pos_4 = convertToInt(subtract(add(numberToLong(s_2.a1g_1), fromIndex_0), offset_6));
          var limit_4 = s_2.b1g_1;
          while (pos_4 < limit_4) {
            ...
            while (inductionVariable_1 < last_1) {
              ...
              if (b_4 === t_1) {
                tmp$ret$2 = add(numberToLong(pos_4 - s_2.a1g_1 | 0), offset_6);
                break $l$block_10;
              }
            }
            pos_4 = pos_4 + 1 | 0;
...
protoOf(Buffer).c1h = function (offset, bytes) {
  return this.b1j(offset, bytes, 0, bytes.t());
};
protoOf(Buffer).b1j = function (offset, bytes, bytesOffset, byteCount) {
  var tmp$ret$0;
  $l$block_0: {
    // Inline function 'okio.internal.commonRangeEquals' call
    if (compare(offset, new Long(0, 0)) < 0 || bytesOffset < 0 || byteCount < 0 || compare(subtract(this.w1g_1, offset), fromInt(byteCount)) < 0 || (bytes.t() - bytesOffset | 0) < byteCount) {
      tmp$ret$0 = false;
      break $l$block_0;
    }
    var inductionVariable = 0;
    if (inductionVariable < byteCount)
      do {
        ...
        if (!(this.x1g(tmp$ret$1) === bytes.v(bytesOffset + i | 0))) {
          tmp$ret$0 = false;
          break $l$block_0;
        }
      }
...
protoOf(Buffer).equals = function (other) {
  ...
  $l$block_3: {
    ...
    if (!equalsLong(this.w1g_1, other.w1g_1)) {
      tmp$ret$0 = false;
      break $l$block_3;
    }
    if (equalsLong(this.w1g_1, new Long(0, 0))) {
    ...
    var sa = ensureNotNull(this.v1g_1);
    var sb = ensureNotNull(other.v1g_1);
    var posA = sa.a1g_1;
    var posB = sb.a1g_1;
    var pos = new Long(0, 0);
    var count;
    while (compare(pos, this.w1g_1) < 0) {
      var tmp0 = sa.b1g_1 - posA | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = sb.b1g_1 - posB | 0;
      ...
      if (posA === sa.b1g_1) {
        sa = ensureNotNull(sa.e1g_1);
        posA = sa.a1g_1;
      }
      if (posB === sb.b1g_1) {
        sb = ensureNotNull(sb.e1g_1);
        posB = sb.a1g_1;
      }
      pos = add(pos, count);
    }
...
protoOf(Buffer).hashCode = function () {
  ...
  $l$block: {
    ...
    do {
      ...
      var limit = s.b1g_1;
      while (pos < limit) {
        result = imul(31, result) + s.z1f_1[pos] | 0;
        pos = pos + 1 | 0;
      }
      s = ensureNotNull(s.e1g_1);
    }
...
protoOf(Buffer).toString = function () {
  return this.c1j().toString();
};
protoOf(Buffer).c1j = function () {
  // Inline function 'okio.internal.commonSnapshot' call
  // Inline function 'kotlin.check' call
  if (!(compare(this.w1g_1, new Long(2147483647, 0)) <= 0)) {
    var message = 'size > Int.MAX_VALUE: ' + this.w1g_1.toString();
    throw IllegalStateException_init_$Create$(toString(message));
  }
  return this.q1i(convertToInt(this.w1g_1));
};
protoOf(Buffer).q1i = function (byteCount) {
  ...
  $l$block: {
    // Inline function 'okio.internal.commonSnapshot' call
    if (byteCount === 0) {
      tmp$ret$0 = Companion_getInstance_1().l1h_1;
      break $l$block;
    }
    checkOffsetAndCount(this.w1g_1, new Long(0, 0), fromInt(byteCount));
    var offset = 0;
    var segmentCount = 0;
    var s = this.v1g_1;
    while (offset < byteCount) {
      if (ensureNotNull(s).b1g_1 === s.a1g_1) {
        throw AssertionError_init_$Create$('s.limit == s.pos');
      }
      offset = offset + (s.b1g_1 - s.a1g_1 | 0) | 0;
    ...
    s = this.v1g_1;
    while (offset < byteCount) {
      segments[segmentCount] = ensureNotNull(s).z1f_1;
      offset = offset + (s.b1g_1 - s.a1g_1 | 0) | 0;
      var tmp = segmentCount;
      // Inline function 'kotlin.comparisons.minOf' call
      var a = offset;
      directory[tmp] = Math.min(a, byteCount);
      directory[segmentCount + segments.length | 0] = s.a1g_1;
      s.c1g_1 = true;
      segmentCount = segmentCount + 1 | 0;
      s = s.e1g_1;
    }
...
protoOf(Companion_2).d1j = function (_this__u8e3s4, normalize) {
  return commonToPath(_this__u8e3s4, normalize);
};
protoOf(Companion_2).t1h = function (_this__u8e3s4, normalize, $super) {
  normalize = normalize === VOID ? false : normalize;
  return $super === VOID ? this.d1j(_this__u8e3s4, normalize) : $super.d1j.call(this, _this__u8e3s4, normalize);
};
...
protoOf(Path).f1j = function (other) {
  // Inline function 'okio.internal.commonCompareTo' call
  return this.e1j_1.f1i(other.e1j_1);
};
protoOf(Path).v1 = function (other) {
  return this.f1j(other instanceof Path ? other : THROW_CCE());
};
...
protoOf(RealBufferedSource).y1i = function (sink, byteCount) {
  var tmp$ret$4;
  $l$block_0: {
    // Inline function 'okio.internal.commonRead' call
    // Inline function 'kotlin.require' call
    ...
    if (equalsLong(this.i1j_1.w1g_1, new Long(0, 0))) {
      if (equalsLong(byteCount, new Long(0, 0))) {
        tmp$ret$4 = new Long(0, 0);
        break $l$block_0;
      }
      var read = this.g1j_1.y1i(this.i1j_1, new Long(8192, 0));
    ...
    // Inline function 'kotlin.comparisons.minOf' call
    var b = this.i1j_1.w1g_1;
    var toRead = compare(byteCount, b) <= 0 ? byteCount : b;
    tmp$ret$4 = this.i1j_1.y1i(sink, toRead);
  }
  return tmp$ret$4;
};
protoOf(RealBufferedSource).j1j = function (byteCount) {
  // Inline function 'okio.internal.commonRequire' call
  if (!this.k1j(byteCount))
    throw EOFException_init_$Create$();
  return Unit_instance;
};
protoOf(RealBufferedSource).k1j = function (byteCount) {
  var tmp$ret$4;
  $l$block: {
    ...
    while (compare(this.i1j_1.w1g_1, byteCount) < 0) {
      if (equalsLong(this.g1j_1.y1i(this.i1j_1, new Long(8192, 0)), new Long(-1, -1))) {
        tmp$ret$4 = false;
        break $l$block;
      }
    }
...
protoOf(RealBufferedSource).y1g = function (byteCount) {
  // Inline function 'okio.internal.commonReadUtf8' call
  this.j1j(byteCount);
  return this.i1j_1.y1g(byteCount);
};
protoOf(RealBufferedSource).r1i = function () {
  // Inline function 'okio.internal.commonReadUtf8Line' call
  // Inline function 'kotlin.code' call
  var this_0 = _Char___init__impl__6a9atx(10);
  var tmp$ret$0 = Char__toInt_impl_vasixd(this_0);
  ...
  if (equalsLong(newline, new Long(-1, -1))) {
    var tmp_0;
    if (!equalsLong(this.i1j_1.w1g_1, new Long(0, 0))) {
      tmp_0 = this.y1g(this.i1j_1.w1g_1);
    } else {
      tmp_0 = null;
    }
    tmp = tmp_0;
  } else {
    tmp = readUtf8Line(this.i1j_1, newline);
  }
  return tmp;
};
protoOf(RealBufferedSource).s1i = function (b) {
  return this.z1i(b, new Long(0, 0), new Long(-1, 2147483647));
};
protoOf(RealBufferedSource).z1i = function (b, fromIndex, toIndex) {
  var tmp$ret$4;
  $l$block_0: {
    // Inline function 'okio.internal.commonIndexOf' call
    var fromIndex_0 = fromIndex;
    ...
    while (compare(fromIndex_0, toIndex) < 0) {
      var result = this.i1j_1.z1i(b, fromIndex_0, toIndex);
      if (!equalsLong(result, new Long(-1, -1))) {
        tmp$ret$4 = result;
        break $l$block_0;
      }
      var lastBufferSize = this.i1j_1.w1g_1;
      if (compare(lastBufferSize, toIndex) >= 0 || equalsLong(this.g1j_1.y1i(this.i1j_1, new Long(8192, 0)), new Long(-1, -1))) {
        tmp$ret$4 = new Long(-1, -1);
        break $l$block_0;
      }
...
protoOf(RealBufferedSource).v1h = function () {
  var tmp$ret$0;
  $l$block: {
    // Inline function 'okio.internal.commonClose' call
    if (this.h1j_1) {
...
protoOf(RealBufferedSource).toString = function () {
  // Inline function 'okio.internal.commonToString' call
  return 'buffer(' + toString(this.g1j_1) + ')';
};
function SegmentPool() {
  this.m1g_1 = 0;
  this.n1g_1 = 0;
}
protoOf(SegmentPool).o1g = function () {
  return Segment_init_$Create$();
};
protoOf(SegmentPool).r1g = function (segment) {
};
