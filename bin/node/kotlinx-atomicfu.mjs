...
protoOf(atomicfu$AtomicRefArray$ref).w1k = function () {
  return this.v1k_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.v1k_1[index];
};
...
protoOf(AtomicRef).x1k = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).y1k = function () {
...
protoOf(AtomicBoolean).z1k = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).y1k = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).a1l = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicLong).y1k = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).b1l = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).y1k = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).w1k);
//endregion
