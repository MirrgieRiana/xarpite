...
protoOf(atomicfu$AtomicRefArray$ref).q1m = function () {
...
protoOf(AtomicRef).r1m = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).s1m = function () {
...
protoOf(AtomicBoolean).t1m = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).s1m = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).s1m = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).v1m = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).s1m = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).q1m);
//endregion
