...
protoOf(atomicfu$AtomicRefArray$ref).l1p = function () {
  return this.k1p_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.k1p_1[index];
};
...
protoOf(AtomicRef).m1p = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).n1p = function () {
...
protoOf(AtomicBoolean).o1p = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).n1p = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).p1p = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).n1p = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).q1p = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicLong).n1p = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).l1p);
//endregion
