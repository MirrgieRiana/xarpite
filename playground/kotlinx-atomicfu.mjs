...
protoOf(atomicfu$AtomicRefArray$ref).c1i = function () {
  return this.b1i_1.length;
};
protoOf(atomicfu$AtomicRefArray$ref).atomicfu$get = function (index) {
  return this.b1i_1[index];
};
...
protoOf(AtomicRef).d1i = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicRef).e1i = function () {
...
protoOf(AtomicBoolean).f1i = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicBoolean).e1i = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicLong).g1i = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicLong).e1i = function () {
  return this.kotlinx$atomicfu$value;
};
...
protoOf(AtomicInt).h1i = function (_set____db54di) {
  this.kotlinx$atomicfu$value = _set____db54di;
};
protoOf(AtomicInt).e1i = function () {
  return this.kotlinx$atomicfu$value;
};
...
defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).c1i);
//endregion
