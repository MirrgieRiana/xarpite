...
function AbstractCoroutine(parentContext, initParentJob, active) {
  ...
  if (initParentJob) {
    this.k1i(parentContext.x8(Key_instance_2));
  }
  this.n1i_1 = parentContext.tf(this);
}
protoOf(AbstractCoroutine).q8 = function () {
  return this.n1i_1;
};
protoOf(AbstractCoroutine).o1i = function () {
  return this.n1i_1;
};
protoOf(AbstractCoroutine).p1i = function () {
  return protoOf(JobSupport).p1i.call(this);
};
protoOf(AbstractCoroutine).q1i = function (value) {
};
protoOf(AbstractCoroutine).r1i = function (cause, handled) {
};
protoOf(AbstractCoroutine).s1i = function () {
  return get_classSimpleName(this) + ' was cancelled';
};
protoOf(AbstractCoroutine).t1i = function (state) {
  if (state instanceof CompletedExceptionally) {
    this.r1i(state.u1i_1, state.w1i());
  } else {
    this.q1i((state == null ? true : !(state == null)) ? state : THROW_CCE());
  }
};
protoOf(AbstractCoroutine).v8 = function (result) {
  var state = this.x1i(toState_0(result));
  if (state === get_COMPLETING_WAITING_CHILDREN())
    return Unit_instance;
  this.y1i(state);
};
protoOf(AbstractCoroutine).y1i = function (state) {
  return this.z1i(state);
};
protoOf(AbstractCoroutine).a1j = function (exception) {
  handleCoroutineException(this.n1i_1, exception);
};
protoOf(AbstractCoroutine).b1j = function () {
  var tmp0_elvis_lhs = get_coroutineName(this.n1i_1);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return protoOf(JobSupport).b1j.call(this);
  } else {
    tmp = tmp0_elvis_lhs;
  }
  var coroutineName = tmp;
  return '"' + coroutineName + '":' + protoOf(JobSupport).b1j.call(this);
};
protoOf(AbstractCoroutine).c1j = function (start, receiver, block) {
  start.f1j(block, receiver, this);
};
function launch(_this__u8e3s4, context, start, block) {
  context = context === VOID ? EmptyCoroutineContext_getInstance() : context;
  start = start === VOID ? CoroutineStart_DEFAULT_getInstance() : start;
  var newContext = newCoroutineContext(_this__u8e3s4, context);
  var coroutine = start.o1k() ? new LazyStandaloneCoroutine(newContext, block) : new StandaloneCoroutine(newContext, true);
  coroutine.c1j(start, coroutine, block);
  return coroutine;
}
function async(_this__u8e3s4, context, start, block) {
  ...
  start = start === VOID ? CoroutineStart_DEFAULT_getInstance() : start;
  var newContext = newCoroutineContext(_this__u8e3s4, context);
  var coroutine = start.o1k() ? new LazyDeferredCoroutine(newContext, block) : new DeferredCoroutine(newContext, true);
  coroutine.c1j(start, coroutine, block);
  return coroutine;
}
...
function LazyStandaloneCoroutine(parentContext, block) {
  ...
  this.v1k_1 = createCoroutineUnintercepted(block, this, this);
}
protoOf(LazyStandaloneCoroutine).n1j = function () {
  startCoroutineCancellable(this.v1k_1, this);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this.e1l_1.n1k(this);
...
protoOf(DeferredCoroutine).i1l = function () {
  var tmp = this.m1k();
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(DeferredCoroutine).j1l = function ($completion) {
...
function LazyDeferredCoroutine(parentContext, block) {
  ...
  this.n1l_1 = createCoroutineUnintercepted(block, this, this);
}
protoOf(LazyDeferredCoroutine).n1j = function () {
  startCoroutineCancellable(this.n1l_1, this);
};
...
protoOf(DisposeOnCancel).z1l = function (cause) {
  return this.y1l_1.a1m();
};
protoOf(DisposeOnCancel).toString = function () {
  return 'DisposeOnCancel[' + toString(this.y1l_1) + ']';
};
function getOrCreateCancellableContinuation(delegate) {
  if (!(delegate instanceof DispatchedContinuation)) {
    return new CancellableContinuationImpl(delegate, 1);
  }
  var tmp0_safe_receiver = delegate.h1m();
  var tmp;
...
function _get_parentHandle__f8dcex($this) {
  return $this.w1l_1.kotlinx$atomicfu$value;
}
function _get_stateDebugRepresentation__bf18u4($this) {
  var tmp0_subject = $this.j1j();
  var tmp;
...
function isReusable($this) {
  var tmp;
  if (get_isReusableMode($this.k1m_1)) {
    var tmp_0 = $this.s1l_1;
    tmp = (tmp_0 instanceof DispatchedContinuation ? tmp_0 : THROW_CCE()).j1m();
  } else {
    tmp = false;
  }
  return tmp;
...
function cancelLater($this, cause) {
  ...
  return dispatched.l1m(cause);
}
function callSegmentOnCancellation($this, segment, cause) {
  // Inline function 'kotlinx.coroutines.index' call
  var index = $this.u1l_1.kotlinx$atomicfu$value & 536870911;
  ...
  try {
    segment.q1m(index, cause, $this.q8());
  } catch ($p) {
  ...
  while (true) {
    ...
    switch (cur >> 29) {
      case 0:
        ...
        if ($this.u1l_1.atomicfu$compareAndSet(cur, tmp$ret$2))
          return true;
        break;
      case 2:
        return false;
...
function installParentHandle($this) {
  ...
  $this.w1l_1.atomicfu$compareAndSet(null, handle);
  return handle;
}
function invokeOnCancellationImpl($this, handler) {
  ...
  while (true) {
    ...
    if (state instanceof Active) {
      if ($this.v1l_1.atomicfu$compareAndSet(state, handler))
        return Unit_instance;
    } else {
      var tmp;
      ...
      if (tmp) {
        ...
        if (state instanceof CompletedExceptionally) {
          ...
          if (state instanceof CancelledContinuation) {
            ...
            var cause = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.u1i_1;
            if (isInterface(handler, CancelHandler)) {
              $this.w1m(handler, cause);
            } else {
          ...
          if (state instanceof CompletedContinuation) {
            ...
            if (!isInterface(handler, CancelHandler))
              THROW_CCE();
            if (state.x1m()) {
              $this.w1m(handler, state.v1m_1);
              return Unit_instance;
            }
            var update = state.y1m(VOID, handler);
            if ($this.v1l_1.atomicfu$compareAndSet(state, update))
              return Unit_instance;
          } else {
            if (handler instanceof Segment)
              return Unit_instance;
            ...
            if ($this.v1l_1.atomicfu$compareAndSet(state, update_0))
              return Unit_instance;
          }
        }
      }
  ...
  while (true) {
    ...
    $l$block: {
      if (!(tmp0 == null) ? isInterface(tmp0, NotCompleted) : false) {
        var update = resumedState($this, tmp0, proposedUpdate, $this.k1m_1, onCancellation, idempotent);
        if (!$this.v1l_1.atomicfu$compareAndSet(tmp0, update)) {
          break $l$block;
        }
        ...
        if (tmp0 instanceof CompletedContinuation) {
          var tmp;
          if (!(idempotent == null) && tmp0.u1m_1 === idempotent) {
            // Inline function 'kotlinx.coroutines.assert' call
...
function CancellableContinuationImpl(delegate, resumeMode) {
  ...
  this.s1l_1 = delegate;
  // Inline function 'kotlinx.coroutines.assert' call
  this.t1l_1 = this.s1l_1.q8();
  var tmp = this;
  // Inline function 'kotlinx.coroutines.decisionAndIndex' call
  var tmp$ret$1 = (0 << 29) + 536870911 | 0;
  tmp.u1l_1 = atomic$int$1(tmp$ret$1);
  this.v1l_1 = atomic$ref$1(Active_instance);
  this.w1l_1 = atomic$ref$1(null);
}
...
protoOf(CancellableContinuationImpl).j1j = function () {
  return this.v1l_1.kotlinx$atomicfu$value;
};
...
protoOf(CancellableContinuationImpl).c1n = function () {
  ...
  if (this.k1j()) {
    handle.a1m();
    this.w1l_1.kotlinx$atomicfu$value = NonDisposableHandle_instance;
  }
};
protoOf(CancellableContinuationImpl).i1m = function () {
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  var state = this.v1l_1.kotlinx$atomicfu$value;
  // Inline function 'kotlinx.coroutines.assert' call
  var tmp;
  if (state instanceof CompletedContinuation) {
    tmp = !(state.u1m_1 == null);
  } else {
    tmp = false;
  }
  if (tmp) {
  ...
  var tmp_0 = this.u1l_1;
  // Inline function 'kotlinx.coroutines.decisionAndIndex' call
  tmp_0.kotlinx$atomicfu$value = (0 << 29) + 536870911 | 0;
  this.v1l_1.kotlinx$atomicfu$value = Active_instance;
  return true;
};
protoOf(CancellableContinuationImpl).d1n = function () {
  return this.j1j();
};
protoOf(CancellableContinuationImpl).e1n = function (takenState, cause) {
  var this_0 = this.v1l_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (!(state == null) ? isInterface(state, NotCompleted) : false) {
      ...
      if (state instanceof CompletedExceptionally)
        ...
        if (state instanceof CompletedContinuation) {
          ...
          var update = state.y1m(VOID, VOID, VOID, VOID, cause);
          if (this.v1l_1.atomicfu$compareAndSet(state, update)) {
            state.f1n(this, cause);
            return Unit_instance;
          }
        } else {
          if (this.v1l_1.atomicfu$compareAndSet(state, new CompletedContinuation(state, VOID, VOID, VOID, cause))) {
            return Unit_instance;
          }
        }
      }
...
protoOf(CancellableContinuationImpl).g1n = function (cause) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.v1l_1;
  while (true) {
    var tmp0 = this_0.kotlinx$atomicfu$value;
    $l$block: {
      ...
      detachChildIfNonReusable(this);
      dispatchResume(this, this.k1m_1);
      return true;
    }
  }
};
protoOf(CancellableContinuationImpl).h1n = function (cause) {
  if (cancelLater(this, cause))
    return Unit_instance;
  this.g1n(cause);
  detachChildIfNonReusable(this);
};
protoOf(CancellableContinuationImpl).w1m = function (handler, cause) {
  // Inline function 'kotlinx.coroutines.CancellableContinuationImpl.callCancelHandlerSafely' call
  try {
    handler.z1l(cause);
  } catch ($p) {
...
protoOf(CancellableContinuationImpl).i1n = function (onCancellation, cause, value) {
  try {
...
protoOf(CancellableContinuationImpl).j1n = function (parent) {
  return parent.o1j();
};
protoOf(CancellableContinuationImpl).k1n = function () {
  ...
  var state = this.j1j();
  if (state instanceof CompletedExceptionally)
    throw recoverStackTrace(state.u1i_1, this);
  if (get_isCancellableMode(this.k1m_1)) {
    var job = this.q8().x8(Key_instance_2);
    if (!(job == null) && !job.p1i()) {
      var cause = job.o1j();
      this.e1n(state, cause);
      throw recoverStackTrace(cause, this);
    }
  }
  return this.m1n(state);
};
protoOf(CancellableContinuationImpl).l1n = function () {
  var tmp = this.s1l_1;
  var tmp0_safe_receiver = tmp instanceof DispatchedContinuation ? tmp : null;
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.n1n(this);
  var tmp_0;
  if (tmp1_elvis_lhs == null) {
    return Unit_instance;
  } else {
  ...
  this.a1n();
  this.g1n(cancellationCause);
};
protoOf(CancellableContinuationImpl).v8 = function (result) {
  return this.o1n(toState(result, this), this.k1m_1);
};
protoOf(CancellableContinuationImpl).p1n = function (value, onCancellation) {
  return this.q1n(value, this.k1m_1, onCancellation);
};
protoOf(CancellableContinuationImpl).r1n = function (segment, index) {
  var tmp0 = this.u1l_1;
  $l$block: {
...
protoOf(CancellableContinuationImpl).x1l = function (handler) {
  return invokeOnCancellationImpl(this, handler);
};
protoOf(CancellableContinuationImpl).q1n = function (proposedUpdate, resumeMode, onCancellation) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.v1l_1;
  while (true) {
    var tmp0 = this_0.kotlinx$atomicfu$value;
        ...
        if (tmp0 instanceof CancelledContinuation) {
          if (tmp0.v1n()) {
            if (onCancellation == null)
              ...
              this.i1n(onCancellation, tmp0.u1i_1, proposedUpdate);
            }
            return Unit_instance;
          }
        }
...
protoOf(CancellableContinuationImpl).o1n = function (proposedUpdate, resumeMode, onCancellation, $super) {
  onCancellation = onCancellation === VOID ? null : onCancellation;
  var tmp;
  if ($super === VOID) {
    this.q1n(proposedUpdate, resumeMode, onCancellation);
    tmp = Unit_instance;
  } else {
    tmp = $super.q1n.call(this, proposedUpdate, resumeMode, onCancellation);
  }
  return tmp;
};
protoOf(CancellableContinuationImpl).a1n = function () {
...
protoOf(CancellableContinuationImpl).o1l = function (value, idempotent, onCancellation) {
  return tryResumeImpl(this, value, idempotent, onCancellation);
};
protoOf(CancellableContinuationImpl).p1l = function (token) {
  // Inline function 'kotlinx.coroutines.assert' call
  dispatchResume(this, this.k1m_1);
};
protoOf(CancellableContinuationImpl).q1l = function (_this__u8e3s4, value) {
  var tmp = this.s1l_1;
  var dc = tmp instanceof DispatchedContinuation ? tmp : null;
  var tmp_0;
  if ((dc == null ? null : dc.c1m_1) === _this__u8e3s4) {
    tmp_0 = 4;
  } else {
    tmp_0 = this.k1m_1;
  }
  this.o1n(value, tmp_0);
};
protoOf(CancellableContinuationImpl).m1n = function (state) {
  var tmp;
  if (state instanceof CompletedContinuation) {
    var tmp_0 = state.r1m_1;
...
protoOf(CancellableContinuationImpl).w1n = function (state) {
  var tmp0_safe_receiver = protoOf(DispatchedTask).w1n.call(this, state);
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
    // Inline function 'kotlin.let' call
    tmp = recoverStackTrace(tmp0_safe_receiver, this.s1l_1);
  }
  return tmp;
};
protoOf(CancellableContinuationImpl).toString = function () {
  return this.x1n() + '(' + toDebugString(this.s1l_1) + '){' + _get_stateDebugRepresentation__bf18u4(this) + '}@' + get_hexAddress(this);
};
...
function CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
  ...
  this.r1m_1 = result;
  this.s1m_1 = cancelHandler;
  this.t1m_1 = onCancellation;
  this.u1m_1 = idempotentResume;
  this.v1m_1 = cancelCause;
}
protoOf(CompletedContinuation).x1m = function () {
  return !(this.v1m_1 == null);
};
protoOf(CompletedContinuation).f1n = function (cont, cause) {
  var tmp0_safe_receiver = this.s1m_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    cont.w1m(tmp0_safe_receiver, cause);
  }
  var tmp1_safe_receiver = this.t1m_1;
  if (tmp1_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    cont.i1n(tmp1_safe_receiver, cause, this.r1m_1);
  }
};
protoOf(CompletedContinuation).a1o = function (result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
  return new CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause);
};
protoOf(CompletedContinuation).y1m = function (result, cancelHandler, onCancellation, idempotentResume, cancelCause, $super) {
  result = result === VOID ? this.r1m_1 : result;
  cancelHandler = cancelHandler === VOID ? this.s1m_1 : cancelHandler;
  onCancellation = onCancellation === VOID ? this.t1m_1 : onCancellation;
  idempotentResume = idempotentResume === VOID ? this.u1m_1 : idempotentResume;
  cancelCause = cancelCause === VOID ? this.v1m_1 : cancelCause;
  return $super === VOID ? this.a1o(result, cancelHandler, onCancellation, idempotentResume, cancelCause) : $super.a1o.call(this, result, cancelHandler, onCancellation, idempotentResume, cancelCause);
};
protoOf(CompletedContinuation).toString = function () {
  return 'CompletedContinuation(result=' + toString_0(this.r1m_1) + ', cancelHandler=' + toString_0(this.s1m_1) + ', onCancellation=' + toString_0(this.t1m_1) + ', idempotentResume=' + toString_0(this.u1m_1) + ', cancelCause=' + toString_0(this.v1m_1) + ')';
};
protoOf(CompletedContinuation).hashCode = function () {
  var result = this.r1m_1 == null ? 0 : hashCode(this.r1m_1);
  result = imul(result, 31) + (this.s1m_1 == null ? 0 : hashCode(this.s1m_1)) | 0;
  ...
  result = imul(result, 31) + (this.v1m_1 == null ? 0 : hashCode(this.v1m_1)) | 0;
  return result;
};
...
protoOf(ChildContinuation).g1o = function () {
  return true;
};
protoOf(ChildContinuation).z1l = function (cause) {
  this.f1o_1.h1n(this.f1o_1.j1n(this.l1o()));
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this.b1p_1.n1k(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(CompletableDeferredImpl).v1j = function () {
  return true;
};
protoOf(CompletableDeferredImpl).i1l = function () {
  var tmp = this.m1k();
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(CompletableDeferredImpl).j1l = function ($completion) {
  var tmp = new $awaitCOROUTINE$_0(this, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(CompletableDeferredImpl).e1p = function (value) {
  return this.e1k(value);
};
protoOf(CompletableDeferredImpl).f1p = function (exception) {
  return this.e1k(new CompletedExceptionally(exception));
};
function CompletedExceptionally(cause, handled) {
  handled = handled === VOID ? false : handled;
  this.u1i_1 = cause;
  this.v1i_1 = atomic$boolean$1(handled);
}
protoOf(CompletedExceptionally).w1i = function () {
  return this.v1i_1.kotlinx$atomicfu$value;
};
protoOf(CompletedExceptionally).z1m = function () {
  return this.v1i_1.atomicfu$compareAndSet(false, true);
};
protoOf(CompletedExceptionally).toString = function () {
  return get_classSimpleName(this) + '[' + this.u1i_1.toString() + ']';
};
function CancelledContinuation(continuation, cause, handled) {
  CompletedExceptionally.call(this, cause == null ? CancellationException_init_$Create$('Continuation ' + toString(continuation) + ' was cancelled normally') : cause, handled);
  this.u1n_1 = atomic$boolean$1(false);
}
protoOf(CancelledContinuation).v1n = function () {
  return this.u1n_1.atomicfu$compareAndSet(false, true);
};
...
function recoverResult(state, uCont) {
  ...
  if (state instanceof CompletedExceptionally) {
    ...
    var exception = recoverStackTrace(state.u1i_1, uCont);
...
protoOf(CoroutineDispatcher).h1p = function (context) {
  return true;
};
protoOf(CoroutineDispatcher).j1p = function (context, block) {
...
function handleCoroutineException(context, exception) {
  ...
  try {
    ...
    if (tmp0_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      tmp0_safe_receiver.m1p(context, reportException);
      return Unit_instance;
    }
  } catch ($p) {
    if ($p instanceof Error) {
...
function MainScope() {
  return new ContextScope(SupervisorJob().tf(Dispatchers_getInstance().r1p()));
}
...
protoOf(GlobalScope).o1i = function () {
...
protoOf(CoroutineStart).f1j = function (block, receiver, completion) {
  var tmp;
  switch (this.q2_1) {
    case 0:
...
protoOf(CoroutineStart).o1k = function () {
...
function delay(timeMillis, $completion) {
  ...
  if (compare(timeMillis, new Long(-1, 2147483647)) < 0) {
    get_delay(cancellable.q8()).s1p(timeMillis, cancellable);
  }
  return cancellable.k1n();
}
...
function EventLoop() {
  ...
  this.u1p_1 = new Long(0, 0);
  this.v1p_1 = false;
  this.w1p_1 = null;
}
protoOf(EventLoop).x1p = function () {
...
protoOf(EventLoop).y1p = function (task) {
  var tmp0_elvis_lhs = this.w1p_1;
  var tmp;
  if (tmp0_elvis_lhs == null) {
...
protoOf(EventLoop).z1p = function () {
  return compare(this.u1p_1, delta(this, true)) >= 0;
};
protoOf(EventLoop).a1q = function () {
  var tmp0_safe_receiver = this.w1p_1;
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.k();
  return tmp1_elvis_lhs == null ? true : tmp1_elvis_lhs;
};
protoOf(EventLoop).b1q = function (unconfined) {
  this.u1p_1 = add(this.u1p_1, delta(this, unconfined));
  if (!unconfined)
    this.v1p_1 = true;
};
protoOf(EventLoop).c1q = function (unconfined) {
  this.u1p_1 = subtract(this.u1p_1, delta(this, unconfined));
  if (compare(this.u1p_1, new Long(0, 0)) > 0)
    return Unit_instance;
  // Inline function 'kotlinx.coroutines.assert' call
  if (this.v1p_1) {
    this.d1q();
...
protoOf(EventLoop).d1q = function () {
};
function ThreadLocalEventLoop() {
  ThreadLocalEventLoop_instance = this;
  this.e1q_1 = commonThreadLocal(new Symbol('ThreadLocalEventLoop'));
}
protoOf(ThreadLocalEventLoop).f1q = function () {
  var tmp0_elvis_lhs = this.e1q_1.h1q();
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.also' call
    var this_0 = createEventLoop();
    ThreadLocalEventLoop_getInstance().e1q_1.i1q(this_0);
    tmp = this_0;
  } else {
    tmp = tmp0_elvis_lhs;
  }
...
protoOf(NonDisposableHandle).i1j = function () {
  return null;
};
protoOf(NonDisposableHandle).a1m = function () {
};
protoOf(NonDisposableHandle).a1k = function (cause) {
  return false;
};
...
function invokeOnCompletion(_this__u8e3s4, invokeImmediately, handler) {
  ...
  if (_this__u8e3s4 instanceof JobSupport) {
    tmp = _this__u8e3s4.t1j(invokeImmediately, handler);
  } else {
    var tmp_0 = handler.g1o();
    tmp = _this__u8e3s4.s1j(tmp_0, invokeImmediately, JobNode$invoke$ref(handler));
  }
  return tmp;
}
function ensureActive_0(_this__u8e3s4) {
  if (!_this__u8e3s4.p1i())
    throw _this__u8e3s4.o1j();
}
...
protoOf(Empty).p1i = function () {
  return this.j1q_1;
};
protoOf(Empty).m1o = function () {
  return null;
};
protoOf(Empty).toString = function () {
  return 'Empty{' + (this.j1q_1 ? 'Active' : 'New') + '}';
};
function Incomplete() {
}
function NodeList() {
...
protoOf(NodeList).p1i = function () {
  return true;
};
protoOf(NodeList).m1o = function () {
  return this;
};
protoOf(NodeList).n1q = function (state) {
...
protoOf(NodeList).toString = function () {
  return get_DEBUG() ? this.n1q('Active') : protoOf(LockFreeLinkedListHead).toString.call(this);
};
function JobNode() {
  LockFreeLinkedListNode.call(this);
}
protoOf(JobNode).l1o = function () {
  var tmp = this.k1o_1;
  if (!(tmp == null))
    return tmp;
  else {
...
protoOf(JobNode).p1i = function () {
  return true;
};
protoOf(JobNode).m1o = function () {
  return null;
};
protoOf(JobNode).a1m = function () {
  return this.l1o().u1j(this);
};
protoOf(JobNode).toString = function () {
  return get_classSimpleName(this) + '@' + get_hexAddress(this) + '[job@' + get_hexAddress(this.l1o()) + ']';
};
function _set_exceptionsHolder__tqm22h($this, value) {
  $this.s1q_1.kotlinx$atomicfu$value = value;
}
function _get_exceptionsHolder__nhszp($this) {
  return $this.s1q_1.kotlinx$atomicfu$value;
}
...
function finalizeFinishingState($this, state, proposedUpdate) {
  ...
  var proposedException = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.u1i_1;
  var wasCancelling;
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  wasCancelling = state.t1q();
  var exceptions = state.u1q(proposedException);
  ...
  if (!(finalException == null)) {
    ...
    if (handled) {
      (finalState instanceof CompletedExceptionally ? finalState : THROW_CCE()).z1m();
    }
  }
  if (!wasCancelling) {
  ...
  $this.t1i(finalState);
  var casSuccess = $this.i1i_1.atomicfu$compareAndSet(state, boxIncomplete(finalState));
  // Inline function 'kotlinx.coroutines.assert' call
...
function getFinalRootCause($this, state, exceptions) {
  if (exceptions.k()) {
    if (state.t1q()) {
      ...
      return new JobCancellationException(null == null ? $this.s1i() : null, null, $this);
    }
    return null;
  }
  var tmp$ret$2;
...
function tryFinalizeSimpleState($this, state, update) {
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  if (!$this.i1i_1.atomicfu$compareAndSet(state, boxIncomplete(update)))
    return false;
  $this.g1k(null);
  $this.t1i(update);
...
function completeStateFinalization($this, state, update) {
  var tmp0_safe_receiver = $this.h1j();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    tmp0_safe_receiver.a1m();
    $this.g1j(NonDisposableHandle_instance);
  }
  ...
  if (state instanceof JobNode) {
    try {
      ...
      if ($p instanceof Error) {
        var ex = $p;
        $this.a1j(new CompletionHandlerException('Exception in completion handler ' + state.toString() + ' for ' + $this.toString(), ex));
      } else {
        throw $p;
      }
    }
  } else {
    var tmp2_safe_receiver = state.m1o();
...
function cancelParent($this, cause) {
  ...
  return parent.a1k(cause) || isCancellation;
}
...
function startInternal($this, state) {
  if (state instanceof Empty) {
    if (state.j1q_1)
      return 0;
    if (!$this.i1i_1.atomicfu$compareAndSet(state, get_EMPTY_ACTIVE()))
      return -1;
    $this.n1j();
    return 1;
  } else {
    if (state instanceof InactiveNodeList) {
      if (!$this.i1i_1.atomicfu$compareAndSet(state, state.v1q_1))
        return -1;
      $this.n1j();
      return 1;
    } else {
...
function promoteEmptyToNodeList($this, state) {
  ...
  var update = state.j1q_1 ? list : new InactiveNodeList(list);
  $this.i1i_1.atomicfu$compareAndSet(state, update);
}
function promoteSingleToNodeList($this, state) {
  state.s1o(new NodeList());
  // Inline function 'kotlinx.coroutines.internal.LockFreeLinkedListNode.nextNode' call
  var list = state.n1o_1;
  $this.i1i_1.atomicfu$compareAndSet(state, list);
}
...
function createCauseException($this, cause) {
  ...
  if (cause == null ? true : cause instanceof Error) {
    ...
    if (cause == null) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      tmp_0 = new JobCancellationException(null == null ? $this.s1i() : null, null, $this);
    } else {
      tmp_0 = cause;
    }
    tmp = tmp_0;
  } else {
    tmp = ((!(cause == null) ? isInterface(cause, ParentJob) : false) ? cause : THROW_CCE()).d1k();
  }
  return tmp;
}
    ...
    $l$block: {
      if (tmp0 instanceof Finishing) {
        ...
        if (notifyRootCause == null)
          ...
          // Inline function 'kotlin.let' call
          notifyCancelling($this, tmp0.p1q_1, notifyRootCause);
        }
        return get_COMPLETING_ALREADY();
      } else {
...
function tryMakeCancelling($this, state, rootCause) {
  ...
  if (!$this.i1i_1.atomicfu$compareAndSet(state, cancelling))
    return false;
...
function tryMakeCompletingSlowPath($this, state, proposedUpdate) {
  ...
  finishing.a1r(true);
  if (!(finishing === state)) {
    if (!$this.i1i_1.atomicfu$compareAndSet(state, finishing))
      return get_COMPLETING_RETRY();
  }
  // Inline function 'kotlinx.coroutines.assert' call
  var wasCancelling = finishing.t1q();
  var tmp0_safe_receiver = proposedUpdate instanceof CompletedExceptionally ? proposedUpdate : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    finishing.y1q(tmp0_safe_receiver.u1i_1);
  }
  // Inline function 'kotlin.takeIf' call
  var this_0 = finishing.z1q();
  var tmp_0;
  if (!wasCancelling) {
    tmp_0 = this_0;
  } else {
...
function _get_exceptionOrNull__b3j7js($this, _this__u8e3s4) {
  ...
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.u1i_1;
}
function tryWaitForChild($this, state, child, proposedUpdate) {
  ...
  $l$1: do {
    $l$0: do {
      var handle = invokeOnCompletion(child_0.f1r_1, false, new ChildCompletion($this_0, state_0, child_0, proposedUpdate_0));
...
function stateString($this, state) {
  var tmp;
  if (state instanceof Finishing) {
    tmp = state.t1q() ? 'Cancelling' : state.w1q() ? 'Completing' : 'Active';
  } else {
    if (!(state == null) ? isInterface(state, Incomplete) : false) {
      tmp = state.p1i() ? 'Active' : 'New';
    } else {
      if (state instanceof CompletedExceptionally) {
        tmp = 'Cancelled';
      } else {
...
function Finishing(list, isCompleting, rootCause) {
  ...
  this.p1q_1 = list;
  this.q1q_1 = atomic$boolean$1(isCompleting);
  this.r1q_1 = atomic$ref$1(rootCause);
  this.s1q_1 = atomic$ref$1(null);
}
protoOf(Finishing).m1o = function () {
  return this.p1q_1;
};
protoOf(Finishing).a1r = function (value) {
  this.q1q_1.kotlinx$atomicfu$value = value;
};
protoOf(Finishing).w1q = function () {
  return this.q1q_1.kotlinx$atomicfu$value;
};
protoOf(Finishing).g1r = function (value) {
  this.r1q_1.kotlinx$atomicfu$value = value;
};
protoOf(Finishing).z1q = function () {
  return this.r1q_1.kotlinx$atomicfu$value;
};
protoOf(Finishing).x1q = function () {
  return _get_exceptionsHolder__nhszp(this) === get_SEALED();
};
protoOf(Finishing).t1q = function () {
  return !(this.z1q() == null);
};
protoOf(Finishing).p1i = function () {
  return this.z1q() == null;
};
protoOf(Finishing).u1q = function (proposedException) {
...
protoOf(Finishing).y1q = function (exception) {
  var rootCause = this.z1q();
  if (rootCause == null) {
    this.g1r(exception);
    return Unit_instance;
...
protoOf(Finishing).toString = function () {
  return 'Finishing[cancelling=' + this.t1q() + ', completing=' + this.w1q() + ', rootCause=' + toString_0(this.z1q()) + ', exceptions=' + toString_0(_get_exceptionsHolder__nhszp(this)) + ', list=' + this.p1q_1.toString() + ']';
};
function ChildCompletion(parent, state, child, proposedUpdate) {
  ...
  this.m1r_1 = state;
  this.n1r_1 = child;
  this.o1r_1 = proposedUpdate;
}
protoOf(ChildCompletion).g1o = function () {
  return false;
};
protoOf(ChildCompletion).z1l = function (cause) {
  continueCompleting(this.l1r_1, this.m1r_1, this.n1r_1, this.o1r_1);
};
function AwaitContinuation(delegate, job) {
  CancellableContinuationImpl.call(this, delegate, 1);
  this.v1r_1 = job;
}
protoOf(AwaitContinuation).j1n = function (parent) {
  var state = this.v1r_1.j1j();
  if (state instanceof Finishing) {
    var tmp0_safe_receiver = state.z1q();
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
...
protoOf(AwaitContinuation).x1n = function () {
...
function JobSupport(active) {
  this.i1i_1 = atomic$ref$1(active ? get_EMPTY_ACTIVE() : get_EMPTY_NEW());
  this.j1i_1 = atomic$ref$1(null);
}
protoOf(JobSupport).l2 = function () {
  return Key_instance_2;
};
protoOf(JobSupport).g1j = function (value) {
  this.j1i_1.kotlinx$atomicfu$value = value;
};
protoOf(JobSupport).h1j = function () {
  return this.j1i_1.kotlinx$atomicfu$value;
};
protoOf(JobSupport).i1j = function () {
  var tmp0_safe_receiver = this.h1j();
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.i1j();
};
protoOf(JobSupport).k1i = function (parent) {
  // Inline function 'kotlinx.coroutines.assert' call
  if (parent == null) {
    this.g1j(NonDisposableHandle_instance);
    return Unit_instance;
...
protoOf(JobSupport).j1j = function () {
  return this.i1i_1.kotlinx$atomicfu$value;
};
protoOf(JobSupport).p1i = function () {
  var state = this.j1j();
  var tmp;
  if (!(state == null) ? isInterface(state, Incomplete) : false) {
    tmp = state.p1i();
...
protoOf(JobSupport).k1j = function () {
  var tmp = this.j1j();
  return !(!(tmp == null) ? isInterface(tmp, Incomplete) : false);
};
protoOf(JobSupport).l1j = function () {
  var state = this.j1j();
  var tmp;
  if (state instanceof CompletedExceptionally) {
    tmp = true;
...
protoOf(JobSupport).m1j = function () {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var state = this.j1j();
...
protoOf(JobSupport).n1j = function () {
};
protoOf(JobSupport).o1j = function () {
  ...
  if (state instanceof Finishing) {
    var tmp0_safe_receiver = state.z1q();
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : this.p1j(tmp0_safe_receiver, get_classSimpleName(this) + ' is cancelling');
    var tmp_0;
    if (tmp1_elvis_lhs == null) {
...
protoOf(JobSupport).p1j = function (_this__u8e3s4, message) {
  var tmp0_elvis_lhs = _this__u8e3s4 instanceof CancellationException ? _this__u8e3s4 : null;
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
    tmp = new JobCancellationException(message == null ? this.s1i() : message, _this__u8e3s4, this);
  } else {
    tmp = tmp0_elvis_lhs;
  }
  return tmp;
};
protoOf(JobSupport).q1j = function (_this__u8e3s4, message, $super) {
  message = message === VOID ? null : message;
  return $super === VOID ? this.p1j(_this__u8e3s4, message) : $super.p1j.call(this, _this__u8e3s4, message);
};
protoOf(JobSupport).r1j = function (handler) {
  return this.t1j(true, new InvokeOnCompletion(handler));
};
protoOf(JobSupport).s1j = function (onCancelling, invokeImmediately, handler) {
  var tmp;
  if (onCancelling) {
  ...
  return this.t1j(invokeImmediately, tmp);
};
protoOf(JobSupport).t1j = function (invokeImmediately, node) {
  node.k1o_1 = this;
  var tmp$ret$0;
  $l$block_1: {
    ...
    while (true) {
      ...
      if (state instanceof Empty) {
        if (state.j1q_1) {
          if (this.i1i_1.atomicfu$compareAndSet(state, node)) {
            tmp$ret$0 = true;
            break $l$block_1;
          }
        } else {
        ...
        if (!(state == null) ? isInterface(state, Incomplete) : false) {
          ...
          if (list == null) {
            ...
            if (node.g1o()) {
              ...
              var rootCause = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.z1q();
              var tmp_0;
              if (rootCause == null) {
                tmp_0 = list.q1o(node, 5);
              } else {
  ...
  if (added)
    ...
    node.z1l(tmp0_safe_receiver_0 == null ? null : tmp0_safe_receiver_0.u1i_1);
  }
  return NonDisposableHandle_instance;
};
protoOf(JobSupport).u1j = function (node) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var state = this.j1j();
    if (state instanceof JobNode) {
...
protoOf(JobSupport).v1j = function () {
  return false;
};
protoOf(JobSupport).w1j = function (cause) {
  var tmp;
  if (cause == null) {
    // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
    tmp = new JobCancellationException(null == null ? this.s1i() : null, null, this);
  } else {
    tmp = cause;
  }
  this.y1j(tmp);
};
protoOf(JobSupport).s1i = function () {
  return 'Job was cancelled';
};
protoOf(JobSupport).y1j = function (cause) {
  this.c1k(cause);
};
protoOf(JobSupport).z1j = function (parentJob) {
  this.c1k(parentJob);
};
protoOf(JobSupport).a1k = function (cause) {
  if (cause instanceof CancellationException)
    return true;
  return this.c1k(cause) && this.i1k();
};
protoOf(JobSupport).b1k = function (cause) {
  return this.c1k(cause);
};
...
protoOf(JobSupport).d1k = function () {
  var state = this.j1j();
  var tmp;
  if (state instanceof Finishing) {
    tmp = state.z1q();
...
protoOf(JobSupport).e1k = function (proposedUpdate) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var tmp0 = this.j1j();
    $l$block: {
...
protoOf(JobSupport).x1i = function (proposedUpdate) {
  // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
  while (true) {
    var tmp0 = this.j1j();
    $l$block: {
      ...
      if (state instanceof Empty) {
        ...
        if (!(state == null) ? isInterface(state, Incomplete) : false) {
          ...
          if (list == null) {
            ...
            var addedBeforeCancellation = list.q1o(node, 7);
            var tmp;
            if (addedBeforeCancellation) {
              tmp = true;
            } else {
              var addedBeforeCompletion = list.q1o(node, 3);
              var latestState = this.j1j();
              var tmp_0;
              if (latestState instanceof Finishing) {
                tmp_0 = latestState.z1q();
              } else {
                // Inline function 'kotlinx.coroutines.assert' call
                var tmp0_safe_receiver = latestState instanceof CompletedExceptionally ? latestState : null;
                tmp_0 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.u1i_1;
              }
              var rootCause = tmp_0;
              node.z1l(rootCause);
              var tmp_1;
...
protoOf(JobSupport).a1j = function (exception) {
  throw exception;
};
...
protoOf(JobSupport).t1i = function (state) {
};
protoOf(JobSupport).z1i = function (state) {
};
protoOf(JobSupport).toString = function () {
  return this.k1k() + '@' + get_hexAddress(this);
};
protoOf(JobSupport).k1k = function () {
  return this.b1j() + '{' + stateString(this, this.j1j()) + '}';
};
protoOf(JobSupport).b1j = function () {
...
protoOf(JobSupport).n1k = function ($completion) {
  $l$loop: while (true) {
    var state = this.j1j();
    if (!(!(state == null) ? isInterface(state, Incomplete) : false)) {
      if (state instanceof CompletedExceptionally) {
...
protoOf(InactiveNodeList).m1o = function () {
  return this.v1q_1;
};
protoOf(InactiveNodeList).p1i = function () {
  return false;
};
protoOf(InactiveNodeList).toString = function () {
  return get_DEBUG() ? this.v1q_1.n1q('New') : anyToString(this);
};
function InvokeOnCompletion(handler) {
  JobNode.call(this);
  this.a1s_1 = handler;
}
protoOf(InvokeOnCompletion).g1o = function () {
  return false;
};
protoOf(InvokeOnCompletion).z1l = function (cause) {
  return this.a1s_1(cause);
};
function InvokeOnCancelling(handler) {
  JobNode.call(this);
  this.f1s_1 = handler;
  this.g1s_1 = atomic$boolean$1(false);
}
protoOf(InvokeOnCancelling).g1o = function () {
  return true;
};
protoOf(InvokeOnCancelling).z1l = function (cause) {
  if (this.g1s_1.atomicfu$compareAndSet(false, true))
    this.f1s_1(cause);
};
...
protoOf(ChildHandleNode).i1j = function () {
  return this.l1o();
};
protoOf(ChildHandleNode).g1o = function () {
  return true;
};
protoOf(ChildHandleNode).z1l = function (cause) {
  return this.f1r_1.z1j(this.l1o());
};
protoOf(ChildHandleNode).a1k = function (cause) {
  return this.l1o().a1k(cause);
};
function unboxState(_this__u8e3s4) {
  _init_properties_JobSupport_kt__68f172();
  var tmp0_safe_receiver = _this__u8e3s4 instanceof IncompleteStateBox ? _this__u8e3s4 : null;
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.h1s_1;
  return tmp1_elvis_lhs == null ? _this__u8e3s4 : tmp1_elvis_lhs;
}
function ResumeAwaitOnCompletion(continuation) {
  JobNode.call(this);
  this.m1s_1 = continuation;
}
protoOf(ResumeAwaitOnCompletion).g1o = function () {
  return false;
};
protoOf(ResumeAwaitOnCompletion).z1l = function (cause) {
  var state = this.l1o().j1j();
  // Inline function 'kotlinx.coroutines.assert' call
  if (state instanceof CompletedExceptionally) {
    var tmp0 = this.m1s_1;
    // Inline function 'kotlin.coroutines.resumeWithException' call
    // Inline function 'kotlin.Companion.failure' call
    var exception = state.u1i_1;
    var tmp$ret$1 = _Result___init__impl__xyqfz8(createFailure(exception));
    tmp0.v8(tmp$ret$1);
  } else {
    var tmp0_0 = this.m1s_1;
...
function handlesExceptionF($this) {
  ...
  while (true) {
    if (parentJob.i1k())
      return true;
    var tmp_1 = parentJob.h1j();
    var tmp2_safe_receiver = tmp_1 instanceof ChildHandleNode ? tmp_1 : null;
    var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.l1o();
    var tmp_2;
...
function JobImpl(parent) {
  JobSupport.call(this, true);
  this.k1i(parent);
  this.p1s_1 = handlesExceptionF(this);
}
protoOf(JobImpl).v1j = function () {
  return true;
};
...
protoOf(MainCoroutineDispatcher).toString = function () {
  var tmp0_elvis_lhs = this.s1s();
  return tmp0_elvis_lhs == null ? get_classSimpleName(this) + '@' + get_hexAddress(this) : tmp0_elvis_lhs;
};
protoOf(MainCoroutineDispatcher).s1s = function () {
  var main = Dispatchers_getInstance().r1p();
  if (this === main)
...
protoOf(SupervisorJobImpl).a1k = function (cause) {
  return false;
};
...
protoOf(Unconfined).h1p = function (context) {
  return false;
};
protoOf(Unconfined).i1p = function (context, block) {
  var yieldContext = context.x8(Key_instance_3);
  if (!(yieldContext == null)) {
    yieldContext.y1s_1 = true;
    return Unit_instance;
  }
...
function yield_0($completion) {
  ...
  $l$block_0: {
    ...
    var cont = tmp_0;
    if (safeIsDispatchNeeded(cont.c1m_1, context)) {
      cont.z1s(context, Unit_instance);
    } else {
      var yieldContext = new YieldContext();
      cont.z1s(context.tf(yieldContext), Unit_instance);
      if (yieldContext.y1s_1) {
...
function setElementLazy($this, index, value) {
  ...
  $this.f1t_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value = value;
}
function ChannelSegment(id, prev, channel, pointers) {
  Segment.call(this, id, prev, pointers);
  this.e1t_1 = channel;
  this.f1t_1 = atomicfu$AtomicRefArray$ofNulls(imul(get_SEGMENT_SIZE(), 2));
}
protoOf(ChannelSegment).g1t = function () {
  return ensureNotNull(this.e1t_1);
};
protoOf(ChannelSegment).h1t = function () {
  return get_SEGMENT_SIZE();
};
protoOf(ChannelSegment).i1t = function (index, element) {
  setElementLazy(this, index, element);
};
protoOf(ChannelSegment).j1t = function (index) {
  var tmp = this.f1t_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value;
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(ChannelSegment).k1t = function (index) {
  // Inline function 'kotlin.also' call
  var this_0 = this.j1t(index);
  this.l1t(index);
  return this_0;
};
protoOf(ChannelSegment).l1t = function (index) {
  setElementLazy(this, index, null);
};
protoOf(ChannelSegment).m1t = function (index) {
  return this.f1t_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value;
};
protoOf(ChannelSegment).n1t = function (index, value) {
  this.f1t_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value = value;
};
protoOf(ChannelSegment).o1t = function (index, from, to) {
  return this.f1t_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$compareAndSet(from, to);
};
protoOf(ChannelSegment).p1t = function (index, update) {
  return this.f1t_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$getAndSet(update);
};
protoOf(ChannelSegment).q1m = function (index, cause, context) {
  var isSender = index >= get_SEGMENT_SIZE();
  var index_0 = isSender ? index - get_SEGMENT_SIZE() | 0 : index;
  var element = this.j1t(index_0);
  $l$loop: while (true) {
    var cur = this.m1t(index_0);
    var tmp;
    ...
    if (tmp) {
      ...
      if (this.o1t(index_0, cur, update)) {
        this.l1t(index_0);
        this.c1u(index_0, !isSender);
        if (isSender) {
          var tmp0_safe_receiver = this.g1t().r1t_1;
          if (tmp0_safe_receiver == null)
            null;
          else {
      ...
      if (cur === get_INTERRUPTED_SEND() || cur === get_INTERRUPTED_RCV()) {
        this.l1t(index_0);
        if (isSender) {
          var tmp1_safe_receiver = this.g1t().r1t_1;
          if (tmp1_safe_receiver == null)
            null;
          else {
...
protoOf(ChannelSegment).c1u = function (index, receiver) {
  if (receiver) {
    var tmp = this.g1t();
    var tmp0 = this.o1m_1;
...
function onClosedHasNext($this) {
  $this.q1u_1 = get_CHANNEL_CLOSED();
  var tmp0_elvis_lhs = $this.s1u_1.t1u();
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
...
function hasNextOnNoWaiterSuspend($this, segment, index, r, $completion) {
  ...
  try {
    ...
    if (updCellResult === get_SUSPEND()) {
      ...
      if (compare(r, this_0.u1u()) < 0) {
        segment.o1u();
      }
      $l$block_0: {
        // Inline function 'kotlinx.coroutines.channels.BufferedChannel.receiveImpl' call
        var segment_0 = this_0.x1t_1.kotlinx$atomicfu$value;
        $l$loop_0: while (true) {
          if (this_0.v1u()) {
            onClosedHasNextNoWaiterSuspend($this);
            break $l$block_0;
          }
          var r_0 = this_0.t1t_1.atomicfu$getAndIncrement$long();
          ...
          if (!equalsLong(segment_0.o1m_1, id)) {
          ...
          if (updCellResult_0 === get_SUSPEND()) {
            ...
            $this.q1u_1 = element;
            $this.r1u_1 = null;
            var tmp0_safe_receiver = $this.s1u_1.r1t_1;
            cancellable.p1n(true, tmp0_safe_receiver == null ? null : bindCancellationFun($this.s1u_1, tmp0_safe_receiver, element));
          }
          break $l$block_0;
        }
      }
      ...
      $this.q1u_1 = element_0;
      $this.r1u_1 = null;
      var tmp0_safe_receiver_0 = $this.s1u_1.r1t_1;
      cancellable.p1n(true, tmp0_safe_receiver_0 == null ? null : bindCancellationFun($this.s1u_1, tmp0_safe_receiver_0, element_0));
    }
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
...
function onClosedHasNextNoWaiterSuspend($this) {
  var cont = ensureNotNull($this.r1u_1);
  $this.r1u_1 = null;
  $this.q1u_1 = get_CHANNEL_CLOSED();
  var cause = $this.s1u_1.t1u();
  if (cause == null) {
    // Inline function 'kotlin.coroutines.resume' call
    // Inline function 'kotlin.Companion.success' call
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 8;
          if (!(this.e1v_1.q1u_1 === get_NO_RECEIVE_RESULT()) && !(this.e1v_1.q1u_1 === get_CHANNEL_CLOSED())) {
            var tmp_0 = this;
            tmp_0.f1v_1 = true;
            this.k8_1 = 11;
            continue $sm;
        ...
        case 1:
          ...
          this.i1v_1 = this.l1v_1.x1t_1.kotlinx$atomicfu$value;
          this.k8_1 = 2;
          continue $sm;
        case 2:
          if (!true) {
          ...
          if (this.l1v_1.v1u()) {
            var tmp_3 = this;
            tmp_3.g1v_1 = onClosedHasNext(this.e1v_1);
            this.k8_1 = 10;
            continue $sm;
          } else {
            this.k8_1 = 3;
        ...
        case 3:
          this.j1v_1 = this.l1v_1.t1t_1.atomicfu$getAndIncrement$long();
          var tmp0 = this.j1v_1;
          var other = get_SEGMENT_SIZE();
          ...
          var other_0 = get_SEGMENT_SIZE();
          tmp_4.k1v_1 = convertToInt(modulo(tmp0_0, fromInt(other_0)));
          if (!equalsLong(this.i1v_1.o1m_1, id)) {
        ...
        case 5:
          ...
          if (updCellResult === get_SUSPEND()) {
            ...
            if (updCellResult === get_FAILED()) {
              if (compare(this.j1v_1, this.l1v_1.u1u()) < 0) {
                this.i1v_1.o1u();
              }
              this.k8_1 = 2;
              var tmp_8 = this;
              ...
              if (updCellResult === get_SUSPEND_NO_WAITER()) {
                ...
                var r = this.j1v_1;
                this.k8_1 = 6;
                suspendResult = hasNextOnNoWaiterSuspend(this.e1v_1, tmp0_1, tmp2, r, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
...
function _get_bufferEndCounter__2d4hee($this) {
  return $this.u1t_1.kotlinx$atomicfu$value;
}
...
function onClosedSend($this, element, $completion) {
  ...
  cancellable.c1n();
  $l$block: {
    var tmp0_safe_receiver = $this.r1t_1;
    var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : callUndeliveredElementCatchingException(tmp0_safe_receiver, element);
    if (tmp1_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      addSuppressed(tmp1_safe_receiver, $this.q1v());
    ...
    switch (updateCellSend($this, segment, index, element, s, cancellable, false)) {
      ...
      case 5:
        ...
        $l$block_5: {
          ...
          var segment_0 = $this.w1t_1.kotlinx$atomicfu$value;
          $l$loop_0: while (true) {
            var sendersAndCloseStatusCur = $this.s1t_1.atomicfu$getAndIncrement$long();
...
function prepareSenderForSuspension($this, _this__u8e3s4, segment, index) {
  _this__u8e3s4.r1n(segment, index + get_SEGMENT_SIZE() | 0);
}
function onClosedSendOnNoWaiterSuspend($this, element, cont) {
  ...
  // Inline function 'kotlin.coroutines.resumeWithException' call
  // Inline function 'kotlin.Companion.failure' call
  var exception = recoverStackTrace($this.q1v(), cont);
  var tmp$ret$0 = _Result___init__impl__xyqfz8(createFailure(exception));
  cont.v8(tmp$ret$0);
}
...
function updateCellSend($this, segment, index, element, s, waiter, closed) {
  segment.i1t(index, element);
  if (closed)
    return updateCellSendSlow($this, segment, index, element, s, waiter, closed);
  var state = segment.m1t(index);
  if (state === null) {
    if (bufferOrRendezvousSend($this, s)) {
      if (segment.o1t(index, null, get_BUFFERED())) {
        return 1;
      }
    } else {
      if (waiter == null) {
        ...
        if (segment.o1t(index, null, waiter))
          return 2;
      }
    }
  } else {
    if (!(state == null) ? isInterface(state, Waiter) : false) {
      ...
      if (tryResumeReceiver($this, state, element)) {
        segment.n1t(index, get_DONE_RCV());
        $this.s1v();
        tmp = 0;
      } else {
        if (!(segment.p1t(index, get_INTERRUPTED_RCV()) === get_INTERRUPTED_RCV())) {
          segment.c1u(index, true);
        }
        tmp = 5;
      }
      return tmp;
  ...
  while (true) {
    ...
    if (state === null) {
      if (bufferOrRendezvousSend($this, s) && !closed) {
        ...
        if (closed) {
          if (segment.o1t(index, null, get_INTERRUPTED_SEND())) {
            segment.c1u(index, false);
            return 4;
          }
        } else if (waiter == null)
          return 3;
        else if (segment.o1t(index, null, waiter))
          return 2;
      }
    } else if (state === get_IN_BUFFER()) {
      if (segment.o1t(index, state, get_BUFFERED())) {
        return 1;
      }
...
function tryResumeReceiver($this, _this__u8e3s4, element) {
  ...
  if (isInterface(_this__u8e3s4, SelectInstance)) {
    tmp = _this__u8e3s4.y1v($this, element);
  } else {
    if (_this__u8e3s4 instanceof ReceiveCatching) {
      if (!(_this__u8e3s4 instanceof ReceiveCatching))
        THROW_CCE();
      var tmp_0 = Companion_getInstance().w1v(element);
      var tmp1_safe_receiver = $this.r1t_1;
      tmp = tryResume0(_this__u8e3s4.x1v_1, new ChannelResult(tmp_0), tmp1_safe_receiver == null ? null : bindCancellationFunResult($this, tmp1_safe_receiver));
    } else {
      if (_this__u8e3s4 instanceof BufferedChannelIterator) {
        if (!(_this__u8e3s4 instanceof BufferedChannelIterator))
          THROW_CCE();
        tmp = _this__u8e3s4.u1v(element);
      } else {
        if (isInterface(_this__u8e3s4, CancellableContinuation)) {
          if (!isInterface(_this__u8e3s4, CancellableContinuation))
            THROW_CCE();
          var tmp2_safe_receiver = $this.r1t_1;
...
function prepareReceiverForSuspension($this, _this__u8e3s4, segment, index) {
  $this.z1v();
  _this__u8e3s4.r1n(segment, index);
}
function updateCellReceive($this, segment, index, r, waiter) {
  var state = segment.m1t(index);
  if (state === null) {
    // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
    var this_0 = $this.s1t_1.kotlinx$atomicfu$value;
    var senders = bitwiseAnd(this_0, new Long(-1, 268435455));
    if (compare(r, senders) >= 0) {
      if (waiter === null) {
        return get_SUSPEND_NO_WAITER();
      }
      if (segment.o1t(index, state, waiter)) {
        expandBuffer($this);
        return get_SUSPEND();
      }
    }
  } else if (state === get_BUFFERED())
    if (segment.o1t(index, state, get_DONE_RCV())) {
      expandBuffer($this);
      return segment.k1t(index);
    }
...
function updateCellReceiveSlow($this, segment, index, r, waiter) {
  $l$loop: while (true) {
    ...
    if (state === null || state === get_IN_BUFFER()) {
      ...
      var senders = bitwiseAnd(this_0, new Long(-1, 268435455));
      if (compare(r, senders) < 0) {
        if (segment.o1t(index, state, get_POISONED())) {
          expandBuffer($this);
          return get_FAILED();
        }
      } else {
      ...
      if (segment.o1t(index, state, get_RESUMING_BY_RCV())) {
        ...
        if (tryResumeSender($this, sender, segment, index)) {
          segment.n1t(index, get_DONE_RCV());
          expandBuffer($this);
          tmp_0 = segment.k1t(index);
        } else {
          segment.n1t(index, get_INTERRUPTED_SEND());
          segment.c1u(index, false);
          if (helpExpandBuffer) {
            expandBuffer($this);
          }
  ...
  if (isInterface(_this__u8e3s4, CancellableContinuation)) {
    ...
    if (isInterface(_this__u8e3s4, SelectInstance)) {
      if (!(_this__u8e3s4 instanceof SelectImplementation))
        THROW_CCE();
      var trySelectResult = _this__u8e3s4.e1w($this, Unit_instance);
      ...
      if (_this__u8e3s4 instanceof SendBroadcast) {
        tmp = tryResume0(_this__u8e3s4.a1w_1, true);
      } else {
...
function expandBuffer($this) {
  if (_get_isRendezvousOrUnlimited__3mdufi($this))
    return Unit_instance;
  var segment = $this.y1t_1.kotlinx$atomicfu$value;
  try_again: while (true) {
    var b = $this.u1t_1.atomicfu$getAndIncrement$long();
    // Inline function 'kotlin.Long.div' call
    var other = get_SEGMENT_SIZE();
    var id = divide(b, fromInt(other));
    var s = $this.u1u();
    if (compare(s, b) <= 0) {
      if (compare(segment.o1m_1, id) < 0 && !(segment.k1u() == null)) {
        moveSegmentBufferEndToSpecifiedOrLast($this, id, segment);
      }
      incCompletedExpandBufferAttempts$default($this);
      return Unit_instance;
    }
    if (!equalsLong(segment.o1m_1, id)) {
...
function updateCellExpandBuffer($this, segment, index, b) {
  var state = segment.m1t(index);
  if (!(state == null) ? isInterface(state, Waiter) : false) {
    if (compare(b, $this.t1t_1.kotlinx$atomicfu$value) >= 0) {
      if (segment.o1t(index, state, get_RESUMING_BY_EB())) {
        var tmp;
        if (tryResumeSender($this, state, segment, index)) {
          segment.n1t(index, get_BUFFERED());
          tmp = true;
        } else {
          segment.n1t(index, get_INTERRUPTED_SEND());
          segment.c1u(index, false);
...
function updateCellExpandBufferSlow($this, segment, index, b) {
  $l$loop: while (true) {
    ...
    if (!(state == null) ? isInterface(state, Waiter) : false) {
      if (compare(b, $this.t1t_1.kotlinx$atomicfu$value) < 0) {
        if (segment.o1t(index, state, new WaiterEB(state)))
          return true;
      } else {
        if (segment.o1t(index, state, get_RESUMING_BY_EB())) {
          var tmp;
      ...
      if (state === get_INTERRUPTED_SEND())
        ...
        if (state === null) {
          if (segment.o1t(index, state, get_IN_BUFFER()))
            return true;
        } else {
...
function incCompletedExpandBufferAttempts($this, nAttempts) {
  // Inline function 'kotlin.also' call
  var this_0 = $this.v1t_1.atomicfu$addAndGet$long(nAttempts);
  // Inline function 'kotlinx.coroutines.channels.ebPauseExpandBuffers' call
  if (!equalsLong(bitwiseAnd(this_0, new Long(0, 1073741824)), new Long(0, 0))) {
    $l$loop: while (true) {
      // Inline function 'kotlinx.coroutines.channels.ebPauseExpandBuffers' call
      var this_1 = $this.v1t_1.kotlinx$atomicfu$value;
...
function BufferedChannelIterator($outer) {
  this.s1u_1 = $outer;
  this.q1u_1 = get_NO_RECEIVE_RESULT();
  this.r1u_1 = null;
}
protoOf(BufferedChannelIterator).f1w = function ($completion) {
  var tmp = new $hasNextCOROUTINE$(this, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(BufferedChannelIterator).r1n = function (segment, index) {
  var tmp0_safe_receiver = this.r1u_1;
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.r1n(segment, index);
  }
};
protoOf(BufferedChannelIterator).s = function () {
  var result = this.q1u_1;
  // Inline function 'kotlin.check' call
  ...
  if (result === get_CHANNEL_CLOSED())
    throw recoverStackTrace_0(_get_receiveException__foorc1(this.s1u_1));
  return (result == null ? true : !(result == null)) ? result : THROW_CCE();
};
protoOf(BufferedChannelIterator).u1v = function (element) {
  var cont = ensureNotNull(this.r1u_1);
  this.r1u_1 = null;
  this.q1u_1 = element;
  var tmp0_safe_receiver = this.s1u_1.r1t_1;
  return tryResume0(cont, true, tmp0_safe_receiver == null ? null : bindCancellationFun(this.s1u_1, tmp0_safe_receiver, element));
};
protoOf(BufferedChannelIterator).g1w = function () {
  var cont = ensureNotNull(this.r1u_1);
  this.r1u_1 = null;
  this.q1u_1 = get_CHANNEL_CLOSED();
  var cause = this.s1u_1.t1u();
...
function completeClose($this, sendersCur) {
  ...
  if ($this.j1w()) {
    ...
    if (!equalsLong(lastBufferedCellGlobalIndex, new Long(-1, -1))) {
      $this.i1w(lastBufferedCellGlobalIndex);
    }
  }
...
function closeLinkedList($this) {
  var lastSegment = $this.y1t_1.kotlinx$atomicfu$value;
  // Inline function 'kotlin.let' call
  var it = $this.w1t_1.kotlinx$atomicfu$value;
  if (compare(it.o1m_1, lastSegment.o1m_1) > 0)
    lastSegment = it;
  // Inline function 'kotlin.let' call
  var it_0 = $this.x1t_1.kotlinx$atomicfu$value;
  if (compare(it_0.o1m_1, lastSegment.o1m_1) > 0)
    lastSegment = it_0;
  ...
  while (true) {
    ...
    if (0 <= inductionVariable)
      do {
        ...
        var tmp0 = segment.o1m_1;
        // Inline function 'kotlin.Long.times' call
        var other = get_SEGMENT_SIZE();
        // Inline function 'kotlin.Long.plus' call
        var this_0 = multiply(tmp0, fromInt(other));
        var globalIndex = add(this_0, fromInt(index));
        if (compare(globalIndex, $this.r1v()) < 0)
          return new Long(-1, -1);
        cell_update: while (true) {
          var state = segment.m1t(index);
          if (state === null || state === get_IN_BUFFER()) {
            if (segment.o1t(index, state, get_CHANNEL_CLOSED())) {
              segment.e1u();
              break cell_update;
            }
          } else if (state === get_BUFFERED())
    ...
    var tmp0_elvis_lhs = segment.n1u();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return new Long(-1, -1);
    } else {
...
function removeUnprocessedElements($this, lastSegment) {
  var onUndeliveredElement = $this.r1t_1;
            ...
            if (state === get_BUFFERED()) {
              ...
              if (state === get_IN_BUFFER() || state === null) {
                ...
                if (tmp) {
                  ...
                  if (segment.o1t(index, state, get_CHANNEL_CLOSED())) {
                    if (!(onUndeliveredElement == null)) {
                      var element_0 = segment.j1t(index);
      ...
      do {
        ...
        cell_update: while (true) {
          ...
          if (state === null || state === get_IN_BUFFER()) {
            ...
            if (state instanceof WaiterEB) {
              if (segment.o1t(index, state, get_CHANNEL_CLOSED())) {
                suspendedReceivers = InlineList__plus_impl_nuetvo(suspendedReceivers, state.t1v_1);
                segment.c1u(index, true);
                break cell_update;
              }
            } else {
...
function resumeWaiterOnClosedChannel($this, _this__u8e3s4, receiver) {
  if (_this__u8e3s4 instanceof SendBroadcast) {
    // Inline function 'kotlin.coroutines.resume' call
    var this_0 = _this__u8e3s4.a1w_1;
    // Inline function 'kotlin.Companion.success' call
    var tmp$ret$0 = _Result___init__impl__xyqfz8(false);
    this_0.v8(tmp$ret$0);
  } else {
    if (isInterface(_this__u8e3s4, CancellableContinuation)) {
      // Inline function 'kotlin.coroutines.resumeWithException' call
      // Inline function 'kotlin.Companion.failure' call
      var exception = receiver ? _get_receiveException__foorc1($this) : $this.q1v();
      var tmp$ret$2 = _Result___init__impl__xyqfz8(createFailure(exception));
      _this__u8e3s4.v8(tmp$ret$2);
    } else {
      if (_this__u8e3s4 instanceof ReceiveCatching) {
        var tmp0 = _this__u8e3s4.x1v_1;
        // Inline function 'kotlin.coroutines.resume' call
        // Inline function 'kotlin.Companion.success' call
        var value = new ChannelResult(Companion_getInstance().k1w($this.t1u()));
        ...
        if (_this__u8e3s4 instanceof BufferedChannelIterator) {
          ...
          if (isInterface(_this__u8e3s4, SelectInstance))
            _this__u8e3s4.y1v($this, get_CHANNEL_CLOSED());
          else {
            // Inline function 'kotlin.error' call
            var message = 'Unexpected waiter: ' + toString(_this__u8e3s4);
            throw IllegalStateException_init_$Create$(toString(message));
...
function isClosed($this, sendersAndCloseStatusCur, isClosedForReceive) {
  ...
  switch (convertToInt(shiftRight(sendersAndCloseStatusCur, 60))) {
    ...
    case 2:
      ...
      tmp = isClosedForReceive ? !$this.l1w() : true;
      break;
    case 3:
      // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
...
function isCellNonEmpty($this, segment, index, globalIndex) {
  while (true) {
    ...
    if (state === null || state === get_IN_BUFFER()) {
      ...
      return equalsLong(globalIndex, $this.r1v());
  }
}
function findSegmentSend($this, id, startFrom) {
    ...
    while (true) {
      ...
      if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(s)) {
        ...
        $l$block_1: {
          ...
          while (true) {
            var cur = tmp0.kotlinx$atomicfu$value;
            if (compare(cur.o1m_1, tmp2.o1m_1) >= 0) {
              tmp$ret$0 = true;
              break $l$block_1;
            }
            if (!tmp2.g1u()) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    completeCloseOrCancel($this);
    var tmp0_0 = startFrom.o1m_1;
    // Inline function 'kotlin.Long.times' call
    var other = get_SEGMENT_SIZE();
    var tmp$ret$3 = multiply(tmp0_0, fromInt(other));
    if (compare(tmp$ret$3, $this.r1v()) < 0) {
      startFrom.o1u();
    }
    tmp_0 = null;
  } else {
...
function findSegmentReceive($this, id, startFrom) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    if (tmp_1) {
      var tmp0_2 = $this.y1t_1;
      $l$block_5: {
        // Inline function 'kotlinx.coroutines.internal.moveForward' call
        while (true) {
          var cur_0 = tmp0_2.kotlinx$atomicfu$value;
          if (compare(cur_0.o1m_1, segment.o1m_1) >= 0) {
            break $l$block_5;
          }
          if (!segment.g1u()) {
            break $l$block_5;
...
function findSegmentBufferEnd($this, id, startFrom, currentBufferEndCounter) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    if (compare(segment.o1m_1, id) > 0) {
      ...
      var tmp0_0 = segment.o1m_1;
      // Inline function 'kotlin.Long.times' call
      var other = get_SEGMENT_SIZE();
      var tmp$ret$4 = multiply(tmp0_0, fromInt(other));
      if ($this.u1t_1.atomicfu$compareAndSet(tmp_2, tmp$ret$4)) {
        var tmp0_1 = segment.o1m_1;
        // Inline function 'kotlin.Long.times' call
        var other_0 = get_SEGMENT_SIZE();
...
function moveSegmentBufferEndToSpecifiedOrLast($this, id, startFrom) {
  ...
  $l$loop: while (compare(segment.o1m_1, id) < 0) {
    var tmp0_elvis_lhs = segment.k1u();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      break $l$loop;
    } else {
  ...
  while (true) {
    $l$loop_0: while (segment.f1u()) {
      var tmp1_elvis_lhs = segment.k1u();
      var tmp_0;
      if (tmp1_elvis_lhs == null) {
        break $l$loop_0;
      } else {
...
function updateSendersCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if ($this.s1t_1.atomicfu$compareAndSet(cur, update))
      return Unit_instance;
  }
  return Unit_instance;
}
function updateReceiversCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if (compare(cur, value) >= 0)
      return Unit_instance;
    if ($this.t1t_1.atomicfu$compareAndSet(cur, value))
      return Unit_instance;
  }
  return Unit_instance;
}
...
function onCancellationChannelResultImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.r1t_1), ensureNotNull(ChannelResult__getOrNull_impl_f5e07h(element)), context);
}
...
function onCancellationImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.r1t_1), element, context);
}
function BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$lambda$lambda($element, this$0, $select) {
  return function (_unused_var__etf5q3, _unused_var__etf5q3_0, _unused_var__etf5q3_1) {
    var tmp;
    if (!($element === get_CHANNEL_CLOSED())) {
      callUndeliveredElement(this$0.r1t_1, ($element == null ? true : !($element == null)) ? $element : THROW_CCE(), $select.q8());
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function BufferedChannel$onCancellationChannelResultImplDoNotCall$ref(p0) {
  var l = function (_this__u8e3s4, p0_0, p1) {
    var tmp0 = p0;
    onCancellationChannelResultImplDoNotCall(tmp0, _this__u8e3s4, p0_0.n1w_1, p1);
    return Unit_instance;
  };
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 11;
          var tmp_0 = this;
          tmp_0.i1x_1 = this.w1w_1;
          var tmp_1 = this;
          tmp_1.h1x_1 = this.x1w_1;
          var tmp_2 = this;
          tmp_2.g1x_1 = null;
          this.k8_1 = 1;
          continue $sm;
        case 1:
          this.a1x_1 = this.i1x_1;
          this.d1x_1 = this.h1x_1;
          this.b1x_1 = this.g1x_1;
          this.z1w_1 = this.a1x_1.w1t_1.kotlinx$atomicfu$value;
          this.k8_1 = 2;
          continue $sm;
        case 2:
          if (!true) {
          ...
          var sendersAndCloseStatusCur = this.a1x_1.s1t_1.atomicfu$getAndIncrement$long();
          var tmp_3 = this;
          tmp_3.c1x_1 = bitwiseAnd(sendersAndCloseStatusCur, new Long(-1, 268435455));
          this.e1x_1 = _get_isClosedForSend0__kxgf9m(this.a1x_1, sendersAndCloseStatusCur);
          var tmp0 = this.c1x_1;
          var other = get_SEGMENT_SIZE();
          var id = divide(tmp0, fromInt(other));
          var tmp_4 = this;
          var tmp0_0 = this.c1x_1;
          var other_0 = get_SEGMENT_SIZE();
          tmp_4.y1w_1 = convertToInt(modulo(tmp0_0, fromInt(other_0)));
          if (!equalsLong(this.z1w_1.o1m_1, id)) {
            var tmp0_elvis_lhs = findSegmentSend(this.a1x_1, id, this.z1w_1);
            if (tmp0_elvis_lhs == null) {
              if (this.e1x_1) {
                this.k8_1 = 10;
                suspendResult = onClosedSend(this.w1w_1, this.x1w_1, this);
                if (suspendResult === get_COROUTINE_SUSPENDED()) {
                  return suspendResult;
                }
                continue $sm;
        ...
        case 3:
          this.z1w_1 = this.f1x_1;
          this.k8_1 = 4;
          continue $sm;
        case 4:
          var tmp1_subject = updateCellSend(this.a1x_1, this.z1w_1, this.y1w_1, this.d1x_1, this.c1x_1, this.b1x_1, this.e1x_1);
          if (tmp1_subject === 0) {
            this.z1w_1.o1u();
            this.k8_1 = 13;
            continue $sm;
            ...
            if (tmp1_subject === 1) {
              ...
              if (tmp1_subject === 2) {
                ...
                if (tmp1_subject === 4) {
                  if (compare(this.c1x_1, this.a1x_1.r1v()) < 0) {
                    this.z1w_1.o1u();
                  }
                  this.k8_1 = 7;
                  suspendResult = onClosedSend(this.w1w_1, this.x1w_1, this);
                  ...
                  if (tmp1_subject === 5) {
                    ...
                    if (tmp1_subject === 3) {
                      var tmp0_1 = this.z1w_1;
                      var tmp2 = this.y1w_1;
                      var tmp4 = this.d1x_1;
                      var s = this.c1x_1;
                      this.k8_1 = 6;
                      suspendResult = sendOnNoWaiterSuspend(this.w1w_1, tmp0_1, tmp2, tmp4, s, this);
                      if (suspendResult === get_COROUTINE_SUSPENDED()) {
                        return suspendResult;
                      }
                      continue $sm;
        ...
        case 7:
          ...
          continue $sm;
        case 8:
          var tmp_6 = this.b1x_1;
          var tmp2_safe_receiver = (!(tmp_6 == null) ? isInterface(tmp_6, Waiter) : false) ? tmp_6 : null;
          if (tmp2_safe_receiver == null)
            null;
          else {
            prepareSenderForSuspension(this.a1x_1, tmp2_safe_receiver, this.z1w_1, this.y1w_1);
          }
...
function BufferedChannel(capacity, onUndeliveredElement) {
  ...
  this.q1t_1 = capacity;
  this.r1t_1 = onUndeliveredElement;
  // Inline function 'kotlin.require' call
  if (!(this.q1t_1 >= 0)) {
    var message = 'Invalid channel capacity: ' + this.q1t_1 + ', should be >=0';
    throw IllegalArgumentException_init_$Create$(toString(message));
  }
  this.s1t_1 = atomic$long$1(new Long(0, 0));
  this.t1t_1 = atomic$long$1(new Long(0, 0));
  this.u1t_1 = atomic$long$1(initialBufferEnd(this.q1t_1));
  this.v1t_1 = atomic$long$1(_get_bufferEndCounter__2d4hee(this));
  var firstSegment = new ChannelSegment(new Long(0, 0), null, this, 3);
  this.w1t_1 = atomic$ref$1(firstSegment);
  this.x1t_1 = atomic$ref$1(firstSegment);
  var tmp = this;
  var tmp_0;
  if (_get_isRendezvousOrUnlimited__3mdufi(this)) {
  ...
  tmp_2.z1t_1 = tmp_3;
  this.a1u_1 = atomic$ref$1(get_NO_CLOSE_CAUSE());
  this.b1u_1 = atomic$ref$1(null);
}
...
protoOf(BufferedChannel).r1v = function () {
  return this.t1t_1.kotlinx$atomicfu$value;
};
protoOf(BufferedChannel).j1x = function (element, $completion) {
  var tmp = new $sendCOROUTINE$(this, element, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(BufferedChannel).k1x = function (element) {
  if (shouldSendSuspend0(this, this.s1t_1.kotlinx$atomicfu$value))
    return Companion_getInstance().l1x();
  var tmp4 = get_INTERRUPTED_SEND();
  var tmp$ret$4;
  $l$block_4: {
    // Inline function 'kotlinx.coroutines.channels.BufferedChannel.sendImpl' call
    var segment = this.w1t_1.kotlinx$atomicfu$value;
    $l$loop_0: while (true) {
      var sendersAndCloseStatusCur = this.s1t_1.atomicfu$getAndIncrement$long();
      // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
      ...
      if (!equalsLong(segment.o1m_1, id)) {
        ...
        if (tmp0_elvis_lhs == null) {
          var tmp_0;
          if (closed) {
            tmp$ret$4 = Companion_getInstance().k1w(this.q1v());
            break $l$block_4;
          } else {
            continue $l$loop_0;
          }
      ...
      switch (updateCellSend(this, segment, i, element, s, tmp4, closed)) {
        case 0:
          segment.o1u();
          tmp$ret$4 = Companion_getInstance().w1v(Unit_instance);
          break $l$block_4;
        case 1:
          tmp$ret$4 = Companion_getInstance().w1v(Unit_instance);
          break $l$block_4;
        case 2:
          ...
          segment.e1u();
          tmp$ret$4 = Companion_getInstance().l1x();
          break $l$block_4;
        case 4:
          if (compare(s, this.r1v()) < 0) {
            segment.o1u();
...
protoOf(BufferedChannel).m1x = function (element) {
  var tmp$ret$3;
  // Inline function 'kotlinx.coroutines.channels.BufferedChannel.sendImpl' call
  ...
  $l$loop_0: while (true) {
    ...
    if (!equalsLong(segment.o1m_1, id)) {
      ...
      if (tmp0_elvis_lhs == null) {
        var tmp_0;
        if (closed) {
          return Companion_getInstance().k1w(this.q1v());
        } else {
          continue $l$loop_0;
        }
      } else {
    ...
    switch (updateCellSend(this, segment, i, element, s, waiter, closed)) {
      case 0:
        segment.o1u();
        return Companion_getInstance().w1v(Unit_instance);
      case 1:
        return Companion_getInstance().w1v(Unit_instance);
      case 2:
        if (closed) {
...
protoOf(BufferedChannel).z1v = function () {
};
protoOf(BufferedChannel).s1v = function () {
};
protoOf(BufferedChannel).i1w = function (globalCellIndex) {
  // Inline function 'kotlinx.coroutines.assert' call
  var segment = this.x1t_1.kotlinx$atomicfu$value;
  $l$loop_0: while (true) {
    var r = this.t1t_1.kotlinx$atomicfu$value;
    // Inline function 'kotlin.Long.plus' call
    var other = this.q1t_1;
    ...
    if (!this.t1t_1.atomicfu$compareAndSet(r, tmp$ret$3))
      continue $l$loop_0;
    // Inline function 'kotlin.Long.div' call
    var other_0 = get_SEGMENT_SIZE();
...
protoOf(BufferedChannel).d1u = function (globalIndex) {
  if (_get_isRendezvousOrUnlimited__3mdufi(this))
    return Unit_instance;
  ...
  if (inductionVariable < times)
    do {
      ...
      var this_0 = this.v1t_1.kotlinx$atomicfu$value;
  ...
  while (true) {
    ...
    var ebCompletedAndBit = this.v1t_1.kotlinx$atomicfu$value;
    // Inline function 'kotlinx.coroutines.channels.ebCompletedCounter' call
    ...
    if (!pauseExpandBuffers) {
      this.v1t_1.atomicfu$compareAndSet(ebCompletedAndBit, constructEBCompletedAndPauseFlag(ebCompleted_0, true));
    }
  }
};
...
protoOf(BufferedChannel).t1u = function () {
  var tmp = this.a1u_1.kotlinx$atomicfu$value;
...
protoOf(BufferedChannel).o1x = function (cause) {
  return this.p1x(cause, false);
};
protoOf(BufferedChannel).w1j = function (cause) {
  this.r1x(cause);
};
protoOf(BufferedChannel).r1x = function (cause) {
  return this.p1x(cause == null ? CancellationException_init_$Create$('Channel was cancelled') : cause, true);
};
protoOf(BufferedChannel).p1x = function (cause, cancel) {
  if (cancel) {
    markCancellationStarted(this);
  }
  var closedByThisOperation = this.a1u_1.atomicfu$compareAndSet(get_NO_CLOSE_CAUSE(), cause);
  if (cancel) {
    markCancelled(this);
  } else {
    markClosed(this);
...
protoOf(BufferedChannel).j1w = function () {
  return false;
};
protoOf(BufferedChannel).h1w = function () {
  return _get_isClosedForSend0__kxgf9m(this, this.s1t_1.kotlinx$atomicfu$value);
};
protoOf(BufferedChannel).v1u = function () {
  return _get_isClosedForReceive0__f7qknl(this, this.s1t_1.kotlinx$atomicfu$value);
};
protoOf(BufferedChannel).l1w = function () {
  $l$loop: while (true) {
    var segment = this.x1t_1.kotlinx$atomicfu$value;
    var r = this.r1v();
    var s = this.u1u();
    ...
    if (!equalsLong(segment.o1m_1, id)) {
      ...
      if (tmp0_elvis_lhs == null) {
        var tmp_0;
        if (compare(this.x1t_1.kotlinx$atomicfu$value.o1m_1, id) < 0) {
          return false;
        } else {
          continue $l$loop;
        }
    ...
    this.t1t_1.atomicfu$compareAndSet(r, tmp$ret$2);
  }
};
protoOf(BufferedChannel).toString = function () {
  ...
  sb.r7('capacity=' + this.q1t_1 + ',');
  sb.r7('data=[');
  // Inline function 'kotlin.collections.filter' call
  var tmp0 = listOf([this.x1t_1.kotlinx$atomicfu$value, this.w1t_1.kotlinx$atomicfu$value, this.y1t_1.kotlinx$atomicfu$value]);
  ...
  append_elements: while (true) {
    ...
    if (inductionVariable < last_0)
      process_cell: do {
        ...
        var cellState = segment.m1t(i);
        var element_0 = segment.j1t(i);
        var tmp;
    ...
    var tmp2_elvis_lhs = segment.k1u();
    var tmp_0;
    if (tmp2_elvis_lhs == null) {
      break append_elements;
    } else {
...
protoOf(WaiterEB).toString = function () {
  return 'WaiterEB(' + toString(this.t1v_1) + ')';
};
...
function tryResume0(_this__u8e3s4, value, onCancellation) {
  ...
  _init_properties_BufferedChannel_kt__d6uc4y();
  // Inline function 'kotlin.let' call
  var token = _this__u8e3s4.o1l(value, null, onCancellation);
  var tmp;
  if (!(token == null)) {
    _this__u8e3s4.p1l(token);
    tmp = true;
  } else {
    tmp = false;
  }
...
function createSegment(id, prev) {
  _init_properties_BufferedChannel_kt__d6uc4y();
  return new ChannelSegment(id, prev, prev.g1t(), 0);
}
...
function Factory() {
  ...
  this.s1x_1 = 2147483647;
  this.t1x_1 = 0;
  this.u1x_1 = -1;
  this.v1x_1 = -2;
  this.w1x_1 = -3;
  this.x1x_1 = 'kotlinx.coroutines.channels.defaultBuffer';
  this.y1x_1 = systemProp('kotlinx.coroutines.channels.defaultBuffer', 64, 1, 2147483646);
}
...
function ChannelResult__exceptionOrNull_impl_16ei30($this) {
  ...
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.z1x_1;
}
function Failed() {
}
...
protoOf(Closed).equals = function (other) {
  ...
  if (other instanceof Closed) {
    tmp = equals(this.z1x_1, other.z1x_1);
  } else {
    tmp = false;
  }
  return tmp;
...
protoOf(Closed).toString = function () {
  return 'Closed(' + toString_0(this.z1x_1) + ')';
};
function Companion() {
  Companion_instance_0 = this;
  this.v1v_1 = new Failed();
}
protoOf(Companion).w1v = function (value) {
  return _ChannelResult___init__impl__siwsuf(value);
};
protoOf(Companion).l1x = function () {
  return _ChannelResult___init__impl__siwsuf(this.v1v_1);
};
protoOf(Companion).k1w = function (cause) {
...
function ChannelResult__equals_impl_f471ri($this, other) {
  if (!(other instanceof ChannelResult))
    return false;
  var tmp0_other_with_cast = other instanceof ChannelResult ? other.n1w_1 : THROW_CCE();
...
protoOf(ChannelResult).toString = function () {
  return ChannelResult__toString_impl_rrcqu7(this.n1w_1);
};
protoOf(ChannelResult).hashCode = function () {
  return ChannelResult__hashCode_impl_lilec2(this.n1w_1);
};
protoOf(ChannelResult).equals = function (other) {
  return ChannelResult__equals_impl_f471ri(this.n1w_1, other);
};
...
function Channel(capacity, onBufferOverflow, onUndeliveredElement) {
  ...
  switch (capacity) {
    ...
    case 2147483647:
      ...
      break;
    case -2:
      tmp = onBufferOverflow.equals(BufferOverflow_SUSPEND_getInstance()) ? new BufferedChannel(Factory_getInstance().y1x_1, onUndeliveredElement) : new ConflatedBufferedChannel(1, onBufferOverflow, onUndeliveredElement);
      break;
    default:
...
protoOf(ChannelCoroutine).w1j = function (cause) {
  if (this.l1j())
    return Unit_instance;
  var tmp;
  if (cause == null) {
...
protoOf(ChannelCoroutine).a1y = function (cause, $super) {
  return this.x1j(cause, ($super == null ? true : $super instanceof ChannelCoroutine) ? $super : THROW_CCE());
};
protoOf(ChannelCoroutine).y1j = function (cause) {
  var exception = this.q1j(cause);
  this.e1y_1.w1j(exception);
  this.b1k(exception);
};
protoOf(ChannelCoroutine).j1x = function (element, $completion) {
  return this.e1y_1.j1x(element, $completion);
};
protoOf(ChannelCoroutine).o1x = function (cause) {
  return this.e1y_1.o1x(cause);
};
...
function cancelConsumed(_this__u8e3s4, cause) {
  ...
  _this__u8e3s4.w1j(tmp);
}
function trySendImpl($this, element, isSendOp) {
  return $this.s1y_1 === BufferOverflow_DROP_LATEST_getInstance() ? trySendDropLatest($this, element, isSendOp) : $this.m1x(element);
}
function trySendDropLatest($this, element, isSendOp) {
  var result = protoOf(BufferedChannel).k1x.call($this, element);
...
function ConflatedBufferedChannel(capacity, onBufferOverflow, onUndeliveredElement) {
  ...
  this.r1y_1 = capacity;
  this.s1y_1 = onBufferOverflow;
  // Inline function 'kotlin.require' call
  if (!!(this.s1y_1 === BufferOverflow_SUSPEND_getInstance())) {
    var message = 'This implementation does not support suspension for senders, use ' + getKClass(BufferedChannel).w9() + ' instead';
    throw IllegalArgumentException_init_$Create$(toString(message));
  }
  // Inline function 'kotlin.require' call
  if (!(this.r1y_1 >= 1)) {
    var message_0 = 'Buffered channel capacity must be at least 1, but ' + this.r1y_1 + ' was specified';
    throw IllegalArgumentException_init_$Create$(toString(message_0));
  }
}
protoOf(ConflatedBufferedChannel).j1w = function () {
  return this.s1y_1.equals(BufferOverflow_DROP_OLDEST_getInstance());
};
protoOf(ConflatedBufferedChannel).j1x = function (element, $completion) {
...
protoOf(ConflatedBufferedChannel).k1x = function (element) {
...
protoOf(ProducerCoroutine).p1i = function () {
  return protoOf(ChannelCoroutine).p1i.call(this);
};
protoOf(ProducerCoroutine).x1y = function (value) {
  this.e1y_1.q1x();
};
protoOf(ProducerCoroutine).q1i = function (value) {
  return this.x1y(value instanceof Unit ? value : THROW_CCE());
};
protoOf(ProducerCoroutine).r1i = function (cause, handled) {
  var processed = this.e1y_1.o1x(cause);
  if (!processed && !handled) {
    handleCoroutineException(this.n1i_1, cause);
  }
};
protoOf(ProducerCoroutine).a1y = function (cause, $super) {
  return this.x1j(cause, ($super == null ? true : $super instanceof ProducerCoroutine) ? $super : THROW_CCE());
};
function flow(block) {
...
protoOf(SafeFlow).z1y = function (collector, $completion) {
  return this.y1y_1(collector, $completion);
};
function produceIn(_this__u8e3s4, scope) {
  return asChannelFlow(_this__u8e3s4).e1z(scope);
}
    ...
    try {
      ...
      switch (tmp) {
        ...
        case 1:
          this.l8_1 = 7;
          this.l8_1 = 6;
          this.r1z_1 = this.o1z_1.q();
          this.k8_1 = 2;
          continue $sm;
        case 2:
          this.k8_1 = 3;
          suspendResult = this.r1z_1.f1w(this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 3:
          ...
          var element = this.r1z_1.s();
          this.k8_1 = 4;
          suspendResult = this.n1z_1.s1z(element, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
        ...
        case 7:
          ...
          var t = this.n8_1;
          if (this.p1z_1) {
            cancelConsumed(this.o1z_1, this.q1z_1);
          }
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 5;
          var tmp_0 = this;
          tmp_0.d20_1 = new SafeCollector(this.c20_1, this.q8());
          this.k8_1 = 1;
          continue $sm;
        case 1:
          this.l8_1 = 4;
          this.k8_1 = 2;
          suspendResult = this.b20_1.z1y(this.d20_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(AbstractFlow).a1z = function (collector, $completion) {
...
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).s20 = function (it, $completion) {
  var tmp = this.t20(it, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).b9 = function (p1, $completion) {
  return this.s20((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this.q20_1.u20(this.r20_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlow$_get_collectToFun_$slambda_j53z2e).t20 = function (it, completion) {
  var i = new ChannelFlow$_get_collectToFun_$slambda_j53z2e(this.q20_1, completion);
  i.r20_1 = it;
  return i;
};
function ChannelFlow$_get_collectToFun_$slambda_j53z2e_0(this$0, resultContinuation) {
  ...
  var l = function (it, $completion) {
    return i.s20(it, $completion);
  };
  l.$arity = 1;
  return l;
}
function ChannelFlow$collect$slambda($collector, this$0, resultContinuation) {
  this.d21_1 = $collector;
  this.e21_1 = this$0;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(ChannelFlow$collect$slambda).g21 = function ($this$coroutineScope, $completion) {
  var tmp = this.h21($this$coroutineScope, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(ChannelFlow$collect$slambda).b9 = function (p1, $completion) {
  return this.g21((!(p1 == null) ? isInterface(p1, CoroutineScope) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = emitAll(this.d21_1, this.e21_1.e1z(this.f21_1), this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlow$collect$slambda).h21 = function ($this$coroutineScope, completion) {
  var i = new ChannelFlow$collect$slambda(this.d21_1, this.e21_1, completion);
  i.f21_1 = $this$coroutineScope;
  return i;
};
function ChannelFlow$collect$slambda_0($collector, this$0, resultContinuation) {
  ...
  var l = function ($this$coroutineScope, $completion) {
    return i.g21($this$coroutineScope, $completion);
  };
  l.$arity = 1;
  return l;
}
function ChannelFlow(context, capacity, onBufferOverflow) {
  this.b1z_1 = context;
  this.c1z_1 = capacity;
  this.d1z_1 = onBufferOverflow;
  // Inline function 'kotlinx.coroutines.assert' call
}
protoOf(ChannelFlow).i21 = function () {
  return ChannelFlow$_get_collectToFun_$slambda_j53z2e_0(this, null);
};
protoOf(ChannelFlow).j21 = function () {
  return this.c1z_1 === -3 ? -2 : this.c1z_1;
};
protoOf(ChannelFlow).e1z = function (scope) {
  return produce(scope, this.b1z_1, this.j21(), this.d1z_1, CoroutineStart_ATOMIC_getInstance(), VOID, this.i21());
};
protoOf(ChannelFlow).a1z = function (collector, $completion) {
  return coroutineScope(ChannelFlow$collect$slambda_0(collector, this, null), $completion);
};
protoOf(ChannelFlow).k21 = function () {
  return null;
};
protoOf(ChannelFlow).toString = function () {
  var props = ArrayList_init_$Create$(4);
  var tmp0_safe_receiver = this.k21();
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    props.f(tmp0_safe_receiver);
  }
  if (!(this.b1z_1 === EmptyCoroutineContext_getInstance())) {
    props.f('context=' + toString(this.b1z_1));
  }
  if (!(this.c1z_1 === -3)) {
    props.f('capacity=' + this.c1z_1);
  }
  if (!this.d1z_1.equals(BufferOverflow_SUSPEND_getInstance())) {
    props.f('onBufferOverflow=' + this.d1z_1.toString());
  }
...
protoOf(ChannelFlowOperatorImpl).p21 = function (collector, $completion) {
  return this.t21_1.a1z(collector, $completion);
};
...
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).e22 = function (it, $completion) {
  var tmp = this.f22(it, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).b9 = function (p1, $completion) {
  return this.e22((!(p1 == null) ? isInterface(p1, FlowCollector) : false) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this.c22_1.p21(this.d22_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowOperator$collectWithContextUndispatched$slambda).f22 = function (it, completion) {
  var i = new ChannelFlowOperator$collectWithContextUndispatched$slambda(this.c22_1, completion);
  i.d22_1 = it;
  return i;
};
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 7;
          if (this.o22_1.c1z_1 === -3) {
            var tmp_0 = this;
            tmp_0.r22_1 = this.q8();
            this.q22_1 = newCoroutineContext_0(this.r22_1, this.o22_1.b1z_1);
            if (equals(this.q22_1, this.r22_1)) {
              this.k8_1 = 6;
              suspendResult = this.o22_1.p21(this.p22_1, this);
              if (suspendResult === get_COROUTINE_SUSPENDED()) {
                return suspendResult;
              }
              continue $sm;
        ...
        case 1:
          if (equals(this.q22_1.x8(Key_instance), this.r22_1.x8(Key_instance))) {
            this.k8_1 = 5;
            suspendResult = collectWithContextUndispatched(this.o22_1, this.p22_1, this.q22_1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
            continue $sm;
        ...
        case 3:
          this.k8_1 = 4;
          suspendResult = protoOf(ChannelFlow).a1z.call(this.o22_1, this.p22_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(ChannelFlowOperator).u20 = function (scope, $completion) {
  return this.p21(new SendingCollector(scope), $completion);
};
protoOf(ChannelFlowOperator).a1z = function (collector, $completion) {
...
protoOf(ChannelFlowOperator).toString = function () {
  return toString(this.t21_1) + ' -> ' + protoOf(ChannelFlow).toString.call(this);
};
...
function UndispatchedContextCollector$emitRef$slambda($downstream, resultContinuation) {
  this.a23_1 = $downstream;
  CoroutineImpl.call(this, resultContinuation);
}
protoOf(UndispatchedContextCollector$emitRef$slambda).c23 = function (it, $completion) {
  var tmp = this.d23(it, $completion);
  tmp.m8_1 = Unit_instance;
  tmp.n8_1 = null;
  return tmp.s8();
};
protoOf(UndispatchedContextCollector$emitRef$slambda).b9 = function (p1, $completion) {
  return this.c23((p1 == null ? true : !(p1 == null)) ? p1 : THROW_CCE(), $completion);
};
    ...
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this.a23_1.s1z(this.b23_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
protoOf(UndispatchedContextCollector$emitRef$slambda).d23 = function (it, completion) {
  var i = new UndispatchedContextCollector$emitRef$slambda(this.a23_1, completion);
  i.b23_1 = it;
  return i;
};
function UndispatchedContextCollector$emitRef$slambda_0($downstream, resultContinuation) {
  ...
  var l = function (it, $completion) {
    return i.c23(it, $completion);
  };
  l.$arity = 1;
  return l;
}
function UndispatchedContextCollector(downstream, emitContext) {
  this.e23_1 = emitContext;
  this.f23_1 = threadContextElements(this.e23_1);
  var tmp = this;
  tmp.g23_1 = UndispatchedContextCollector$emitRef$slambda_0(downstream, null);
}
protoOf(UndispatchedContextCollector).s1z = function (value, $completion) {
  return withContextUndispatched(this.e23_1, value, this.f23_1, this.g23_1, $completion);
};
...
protoOf(StackFrameContinuation).v8 = function (result) {
  this.h23_1.v8(result);
};
function checkOwnership(_this__u8e3s4, owner) {
  if (!(_this__u8e3s4.j23_1 === owner))
    throw _this__u8e3s4;
}
...
function checkContext$lambda($this_checkContext) {
  return function (count, element) {
    var key = element.l2();
    var collectElement = $this_checkContext.f20_1.x8(key);
    var tmp;
...
protoOf(SendingCollector).s1z = function (value, $completion) {
  return this.k23_1.j1x(value, $completion);
};
function ensureActive_1(_this__u8e3s4) {
  if (_this__u8e3s4 instanceof ThrowingCollector)
    throw _this__u8e3s4.l23_1;
}
...
protoOf(first$$inlined$collectWhile$1).y23 = function (value, $completion) {
  this.x23_1._v = value;
  if (!false) {
...
protoOf(first$$inlined$collectWhile$1).s1z = function (value, $completion) {
  return this.y23((value == null ? true : !(value == null)) ? value : THROW_CCE(), $completion);
};
function $firstCOROUTINE$(_this__u8e3s4, resultContinuation) {
  CoroutineImpl.call(this, resultContinuation);
  this.u23_1 = _this__u8e3s4;
}
  ...
  $sm: do
    try {
      ...
      switch (tmp) {
        case 0:
          this.l8_1 = 3;
          this.v23_1 = {_v: get_NULL()};
          var this_0 = this.u23_1;
          var tmp_0 = this;
          tmp_0.w23_1 = new first$$inlined$collectWhile$1(this.v23_1);
          this.l8_1 = 2;
          this.k8_1 = 1;
          suspendResult = this_0.a1z(this.w23_1, this);
          if (suspendResult === get_COROUTINE_SUSPENDED()) {
            return suspendResult;
          }
...
function Segment(id, prev, pointers) {
  ...
  this.o1m_1 = id;
  this.p1m_1 = atomic$int$1(pointers << 16);
}
protoOf(Segment).f1u = function () {
  return this.p1m_1.kotlinx$atomicfu$value === this.h1t() && !this.m1u();
};
protoOf(Segment).g1u = function () {
  var tmp0 = this.p1m_1;
  var tmp$ret$1;
  $l$block_0: {
...
protoOf(Segment).h1u = function () {
  return this.p1m_1.atomicfu$addAndGet(-65536) === this.h1t() && !this.m1u();
};
protoOf(Segment).e1u = function () {
  if (this.p1m_1.atomicfu$incrementAndGet() === this.h1t()) {
    this.u3();
  }
};
...
function SegmentOrClosed__equals_impl_6erq1g($this, other) {
  if (!(other instanceof SegmentOrClosed))
    return false;
  var tmp0_other_with_cast = other instanceof SegmentOrClosed ? other.m1w_1 : THROW_CCE();
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
...
protoOf(SegmentOrClosed).toString = function () {
  return SegmentOrClosed__toString_impl_pzb2an(this.m1w_1);
};
protoOf(SegmentOrClosed).hashCode = function () {
  return SegmentOrClosed__hashCode_impl_4855hs(this.m1w_1);
};
protoOf(SegmentOrClosed).equals = function (other) {
  return SegmentOrClosed__equals_impl_6erq1g(this.m1w_1, other);
};
function _get_nextOrClosed__w0gmuv($this) {
  return $this.i1u_1.kotlinx$atomicfu$value;
}
function _get_aliveSegmentLeft__mr4ndu($this) {
  var cur = $this.n1u();
  while (!(cur === null) && cur.f1u())
    cur = cur.j1u_1.kotlinx$atomicfu$value;
  return cur;
}
function _get_aliveSegmentRight__7ulr0b($this) {
  // Inline function 'kotlinx.coroutines.assert' call
  var cur = ensureNotNull($this.k1u());
  while (cur.f1u()) {
    var tmp0_elvis_lhs = cur.k1u();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return cur;
    } else {
...
function ConcurrentLinkedListNode(prev) {
  this.i1u_1 = atomic$ref$1(null);
  this.j1u_1 = atomic$ref$1(prev);
}
protoOf(ConcurrentLinkedListNode).k1u = function () {
  // Inline function 'kotlinx.coroutines.internal.ConcurrentLinkedListNode.nextOrIfClosed' call
  // Inline function 'kotlin.let' call
...
protoOf(ConcurrentLinkedListNode).l1u = function (value) {
  return this.i1u_1.atomicfu$compareAndSet(null, value);
};
protoOf(ConcurrentLinkedListNode).m1u = function () {
  return this.k1u() == null;
};
protoOf(ConcurrentLinkedListNode).n1u = function () {
  return this.j1u_1.kotlinx$atomicfu$value;
};
protoOf(ConcurrentLinkedListNode).o1u = function () {
  // Inline function 'kotlinx.atomicfu.AtomicRef.lazySet' call
  this.j1u_1.kotlinx$atomicfu$value = null;
};
protoOf(ConcurrentLinkedListNode).p1u = function () {
  return this.i1u_1.atomicfu$compareAndSet(null, get_CLOSED());
};
protoOf(ConcurrentLinkedListNode).u3 = function () {
  ...
  $l$loop_0: while (true) {
    ...
    if (!(prev === null))
      prev.i1u_1.kotlinx$atomicfu$value = next;
    if (next.f1u() && !next.m1u())
      continue $l$loop_0;
    if (!(prev === null) && prev.f1u())
      continue $l$loop_0;
    return Unit_instance;
  }
};
function findSegmentInternal(_this__u8e3s4, id, createNewSegment) {
  _init_properties_ConcurrentLinkedList_kt__5gcgzy();
  var cur = _this__u8e3s4;
  $l$loop: while (compare(cur.o1m_1, id) < 0 || cur.f1u()) {
    // Inline function 'kotlinx.coroutines.internal.ConcurrentLinkedListNode.nextOrIfClosed' call
    var this_0 = cur;
    // Inline function 'kotlin.let' call
    var it = access$_get_nextOrClosed__ywzond(this_0);
...
function _get_reusableCancellableContinuation__9qex09($this) {
  var tmp = $this.g1m_1.kotlinx$atomicfu$value;
  return tmp instanceof CancellableContinuationImpl ? tmp : null;
}
function DispatchedContinuation(dispatcher, continuation) {
  DispatchedTask.call(this, -1);
  this.c1m_1 = dispatcher;
  this.d1m_1 = continuation;
  this.e1m_1 = get_UNDEFINED();
  this.f1m_1 = threadContextElements(this.q8());
  this.g1m_1 = atomic$ref$1(null);
}
protoOf(DispatchedContinuation).j1m = function () {
  return !(this.g1m_1.kotlinx$atomicfu$value == null);
};
protoOf(DispatchedContinuation).z23 = function () {
  // Inline function 'kotlinx.atomicfu.loop' call
...
protoOf(DispatchedContinuation).k1p = function () {
  ...
  if (tmp0_safe_receiver == null)
    ...
    tmp0_safe_receiver.a1n();
  }
};
protoOf(DispatchedContinuation).h1m = function () {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.g1m_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (state === null) {
      this.g1m_1.kotlinx$atomicfu$value = get_REUSABLE_CLAIMED();
      return null;
    } else {
      if (state instanceof CancellableContinuationImpl) {
        if (this.g1m_1.atomicfu$compareAndSet(state, get_REUSABLE_CLAIMED())) {
...
protoOf(DispatchedContinuation).n1n = function (continuation) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.g1m_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (state === get_REUSABLE_CLAIMED()) {
      if (this.g1m_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), continuation))
        return null;
    } else {
      if (state instanceof Error) {
        // Inline function 'kotlin.require' call
        // Inline function 'kotlin.require' call
        if (!this.g1m_1.atomicfu$compareAndSet(state, null)) {
...
protoOf(DispatchedContinuation).l1m = function (cause) {
  // Inline function 'kotlinx.atomicfu.loop' call
  var this_0 = this.g1m_1;
  while (true) {
    var state = this_0.kotlinx$atomicfu$value;
    if (equals(state, get_REUSABLE_CLAIMED())) {
      if (this.g1m_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), cause))
        return true;
    } else {
      if (state instanceof Error)
        return true;
...
protoOf(DispatchedContinuation).d1n = function () {
  var state = this.e1m_1;
  // Inline function 'kotlinx.coroutines.assert' call
  this.e1m_1 = get_UNDEFINED();
  return state;
};
...
protoOf(DispatchedContinuation).v8 = function (result) {
  ...
  if (safeIsDispatchNeeded(this.c1m_1, this.q8())) {
    this.e1m_1 = state;
    this.k1m_1 = 0;
    safeDispatch(this.c1m_1, this.q8(), this);
  } else {
    $l$block: {
      // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
      // Inline function 'kotlinx.coroutines.assert' call
      var eventLoop = ThreadLocalEventLoop_getInstance().f1q();
      if (false && eventLoop.a1q()) {
        break $l$block;
      }
      var tmp;
      if (eventLoop.z1p()) {
        ...
        try {
          ...
          // Inline function 'kotlinx.coroutines.withCoroutineContext' call
          this.f1m_1;
          this.d1m_1.v8(result);
          $l$loop: while (eventLoop.x1p()) {
          }
        } catch ($p) {
          if ($p instanceof Error) {
            var e = $p;
...
protoOf(DispatchedContinuation).z1s = function (context, value) {
  this.e1m_1 = value;
  this.k1m_1 = 1;
  this.c1m_1.j1p(context, this);
};
protoOf(DispatchedContinuation).toString = function () {
  return 'DispatchedContinuation[' + this.c1m_1.toString() + ', ' + toDebugString(this.d1m_1) + ']';
};
protoOf(DispatchedContinuation).q8 = function () {
  return this.d1m_1.q8();
};
function safeDispatch(_this__u8e3s4, context, runnable) {
  _init_properties_DispatchedContinuation_kt__tnmqc0();
  try {
    _this__u8e3s4.i1p(context, runnable);
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
...
function safeIsDispatchNeeded(_this__u8e3s4, context) {
  _init_properties_DispatchedContinuation_kt__tnmqc0();
  try {
    return _this__u8e3s4.h1p(context);
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
      throw new DispatchException(e, _this__u8e3s4, context);
...
function yieldUndispatched(_this__u8e3s4) {
  ...
  $l$block: {
    ...
    // Inline function 'kotlinx.coroutines.assert' call
    var eventLoop = ThreadLocalEventLoop_getInstance().f1q();
    if (true && eventLoop.a1q()) {
      tmp$ret$1 = false;
      break $l$block;
    }
    var tmp;
    if (eventLoop.z1p()) {
      _this__u8e3s4.e1m_1 = Unit_instance;
      _this__u8e3s4.k1m_1 = 1;
      eventLoop.y1p(_this__u8e3s4);
      tmp = true;
    } else {
      // Inline function 'kotlinx.coroutines.runUnconfinedEventLoop' call
      eventLoop.b1q(true);
...
function resumeCancellableWith(_this__u8e3s4, result) {
  ...
  if (_this__u8e3s4 instanceof DispatchedContinuation) {
    ...
    var state = toState_0(result);
    if (safeIsDispatchNeeded(_this__u8e3s4.c1m_1, _this__u8e3s4.q8())) {
      _this__u8e3s4.e1m_1 = state;
      _this__u8e3s4.k1m_1 = 1;
      safeDispatch(_this__u8e3s4.c1m_1, _this__u8e3s4.q8(), _this__u8e3s4);
    } else {
      $l$block: {
        // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
        // Inline function 'kotlinx.coroutines.assert' call
...
function DispatchedTask(resumeMode) {
  ...
  this.k1m_1 = resumeMode;
}
protoOf(DispatchedTask).e1n = function (takenState, cause) {
};
protoOf(DispatchedTask).m1n = function (state) {
  return (state == null ? true : !(state == null)) ? state : THROW_CCE();
};
protoOf(DispatchedTask).w1n = function (state) {
  var tmp0_safe_receiver = state instanceof CompletedExceptionally ? state : null;
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.u1i_1;
};
protoOf(DispatchedTask).y1n = function () {
  // Inline function 'kotlinx.coroutines.assert' call
  try {
    var tmp = this.b1n();
    var delegate = tmp instanceof DispatchedContinuation ? tmp : THROW_CCE();
    var continuation = delegate.d1m_1;
    // Inline function 'kotlinx.coroutines.withContinuationContext' call
    delegate.f1m_1;
    var context = continuation.q8();
    var state = this.d1n();
    var exception = this.w1n(state);
    var job = exception == null && get_isCancellableMode(this.k1m_1) ? context.x8(Key_instance_2) : null;
    if (!(job == null) && !job.p1i()) {
      var cause = job.o1j();
      this.e1n(state, cause);
      // Inline function 'kotlinx.coroutines.resumeWithStackTrace' call
    ...
    if ($p instanceof DispatchException) {
      var e = $p;
      handleCoroutineException(this.b1n().q8(), e.l1p_1);
    } else {
      if ($p instanceof Error) {
        var e_0 = $p;
        this.z1n(e_0);
...
protoOf(DispatchedTask).z1n = function (exception) {
  var reason = new CoroutinesInternalError('Fatal exception in coroutines machinery for ' + toString(this) + '. ' + "Please read KDoc to 'handleFatalException' method and report this incident to maintainers", exception);
  handleCoroutineException(this.b1n().q8(), reason);
};
...
function dispatch(_this__u8e3s4, mode) {
  // Inline function 'kotlinx.coroutines.assert' call
  var delegate = _this__u8e3s4.b1n();
  ...
  if (tmp_0) {
    tmp = get_isCancellableMode(mode) === get_isCancellableMode(_this__u8e3s4.k1m_1);
  } else {
    tmp = false;
  }
  if (tmp) {
    var dispatcher = delegate.c1m_1;
...
function resumeUnconfined(_this__u8e3s4) {
  ...
  if (eventLoop.z1p()) {
    ...
    eventLoop.b1q(true);
    try {
      resume(_this__u8e3s4, _this__u8e3s4.b1n(), true);
      $l$loop: while (eventLoop.x1p()) {
      }
    } catch ($p) {
      if ($p instanceof Error) {
...
function resume(_this__u8e3s4, delegate, undispatched) {
  var state = _this__u8e3s4.d1n();
  var exception = _this__u8e3s4.w1n(state);
  var tmp;
  if (!(exception == null)) {
    // Inline function 'kotlin.Companion.failure' call
    tmp = _Result___init__impl__xyqfz8(createFailure(exception));
    ...
    // Inline function 'kotlin.Companion.success' call
    var value = _this__u8e3s4.m1n(state);
    tmp = _Result___init__impl__xyqfz8(value);
  }
  var result = tmp;
  if (undispatched) {
...
protoOf(ContextScope).o1i = function () {
  return this.a24_1;
};
...
protoOf(ScopeCoroutine).h1k = function () {
  return true;
};
protoOf(ScopeCoroutine).z1i = function (state) {
  resumeCancellableWith(intercepted(this.e24_1), recoverResult(state, this.e24_1));
};
protoOf(ScopeCoroutine).f24 = function () {
};
protoOf(ScopeCoroutine).y1i = function (state) {
  this.e24_1.v8(recoverResult(state, this.e24_1));
};
...
function startUndspatched(_this__u8e3s4, alwaysRethrow, receiver, block) {
  ...
  if (result === get_COROUTINE_SUSPENDED())
    return get_COROUTINE_SUSPENDED();
  var state = _this__u8e3s4.x1i(result);
  if (state === get_COMPLETING_WAITING_CHILDREN())
    return get_COROUTINE_SUSPENDED();
  _this__u8e3s4.f24();
  var tmp_1;
  if (state instanceof CompletedExceptionally) {
    var tmp_2;
    if (alwaysRethrow || notOwnTimeout(_this__u8e3s4, state.u1i_1)) {
      throw recoverStackTrace(state.u1i_1, _this__u8e3s4.e24_1);
    } else {
      if (result instanceof CompletedExceptionally) {
        throw recoverStackTrace(result.u1i_1, _this__u8e3s4.e24_1);
      } else {
        tmp_2 = result;
      }
    }
...
function dispatchExceptionAndMakeCompleting(_this__u8e3s4, e) {
  _this__u8e3s4.e1k(new CompletedExceptionally(e.l1p_1));
  throw recoverStackTrace(e.l1p_1, _this__u8e3s4.e24_1);
}
...
function trySelectInternal($this, clauseObject, internalResult) {
  $l$loop: while (true) {
    var curState = $this.b1w_1.kotlinx$atomicfu$value;
    if (isInterface(curState, CancellableContinuation)) {
      ...
      var clause = tmp;
      var onCancellation = clause.l24($this, internalResult);
      if ($this.b1w_1.atomicfu$compareAndSet(curState, clause)) {
        var cont = isInterface(curState, CancellableContinuation) ? curState : THROW_CCE();
        $this.d1w_1 = internalResult;
        if (tryResume_0(cont, onCancellation))
          return 0;
        $this.d1w_1 = get_NO_RESULT();
        return 2;
      }
    } else {
      var tmp_0;
      ...
      if (tmp_0)
        ...
        if (equals(curState, get_STATE_CANCELLED()))
          ...
          if (equals(curState, get_STATE_REG())) {
            if ($this.b1w_1.atomicfu$compareAndSet(curState, listOf_0(clauseObject)))
              return 1;
          } else {
            if (isInterface(curState, KtList)) {
              if ($this.b1w_1.atomicfu$compareAndSet(curState, plus_0(curState, clauseObject)))
                return 1;
            } else {
              // Inline function 'kotlin.error' call
...
protoOf(ClauseData).l24 = function (select, internalResult) {
  var tmp0_safe_receiver = this.k24_1;
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver(select, this.j24_1, internalResult);
};
function SelectImplementation() {
}
protoOf(SelectImplementation).e1w = function (clauseObject, result) {
...
function tryResume_0(_this__u8e3s4, onCancellation) {
  _init_properties_Select_kt__zhm2jg();
  var tmp0_elvis_lhs = _this__u8e3s4.o1l(Unit_instance, null, onCancellation);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
...
protoOf(NodeDispatcher).o24 = function () {
  process.nextTick(this.v24_1.t24_1);
};
...
function ScheduledMessageQueue(dispatcher) {
  ...
  this.s24_1 = dispatcher;
  var tmp = this;
  tmp.t24_1 = ScheduledMessageQueue$processQueue$lambda(this);
}
protoOf(ScheduledMessageQueue).a25 = function () {
  this.s24_1.o24();
};
protoOf(ScheduledMessageQueue).b25 = function () {
  setTimeout(this.t24_1, 0);
};
protoOf(ScheduledMessageQueue).c25 = function (timeout) {
  setTimeout(this.t24_1, timeout);
};
...
function WindowMessageQueue$lambda(this$0) {
  return function (event) {
    var tmp;
    if (event.source == this$0.m25_1 && event.data == this$0.n25_1) {
...
function WindowMessageQueue(window_0) {
  MessageQueue.call(this);
  this.m25_1 = window_0;
  this.n25_1 = 'dispatchCoroutine';
  this.m25_1.addEventListener('message', WindowMessageQueue$lambda(this), true);
}
protoOf(WindowMessageQueue).a25 = function () {
  var tmp = Promise.resolve(Unit_instance);
  tmp.then(WindowMessageQueue$schedule$lambda(this));
};
protoOf(WindowMessageQueue).b25 = function () {
  this.m25_1.postMessage(this.n25_1, '*');
};
...
function asPromise$lambda$lambda($this_asPromise, $reject, $resolve) {
  return function (it) {
    var e = $this_asPromise.l1k();
    var tmp;
    if (!(e == null)) {
      tmp = $reject(e);
    } else {
      tmp = $resolve($this_asPromise.i1l());
    }
    return Unit_instance;
  };
}
function asPromise$lambda($this_asPromise) {
  return function (resolve, reject) {
    $this_asPromise.r1j(asPromise$lambda$lambda($this_asPromise, reject, resolve));
    return Unit_instance;
  };
}
...
protoOf(UnconfinedEventLoop).i1p = function (context, block) {
  unsupported();
};
...
protoOf(SetTimeoutDispatcher).o24 = function () {
  this.v24_1.c25(0);
};
...
function SetTimeoutBasedDispatcher$scheduleResumeAfterDelay$lambda($continuation, this$0) {
  return function () {
    ...
    $continuation.q1l(this$0, Unit_instance);
    return Unit_instance;
  };
}
function SetTimeoutBasedDispatcher() {
  CoroutineDispatcher.call(this);
  this.v24_1 = new ScheduledMessageQueue(this);
}
protoOf(SetTimeoutBasedDispatcher).i1p = function (context, block) {
  this.v24_1.d25(block);
};
protoOf(SetTimeoutBasedDispatcher).s1p = function (timeMillis, continuation) {
...
function MessageQueue() {
  this.w24_1 = ArrayDeque_init_$Create$();
  this.x24_1 = 16;
  this.y24_1 = false;
}
protoOf(MessageQueue).d25 = function (element) {
  this.e25(element);
  if (!this.y24_1) {
    this.y24_1 = true;
    this.a25();
...
protoOf(MessageQueue).z24 = function () {
  try {
    // Inline function 'kotlin.repeat' call
    var times = this.x24_1;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
...
protoOf(MessageQueue).e25 = function (element) {
  return this.w24_1.f(element);
};
protoOf(MessageQueue).f = function (element) {
  return this.e25((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).f25 = function (index, element) {
  this.w24_1.n2(index, element);
};
...
protoOf(MessageQueue).g25 = function (elements) {
  return this.w24_1.u(elements);
};
...
protoOf(MessageQueue).h25 = function (index, element) {
  return this.w24_1.x(index, element);
};
protoOf(MessageQueue).x = function (index, element) {
  return this.h25(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
};
protoOf(MessageQueue).o2 = function (index) {
  return this.w24_1.o2(index);
};
protoOf(MessageQueue).y1 = function (index) {
  return this.w24_1.y1(index);
};
protoOf(MessageQueue).z1 = function (fromIndex, toIndex) {
  return this.w24_1.z1(fromIndex, toIndex);
};
protoOf(MessageQueue).k = function () {
  return this.w24_1.k();
};
protoOf(MessageQueue).i25 = function (element) {
  return this.w24_1.x1(element);
};
...
protoOf(MessageQueue).v = function (index) {
  return this.w24_1.v(index);
};
protoOf(MessageQueue).t = function () {
  return this.w24_1.sd_1;
};
function WindowClearTimeout($outer, handle) {
  this.v25_1 = $outer;
  ClearTimeout.call(this, handle);
}
protoOf(WindowClearTimeout).a1m = function () {
  w3cClearTimeout(this.v25_1.x25_1, this.z25_1);
};
...
function WindowDispatcher(window_0) {
  CoroutineDispatcher.call(this);
  this.x25_1 = window_0;
  this.y25_1 = new WindowMessageQueue(this.x25_1);
}
protoOf(WindowDispatcher).i1p = function (context, block) {
  return this.y25_1.d25(block);
};
protoOf(WindowDispatcher).s1p = function (timeMillis, continuation) {
  var handle = w3cSetTimeout_0(this.x25_1, WindowDispatcher$scheduleResumeAfterDelay$lambda(continuation, this), delayToInt(timeMillis));
...
protoOf(ClearTimeout).a1m = function () {
  w3cClearTimeout_0(this.z25_1);
};
protoOf(ClearTimeout).z1l = function (cause) {
  this.a1m();
};
protoOf(ClearTimeout).toString = function () {
  return 'ClearTimeout[' + this.z25_1 + ']';
};
function get_DefaultDelay() {
  var tmp = Dispatchers_getInstance().n1p_1;
...
function newCoroutineContext(_this__u8e3s4, context) {
  var combined = _this__u8e3s4.o1i().tf(context);
  return !(combined === Dispatchers_getInstance().n1p_1) && combined.x8(Key_instance) == null ? combined.tf(Dispatchers_getInstance().n1p_1) : combined;
}
...
function Dispatchers() {
  ...
  this.n1p_1 = createDefaultDispatcher();
  this.o1p_1 = Unconfined_getInstance();
  this.p1p_1 = new JsMainDispatcher(this.n1p_1, false);
  this.q1p_1 = null;
}
protoOf(Dispatchers).r1p = function () {
  var tmp0_elvis_lhs = this.q1p_1;
  return tmp0_elvis_lhs == null ? this.p1p_1 : tmp0_elvis_lhs;
};
...
function JsMainDispatcher(delegate, invokeImmediately) {
  ...
  this.b26_1 = delegate;
  this.c26_1 = invokeImmediately;
  this.d26_1 = this.c26_1 ? this : new JsMainDispatcher(this.b26_1, true);
}
protoOf(JsMainDispatcher).r1s = function () {
  return this.d26_1;
};
protoOf(JsMainDispatcher).h1p = function (context) {
  return !this.c26_1;
};
protoOf(JsMainDispatcher).i1p = function (context, block) {
  return this.b26_1.i1p(context, block);
};
protoOf(JsMainDispatcher).j1p = function (context, block) {
  return this.b26_1.j1p(context, block);
};
protoOf(JsMainDispatcher).toString = function () {
  var tmp0_elvis_lhs = this.s1s();
  return tmp0_elvis_lhs == null ? this.b26_1.toString() : tmp0_elvis_lhs;
};
...
protoOf(JobCancellationException).toString = function () {
  return protoOf(CancellationException).toString.call(this) + '; job=' + toString(this.e26_1);
};
protoOf(JobCancellationException).equals = function (other) {
  ...
  if (other === this) {
    ...
    if (tmp_2) {
      tmp_1 = equals(other.e26_1, this.e26_1);
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
...
protoOf(JobCancellationException).hashCode = function () {
  var tmp = imul(imul(getStringHashCode(ensureNotNull(this.message)), 31) + hashCode(this.e26_1) | 0, 31);
...
function SafeCollector(collector, collectContext) {
  this.e20_1 = collector;
  this.f20_1 = collectContext;
  var tmp = this;
  tmp.g20_1 = this.f20_1.sf(0, SafeCollector$collectContextSize$lambda);
  this.h20_1 = null;
}
protoOf(SafeCollector).s1z = function (value, $completion) {
  // Inline function 'kotlinx.coroutines.currentCoroutineContext' call
  // Inline function 'kotlin.js.getCoroutineContext' call
  var currentContext = $completion.q8();
  ensureActive(currentContext);
  if (!(this.h20_1 === currentContext)) {
    checkContext(this, currentContext);
    this.h20_1 = currentContext;
  }
  return this.e20_1.s1z(value, $completion);
};
...
protoOf(LockFreeLinkedListNode).q1o = function (node, permissionsBitmask) {
  var prev = this.o1o_1;
  var tmp;
  if (prev instanceof ListClosed) {
    tmp = ((prev.i26_1 & permissionsBitmask) === 0 && prev.q1o(node, permissionsBitmask));
  } else {
    node.n1o_1 = this;
    node.o1o_1 = prev;
    prev.n1o_1 = node;
...
protoOf(LockFreeLinkedListNode).o1q = function (forbiddenElementsBit) {
  this.q1o(new ListClosed(forbiddenElementsBit), forbiddenElementsBit);
};
protoOf(LockFreeLinkedListNode).r1o = function () {
  if (this.p1o_1)
    return false;
  var prev = this.o1o_1;
  var next = this.n1o_1;
...
protoOf(LockFreeLinkedListNode).s1o = function (node) {
  if (!(this.n1o_1 === this))
    return false;
  this.q1o(node, -2147483648);
  return true;
};
function ListClosed(forbiddenElementsBitmask) {
  LockFreeLinkedListNode.call(this);
  this.i26_1 = forbiddenElementsBitmask;
}
...
protoOf(CommonThreadLocal).h1q = function () {
  var tmp = this.g1q_1;
  return (tmp == null ? true : !(tmp == null)) ? tmp : THROW_CCE();
};
protoOf(CommonThreadLocal).i1q = function (value) {
  this.g1q_1 = value;
};
...
protoOf(JobSupport).x1j = cancel$default;
...
protoOf(BufferedChannel).q1x = close$default;
protoOf(ChannelCoroutine).q1x = close$default;
